...
\usepackage[paperwidth=130mm, paperheight=186mm, top=0mm, bottom=0mm, left=0mm, right=0mm]{geometry}
% formatage marges, etc.
\setlength{\voffset}{-18mm} % offset haut
\setlength{\hoffset}{-5mm} % offset gauche
\setlength{\topmargin}{0mm} % marge en tête
\setlength{\headsep}{5mm} % marge header/body
\setlength{\oddsidemargin}{-10mm} % marge texte gauche
\setlength{\evensidemargin}{-10mm} % marge texte droite
\setlength{\textheight}{159mm} % hauteur du texte
...
\clearpage\input{bjc_2014/annexes/torah}
\clearpage\input{bjc_2014/01-Genese}
\clearpage\input{bjc_2014/annexes/notes}
...
\clearpage\input{bjc_2014/annexes/neviim}
...
\clearpage\input{bjc_2014/annexes/ketouvim}
...
\clearpage\input{bjc_2014/annexes/evangiles}
...
\clearpage\input{bjc_2014/annexes/testament}
