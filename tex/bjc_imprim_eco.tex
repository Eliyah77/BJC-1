...
\usepackage[paperwidth=5.1141in, paperheight=7.0866in, top=0in, bottom=0in, left=0in, right=0in]{geometry}
...
\setlength{\textheight}{6in} % hauteur du texte
\setlength{\textwidth}{4.1in} % largeur du texte
...
\usepackage{setspace}
% définition police
\setmainfont[Ligatures=TeX,Scale=0.80]{Liberation Serif}
