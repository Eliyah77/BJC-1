...
\VS{12}Car c'est ici notre gloire, à savoir le témoignage de notre conscience, que nous nous sommes conduits dans le monde, et particulièrement avec vous, avec la simplicité et la sincérité de Dieu, non point avec une sagesse charnelle, mais selon la grâce de Dieu.
...
\VS{6}qui nous a aussi rendus capables d'être serviteurs de la Nouvelle Alliance\FTNT{Dans la plupart des versions, le mot grec « diatheke » a été traduit par « testament » alors que ce mot signifie aussi « alliance ». On le retrouve notamment dans les passages suivants : \vref{Mt. 26:28} ; \vref{Mc. 14:24} ; \vref{Lu. 1:72} ; \vref{22:20} ; \vref{Ac. 3:25} ; \vref{7:8} ; \vref{Ga. 3:15,17} ; \vref{4:24} ; \vref{1 Co. 11:25} ; \vref{Ro. 9:4} ; \vref{11:27} ; \vref{Ep. 2:12} ; \vref{Hé. 7:22} ; \vref{8:6,8-9} ; \vref{9:4,15-17,20} ; \vref{10:16,29} ; \vref{12:24} ; \vref{13:20} ; \vref{Ap. 11:19}. Le fait d'avoir regroupé les écrits de Genèse à Malachie sous l'appellatif « Ancien Testament » a induit beaucoup de chrétiens en erreur. L'Ancienne Alliance correspond uniquement à la loi cérémonielle de Moïse qui a été accomplie par Christ à la croix (\vref{Jn. 19:30}). Ainsi, avant la mort du Seigneur, on ne peut pas parler de testament puisqu'il faut qu'il y ait au préalable la mort du testateur. Or il est évident que les animaux sacrifiés sous la loi ne nous ont rien légué (\vref{Hé. 9:1-16}).}, non de la lettre, mais de l'Esprit ; car la lettre tue, mais l'Esprit vivifie.
...
\VS{13}Nous ne sommes pas comme Moïse qui mettait un voile sur son visage, afin que les enfants d'Israël ne fixent pas les regards sur la fin de ce qui devait être anéanti\FTNT{Ce mot grec signifie aussi : rendre vain, inemployé, inactif, cessé, abolir (voir \vref{Ep. 2:15}, \vref{Ro. 3:3} ; \vref{3:31} ; \vref{4:14}}.
...
\Chap{4}
\TextTitle{La vérité pratique du service de Paul}
...
\VS{6}Car Dieu, qui a dit que la lumière resplendisse des ténèbres\FTNT{\vref{Ge. 1:3}.}, est celui qui a resplendi dans nos cœurs, pour manifester la connaissance de la gloire de Dieu qui se trouve en Jésus-Christ.
...
\VS{13}Or ayant un même esprit de foi, selon qu'il est écrit : J'ai cru, c'est pourquoi j'ai parlé\FTNT{\vref{Ps. 116:10}.} ! Nous croyons et c'est pourquoi nous parlons,
...
\Chap{6}
\TextTitle{La perseverance}
\VerseOne{}Ainsi donc étant ouvriers avec lui, nous vous prions aussi à ne pas recevoir la grâce de Dieu en vain.
\VS{2}Car il dit : Je t'ai exaucé au temps favorable et t'ai secouru au jour du salut\FTNT{\vref{Es. 49:8}.} ; voici maintenant le temps favorable, voici maintenant le jour du salut.
\VS{3}Ne donnons aucun scandale en quoi que ce soit, afin que notre service ne soit point blâmé.
...
\VS{16}Et quel rapport y a-t-il entre le temple de Dieu et les idoles ? Car vous êtes le temple du Dieu vivant, selon ce que Dieu a dit : J'habiterai au milieu d'eux et j'y marcherai ; je serai leur Dieu et ils seront mon peuple\FTNT{\vref{Lé. 26:12} ; \vref{Ez. 37:26}.}.
\VS{17}C'est pourquoi, sortez du milieu d'eux et séparez-vous, dit le Seigneur ; ne touchez à aucune chose souillée et je vous recevrai\FTNT{\vref{Es. 52:11} ; \vref{Ap. 18:4}.}.
\VS{18}Je serai pour vous un Père et vous serez pour moi des fils et des filles, dit le Seigneur Tout-Puissant\FTNT{\vref{Jn. 1:12} ; \vref{Ap. 21:7}.}.
\Chap{7}
...
\VS{15}selon ce qui est écrit : Celui qui avait beaucoup n'a rien eu de superflu, et celui qui avait peu n'en a pas eu moins\FTNT{\vref{Ex. 16:18}.}.
...
\VS{9}selon ce qui est écrit : Il a fait des largesses, il a donné aux pauvres. Sa justice demeure éternellement\FTNT{\vref{Ps. 112:9}.}.
...
\VS{18}Car ce n'est pas celui qui se recommande lui-même qui est approuvé, mais celui que le Seigneur recommande\FTNT{Le Seigneur recommande ses serviteurs, il témoigne d'eux auprès des autres (\vref{Ac. 10:1-48}). Un véritable serviteur de Dieu laisse au Seigneur le soin de témoigner de lui auprès des autres, alors que les faux ouvriers se recommandent eux-mêmes (\vref{2 Co. 3:1}).}.
\Chap{11}
...
\VS{3}Mais je crains que comme le serpent séduisit Eve\FTNT{\vref{Ge. 3:1-6}.} par sa ruse, vos pensées aussi ne se corrompent en se détournant de la simplicité qui est en Christ.
...
\TextTitle{Paul se glorifie de sa faiblesse\FTNTT{\vref{2 Co. 11:16-12:18}}}
...
\VerseOne{}C'est ici la troisième fois que je viens à vous. Par la bouche de deux ou de trois témoins,\FTNT{\vref{De. 19:15}.} toute parole sera confirmée.
