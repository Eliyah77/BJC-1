...
\VS{22}qui nous a aussi marqués d’un sceau, et nous a donné les arrhes\FTNT{Du grec «~arrhabon~»~: arrhes~; monnaie donnée en gage d’un futur paiement, en attendant que le solde soit payé.} de l'Esprit dans nos cœur.
...
\VS{3}Et je vous ai même écrit ceci, afin que quand j'arriverai, je n'aie point de tristesse de la part de ceux de qui je devais recevoir de la joie, ayant cette confiance à l'égard de vous tous que ma joie est celle de vous tous.
...
\VS{5}Si quelqu'un a été la cause de cette tristesse, ce n'est pas moi seul qu'il a attristé, mais en quelque sorte (afin que je ne vous surcharge pas) c'est vous tous[qu'il avait attristé].
...
\VS{12}Au reste, étant venu à Troas pour l'Evangile de Christ, quoique la porte m'y fût ouverte par le Seigneur, je n’ai pourtant point eu de repos en mon esprit, parce que je n'ai pas trouvé pas Tite, mon frère ;
...
\VS{13}Or ayant un même esprit de foi, selon qu'il est écrit : J'ai cru, c'est pourquoi j'ai parlé\FTNT{Ps. 116:10.} ! Nous croyons aussi , et c'est aussi pourquoi aussi nous parlons,
...
\VS{15}et qu'il est mort pour tous, afin que ceux qui vivent, dorénavant pour eux-mêmes, mais pour celui qui est mort et ressuscité pour eux.
...
\VS{8}Car bien que je vous vous aie attristés par ma lettre, je ne m'en repens pas. Et si je m'en suis repenti, car je vois que cette lettre vous a affligés, bien que momentanément,
...
\VS{6}Nous avons exhorté Tite, comme il avait auparavant commencé, qu'il achève aussi cette grâce\FTNT{Autre traduction : «~Œuvre de charité~»} envers vous.
\TextTitle{Exemple du Messie}
\VS{7}C'est pourquoi, comme vous excellez en toutes choses, en foi, en parole, en connaissance, en toute diligence, et dans la charité que vous avez pour nous, faites en sorte d’exceller aussi dans cette grâce.
\VS{8}Je ne dis pas cela pour vous donner un ordre, mais pour éprouver par la diligence des autres la sincérité de votre charité.
...
\VS{10}C'est un avis que je donne là-dessus, car cela vous convient, à vous qui non seulement avez commencé à agir, mais qui en avez eu la volonté dès l'année dernière.
...
\VS{17}lequel a bien reçu mon exhortation, et c'est avec un zèle nouveau et de son plein gré qu'il part pour aller chez vous.
\VS{18}Et nous avons aussi envoyé avec lui le frère dont la louange dans l'Evangile est répandue par toutes les églises ;
\VS{19}de plus, il a été choisi par élection des églises pour être notre compagnon de voyage et pour cette grâce\FTNT{ également traduit par «~les aumônes~»} qui est administrée par nous à la gloire du Seigneur même, et afin de répondre à l’ardeur de votre zèle.
...
\VS{2}Je connais un homme en Christ, qui fut ravi jusqu’au troisième ciel, il y a quatorze ans, (si ce fut dans son corps, je ne sais pas ; si ce fut hors du corps, je ne sais pas ; Dieu le sait).
...
\VS{10}Et à cause de cela je prends plaisir dans les infirmités, dans les outrages, dans les nécessités, dans les persécutions, et dans les angoisses pour Christ ; car quand je suis faible, c'est alors que je suis fort.
\TextTitle{Avertissements}
\VS{11}J'ai été insensé en me glorifiant, mais vous m'y avez contraint ; c’est par vous que je devais être recommandé, car je n'ai été inférieur en rien aux plus excellents apôtres, quoique je ne sois rien.
\VS{12}Certainement les marques de mon apostolat ont éclaté au milieu de vous par une patience à toute épreuve, par des signes, des prodiges et des miracles.
...
\VS{18}J'ai prié Tite d'aller chez vous, et avec lui j’ai envoyé le frère. Tite a-t-il tiré profit de vous ? Et n'avons-nous pas lui et moi marché d'un même esprit ? N'avons-nous pas marché sur les mêmes traces ?
...
\VS{20}Car je crains de ne pas vous trouver, à mon arrivée, tels que je voudrais, et que je sois trouvé par vous tel que vous ne voudriez pas. Je crains de trouver des querelles, des envies, des colères, des débats, des médisances, des murmures, des enflures d'orgueil, des désordres.
...
\VerseOne{}C'est ici la troisième fois que je viens à vous. Toute affaire se réglera sur la déclaration de deux ou de trois témoins\FTNT{De. 19:15.}.
...
\VS{4}Car il a été crucifié dans sa faiblesse, mais il vit par la puissance de Dieu ; et nous de même, nous sommes aussi faibles comme lui, mais nous vivrons avec lui par la puissance que Dieu a déployée envers vous.
...
\VS{6}Mais j'espère que vous reconnaîtrez que nous, nous ne sommes pas réprouvés.
\VS{7}Et je prie Dieu que vous ne fassiez rien de mal, non pour paraître nous-mêmes approuvés, mais afin que vous fassiez ce qui est bien et que nous, nous soyons comme des réprouvés.
\VS{8}Car nous ne pouvons rien contre la vérité, mais pour la vérité.
\VS{9}Nous nous réjouissons lorsque nous sommes faibles, tandis que vous êtes forts ; et ce que nous demandons à Dieu, c’est votre entier accomplissement.
...
\VS{11}Au reste, mes frères, réjouissez-vous, tendez à vous rendre parfaits, soyez consolés, ayez un même sentiment, vivez en paix ; et le Dieu de charité et de paix sera avec vous.
