...
\VS{3}Car il paraît en vous que vous êtes la lettre de Christ, gravée par notre service, non avec de l'encre, mais avec l'Esprit du Dieu vivant, non sur des tables de pierre, mais sur les tables de chair, qui sont vos cœurs.
...
\VS{13}Or ayant un même esprit de foi, selon qu'il est écrit~: J'ai cru, c'est pourquoi j'ai parlé\FTNT{Ps. 116:10.}~! Nous croyons et c'est pourquoi nous parlons,
...
\VS{16}C'est pourquoi nous ne nous relâchons pas. Mais quoique notre homme extérieur se détruise, toutefois l'intérieur est renouvelé de jour en jour.
...
\VS{15}et qu'il est mort pour tous, afin que ceux qui vivent, ne vivent pas dorénavant pour eux-mêmes, mais pour celui qui est mort et ressuscité pour eux.
...
\VS{7}Mais que chacun contribue selon ce qu'il a résolu dans son cœur, non pas avec chagrin, non par contrainte, car Dieu aime celui qui donne avec joie.
