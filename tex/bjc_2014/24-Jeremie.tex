...
\VS{3}Et la mort sera plus désirable que la vie pour tous ceux qui resteront de cette race mauvaise, ceux qui seront restés dans tous les lieux où je les aurai chassés, dit Yahweh des armées.
...
\VS{6}Je suis attentif et j'écoute, mais nul ne parlent selon la justice ; il n'y a personne qui se repente de sa méchanceté, disant : Qu'ai-je fait ? Tous ils retournent à leur course, comme le cheval qui se précipite au combat.
\VS{7}Même la cigogne connaît dans les cieux ses saisons ; la tourterelle et l'hirondelle, et la grue observent le temps où elles doivent venir ; mais mon peuple ne connaît pas les règles établies de Yahweh\FTNT{Mt. 16:3.}.
