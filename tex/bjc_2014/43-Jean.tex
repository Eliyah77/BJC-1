...
\begin{multicols}{2}
\Chap{1}
\TextTitle{La divinité de Jésus-Christ\FTNTT{\vref{Jn. 10:30} ; \vref{Hé. 1:5-13}.}}
...
\VS{4}En elle était la vie, et la vie était la lumière des hommes\FTNT{Jésus-Christ notre lumière : \vref{Es. 60:19-20}.}.
...
\TextTitle{Jésus-Christ, la véritable lumière\FTNTT{\vref{Jn. 3:17-21} ; \vref{8:12} ; \vref{9:5} ; \vref{12:46}.}}
...
\VS{11}Il\FTNT{Il est question ici du logos, d'où l'emploi du pronom personnel « il ».} est venu chez les siens, et les siens ne l'ont point reçu.
...
\TextTitle{La Parole faite chair\FTNTT{\vref{Mt. 1:18-23} ; \vref{Lu. 1:30-35} ; \vref{2:11} ; \vref{Jn. 14:9} ; \vref{1 Ti. 3:16}.}}
...
\TextTitle{Témoignage de Jean-Baptiste\FTNTT{\vref{Mt. 3:1-12} ; \vref{Mc. 1:1-11} ; \vref{Lu. 3:1-22}.}}
...
\VS{21}Et ils lui demandèrent : Quoi donc ? Es-tu Elie ? Et il dit : Je ne le suis point\FTNT{En \vref{Mt. 11:14} Jésus confirme pourtant que Jean-Baptiste est bien l'Elie qui devait venir. Comment expliquer qu'il nia l'être lorsqu'il fut interrogé par les pharisiens ? La seule explication plausible c'est qu'il l'ignorait. Toutefois, il avait conscience qu'il était « la voix » prophétisée par Esaïe. Remarquez que lorsqu'il fut emprisonné, il avait envoyé quelques-uns de ses disciples pour demander à Jésus s'il était bien le Messie (\vref{Mt. 11:13} ; \vref{Lu. 7:19-20}) alors qu'il fut le premier à rendre témoignage du Seigneur. Ces éléments ne sont pas contradictoires, ils ne font que révéler les failles liées à la nature humaine de Jean.}. Es-tu le Prophète ? Et il répondit : Non.
...
\VS{23}Il dit : Je suis la voix de celui qui crie dans le désert : Aplanissez le chemin du Seigneur, comme a dit Esaïe le prophète\FTNT{\vref{Es. 40:3}.}.
...
\TextTitle{Premiers disciples de Jésus-Christ\FTNTT{\vref{Mt. 4:18-22} ; \vref{Mc. 1:16-20} ; \vref{Lu. 5:1-11}.}}
...
\TextTitle{La première Pâque\FTNTT{\vref{Jn. 6:4} ; \vref{11:55}.}}
...
\VS{17}Alors ses disciples se souvinrent qu'il était écrit : Le zèle de ta maison me dévore\FTNT{\vref{Ps. 69:10}.}.
...
\VS{3}Jésus répondit, et lui dit : En vérité, en vérité je te dis : Si quelqu'un ne naît d'en haut\FTNT{Naître d'en haut : Dans la plupart des Bibles modernes, on trouve l'expression naître « de nouveau », or cette traduction n'est pas correcte puisque le texte grec utilise l'expression naître « d'en haut ». L'adverbe « d'en haut » vient du mot grec « anothen » qui signifie : depuis le haut, depuis un endroit plus élevé, ce qui vient des cieux ou de Dieu, depuis le début, l'origine. Ce mot se retrouve dans \vref{Mt. 27:51} ; \vref{Mc. 15:38} ; \vref{Lu. 1:3} ; \vref{Jn. 3:31} ; \vref{Jn. 19:11} ; \vref{Jn. 19:23} ; \vref{Ja. 1:17} ; \vref{Ja. 3:15} ; \vref{Ja. 3:17}. « Anothen » vient de « ano » : choses d'en haut. En \vref{Ga. 4:26} « ano » peut se référer au lieu ou au temps. Le lieu : La Jérusalem qui est au-dessus, dans les cieux. Le temps : La Jérusalem céleste qui a précédé la terrestre. Le mot « ano » a été traduit par « en haut » dans \vref{Jn. 8:23} ; \vref{Jn. 11:41} ; \vref{Ac. 2:19} ; \vref{Ga. 4:26} ; \vref{Col. 3:1-2} ; et par « céleste » dans \vref{Ph. 3:14}. Jésus nous enseigne donc que la naissance d'en haut est une naissance qui a eu lieu dans la Nouvelle Jérusalem.}, il ne peut voir le Royaume de Dieu.
...
\VS{14}Or comme Moïse éleva le serpent\FTNT{Le serpent d'airain : \vref{No. 21:9}}dans le désert, ainsi il faut de même que le Fils de l'homme soit élevé,
...
\VS{5}il arriva dans une ville de Samarie, nommée Sychar, près du champ que Jacob avait donné à Joseph son fils\FTNT{\vref{Ge. 48:22}.}.
...
\TextTitle{Le témoignage du Père\FTNTT{\vref{Mt. 3:17}.}}
...
\TextTitle{Le témoignage de l'Ecriture\FTNTT{\vref{Lu. 24:27,44}.}}
...
\Chap{6}
\TextTitle{Multiplication des pains\FTNTT{\vref{Mt. 14:15-21} ; \vref{Mc. 6:32-44} ; \vref{Lu. 9:12-17}.}}
...
\TextTitle{Jésus marche sur les eaux\FTNTT{\vref{Mt. 14:22-33} ; \vref{Mc. 6:45-52}.}}
...
\TextTitle{Mise à l'épreuve de la consécration des disciples\FTNTT{\vref{Mt. 8:19-22} ; \vref{10:36} ; \vref{Lu. 9:23-26}.}}
...
\TextTitle{Pierre reconnaît Jésus comme le Messie\FTNTT{\vref{Mt. 16:13-16} ; \vref{Mc. 8:27-30} ; \vref{Lu. 9:18-21}.}}
...
\TextTitle{La puissance du Saint-Esprit\FTNTT{\vref{Jn. 4:14} ; \vref{Ac. 2:2-4}.}}
...
\TextTitle{Témoignage du Messie\FTNTT{\vref{Jn. 1:9}.}}
...
\VS{17}Il est même écrit dans votre loi que le témoignage de deux hommes est digne de foi\FTNT{\vref{De. 19:15}.}.
...
\VS{58}Et Jésus leur dit : En vérité, en vérité je vous le dis : Avant qu'Abraham fût, Je suis\FTNT{Je suis : L'évangile de Jean rapporte plusieurs déclarations incroyables que Jésus a faites à son sujet : Je suis le pain de vie (\vref{6:35}), Je suis la lumière du monde (\vref{8:12}), Je suis le bon berger (\vref{10:11}), Je suis la porte (\vref{10:7}), Je suis la résurrection (\vref{11:25}), Je suis le chemin, la vérité et la vie (\vref{14:6}), Je suis le vrai cep (\vref{15:1}). Toutefois, dans ce verset, en déclarant être « Je suis », il s'identifie clairement au Nom que YHWH avait révélé à Moïse dans \vref{Ex. 3:14}. C'est précisément pour cette raison que les Juifs ont voulu le lapider.}.
...
\VS{38}Alors il dit : Je crois, Seigneur ; et il l'adora\FTNT{Au travers de la lecture de la Bible, on constate que les anges refusent l'adoration (\vref{Ap. 19:9-10}) de même que les apôtres (\vref{Ac. 10:25-26} ; \vref{Ac. 14:5-18}). Seul Dieu accepte l'adoration puisqu'il en est le seul digne. Jésus n'a jamais refusé l'adoration des hommes, car il est Dieu.}.
...
\Chap{10}
\TextTitle{Jésus, le bon berger\FTNTT{\vref{Ps. 23} ; \vref{Hé. 13:20} ; \vref{1 Pi. 5:4}.}}
...
\VS{7}Jésus donc leur dit encore : En vérité, en vérité, je vous dis : Je suis la porte par où entrent les brebis\FTNT{Les animaux destinés au sacrifice passaient sans doute par la porte des brebis construite du temps de Néhémie (\vref{Né. 3:1}).}.
...
\VS{34}Jésus leur répondit : N'est-il pas écrit dans votre loi : J'ai dit : Vous êtes des dieux\FTNT{\vref{Ps. 82:6} : Le sens du mot « dieu » peut désigner des personnes ayant un certain pouvoir. D'ailleurs, le mot hébreu utilisé dans \vref{Ps. 82:6} est « Elohim », or ce mot signifie aussi « juge ». De plus, dans le contexte du psaume, « vous êtes des dieux » ne s'applique pas à tous, mais seulement à une certaine catégorie de personnes qui exerçaient un pouvoir en Israël : rois, scribes, grands prêtres, etc. Rappelons-nous aussi que Dieu a fait de Moïse un dieu pour Aaron (\vref{Ex. 7:1-2}), mais cela n'a pas fait de lui le Dieu Créateur pour autant. En \vref{Jn. 17:3}, Jésus atteste qu'il n'y a qu'un seul vrai Dieu. Satan veut nous faire croire que nous sommes des dieux et nous amener ainsi à pécher par l'orgueil (\vref{Ge. 3:5}). Toutefois, comme le souligne si bien l'apôtre Paul, même s'il existe des créatures qu'on appelle dieux ou déesses, il ne reste pas moins vrai qu'il n'y a qu'un seul Dieu (\vref{1 Co. 8:5-7}).} ?
...
\TextTitle{Conspiration des pharisiens\FTNTT{\vref{Jn. 12:10-11}.}}
...
\VS{49}Alors l'un d'eux appelé Caïphe, qui était le premier prêtre cette année-là, leur dit : Vous n'y comprenez rien.
...
\VS{51}Or il ne dit pas cela de lui-même ; mais étant premier prêtre de cette année-là, il prophétisa que Jésus devait mourir pour la nation.
...
\Chap{12}
\TextTitle{Jésus oint par Marie de Béthanie\FTNTT{\vref{Mt. 26:6-13} ; \vref{Mc. 14:3-9}.}}
...
\TextTitle{Entrée de Jésus à Jérusalem, des Grecs cherchent à le voir\FTNTT{\vref{Za. 9:9} ; \vref{Mt. 21:1-11} ; \vref{Mc. 11:1-11} ; \vref{Lu. 19:28-40} ; \vref{Ap. 19:11-16}.}}
...
\VS{15}Ne crains point, fille de Sion ; voici, ton Roi vient, assis sur le petit d'une ânesse\FTNT{\vref{Za. 9:9}.}.
...
\VS{38}afin que s'accomplisse cette parole qui a été dite par Esaïe le prophète : Seigneur, qui a cru à notre parole ? Et à qui a été révélé le bras du Seigneur\FTNT{\vref{Es. 53:1}.} ?
\VS{39}C'est pourquoi ils ne pouvaient croire, parce qu'Esaïe a dit encore :
\VS{40}Il a aveuglé leurs yeux ; et il a endurci leur cœur, de peur qu'ils ne voient de leurs yeux, qu'ils ne comprennent du cœur, qu'ils ne se convertissent, et que je ne les guérisse\FTNT{\vref{Es. 6:9-10}.}.
...
\TextTitle{Jésus lave les pieds de ses disciples\FTNTT{\vref{Mt. 26:20-24} ; \vref{Mc. 14:17} ; \vref{Lu. 22:14,21-23}.}}
...
\VS{18}Je ne parle pas de vous tous ; je connais ceux que j'ai choisis. Mais il faut que l'Ecriture s'accomplisse : Celui qui mange le pain avec moi, a levé son talon contre moi\FTNT{\vref{Ps. 41:10}.}.
...
\TextTitle{Jésus annonce la trahison de Judas et le reniement de Pierre\FTNTT{\vref{Mt. 26:21-25} ; \vref{Mc. 14:18-21} ; \vref{Lu. 22:21-23}.}}
...
\VS{25}Mais cela est arrivé afin que s'accomplisse la parole qui est écrite dans leur loi : Ils m'ont haï sans cause\FTNT{\vref{Ps. 35:19} ; \vref{Ps. 69:5}.}.
...
\Chap{16}
\TextTitle{Avertissement de Jésus\FTNTT{\vref{Mt. 24:9-10} ; \vref{Lu. 21:16-19}.}}
...
\Chap{17}
\TextTitle{L'intercession du Messie, le premier prêtre}
...
\Chap{18}
\TextTitle{Gethsémané\FTNTT{\vref{Mt. 26:36-46} ; \vref{Mc. 14:32-42} ; \vref{Lu. 22:39-46}.}}
...
\TextTitle{La trahison et l'arrestation de Jésus\FTNTT{\vref{Mt. 26:47-56} ; \vref{Mc. 14:43-50} ; \vref{Lu. 22:47-54}.}}
...
\VS{5}Ils lui répondirent : Jésus de Nazareth. Jésus leur dit : Moi, Je suis\FTNT{« Moi, Je suis » (En grec « ego eimi »), ce qui fait écho au nom sous lequel Dieu s'était révélé à Moïse en \vref{Ex. 3:14}.}. Et Judas, qui le trahissait, était aussi avec eux.
...
\VS{10}Alors Simon Pierre, qui avait une épée, la tira, et frappa un serviteur du premier prêtre, et lui coupa l'oreille droite. Ce serviteur s'appelait Malchus.
\VS{11}Mais Jésus dit à Pierre : Remets ton épée dans le fourreau. Ne boirai-je pas la coupe que le Père m'a donnée ?
\TextTitle{Jésus devant le premier prêtre\FTNTT{\vref{Mt. 26:57-68} ; \vref{Mc. 14:53-65} ; \vref{Lu. 22:54}.}}
\VS{12}La cohorte, le tribun, et les huissiers des Juifs, se saisirent alors de Jésus, et le lièrent.
\VS{13}Et ils l'emmenèrent premièrement chez Anne ; car il était le beau-père de Caïphe, qui était le premier prêtre de cette année-là.
...
\TextTitle{Le reniement de Pierre\FTNTT{\vref{Mt. 26:69-75} ; \vref{Mc. 14:66-72} ; \vref{Lu. 22:54-62}.}}
\VS{15}Or Simon Pierre, avec un autre disciple, suivait Jésus. Et ce disciple était connu du premier prêtre, et il entra avec Jésus dans la cour du premier prêtre ;
\VS{16}mais Pierre était dehors à la porte. Et l'autre disciple, qui était connu du premier prêtre, sortit dehors et parla à la portière, et fit entrer Pierre.
...
\VS{19}Et le premier prêtre interrogea Jésus sur ses disciples et sur sa doctrine.
...
\VS{22}Quand il eut dit ces choses, un des huissiers, qui se tenait là, donna un coup de sa verge à Jésus, en lui disant : Est-ce ainsi que tu réponds au premier prêtre ?
...
\VS{24}Or Anne l'envoya lié à Caïphe, le premier prêtre.
...
\VS{26}Et un des serviteurs du premier prêtre, parent de celui à qui Pierre avait coupé l'oreille, dit : Ne t'ai-je pas vu dans le jardin avec lui ?
\VS{27}Mais Pierre le nia de nouveau. Et aussitôt le coq chanta.
\TextTitle{Jésus devant Pilate\FTNTT{\vref{Mt. 27:2,11-14} ; \vref{Mc. 15:1-5} ; \vref{Lu. 23:1-7,13-15}.}}
...
\TextTitle{Barabbas libéré et Jésus condamné\FTNTT{\vref{Mt. 27:15-21} ; \vref{Mc. 15:6-15} ; \vref{Lu. 23:18-25}.}}
...
\Chap{19}
\TextTitle{Jésus couronné d'épines\FTNTT{\vref{Mt. 27:30} ; \vref{Mc. 15:16-18}.}}
...
\TextTitle{Pilate tente de relâcher Jésus, en vain\FTNTT{\vref{Mt. 27:22-26} ; \vref{Mc. 15:12-15} ; \vref{Lu. 23:20-25}.}}
...
\VS{6}Mais quand les principaux prêtres et leurs huissiers le virent, ils s'écrièrent, en disant : Crucifie ! Crucifie ! Pilate leur dit : Prenez-le vous-mêmes, et crucifiez-le ; car je ne trouve point de crime en lui.
...
\TextTitle{Jésus crucifié\FTNTT{\vref{Mt. 27:31-50} ; \vref{Mc. 15:20-37} ; \vref{Lu. 23:26-46}.}}
...
\VS{24}Ils se dirent entre eux : Ne la déchirons pas mais tirons au sort, pour savoir à qui elle sera. Et cela arriva ainsi, afin que s'accomplisse cette parole de l'Ecriture : Ils ont partagé entre eux mes vêtements, et ils ont tiré au sort ma tunique\FTNT{\vref{Ps. 22:19}.}. Ainsi firent les soldats.
...
\VS{30}Et quand Jésus eut pris le vinaigre, il dit : Tout est accompli\FTNT{La fin de la période de l'Ancienne Alliance n'a pas eu lieu à la naissance du Seigneur. En effet, \vref{Ga. 4:4} nous dit que Jésus est né sous la loi de Moïse et le récit des quatre évangiles atteste que depuis sa naissance jusqu'à sa mort, Jésus a scrupuleusement respecté et accompli toute la loi. En effet, il a lui-même dit : « Ne croyez pas que je sois venu abolir la loi ou les prophètes ; je ne suis pas venu les abolir, mais les accomplir. » (\vref{Mt. 5:17}). Ainsi, durant son ministère terrestre, le Seigneur demandait à ce qu'on applique la loi (\vref{Mt. 8:4} ; \vref{Mt. 23:23} ; \vref{Lu. 17:11-14}) tout en préparant ses disciples à la Nouvelle Alliance. L'évangile de Matthieu nous relate un événement capital qui a eu lieu juste après la mort du Seigneur : « Alors Jésus, poussa de nouveau un grand cri, et rendit l'esprit. Et voici, le voile du temple se déchira en deux, depuis le haut jusqu'en bas ; et la terre trembla, et les pierres se fendirent. » (\vref{Mt. 27:50-51}). Il convient de rappeler que le temple était divisé en trois parties : le parvis, le lieu saint et le saint des saints. Le parvis était accessible à tout le monde, y compris aux non-Juifs. Le lieu saint n'était accessible qu'aux prêtres. La troisième partie, le saint des saints, n'était accessible qu'au premier prêtre. Le lieu saint était séparé du saint des saints par un voile qui symbolisait le mur d'inimitié (\vref{Es. 59:2} ; \vref{Ro. 3:23}) qui sépare l'homme pécheur de la présence de Dieu, représentée dans le temple par l'arche de l'alliance. Ce voile n'avait rien d'un tissu léger et vaporeux, mais il ressemblait davantage à un épais tapis, opaque et surtout très résistant, et donc très difficile à déchirer. Le premier prêtre rentrait seulement une fois par an dans le saint des saints pour y offrir le sacrifice d'expiation pour le peuple ainsi que pour lui-même (\vref{Lé. 16} ; \vref{Hé. 9:7}). Toutefois, la nécessité de répéter ce sacrifice chaque année prouvait que les exigences de la justice divine n'étaient pas pleinement satisfaites (\vref{Hé. 10:3-4}). L'auteur de l'épître aux Hébreux nous apprend que le voile symbolisait également le corps physique du Messie (\vref{Hé. 10:19-20}). Ainsi, lorsque le Seigneur a succombé à ses meurtrissures, le fameux voile s'est déchiré du haut jusqu'au bas. Or tant que le voile subsistait, l'accès à la présence de Dieu était fermé (\vref{Hé. 9:8}). La déchirure atteste donc qu'en Christ, nous pouvons désormais nous approcher avec assurance du trône de Dieu, sans autre médiateur que le Seigneur lui-même (\vref{1 Ti. 2:5}). « Or là où les péchés sont pardonnés, il n'y a plus d'offrande pour le péché. Ainsi donc, mes frères, nous avons la liberté d'entrer dans le saint des saints au moyen du sang de Jésus, qui est le chemin nouveau et vivant qu'il nous a frayé au travers du voile, c'est-à-dire de sa chair. Et ayant un premier prêtre établi sur la maison de Dieu, approchons-nous de lui avec un cœur sincère et une foi inébranlable, ayant les cœurs purifiés d'une mauvaise conscience, et le corps lavé d'une eau pure. Retenons sans fléchir la profession de notre espérance, car celui qui nous a fait la promesse est fidèle. » \vref{Hé. 10:18-23}. Jésus-Christ est notre Pâque (\vref{1 Co. 5:5-8}), il est le sacrifice parfait qui a expié nos péchés une fois pour toutes (\vref{Hé. 10:10}). Par conséquent, il est celui à qui nous devons nous adresser pour recevoir pardon, miséricorde et compassion. « Tout est accompli ». En s'écriant de la sorte, Jésus-Christ a proclamé la fin de l'Ancienne Alliance. En effet, la loi a été promulguée par Moïse, mais la grâce et la vérité sont venues par Jésus-Christ (\vref{Jn. 1:17}). Toutefois, la Nouvelle Alliance n'a réellement débuté qu'à la Pentecôte avec l'effusion du Saint-Esprit. Voir commentaire en Actes 2.}. Et ayant baissé la tête, il rendit l'esprit.
\TextTitle{Fin de l'Ancienne Alliance\FTNTT{\vref{Mt. 27:50-51} ; \vref{Mc. 15:37-38} ; \vref{Lu. 23:45-46}.}}
...
\VS{36}Ces choses-là sont arrivées, afin que l'Ecriture soit accomplie : Aucun de ses os ne sera brisé\FTNT{\vref{Ex. 12:46} ; \vref{No. 9:12} ; \vref{Ps. 34:21}.}.
\VS{37}Et encore une autre Ecriture, qui dit : Ils verront celui qu'ils ont percé\FTNT{\vref{Za. 12:10}.}.
\TextTitle{Jésus enseveli\FTNTT{\vref{Mt. 27:57-66} ; \vref{Mc. 15:42-47} ; \vref{Lu. 23:50-56}.}}
...
\Chap{20}
\TextTitle{Enchaînement des évènements le jour de la résurrection\FTNTT{\vref{Mt. 28:1-15} ; \vref{Mc. 16:1-14} ; \vref{Lu. 24:1-32}.}}
...
\TextTitle{Jésus apparaît à Marie de Magdala et aux disciples\FTNTT{\vref{Mc. 16:14} ; \vref{Lu. 24:13-49}.}}
...
\TextTitle{Les ressources du Messie pour ses serviteurs\FTNTT{\vref{Lu. 22:35} ; \vref{Ph. 4:19}.}}
...
\TextTitle{La charité, seule motivation pour le service\FTNTT{\vref{1 Co. 13} ; \vref{2 Co. 5:14} ; \vref{Ap. 2:4-5}.}}
...
\TextTitle{Le Maître révèle à Pierre la forme de sa mort}
...
\TextTitle{Tous ses serviteurs ne mourront pas\FTNTT{\vref{1 Co. 15:51-52} ; \vref{1 Th. 4:14-18}.}}
