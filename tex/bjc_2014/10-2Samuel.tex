...
\Chap{3}
\TextTitle{L'autorité de David s'accroît\FTNTT{\vref{1 Ch. 3:1-4}.}}
...
\Chap{5}
\TextTitle{David oint roi sur tout Israël\FTNTT{\vref{1 Ch. 11:1-3}.}}
...
\TextTitle{Jérusalem, capitale de tout Israël\FTNTT{\vref{1 Ch. 11:4-9}.}}
...
\TextTitle{Fils de David nés à Jérusalem\FTNTT{\vref{2 S. 3:2-5} ; \vref{1 Ch. 3:1-4}.}}
...
\TextTitle{Yahweh livre les Philistins à David\FTNTT{\vref{2 S. 23:13-17} ; \vref{1 Ch. 14:8-17} ; \vref{11:15-19} ; \vref{12:8-15}.}}
...
\Chap{6}
\TextTitle{Désobéissance dans le transport de l'arche\FTNTT{\vref{1 Ch. 13:1-14}.}}
...
\TextTitle{Accueil de l'arche à Jérusalem\FTNTT{\vref{1 Ch. 15:26-16:1}.}}
...
\VS{17}Ils amenèrent l'arche de Yahweh et la posèrent au milieu de la tente que David avait dressée pour elle ; et David offrit des holocaustes et des sacrifices d'offrande de paix\FTNT{Voir commentaire en \vref{Lé. 3:1}.} devant Yahweh.
...
\Chap{7}
\TextTitle{David veut construire une maison à Yahweh\FTNTT{\vref{1 Ch. 17:1-2}.}}
...
\VS{2}qu'il dit à Nathan le prophète : Regarde maintenant ! J'habite dans une maison de cèdres, et l'arche de Dieu habite sous des tapis\FTNT{Dans la plupart des versions, on a traduit ce mot par « tente », alors que le terme hébreu est « yeriy'ah », ce qui signifie « rideau », « drap », « tapis ». Voir \vref{Ex. 26}.}.
\VS{3}Alors Nathan répondit au roi : Va, fais tout ce qui est dans ton cœur, car Yahweh est avec toi.
\TextTitle{Yahweh traite alliance avec David et sa postérité\FTNTT{\vref{1 Ch. 17:3-15}.}}
...
\VS{13}Ce sera lui qui bâtira une maison à mon Nom, et j'affermirai pour toujours le trône de son règne\FTNT{Le royaume millénaire était promis à David et à sa postérité. Il fut proclamé par Jean-Baptiste (\vref{Mt. 3:1-12}), le Messie (\vref{Mt. 4:17}) et les apôtres (\vref{Mt. 10:5-7}) comme étant proche. Présentement, le royaume de Dieu se manifeste par la vie sanctifiée des saints en Christ (\vref{Lu. 17:20} ; \vref{Jn. 3:1-8} ; \vref{Ro. 14:17}). Il n'apparaîtra pas de manière visible avant la « moisson », c'est-à-dire le jugement des nations (\vref{Mt. 13:39-50}). En effet, ce n'est qu'après cette moisson que le royaume sera installé ici-bas, lorsque le Messie rétablira la monarchie et la dynastie de David en sa propre personne. Il rassemblera alors les enfants d'Israël dispersés dans le monde entier et établira sa domination sur toute la terre pendant mille ans. Ce royaume sera remis au Père par le Messie après avoir vaincu le dernier ennemi, c'est-à-dire la mort (\vref{1 Co. 15:24-26}). De ce fait, personne ne mourra pendant le millénium. Toutes les nations monteront tous les ans à Jérusalem pour adorer Yahweh et célébrer la fête des tabernacles qui sera restaurée (\vref{Za. 14}). Le gouvernement théocratique en Israël sera alors restauré (\vref{Es. 1:26}).}.
...
\TextTitle{Louange et reconnaissance de David envers Yahweh\FTNTT{\vref{1 Ch. 17:16-27}.}}
...
\Chap{8}
\TextTitle{Yahweh donne à David la victoire sur ses ennemis\FTNTT{\vref{1 Ch. 18:1-17}.}}
...
\TextTitle{Le pays et le roi de Rabba livrés à Joab et David (\vref{1 Ch. 20:1-3})}
...
\VS{37}Absalom s'était enfui, et il alla chez Talmaï, fils d'Ammihur, roi de Gueschur\FTNT{Absalom s'était réfugié chez Talmaï, roi de Gueschur (Transjordanie, au nord de la Syrie), qui était le père de Maaca, sa mère (\vref{2 S. 3:3}). Il est donc allé chez son grand-père maternel.}. Et David pleurait tous les jours son fils.
...
\VS{22}On dressa une tente pour Absalom sur le toit et Absalom alla vers les concubines de son père, aux yeux de tout Israël\FTNT{\vref{2 S. 12:11-12}.}.
...
\VerseOne{}Et il se trouvait là un méchant\FTNT{Littéralement « beliya`al » : « méchant, pervers », « ruine, destruction ». Voir commentaire en \vref{1 S. 2:12}.} homme, nommé Schéba, fils de Bicri, Benjamite. Il sonna du shofar et dit : Nous n'avons point de part avec David ni d'héritage avec le fils d'Isaï ! Israël, chacun à ses tentes !
...
\VS{4}Je m'écrie : Loué soit Yahweh ! Et je suis délivré de mes ennemis\FTNT{\vref{Ps. 18:4}.}.
...
\VS{3}Le Dieu d'Israël a parlé, le Rocher\FTNT{Voir commentaire \vref{Es. 8:13-17}.} d'Israël m'a dit : Celui qui règne parmi les hommes avec justice, celui qui règne dans la crainte de Dieu,
...
\TextTitle{Les vaillants hommes de David\FTNTT{\vref{1 Ch. 11:10-47}.}}
...
\Chap{24}
\TextTitle{Péché de David ; plaie mortelle sur Israël\FTNTT{\vref{1 Ch. 21:1-17}.}}
\VerseOne{}La colère de Yahweh s'enflamma encore contre Israël, parce que David fut incité contre eux, en disant : Va, fais le dénombrement d'Israël et de Juda\FTNT{\vref{1 Ch. 21}.}.
...
\TextTitle{Sacrifice de David ; Yahweh met fin à la plaie\FTNTT{\vref{1 Ch. 21:18-30}.}}
