...
\VS{10}Je m’approchai de lui, et je lui donnai la mort (1), sachant bien qu'il ne survivrait après s’être jeté sur sa lance. J'ai pris la couronne qu'il avait sur sa tête, et le bracelet qui était à son bras, et je les apporte ici à mon seigneur.
...
\VS{3}Ils mirent l'arche (1) de Dieu sur un char tout neuf, et l'emmenèrent de la maison d'Abinadab qui était sur la colline ; Uzza et Achjo, fils d'Abinadab, conduisaient le char neuf.
...
\VS{2}qu’il dit à Nathan le prophète : Regarde maintenant ! J'habite dans une maison de cèdres, et l'arche de Dieu habite sous des tapis (1).
...
\VS{13}Ce sera lui qui bâtira une maison à mon Nom, et j'affermirai pour toujours le trône de son règne (2).
...
\Chap{11}
\VerseOne{}Et il arriva, l’année suivante, au temps où les rois partaient en guerre, que David envoya Joab, avec ses serviteurs et tout Israël, pour détruire les fils d’Ammon et assiéger Rabba. Mais David resta à Jérusalem (1).
...
\VS{37}Absalom s’était enfui, et il alla chez Talmaï, fils d’Ammihur, roi de Gueschur (2). Et David pleurait tous les jours son fils.
