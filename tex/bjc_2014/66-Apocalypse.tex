...
%\bigskip
\textit{
\\Le terme apocalypse, du grec « apokalupsis », évoque « l'action de révéler, de révéler ce qui était caché ou inconnu ». Ce mot a pour racine « apokalupto » qui signifie aussi « découvrir, dévoiler ce qui est voilé ou recouvert ».
%\bigskip
...
\VS{17}Quand je le vis, je tombai à ses pieds comme mort, et il mit sa main droite sur moi, en me disant : Ne crains point !
\VS{18}Je suis le premier et le dernier, et je vis. Et j'étais mort, et voici, je suis vivant aux siècles des siècles, amen ! Et je tiens les clefs de Hades\FTNT{Voir commentaire Mt. 16:18.} et de la mort.
...
\VS{2}Je connais tes œuvres, et ton travail, et ta patience, et je sais que tu ne peux pas supporter les méchants, et que tu as éprouvé ceux qui se disent être apôtres et qui ne le sont point, et que tu les as trouvés menteurs ;
...
\VS{9}Je connais tes œuvres, ton affliction et ta pauvreté, quoique tu sois riche, et le blasphème de ceux qui se disent être Juifs, et qui ne le sont point, mais qui sont la synagogue de Satan.
...
\VS{13}Je connais tes œuvres, et le lieu où tu habites, à savoir là où est le trône de Satan. Et que cependant tu retiens mon Nom, et tu n'as pas renié ma foi, même aux jours d'Antipas, mon fidèle martyr\FTNT{Du grec « martus » : témoin.}, qui a été mis à mort chez vous, là où Satan habite.
...
\VS{21}Et je lui ai donné du temps, afin qu'elle se repente de sa prostitution, mais elle ne s'est point repentie.
...
\TextTitle{Sardes:
\\L'Eglise où persistent quelques croyants}
\Chap{3}
...
\VS{4}Toutefois, tu as quelque peu de personnes à Sardes, qui n'ont point souillé leurs vêtements, et qui marcheront avec moi en vêtements blancs, car ils en sont dignes.
...
\TextTitle{Philadelphie:
\\L'Eglise en temps de réveil}
...
\VS{9}Voici, je ferai venir ceux de la synagogue de Satan qui se disent Juifs, et ne le sont point, mais qui mentent ; voici, dis-je, je les ferai venir et se prosterner à tes pieds, et ils connaîtront que je t'aime.
...
\TextTitle{Christ, digne de recevoir la louange et la gloire}
...
\Chap{5}
\TextTitle{Christ, le seul digne d'ouvrir le livre}
...
\VS{2}Et je vis aussi un ange remarquable par sa force, qui criait à haute voix : Qui est digne d'ouvrir le livre, et d'en rompre les sceaux ?
...
\VS{5}Et un des anciens me dit : Ne pleure point, voici le Lion qui vient de la tribu de Juda, de la racine de David, a vaincu pour ouvrir le livre et pour en rompre les sept sceaux.
...
\TextTitle{Adoration de l'Agneau\FTNTT{Ph. 2:9-11}}
...
\VS{8}Je regardai, et je vis un cheval verdâtre ; et celui qui était monté dessus se nommait la Mort, et Hades l'accompagnait. Il leur fut donné le pouvoir sur le quart de la terre pour tuer par l'épée, par la famine, par la mortalité, et par les bêtes sauvages de la terre.
...
\VS{10}Et elles criaient à haute voix, disant : Jusqu'à quand, Seigneur qui es saint et véritable, ne jugeras-tu point et ne vengeras-tu point notre sang de ceux qui habitent sur la terre ?
...
\Chap{7}
\TextTitle{Les 144 000 marqués du sceau}
...
\TextTitle{La multitude des personnes sauvés pendant la grande tribulation}
...
\Chap{8}
\TextTitle{g) Septième sceau : annonce des sept trompettes\FTNTT{Ap. 4:1}}
...
\Chap{11}
\TextTitle{Le temps des nations s'achevera en quarante-deux mois}
...
\TextTitle{Les deux témoins ressuscitent, le grand tremblement de terre}
...
\TextTitle{Septième trompette : Le règne du Messie annoncé, cantique des vingt-quatre vieillards\FTNTT{v. 15-19 ; Ap. 8:2}}
...
\Chap{12}
\TextTitle{Vision de la femme enceinte, Israël, et du dragon rouge, Satan}
...
\TextTitle{Le dragon persécute la femme}
...
\Chap{13}
\TextTitle{La bête qui monte de la mer}
...
\TextTitle{La bête qui monte de la terre}
...
\Chap{14}
\TextTitle{L'Agneau, les 144 000, et le cantique nouveau}
...
\VS{5}Et dans leur bouche il ne s'est point trouvé de fraude, car ils sont sans tache devant le trône de Dieu\FTNT{Ps. 32:2.}.
...
\Chap{15}
\TextTitle{Les sept coupes de la colère de Dieu}
...
\VS{5}Et j'entendis l'ange des eaux qui disait : Seigneur, QUI ES, QUI ETAIT, et QUI VIENT, tu es juste, parce que tu as exercé ce jugement.
...
\VS{2}Avec elle, les rois de la terre ont commis la fornication, et les habitants de la terre ont été enivrés du vin de sa prostituion.
...
\VS{3}Car toutes les nations ont bu du vin de sa prostitution effrénée, et les rois de la terre ont commis fornication avec elle, et les marchands de la terre se sont enrichis par l'excès de son luxe.
...
\TextTitle{Réjouissances des anges suite à la chute de Babylone}
...
\TextTitle{Seconde venue de Christ dans la gloire\FTNTT{Mt. 24:16-30.}}
\VS{11}Puis je vis le ciel ouvert, et voici parut un cheval blanc. Et celui qui était monté dessus s'appelle Fidèle et Véritable, et il juge et combat avec justice.
...
\VS{16}Et sur son vêtement et sur sa cuisse était écrit ces mots : LE ROI DES ROIS ET LE SEIGNEUR DES SEIGNEURS.
...
\VS{3}Il le jeta dans l'abîme, et il l'enferma et mis le sceau sur lui, afin qu'il ne séduise plus les nations, jusqu'à ce que les mille ans soient accomplis. Après quoi, il faut qu'il soit délié pour un peu de temps.
...
\VS{6}Heureux et saints ceux qui ont part à la première résurrection ! La seconde mort n'a point de puissance sur eux, mais ils seront sacrificateurs de Dieu, et de Christ, et ils régneront avec lui mille ans.
...
\TextTitle{Le jugement dernier et la seconde résurrection}
...
\VS{13}Et la mer rendit les morts qui étaient en elle, et la mort et l'enfer\FTNT{le mot « enfer » vient de l'hébreu « Hades ». Voir commentaire dans Mt. 16:18} rendirent les morts qui étaient en eux ; et ils furent jugés chacun selon ses œuvres.
...
\VS{7}Voici, je viens à toute vitesse\FTNT{Dans la plupart des traductions, ce passage a été traduit par « Je viens bientôt ». Or le texte grec utilise le mot « tachu » qui signifie « rapidement, à toute vitesse (sans tarder) ». Beaucoup doutent de cette promesse du Seigneur en faisant la même réflexion évoquée par l'apôtre Pierre : « Où est la promesse de son avènement ? Car depuis que les pères sont morts, toutes choses demeurent comme elles ont été dès le commencement de la création. » (2 Pi. 3:4). Or le Seigneur ne tarde pas dans l'accomplissement de sa promesse, car il a fixé de sa propre autorité une date pour son retour, que lui seul connaît (Za. 14:7 ; Mt. 24:36 ; Mc. 13:32 ; Ac. 1:6-7). Il sera donc fidèle à son calendrier et ne tardera pas (2 Pi. 3:9. ; Hé. 10:37)}. Heureux est celui qui garde les paroles de la prophétie de ce livre !
