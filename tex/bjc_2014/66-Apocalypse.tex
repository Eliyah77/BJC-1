...
\VS{18}Je suis le premier et le dernier, et je vis. Et j'étais mort, et voici, je suis vivant aux siècles des siècles, amen ! Et je tiens les clefs de Hadès\FTNT{Voir commentaire Mt. 16:18.} et de la mort.
...
\TextTitle{Ephèse :
\\L'église qui a perdu le premier amour}
\Chap{2}
...
\TextTitle{Pergame :
\\L'église établie dans le monde}
...
\TextTitle{Sardes:
\\L'église où persistent quelques croyants}
\Chap{3}
...
\VS{8}Je regardai, et je vis un cheval verdâtre ; et celui qui était monté dessus se nommait la Mort, et Hadès l'accompagnait. Il leur fut donné le pouvoir sur le quart de la terre pour tuer par l'épée, par la famine, par la mortalité, et par les bêtes sauvages de la terre.
...
\TextTitle{La multitude des personnes sauvés
...
\Chap{11}
\TextTitle{Le temps des nations s’achèvera 
\\en quarante-deux mois}
...
\Chap{12}
\TextTitle{Vision de la femme enceinte (Israël)
\\et du dragon rouge (Satan)}
...
\VS{4}Sa queue entrainait le tiers des étoiles du ciel et les jeta sur la terre\FTNT{Da. 8:10.}. Puis le dragon s'arrêta devant la femme qui devait accoucher, afin de dévorer son enfant\FTNT{Cet enfant est évidemment Jésus-Christ (Mt. 2:16.)}, dès qu'elle l'aurait mis au monde.
