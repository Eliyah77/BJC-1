...
\\(Gr. : apokálupsis)
\\Signification : action de dévoiler, ôter le voile qui cachait la chose
\\Date de rédaction : Env. 95 ap. J.-C.\\}
}
%\bigskip
\textit{
\\Le terme apocalypse vient du grec «~apokalupsis~» et évoque «~l’action de dévoiler, de révéler ce qui était caché ou
inconnu~».
%\bigskip
...
\TextTitle{Christ, en sa qualité de Roi, est le seul digne d'ouvrir le livre}
...
\TextTitle{La création entière adore l'Agneau\FTNTT{Ph. 2:9-11}}
...
\TextTitle{Sixième trompette : une armée vient d'Extrême-Orient\FTNTT{Ap. 16:12}}
...
\TextTitle{Le septième ange sonne de la trompette ; tout est soumis au Seigneur et à son Christ ; cantique des vingt-quatre Anciens\FTNTT{v. 15-19 ; Ap. 8:2}}
...
\VS{19}Alors je vis la bête, et les rois de la terre, et leurs armées rassemblés pour faire la guerre\FTNT{Guerre d’ Harmaguédon : Voir commentaire Ap. 16:16.} contre celui qui était monté sur le cheval et contre son armée.
...
\TextTitle{Le grand trône blanc du jugement et la seconde résurrection}
