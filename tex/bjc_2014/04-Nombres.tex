...
\VS{3}Ce sont là les noms des fils d'Aaron, les prêtres, qui furent oints et consacrés pour exercer la prêtrise\FTNT{\vref{Ex. 40:15}~; \vref{Lé. 8:30}.}.
\VS{4}Mais Nadab et Abihu moururent en la présence de Yahweh, quand ils offrirent un feu étranger devant Yahweh au désert de Sinaï, et ils n'eurent point d'enfants~; mais Eléazar et Ithamar exercèrent la prêtrise en la présence d'Aaron leur père\FTNT{\vref{Lé. 10:1-2}~; \vref{1 Ch. 24:2}.}.
