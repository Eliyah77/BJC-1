...
\VS{2}Que les enfants d'Israël célèbrent la Pâque\FTNT{\vref{Ex. 12}~; \vref{1 Co. 5:7}.} au temps fixé.
...
\VS{13}Et ils partirent de là et campèrent de l'autre côté de l'Arnon, qui est dans le désert, en sortant du territoire des Amoréens~; car l'Arnon est la frontière de Moab, entre les Moabites et les Amoréens\FTNT{\vref{Jg. 11:18}.}.
