...
\VS{2}Faites le dénombrement de toute l'assemblée des fils d'Israël, selon leurs familles, selon les maisons de leurs pères, en comptant nom par nom, savoir tous les mâles\FTNT{\vref{Ex. 30:12}~; \vref{Ex. 38:26}.}, chacun par tête~;
...
\VS{51}Et quand le tabernacle partira, les Lévites le démonteront, et quand le tabernacle campera, les Lévites le dresseront. Que si quelque étranger en approche, on le fera mourir\FTNT{\vref{Ez. 44:8-9}.}.
...
\VS{3}Ce sont là les noms des fils d'Aaron, les prêtres, qui furent oints et consacrés pour exercer la sacrificature\FTNT{\vref{Ex. 40:15}~; \vref{Lé. 8:30}.}.
\VS{4}Mais Nadab et Abihu moururent en la présence de Yahweh, quand ils offrirent un feu étranger devant Yahweh au désert de Sinaï, et ils n'eurent point d'enfants~; mais Eléazar et Ithamar exercèrent la sacrificature en la présence d'Aaron leur père\FTNT{\vref{Lé. 10:1-2}~; \vref{1 Ch. 24:2}.}.
...
\VS{13}Car tout premier-né m'appartient, depuis le jour où je frappai tout premier-né au pays d'Egypte~; je me suis sanctifié tout premier-né en Israël, depuis les hommes jusqu'aux bêtes~; ils seront à moi, je suis Yahweh\FTNT{\vref{Ex. 13:2}~; \vref{Ex. 22:29}~; \vref{Ex. 34:19}~; \vref{Lé. 27:26}.}.
...
\VS{47}tu prendras cinq sicles par tête, tu les prendras selon le sicle du sanctuaire~; le sicle est de vingt guéras\FTNT{\vref{Ex. 30:13}~; \vref{Lé. 27:6}~; \vref{Lé. 27:25}~; \vref{Ez. 45:12}.}.
...
\VS{5}Quand le camp partira, Aaron et ses fils viendront démonter le voile\FTNT{Le voile intérieur est l'image du corps humain de Christ (\vref{Mt. 26:26}). Ce voile fut déchiré de haut en bas lorsque le Seigneur est mort sur la croix (\vref{Mt. 27:50-51}). Désormais, le croyant peut pénétrer dans la présence du Père (\vref{Hé. 10:19-20}).} qui sert de rideau, et en couvriront l'arche du témoignage~;
...
\VS{9}Et ils prendront un drap de pourpre, en couvriront le chandelier du luminaire avec ses lampes, ses mouchettes, ses vases à cendre, et tous ses vases à huile, dont on fait usage pour son service\FTNT{\vref{Ex. 25:30-38}.}~;
...
\VS{16}Et Eléazar fils d'Aaron, le prêtre, aura la surveillance de l'huile du luminaire, du parfum odoriférant, de l'offrande continuelle, et de l'huile de l'onction~; la charge de tout le tabernacle, et de toutes les choses qui sont dans le lieu saint, et de ses ustensiles\FTNT{\vref{Ex. 30:23-35}.}.
...
\VS{31}Or c'est ici la charge de ce qu'ils auront à porter, selon tout le service qu'ils auront à faire à la tente d'assignation, savoir les planches du tabernacle, ses barres, et ses piliers, avec ses bases\FTNT{\vref{Ex. 26:15}.},
...
\VS{2}Ordonne aux enfants d'Israël qu'ils mettent hors du camp tout lépreux, tout homme ayant une gonorrhée, et tout homme souillé pour un mort\FTNT{\vref{Lé. 13}~; \vref{Lé. 15}.}.
\VS{3}Vous les mettrez dehors, tant l'homme que la femme, vous les mettrez, dis-je, hors du camp, afin qu'ils ne souillent point le camp au milieu de ceux desquels j'habite.
...
\VS{9}De même, toute offrande élevée d'entre toutes les choses sanctifiées des enfants d'Israël, qu'ils présenteront\FTNT{\vref{Ez. 44:30}.} au prêtre, lui appartiendra.
\VS{10} Les choses donc que quelqu'un aura sanctifiées appartiendront au prêtre~; ce que chacun lui aura donné, lui appartiendra\FTNT{\vref{Lé. 10:12-13}.}.
...
\VS{26}le prêtre prendra une poignée de cette offrande comme souvenir\FTNT{Voir commentaire en \vref{Lé. 2:2}.}, et il la brûlera sur l'autel. C'est après cela qu'il fera boire les eaux à la femme.
...
\VS{4}Durant tous les jours de son naziréat il ne mangera d'aucun fruit de la vigne, depuis les pépins jusqu'à la peau du raisin\FTNT{\vref{Jg. 13:7}~; \vref{Lu. 1:15}.}.
\VS{5}Le rasoir ne passera point sur sa tête durant tous les jours de son naziréat. Il sera saint jusqu'à ce que les jours pour lesquels il s'est consacré à Yahweh soient accomplis, et il laissera croître les cheveux de sa tête\FTNT{\vref{Jg. 13:5}~; \vref{1 S. 1:11}.}.
\VS{6}Durant tous les jours pour lesquels il s'est consacré à Yahweh il ne s'approchera d'aucune personne morte\FTNT{\vref{Lé. 21:1-4}.}~;
...
\VS{10}Le huitième jour, il apportera au prêtre deux tourterelles ou deux pigeonneaux, à l'entrée de la tente d'assignation\FTNT{\vref{Lé. 1}~; \vref{Lé. 12:6}.}.
...
\VS{14}Il présentera son offrande à Yahweh~: Un agneau d'un an et sans défaut pour l'holocauste, une brebis d'un an et sans défaut pour le sacrifice d'expiation, et un bélier sans défaut pour le sacrifice d'offrande de paix\FTNT{Voir commentaire en \vref{Lé. 3:1}.}.
...
\VS{20}Et le prêtre les agitera de côté et d'autre devant Yahweh~: C'est une chose sainte qui appartient au prêtre, avec la poitrine agitée et l'épaule offerte par élévation. Et après cela le naziréen boira du vin\FTNT{\vref{Lé. 7:32-34}~; \vref{Ex. 29:24-27}.}.
...
\VS{25}Yahweh fasse luire sa face sur toi, et te fasse grâce\FTNT{\vref{Ps. 67:2}~; \vref{Ps. 119:135}.}~!
...
\VS{6}Moïse donc prit les chars et les bœufs, et il les remit aux Lévites.
...
\VS{89}Et quand Moïse entrait dans la tente d'assignation pour parler avec Yahweh, il entendait une voix qui lui parlait du haut du propitiatoire placé sur l'arche du témoignage, entre les deux chérubins. Et il lui parlait\FTNT{\vref{Ex. 25:22}.}.
\Chap{8}
\TextTitle{Les lampes sur le chandelier}
\VerseOne{}Yahweh parla à Moïse, en disant~:
\VS{2}Parle à Aaron, et tu lui diras~: Quand tu allumeras les lampes, les sept lampes éclaireront sur le devant du chandelier\FTNT{\vref{Ex. 25:37}.}.
...
\VS{4}Or le chandelier était fait de telle manière, qu'il était d'or battu au marteau, d'ouvrage fait au marteau, sa tige aussi, et ses fleurs. On fit ainsi le chandelier selon le modèle que Yahweh en avait fait voir à Moïse\FTNT{\vref{Ex. 25:31-40}.}.
...
\VS{2}Que les enfant d'Israël célèbrent la Pâque\FTNT{\vref{Ex. 12}~; \vref{1 Co. 5:7}.} au temps fixé.
...
\VS{11}Ils la feront le quatorzième jour du second mois, entre les deux soirs~; et ils la mangeront avec du pain sans levain et des herbes amères\FTNT{\vref{Ex. 12:10}~; \vref{Ex. 23:18}~; \vref{Ex. 34:25}~; \vref{De. 16:4}~; \vref{Jn. 19:33-36}.}.
...
\VS{14}Et si un étranger en séjour chez vous célèbre la Pâque de Yahweh, il la fera selon l'ordonnance de la Pâque. II y aura une même ordonnance entre vous, pour l'étranger comme pour celui qui est né au pays\FTNT{\vref{Ex. 12:49}.}.
\TextTitle{La nuée conduit Israël}
\VS{15}Or le jour où le tabernacle fut dressé, la nuée couvrit le tabernacle de la tente d'assignation~; et le soir jusqu'au matin, elle parut sur le tabernacle avec l'apparence d'un feu\FTNT{\vref{Ex. 13:21-22}~; \vref{Ex. 40:34-38}~; \vref{De. 1:33}.}.
...
\VS{35}Or il arrivait qu'au départ de l'arche, Moïse disait~: Lève-toi, ô Yahweh, et tes ennemis seront dispersés, et ceux qui te haïssent s'enfuiront de devant toi\FTNT{\vref{Ps. 68:2}.}~!
...
\VS{4}Et le peuple nombreux qui se trouvaient au milieu d'Israël fut épris de convoitise~; et même, les enfants d'Israël se mirent à pleurer disant~: Qui nous donnera de la viande à manger\FTNT{\vref{Ex. 16:3}~; \vref{Ps. 106:14}~; \vref{1 Co. 10:6}.}~?
...
\VS{6}Et maintenant nos âmes sont asséchées~; nos yeux ne voient que de la manne\FTNT{\vref{Ps. 78:24}.}.
\VS{7}Or la manne était comme la graine de coriandre, et avait l'apparence du bdellium\FTNT{\vref{Ex. 16:14-31}~; \vref{Jn. 6:31-58}.}.
...
\VS{14}Je ne puis, à moi seul, porter tout ce peuple, car il est trop pesant pour moi\FTNT{\vref{De. 1:9-12}.}.
...
\TextTitle{Yahweh établit soixante-dix anciens autour de Moïse\FTNTT{\vref{Ex. 18:19}.}}
...
\VS{23}Yahweh répondit à Moïse: La main de Yahweh serait-elle trop courte~? Tu verras maintenant si ce que je t'ai dit arrivera ou non\FTNT{\vref{Es. 50:2}~; \vref{Es. 59:1-2}.}.
...
\VS{31}Alors Yahweh fit lever un vent de la mer qui amena des cailles et les répandit sur le camp environ le chemin d'une journée, de çà et de là, tout autour du camp~; et il y en avait presque la hauteur de deux coudées sur la terre\FTNT{\vref{Ex. 16:13-15}~; \vref{Ps. 78:26-29}~; \vref{Ps. 105:40}.}.
...
\VS{33}Mais la chair était encore entre leurs dents, avant qu'elle fût mâchée, la colère de Yahweh s'embrasa contre le peuple, et il frappa le peuple d'une très grande plaie\FTNT{\vref{Ps. 78:30-31}.}.
...
\VS{7}Il n'en est pas ainsi de mon serviteur Moïse, qui est fidèle dans toute ma maison\FTNT{\vref{Hé. 3:2}.}.
...
\FTNT{\vref{Ex. 33:11}~; \vref{De. 34:10}.} 
...
\VS{14}Et Yahweh répondit à Moïse~: Si son père lui avait craché au visage, ne serait-elle pas dans l'ignominie pendant sept jours~? Qu'elle soit enfermée sept jours en dehors du camp, après quoi, elle y sera reçue\FTNT{\vref{Lé. 13:46}.}.
...
\VS{28}Seulement, le peuple qui habite ce pays est puissant, les villes sont fortifiées, très grandes~; nous y avons vu des enfants d'Anak\FTNT{\vref{De. 1:24-28}.}.
...
\Chap{14}
\TextTitle{Rébellion et incrédulité d'Israël\FTNTT{\vref{1 Co. 10:1-5}~; \vref{Hé. 3:7-19}}}
\VerseOne{}Alors toute l'assemblée éleva la voix et se mit à pousser des cris, et le peuple pleura cette nuit-là.
\VS{2}Et tous les enfants d'Israël murmurèrent contre Moïse et Aaron, et toute l'assemblée leur dit~: Oh~! Si nous étions morts dans le pays d'Egypte~! Ou si nous étions morts dans ce désert\FTNT{\vref{De. 1:26-27}.}~!
...
\VS{9}Seulement, ne soyez point rebelles contre Yahweh, et ne craignez point le peuple de ce pays-là, car ils seront notre pain, leur protection s'est retirée de dessus eux. Yahweh est avec nous, ne les craignez point\FTNT{\vref{De. 20:3-4}.}~!
...
\VS{13}Et Moïse dit à Yahweh~: Mais les Egyptiens l'entendront, car tu as fait monter par ta puissance ce peuple-ci du milieu d'eux\FTNT{\vref{Ex. 32:10-12}.},
...
\VS{18}Yahweh est lent à la colère et riche en bonté, il ôte l'iniquité et pardonne la rébellion, mais il ne tient point le coupable pour innocent, et il punit l'iniquité des pères sur les fils, jusqu'à la troisième et à la quatrième génération\FTNT{\vref{Ex. 20:5}~; \vref{Ex. 34:6}~; \vref{Ex. 34:7}~; \vref{Ps. 86:15}~; \vref{Ps. 103:8}~; \vref{Ps. 145:8}~; \vref{Jon. 4:2}~; \vref{De. 5:9}.}.
...
\VS{23}tous ceux-là ne verront point le pays que j'ai juré à leurs pères de leur donner, tous ceux, dis-je, qui m'ont irrité par mépris, ne le verront pas\FTNT{\vref{De. 1:35-38}.}.
...
\VS{27}Jusqu'à quand laisserai-je cette méchante assemblée murmurer contre moi~? J'ai entendu les murmures des enfants d'Israël, qui murmuraient contre moi\FTNT{\vref{Ps. 106:25}.}.
...
\VS{42}Ne montez pas~; car Yahweh n'est pas au milieu de vous~; afin que vous ne soyez pas battus devant vos ennemis\FTNT{\vref{De. 1:41-42}.}.
...
\VS{3}et que vous voudrez faire un sacrifice consumé par le feu à Yahweh, un holocauste, ou un sacrifice en accompagnement d'un vœu, ou en offrande volontaire, ou bien dans vos fêtes, pour produire avec votre gros ou votre menu bétail une agréable odeur à Yahweh\FTNT{\vref{Ex. 29:18}~; \vref{Lé. 22:21}.},
\VS{4}celui qui offrira son offrande à Yahweh présentera en offrande un dixième de fleur de farine, pétrie dans un quart de hin d'huile\FTNT{\vref{Lé. 2:1-2}.},
...
\VS{22}Et lorsque vous aurez péché involontairement\FTNT{Voir commentaire en \vref{Lé. 4:2}.}, et que vous n'aurez pas fait tous ces commandements que Yahweh a fait connaître à Moïse,
...
\VS{27}Si c'est une seule personne qui a péché involontairement, elle offrira une chèvre d'un an en offrande pour le péché\FTNT{\vref{Lé. 4:27-28}.}.
...
\TextTitle{Un homme lapidé selon la loi\FTNTT{\vref{Ro. 3:19}~; \vref{7:7-11}~; \vref{2 Co. 3:7-9}~; \vref{Ga. 3:10}.}}
...
\VS{38}Parle aux enfants d'Israël, et dis-leur~: Qu'ils se fassent de génération en génération des franges aux bords de leurs vêtements, et qu'ils mettent sur les franges au bords de leurs vêtements un cordon de couleur pourpre\FTNT{\vref{De. 22:12}~; \vref{Mt. 23:5}.}.
...
\Chap{16}
\TextTitle{La révolte de Koré\FTNTT{\vref{Jud. 11}.}}
\VerseOne{}Or Koré\FTNT{Koré, Dathan et Abiram, s'étaient révoltés contre Aaron et Moïse, car ils voulaient s'attribuer l'honneur d'offrir à Dieu des sacrifices. Ils voulaient exercer la sacrificature (sacerdoce) alors que Yahweh ne les avait pas établis pour le service du culte. Vouloir servir Dieu sans avoir reçu un appel divin est dangereux.}, fils de Jitsehar, fils de Kehath, fils de Lévi, se révolta avec Dathan et Abiram, fils d'Eliab, et On, fils de Péleth, tous trois fils de Ruben.
...
\VS{21}Séparez-vous du milieu de cette assemblée, et je les consumerai en un seul instant\FTNT{\vref{Ex. 32:10}.}.
\VS{22}Mais ils tombèrent sur leur visage et dirent~: Ô Dieu~! Dieu des esprits de toute chair~! Un seul homme a péché, et tu te mettrais en colère contre toute l'assemblée\FTNT{\vref{Hé. 12:9}.}~?
...
\VS{32}Et la terre ouvrit sa bouche et les engloutit, avec leurs tentes et tous les hommes qui étaient à Koré, et tous leurs biens\FTNT{\vref{De. 11:6}~; \vref{Ps. 106:17}.}.
...
\VS{3}mais tu écriras le nom d'Aaron sur la verge de Lévi\FTNT{La verge d'Aaron est une image du Messie ressuscité. Elle avait produit la vie tandis que celles des autres princes n'avaient produit aucun fruit. Cette histoire nous parle également de la confirmation de l'appel d'Aaron face aux critiques dont il était l'objet. On reconnaît l'arbre par ses fruits (\vref{Mt. 7:16-20}~; \vref{Lu. 7:17-22}).}~; car il y aura une verge pour chaque chef des maisons de leurs pères.
...
\VS{10}Et Yahweh dit à Moïse~: Reporte la verge d'Aaron devant le témoignage, pour être conservée comme un signe pour les fils de rébellion, afin que tu fasses cesser de devant moi leurs murmures et qu'ils ne meurent point\FTNT{\vref{Hé. 9:3-5}.}.
...
\VS{10}Vous les mangerez dans un lieu très saint~; tout mâle en mangera~; vous les regarderez comme saintes\FTNT{\vref{Lé. 6:17-22}~; \vref{Lé. 7:6}~; \vref{Lé. 10:13}.}.
\VS{11}Voici encore ce qui t'appartiendra~: Tous les dons que les enfants d'Israël présenteront par élévation et en les agitant de côté et d'autre, je te les donne à toi, à tes fils, et à tes filles avec toi, par une loi perpétuelle~; quiconque sera pur dans ta maison en mangera\FTNT{\vref{Lé. 7:34}~; \vref{Lé. 10:14}.}.
...
\VS{14}Tout ce qui sera dévoué en Israël t'appartiendra\FTNT{\vref{Lé. 27:28}~; \vref{Ez. 44:29}.}.
...
\VS{19}Je t'ai donné, à toi et à tes fils, et à tes filles avec toi, par une loi perpétuelle, toutes les offrandes présentées par élévation des choses sanctifiées, que les enfants d'Israël offriront à Yahweh. C'est une alliance de sel\FTNT{Le sel est un aliment pratiquement impérissable et incorruptible. Dans l'Antiquité, il symbolisait l'incorruptibilité (\vref{Lé. 2:13}).} et à perpétuité devant Yahweh, pour toi et pour ta postérité avec toi.
\VS{20}Puis Yahweh dit à Aaron~: Tu ne posséderas rien dans leur pays, et il n'y aura point de part pour toi au milieu d'eux~; c'est moi qui suis ta part et ta possession, au milieu des enfants d'Israël\FTNT{\vref{De. 10:9}~; \vref{De. 18:2}~; \vref{Ez. 44:28}.}.
\TextTitle{Lois sur les dîmes (\vref{De. 14:22-29})}
...
\\- La 1ère dîme~: Le peuple devait payer une dîme générale au bénéfice des Lévites (\vref{No. 18:21}).
...
\\- La 2ème dîme~: Les Lévites devaient payer la «~dîme de la dîme~», au bénéfice des prêtres (\vref{No. 18:25-31}).
...
\\- La 3ème dîme~: Tous les Israélites devaient conserver une dîme de toute leur production en prévision de leurs pèlerinages annuels à Jérusalem (\vref{De. 14:22-26}).
...
\\- La 4ème dîme~: Il fallait payer une dîme spéciale à l'intention des pauvres, des orphelins et des veuves (\vref{De. 14:28-29}). 
...
\\- Les lois cérémonielles (\vref{Hé. 9:1})
\\Ces lois étaient relatives au culte et concernaient le tabernacle puis le temple, les sacrifices, les ablutions (\vref{Lé. 16}~; \vref{Hé. 9:1-10}). Les dîmes (la dîme des prêtres) devaient être amenées dans le temple (\vref{Mal. 3:10}), elles faisaient donc partie des lois cérémonielles. Or les Lévites et les prêtres de la Première Alliance n'existent plus sous la Nouvelle Alliance car les enfants de Dieu sont un royaume de rois et de prêtres (\vref{Ap. 1:6}~; \vref{Ap. 5:10}).
...
\VS{3}Puis vous la donnerez à Eléazar, le prêtre, qui la mènera hors du camp, et on l'égorgera en sa présence\FTNT{\vref{Lé. 4:12}~; \vref{Hé. 13:11-12}.}.
...
\VS{5}Et on brûlera la jeune vache en sa présence~; on brûlera sa peau, sa chair, son sang et ses excréments\FTNT{\vref{Ex. 29:14}.}.
...
\VS{11}Celui qui touchera un mort, un corps humain quel qu'il soit, sera impur pendant sept jours\FTNT{\vref{Ag. 2:13}.}.
...
\TextTitle{Murmures du peuple à cause du manque d'eau\FTNTT{\vref{De. 32:51}~; cp. \vref{Ex. 17:1-7}.}}
...
\VS{4}Et pourquoi avez-vous fait venir l'assemblée de Yahweh dans ce désert, pour que nous y mourions, nous et notre bétail\FTNT{\vref{Ex. 17:3}.}~?
...
\VS{8}Prends la verge, et convoque l'assemblée, toi et Aaron, ton frère. Vous parlerez en leur présence au rocher\FTNT{Christ, le rocher des âges ( \vref{Es. 8:13-17}~; \vref{1 Co. 10:1-4}).}, et il donnera son eau~; ainsi tu leur feras sortir de l'eau du rocher, et tu donneras à boire à l'assemblée et à leur bétail.
...
\TextTitle{La méchanceté d'Edom\FTNTT{\vref{Ge. 25:30}~; \vref{Ab. 10}.}}
...
\VS{16}Et nous avons crié à Yahweh, et il a entendu nos cris. Il a envoyé l'Ange et nous a retirés d'Egypte. Et voici, nous sommes à Kadès, ville qui est à l'extrémité de ton territoire\FTNT{\vref{Ex. 2:23}~; \vref{Ex. 23:20}~; \vref{Ac. 7:30-38}.}.
...
\VS{28}Et Moïse dépouilla Aaron de ses vêtements et en fit revêtir Eléazar, son fils. Aaron mourut là, au sommet de la montagne. Moïse et Eléazar descendirent de la montagne\FTNT{\vref{De. 10:6}.}.
...
\TextTitle{Le serpent d'airain\FTNTT{\vref{Jn. 3:14-15}~; \vref{2 Co. 5:20}.}}
...
\VS{6}Et Yahweh envoya contre le peuple des serpents brûlants qui mordaient le peuple~; tellement qu'il en mourut un grand nombre en Israël\FTNT{\vref{1 Co. 10:9}.}.
...
\VS{9}Moïse fit un serpent d'airain\FTNT{Voir \vref{Jn. 3:14-16}. Ceux qui regardent à Jésus-Christ, et non aux hommes, obtiennent la délivrance. L'airain nous parle du jugement (\vref{Job 20:24}), le serpent de la malédiction (\vref{Ge. 3:14}), et la perche parle de la croix (\vref{1 Co. 1:18}). Jésus a pris nos malédictions sur la croix de Golgotha (\vref{Ga. 3:13}).}, et le mit sur une perche~; quiconque avait été mordu par un serpent et regardait le serpent d'airain conservait la vie.
...
\VS{13}Et ils partirent de là et campèrent de l'autre côté d'Arnon, qui est dans le désert, en sortant du territoire des Amoréens~; car Arnon est la frontière de Moab, entre les Moabites et les Amoréens\FTNT{\vref{Jg. 11:18}.}.
...
\VS{23}Mais Sihon ne permit pas à Israël de passer sur son territoire~; il rassembla tout son peuple et sortit à la rencontre d'Israël, dans le désert~; il vint à Jahats, et combattit Israël\FTNT{\vref{De. 2:26-30}~; \vref{Jg. 11:29-30}.}.
\VS{24}Israël le fit passer au fil de l'épée et conquit son pays, depuis l'Arnon jusqu'à Jabbok, et jusqu'à la frontière des fils d'Ammon~; car la frontière des fils d'Ammon était forte\FTNT{\vref{De. 2:30}~; \vref{De. 29:7}~; \vref{Ps. 135:11-12}.}.
...
\VS{29}Malheur à toi, Moab~! Peuple de Kemosch, tu es perdu~! Il a livré ses fils qui se sauvaient et ses filles en captivité à Sihon, roi des Amoréens\FTNT{\vref{Jé. 48:46}.}.
...
\VS{34}Et Yahweh dit à Moïse~: Ne le crains point, car je le livre entre tes mains, lui et tout son peuple, et son pays~; tu le traiteras comme tu as traité Sihon, roi des Amoréens, qui habitait à Hesbon\FTNT{\vref{De. 3:1-2}.}.
...
\Chap{22}
\TextTitle{Balak cherche à maudire Israël~; Balaam\FTNTT{\vref{2 Pi. 2:15}~; \vref{Jud. 11}~; \vref{Ap. 2:14}} séduit par les honneurs}
...
\VS{23}L'ânesse vit l'Ange de Yahweh qui se tenait sur le chemin, son épée nue dans la main~; elle se détourna du chemin et alla dans les champs. Balaam frappa l'ânesse pour la ramener dans le chemin\FTNT{\vref{2 Pi. 2:16}~; \vref{Jud. 1:11}.}.
...
\VS{7}Alors Balaam prononça son discours sentencieux et dit~: Balak, roi de Moab, m'a fait descendre d'Aram\FTNT{De l'hébreu «~Aram~» traduit par «~Aram~» ou «~Syrie~» (\vref{1 R. 11:25}).}, des montagnes d'orient, en me disant~: Viens, maudis-moi Jacob~! Viens, dis-je, déteste Israël~!
\VS{8}Mais comment le maudirai-je~? Dieu ne l'a point maudit. Et comment le détesterai-je~? Yahweh ne l'a point détesté.
\VS{9}Car je le regarderai du sommet des rochers, et je le contemplerai du haut des collines~: Voici, ce peuple habitera à part, et il ne sera pas compté parmi les nations\FTNT{\vref{De. 33:28}.}.
...
\VS{11}Alors Balak dit à Balaam~: Que m'as-tu fait~? Je t'ai pris pour maudire mes ennemis, et voici, tu les a bénis, tu les a bénis\FTNT{Le verbe bénir vient de l'hébreu «~Barak~», il est utilisé deux fois de suite dans ce passage. Voir commentaire en \vref{Ge. 2:16-17}.}.~!
...
\VS{19}Dieu n'est point un homme pour mentir ni fils d'un homme pour se repentir. Ce qu'il a dit, ne le fera-t-il pas~? Ce qu'il a déclaré, ne l'exécutera-t-il pas\FTNT{\vref{Ja. 1:17}.}~?
\VS{20}Voici, j'ai reçu la parole pour bénir~: Puisqu'il a béni, je ne le révoquerai point.
\VS{21}Il n'a point aperçu d'iniquité en Jacob, il ne voit point de perversité en Israël~; Yahweh, son Dieu, est avec lui, et il y a en lui un chant de triomphe royal\FTNT{\vref{Jé. 50:20}~; \vref{Ro. 4:7}.}.
...
\VS{10}Alors Balak se mit très en colère contre Balaam, il frappa des mains et Balak parla ainsi à Balaam~: Je t'ai appelé pour maudire mes ennemis, et voici, tu les as bénis, tu les a bénis\FTNT{voir le commentaire en \vref{Ge. 2:16-17}.} trois fois déjà.
\VS{11}Et maintenant, fuis dans ton pays~! J'avais dit que je t'honorerais, je t'honorerais\FTNT{Le mot hébreu est utilisé deux fois dans ce passage. Voir le commentaire en \vref{Ge. 2:17}.}, mais Yahweh t'empêche d'être honoré.
...
\VS{17}Je le vois, mais non pas maintenant~; je le regarde, mais non pas de près~; une Etoile est sortie de Jacob\FTNT{L'Etoile en question est Jésus-Christ, qui se révéla à Jean comme l'Etoile brillante du matin (\vref{Ap. 22:16}).}, et un Sceptre s'est élevé d'Israël. Il transpercera les cotés de Moab, il détruira tous les enfants de Seth.
...
\Chap{25}
\TextTitle{Prostitution d'Israël à Baal-Peor\FTNTT{\vref{No. 31:16}~; \vref{Ja. 4:4}~; \vref{Ap. 2:14}.}}
...
\VS{3}Et Israël s'accoupla à Baal-Peor, c'est pourquoi la colère de Yahweh s'enflamma contre Israël\FTNT{\vref{Ps. 106:28}~; \vref{Os. 9:10}.}.
\VS{4}Et Yahweh dit à Moïse~: Prends tous les chefs du peuple, et fais-les pendre devant Yahweh en face du soleil, afin que la colère de Yahweh se détourne d'Israël\FTNT{\vref{De. 4:3}~; \vref{Jos. 22:17}.}.
...
\VS{8}Et il entra dans la tente de l'homme Israélite et les transperça tous deux, l'homme Israélite puis la femme, par le ventre. Et la plaie s'arrêta parmi les enfants d'Israël\FTNT{\vref{Ps. 106:30}.}.
...
\VS{3}Moïse donc et Eléazar, le prêtre, leur parlèrent dans les plaines de Moab, près du Jourdain de Jéricho, en disant~:
...
\VS{19}Fils de Juda, Er, et Onan~; mais Er et Onan moururent au pays de Canaan\FTNT{\vref{Ge. 38:7-10}~; \vref{Ge. 46:12}.}.
...
\VS{55}Toutefois, que le pays soit partagé par le sort~; et qu'ils prennent leur héritage selon les noms des tribus de leurs pères\FTNT{\vref{Jos. 11:23}~; \vref{Jos. 14:2}~; \vref{Jos. 18:6-8}.}.
...
\VS{61}Nadab et Abihu moururent lorsqu'ils apportèrent du feu étranger devant Yahweh\FTNT{\vref{Lé. 10:1-2}~; \vref{1 Ch. 24:2}.}.
...
\VS{65}Car Yahweh avait dit d'eux~: ils mourront certainement dans le désert, et qu'ainsi il n'en restera pas un, excepté Caleb, fils de Jephunné, et Josué, fils de Nun\FTNT{\vref{1 Co. 10:5}.}.
\Chap{27}
\TextTitle{Loi sur les héritages\FTNTT{\vref{No. 36}.}}
...
\VS{12}Yahweh dit aussi à Moïse~: Monte sur cette montagne d'Abarim, et regarde le pays que je donne aux enfants d'Israël\FTNT{\vref{De. 32:48-49}.}.
...
\VS{16}Que Yahweh, le Dieu des esprits de toute chair, établisse sur l'assemblée un homme\FTNT{\vref{Hé. 12:9}.},
\VS{17}qui sorte devant eux et qui entre devant eux, et qui les fasse sortir et qui les fasse entrer, afin que l'assemblée de Yahweh ne soit pas comme des brebis qui n'ont point de berger\FTNT{\vref{1 R. 22:17}~; \vref{Mt. 9:36}~; \vref{Mc. 6:34}.}.
\VS{18}Alors Yahweh dit à Moïse~: Prends Josué, fils de Nun, un homme en qui est l'Esprit, et tu poseras ta main sur lui\FTNT{\vref{De. 34:9}.}.
...
\VS{21}Et il se présentera devant Eléazar, le prêtre, qui consultera pour lui les jugements de l'urim\FTNT{\vref{Lé. 8:8}.} devant Yahweh~; et à sa parole ils sortiront, et à sa parole ils entreront, lui, les enfants d'Israël, avec lui, et toute l'assemblée.
...
\VerseOne{}Yahweh parla à Moïse, en disant~:
\VS{2}Donne cet ordre aux enfants d'Israël, et dis-leur~: Vous aurez soin de m'offrir en leur temps, mon offrande, ma nourriture, pour mes sacrifices consumés par le feu, qui me sont d'une bonne odeur\FTNT{\vref{Lé. 3:11}~; \vref{Lé. 21:6}.}.
\VS{3}Tu leur diras~: Voici le sacrifice consumé par le feu que vous offrirez à Yahweh~: Deux agneaux d'un an sans défaut, chaque jour, en holocauste perpétuel\FTNT{\vref{Ex. 29:38}.}.
\VS{4}Tu sacrifieras l'un des agneaux le matin, et l'autre agneau entre les deux soirs,
\VS{5}et la dixième partie d'épha de fine farine pour le gâteau pétrie avec le quart d'un hin d'huile vierge\FTNT{\vref{Lé. 2:1}~; \vref{Ex. 29:40}~; \vref{Ex. 16:36}.}.
...
\VS{17}Et au quinzième jour du même mois sera un jour de fête. On mangera pendant sept jours des pains sans levain\FTNT{\vref{Ex. 12}~; \vref{Lé. 23:5-6}.}.
...
\VerseOne{}Et le premier jour du septième mois, vous aurez une sainte convocation~: Vous ne ferez aucune œuvre servile. Ce jour sera publié parmi vous au son des trompettes\FTNT{\vref{Lé. 23:24-25}.}.
...
\VS{7}Et au dixième jour de ce septième mois, vous aurez une sainte convocation, et vous affligerez vos âmes~: Vous ne ferez aucune œuvre\FTNT{\vref{Lé. 16:29-31}~; \vref{Lé. 23:27}.}.
...
\VS{12}Et au quinzième jour du septième mois, vous aurez une sainte convocation~: Vous ne ferez aucune œuvre servile. Vous célébrerez une fête à Yahweh, pendant sept jours\FTNT{\vref{Lé. 23:34-43}.}.
...
\VS{3}Quand un homme fera un vœu à Yahweh, ou aura juré par serment, pour lier son âme par un vœu, il ne violera pas sa parole~; il fera selon toutes les choses qui sont sorties de sa bouche\FTNT{\vref{De. 23:21}.}.
...
\Chap{31}
\TextTitle{Jugements sur Madian\FTNTT{\vref{No. 25:6-18}.}}
\VerseOne{}Yahweh parla à Moïse, en disant~:
...
\VS{8}Ils tuèrent aussi les rois de Madian, outre les autres qui y furent tués, Evi, Rékem, Tsur, Hur, et Réba, cinq rois de Madian~; ils firent aussi passer au fil de l'épée Balaam, fils de Beor\FTNT{\vref{Jos. 13:21-22}.}.
...
\VS{11}Ils prirent tout le butin et tout le pillage, tant des hommes que du bétail\FTNT{\vref{De. 20:14}.}~;
...
\VS{16}Voici ce sont elles qui, à la parole de Balaam, ont donné l'occasion aux fils d'Israël de pécher contre Yahweh dans l'affaire de Peor~; ce qui attira la plaie sur l'assemblée de Yahweh\FTNT{\vref{2 Pi. 2:15}~; \vref{Ap. 2:14}.}.
\VS{17}Or maintenant, tuez tous les mâles d'entre les petits enfants, et tuez toute femme qui a connu un homme en couchant avec lui\FTNT{\vref{Jg. 21:11}.}~;
...
\VS{27}Et partage par moitié le butin entre les combattants qui sont allés à la guerre et toute l'assemblée\FTNT{\vref{1 S. 30:24}.}.
...
\VS{11}Les hommes qui sont montés hors d'Egypte, depuis l'âge de vingt ans et au-dessus, ne verront point le pays que j'ai juré de donner à Abraham, Isaac, et à Jacob~; car ils n'ont point persévéré à me suivre\FTNT{\vref{De. 1:35}.},
...
\VS{40}Moïse donc donna Galaad à Makir, fils de Manassé, qui y habita\FTNT{\vref{De. 3:15}.}.
\VS{41}Jaïr, fils de Manassé, se mit en marche, prit leurs villages, et les appela villages de Jaïr\FTNT{\vref{De. 3:14}~; \vref{1 Ch. 2:22}.}.
...
\VS{3}Les enfants d'Israël donc partirent de Ramsès le quinzième jour du premier mois, dès le lendemain de la Pâque, et ils sortirent à main levée, à la vue de tous les Egyptiens\FTNT{\vref{Ex. 14:8}.}.
\VS{4}Et les Egyptiens ensevelissaient ceux que Yahweh avait frappés parmi eux, à savoir tous les premiers-nés~; même Yahweh exerçait aussi ses jugements contre leurs dieux\FTNT{\vref{Ex. 12:12}~; \vref{Ex. 18:11}.}.
\VS{5}Et les enfants d'Israël partirent de Ramsès, et campèrent à Succoth\FTNT{\vref{Ex. 12:37}.}.
\VS{6}Et ils partirent de Succoth et campèrent à Etham, qui est au bout du désert\FTNT{\vref{Ex. 13:20}.}.
\VS{7}Et ils partirent d'Etham et se détournèrent vers Pi-Hahiroth, qui est vis-à-vis de Baal-Tsephon, et campèrent devant Migdol\FTNT{\vref{Ex. 14:2}.}.
...
\VS{9}Puis ils partirent de Mara et vinrent à Elim où il y avait douze fontaines d'eaux et soixante-dix palmiers, et ils y campèrent\FTNT{\vref{Ex. 15:27}.}.
\VS{10}Et ils partirent d'Elim et campèrent près de la Mer Rouge.
\VS{11}Puis ils partirent de la Mer Rouge et campèrent au désert de Sin\FTNT{\vref{Ex. 16:1}.}.
\VS{12}Ils partirent du désert de Sin et campèrent à Dophka.
\VS{13}Puis ils partirent de Dophka et campèrent à Alusch.
\VS{14}Et ils partirent d'Alusch et campèrent à Rephidim où il n'y avait point d'eau à boire pour le peuple\FTNT{\vref{Ex. 17:1}.}.
\VS{15}Puis ils partirent de Rephidim et campèrent dans le désert de Sinaï\FTNT{\vref{Ex. 17:1}.}.
...
\VS{52}vous chasserez de devant vous tous les habitants du pays, vous détruirez toutes leurs peintures, et vous ruinerez toutes leurs images de fonte, et vous démolirez tous leurs hauts lieux\FTNT{\vref{De. 7:5}~; \vref{De. 12:2}.}.
...
\VS{55}Mais si vous ne chassez pas de devant vous les habitants du pays, il arrivera que ceux d'entre eux que vous aurez laissés comme reste, seront comme des épines à vos yeux, et comme des pointes à vos côtés, et ils vous serreront de près dans le pays auquel vous habiterez\FTNT{\vref{Jos. 23:13}.}.
...
\VS{2}Donne l'ordre aux enfants d'Israël qu'ils donnent aux Lévites, sur l'héritage qu'ils posséderont, des villes pour y habiter. Vous leur donnerez aussi les faubourgs qui sont autour de ces villes\FTNT{\vref{Jos. 21:2}.}.
...
\VS{11}établissez-vous des villes qui vous soient des villes de refuge, afin que le meurtrier qui aura frappé à mort quelqu'un involontairement, s'y enfuie\FTNT{\vref{Jos. 20:2-3}~; \vref{Ex. 21:13}.}.
...
\VS{14}Vous donnerez trois de ces villes au-delà du Jourdain, et les trois autres dans le pays de Canaan, qui seront des villes de refuge\FTNT{\vref{De. 19:2}~; \vref{De. 4:41-42}.}.
...
\VS{21}ou si par inimitié il le frappe de sa main, et qu'il en meure, on punira de mort celui qui l'a frappé, car il est meurtrier~; le vengeur du sang pourra le faire mourir quand il le rencontrera\FTNT{\vref{De. 19:11-12}.}.
...
\VS{30}Celui qui fera mourir le meurtrier, le fera mourir sur la parole de deux témoins~; mais un seul témoin ne sera point reçu en témoignage contre quelqu'un, pour le faire mourir\FTNT{\vref{De. 17:6}~; \vref{De. 19:15}.}.
...
\Chap{36}
\TextTitle{Loi sur les héritages\FTNTT{\vref{No. 27:1-11}.}}
...
\VS{4}Même quand viendra le jubilé pour les enfants d'Israël, on ajoutera leur héritage à l'héritage de la tribu à laquelle elles appartiendront, ainsi leur héritage sera retranché de l'héritage de la tribu de nos pères\FTNT{\vref{Lé. 25:10-13}.}.
