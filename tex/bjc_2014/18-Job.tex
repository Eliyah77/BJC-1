...
\VS{10}Ils ouvrent leur bouche contre moi ; ils me donnent des soufflets pour m'outrager; ils se réunissent tous ensemble contre moi. 
...
\VS{19}Mais maintenant voilà, mon témoin est aux cieux, mon témoin est dans les lieux hauts\FTNT{Ap. 1:5 ; Ap. 3:14.}.
\VS{20}Mes amis se moquent de moi : mais mon œil fond en larmes devant Dieu.
...
\VS{7}Mon œil est obscurci par le chagrin, et tous les mes membres de mon corps sont comme une ombre\FTNT{Ps. 6:7 ; Ps. 31:10.}.
...
\VS{16}Elles descendront au fond du sépulcre, car elles reposeront ensemble avec moi dans la poussière ! 
\Chap{18}
...
\VS{3}Pourquoi sommes-nous regardés comme des bêtes, et porquoi vous tenez-vous pour souillés à vos yeux?
...
\VS{5}Certainement, la lumière des méchants sera éteinte, et l'étincelle de leur feu ne réluira plus\FTNT{Ps. 37:9-10.}.
\VS{6}La lumière sera ténèbres dans sa tente, et la lampe qui éclaire au-dessus d'eux.
...
\VS{3}Vous avez déjà par dix fois tâché de me couvrir de confusion. N'avez-vous pas honte de vous roidir ainsi contre moi ? 
...
\VS{8}Il a fermé mon chemin tellement que ne puis passer; et il a mis des ténèbres sur mes sentiers. 
...
\VS{18}Il rendra ce qu'il aura obtenu par des vexations, et ne l'avalera pas; il restituera à proportion de ce qu'il aura amassé, et ne s'en réjouira pas\FTNT{So. 2:10.}.
...
\VS{30}que le méchant est réservé pour le jour de la ruine, pour le jour que les fureurs sont envoyées\FTNT{Pr. 16:4 ; Ec. 9:12.} ?
