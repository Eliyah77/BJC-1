...
\VerseOne{}Il y avait dans le pays d'Uts\FTNT{\vref{Ge. 36:28}.} un homme appelé Job\FTNT{\vref{Ez. 14:14}~; \vref{Ja. 5:11}.}. Cet homme était intègre\FTNT{\vref{1 R. 8:61}.} et droit, craignant\FTNT{\vref{Ps. 19:10}~; \vref{Pr. 1:7}.} Dieu et se détournant du mal.
\VS{2}Il eut sept fils et trois filles.
\VS{3}Et son bétail était de sept mille brebis, trois mille chameaux, cinq cents paires de bœufs et cinq cents ânesses, avec un très grand nombre de serviteurs\FTNT{\vref{Job 42:12-13}.}~; tellement que cet homme était le plus puissant de tous les Orientaux.
...
\VS{5}Quand les jours de festin étaient passés, Job envoyait chercher ses enfants pour les sanctifier, et se levant de bon matin, il offrait des holocaustes selon le nombre de ses enfants~; car Job disait~: Peut-être mes enfants ont-ils péché, et ont-ils blasphémé contre Dieu dans leurs cœurs. Job faisait toujours ainsi\FTNT{\vref{Job 42:8}.}.
\VS{6}Or, il arriva un jour que les fils de Dieu\FTNT{\vref{Ps. 89:7}~; \vref{Job 38:7}.} vinrent se présenter devant Yahweh, et Satan\FTNT{\vref{Es. 14:12}~; \vref{Ap. 12:9-10}.} entra parmi eux.
\VS{7}Yahweh dit à Satan~: D'où viens-tu~? Et Satan répondit à Yahweh~: Je viens de courir çà et là sur la terre et de m'y promener\FTNT{\vref{1 Pi. 5:8}.}.
...
\VS{12}Et Yahweh dit à Satan~: Voilà, tout ce qui lui appartient est en ton pouvoir~; seulement ne porte pas la main sur lui. Et Satan sortit de devant la face de Yahweh\FTNT{\vref{1 R. 22:22}.}.
...
\VS{16}Cet homme parlait encore, lorsqu'un autre vint et dit~: Le feu de Dieu est tombé du ciel, il a embrasé les brebis et les serviteurs, et les a consumés\FTNT{\vref{2 R. 1:10-12}.}. Et je me suis échappé moi seul, pour te le rapporter.
\VS{17}Cet homme parlait encore, lorsqu'un autre vint et dit~: Les Chaldéens\FTNT{\vref{Ge. 11:28}.} se sont rangés en trois bandes, se sont jetés sur les chameaux et les ont pris, ils ont frappé les serviteurs au tranchant de l'épée, et je me suis échappé moi seul, pour te le rapporter.
...
\VS{20}Alors Job se leva, déchira\FTNT{\vref{Job 2:12}~; \vref{Est. 4:1}.} son manteau et rasa sa tête~; et se jetant par terre, se prosterna,
\VS{21}et dit~: Je suis sorti nu du ventre de ma mère, et nu j'y retournerai\FTNT{\vref{Ec. 5:14}~; \vref{1 Ti. 6:7}.}~; Yahweh a donné, Yahweh a enlevé\FTNT{\vref{1 S. 2:6}.}~; que le nom de Yahweh soit béni~!
\VS{22}En tout cela, Job ne pécha pas et n'attribua rien à Dieu d'indigne de lui.
\Chap{2}
\TextTitle{Deuxième attaque de Satan}
\VerseOne{}Or il arriva un jour que les fils de Dieu vinrent pour se présenter devant Yahweh, Satan\FTNT{\vref{Za. 3:1-2}.} vint aussi au milieu d'eux se présenter devant Yahweh.
...
\VS{3}Yahweh dit à Satan: N'as-tu point considéré mon serviteur Job, qui n'a point d'égal sur la terre~; homme sincère et droit, craignant Dieu, et se détournant du mal, et qui même encore retient son intégrité, quoique tu m'aies incité contre lui pour l'engloutir sans cause\FTNT{\vref{Job 9:17}.}.
\VS{4}Et Satan répondit à Yahweh, en disant~: Peau pour peau, tout ce qu'un homme possède, il le donnera pour sa vie.
\VS{5}Mais étends maintenant ta main, et frappe ses os et à sa chair\FTNT{\vref{Job 19:20}.}, et tu verras s'il ne te blasphème pas en face. 
...
\VS{8}Job prit un tesson pour se gratter et s'assit sur la cendre\FTNT{\vref{Jé. 6:26}~; \vref{Jon. 3:6}.}.
\TextTitle{Réaction de Job et de sa femme}
\VS{9}Et sa femme lui dit~: Conserveras-tu encore ton intégrité~? Bénis\FTNT{\vref{Job 1:11}.} Dieu, et meurs~!
\VS{10}Et il lui dit~: Tu parles comme une femme insensée~! Nous recevons de Dieu les biens, et nous n'en recevrions pas les maux\FTNT{\vref{Es. 45:7}~; \vref{Am. 3:6}~; \vref{La. 3:37}.}~! En tout cela, Job ne pécha pas par ses lèvres.
...
\VerseOne{}Après cela, Job ouvrit la bouche et maudit son jour\FTNT{\vref{Jé. 20:14}~; \vref{Job 10:18}.}.
...
\VS{5}Que les ténèbres et l'ombre de la mort\FTNT{\vref{Job 10:21-22}.} le rendent souillé, que les nuées demeurent sur lui, qu'il soit rendu terrible comme le jour de ceux à qui la vie est amère~! 
...
\VS{8}Qu'ils la maudissent ceux qui maudissent les jours, ceux qui sont prêts à réveiller le léviathan\FTNT{Ce nom vient de la mythologie phénicienne qui en fait le monstre du chaos primitif. C'est également un monstre marin évoqué dans la Bible (\vref{Es. 27:1}~; \vref{Ps. 74:14}~; \vref{104:26}~; \vref{Job 40:25}~; \vref{41:1}).}~!
\VS{9}Que les étoiles de son crépuscule soient obscurcies~; qu'elle attende la lumière, mais qu'il n'y en ait pas, et qu'elle ne voie pas les rayons de l'aube du jour\FTNT{\vref{Job 41:9}.}~!
\VS{10}Parce qu'elle n'a pas fermé le ventre qui m'a porté, et qu'elle n'a pas caché le tourment loin de mes yeux.
\VS{11}Pourquoi ne suis-je pas mort dans le sein de ma mère~? Pourquoi n'ai-je pas expiré aussitôt que je suis sorti de ses entrailles\FTNT{\vref{Job 10:18}.}~?
\VS{12}Pourquoi des genoux m'ont-ils reçu~? Pourquoi des mamelles m'ont-elles allaité~?
\VS{13}Car maintenant je serais couché, je me reposerais, je dormirais~; il y aurait eu dès lors du repos pour moi\FTNT{\vref{Job 17:16}.},
...
\VS{16}Ou que n'ai-je été comme un avorton caché\FTNT{\vref{Ps. 58:9}.}, comme les petits enfants qui n'ont pas vu la lumière.
...
\VS{21}qui attendent en vain la mort, et qui la recherchent plus que le trésor\FTNT{\vref{Ap. 9:6}.},
\VS{22}qui seraient ravis de joie et seraient dans l'allégresse s'ils avaient trouvé le sépulcre~?
\VS{23}Pourquoi, dis-je, la lumière est-elle donnée à l'homme à qui le chemin est caché, et que Dieu a enfermé de tous côtés\FTNT{\vref{Job 19:8}~; \vref{La. 3:7}.}~?
...
\VS{3}Voilà, tu en as enseigné plusieurs, et tu as renforcé les mains affaiblies\FTNT{\vref{Es. 35:3}~; \vref{Hé. 12:12}.},
\VS{4}tes paroles ont affermi ceux qui chancelaient, et tu as fortifié les genoux qui pliaient\FTNT{\vref{Job 16:5}.}.
...
\VS{7}Rappelle, je te prie, dans ton souvenir~: Quel est l'innocent qui a péri~? Quels sont les hommes droits qui ont été exterminés\FTNT{\vref{Job 8:20}.}~?
\VS{8}Selon ce que j'ai vu, ceux qui labourent l'iniquité et qui sèment l'outrage les moissonnent\FTNT{\vref{Job 15:35}~; \vref{Ga. 6:7}.}~;
\VS{9}ils périssent par le souffle de Dieu, et ils sont consumés par le vent de ses narines\FTNT{\vref{Ex. 15:8}~; \vref{Es. 11:4}~; \vref{30:33}~; \vref{Job 15:30}~; \vref{2 Th. 2:8}.}.
...
\VS{13}Au moment où les visions de la nuit agitent la pensée, quand un profond sommeil saisit les hommes\FTNT{\vref{Job 33:15}.},
...
\VS{17}L'homme serait-il juste devant Dieu~? L'homme serait-il pur devant celui qui l'a fait\FTNT{\vref{Job 25:4}.}~?
\VS{18}Voici, il ne se fie pas à ses serviteurs, il trouve la folie à ses anges\FTNT{\vref{Job 15:15}~; \vref{Job 25:5}~; \vref{2 Pi. 2:4}.},
\VS{19}combien plus chez ceux qui habitent des maisons d'argile, qui ont leurs fondements dans la poussière, qui sont consumés à la rencontre d'un vermisseau \FTNT{\vref{Job 25:6}.}~!
...
\Chap{5}
\VerseOne{}Crie maintenant~! Y aura-t-il quelqu'un qui te réponde~? Et vers qui d'entre les saints te tourneras-tu\FTNT{\vref{Job 15:15}.}~?
\VS{2}Certainement la colère tue l'insensé, et le dépit fait mourir le sot.
\VS{3}J'ai vu l'insensé qui s'enracinait \FTNT{\vref{Jé. 12:1-2}.}, mais j'ai aussitôt maudit sa demeure.
\VS{4}Ses fils sont loin de tout secours~; ils sont écrasés à la porte, et personne ne les délivre\FTNT{\vref{Ps. 119:155}.}~!
...
\VS{7}l'homme naît pour la peine\FTNT{\vref{Ge. 3:17-19}~; \vref{Job 14:1-5}.}, comme l'étincelle pour voler et s'élever.
\VS{8}Mais moi, j'aurais recours à Dieu, et j'adresserais mes paroles à Dieu.
\VS{9}Il fait de grandes choses qu'on ne peut sonder, de merveilleuses choses qu'il est impossible de compter\FTNT{\vref{Ps. 72:18}. \vref{Ps. 92:5}~; \vref{Job 9:10}.}.
\VS{10}Il répand la pluie sur la face de la terre, et envoie les eaux sur les campagnes\FTNT{\vref{De. 28:12}~; \vref{Ps. 135:7}~; \vref{Job 28:26}~; \vref{Job 38:25-26}~; \vref{Ac. 14:17}.}~;
\VS{11}il élève ceux qui sont abaissés, et fait que ceux qui sont en deuil soient en sûreté dans une haute retraite\FTNT{\vref{1 S. 2:7}~; \vref{Ez. 21:31}~; \vref{Ps. 113:7-8}.}~;
\VS{12}il anéantit les projets des hommes rusés, de sorte qu'ils ne viennent pas à bout de leurs entreprises\FTNT{\vref{Es. 8:10}~; \vref{Ps. 33:10}~; \vref{Né. 4:15}.}~;
\VS{13}il surprend les sages en leur ruse\FTNT{\vref{1 Co. 3:19}.}, et le conseil des méchants est renversé~:
\VS{14}De jour ils rencontrent les ténèbres, et ils marchent à tâtons en plein midi, comme dans la nuit\FTNT{\vref{De. 28:29}.}.
\VS{15}Ainsi il délivre les pauvres de leur épée et de leur bouche, et les sauve de la main des puissants\FTNT{\vref{Ps. 12:3-4}~; \vref{52:2}~; \vref{57:4}.}~;
\VS{16}ainsi il arrive au pauvre ce qu'il a espéré\FTNT{\vref{1 S. 2:8}.}, mais l'iniquité a la bouche fermée\FTNT{\vref{Es. 52:15}~; \vref{Ps. 63:11}~; \vref{107:42}~; \vref{Pr. 10:6}.}.
\VS{17}Voici, heureux est celui que Dieu châtie~! Ne rejette donc pas le châtiment du Tout-Puissant\FTNT{Ps \vref{94:12}~; \vref{Pr. 3:11-12}~; \vref{Hé. 12:5-6}~; \vref{Ap. 3:19}.}.
\VS{18}Car c'est lui qui fait la plaie et qui la bande~; il blesse et ses mains guérissent\FTNT{\vref{De. 32:39}~; \vref{1 S. 2:6-7}~; cp. \vref{Es. 30:26}~; \vref{Os. 6:1}.}.
\VS{19}Il te délivrera dans six afflictions, et à la septième le mal ne te touchera pas\FTNT{\vref{Ps. 34:20}~; \vref{91:3}~; \vref{Pr. 24:16}.}.
\VS{20}En temps de famine il te garantira de la mort, et en temps de guerre il te préservera de l'épée\FTNT{\vref{Ps. 33:19}~; \vref{37:19}.}.
\VS{21}Tu seras à l'abri du fléau de la langue, et tu n'auras pas peur de la dévastation quand elle arrivera\FTNT{\vref{Ps. 31:21}.}.
\VS{22}Tu riras de la dévastation et de la famine, et tu n'auras pas peur des bêtes de la terre\FTNT{\vref{Es. 65:25}~; \vref{Ez. 34:25}~; \vref{Os. 2:20}.}~;
\VS{23}car tu feras une alliance avec les pierres des champs, et tu seras en paix avec les bêtes sauvages\FTNT{\vref{Os. 2:20}.}.
\VS{24}Tu jouiras en paix de la prospérité sous ta tente, tu pourvoiras à ta demeure et tu n'y seras pas trompé~;
\VS{25}tu verras ta postérité s'accroître, et tes descendants se multiplier comme l'herbe de la terre\FTNT{\vref{Ps. 72:16}~; \vref{127:3-5}~; \vref{128:6}.}.
\VS{26}Tu entreras au sépulcre dans la vieillesse, comme un monceau de gerbes s'entasse en sa saison\FTNT{\vref{Pr. 9:11}~; \vref{10:27}.}.
...
\VS{3}Car elle serait plus pesante que le sable de la mer~; c'est pourquoi mes paroles sont englouties\FTNT{\vref{Pr. 27:3}.}~!
\VS{4}Parce que les flèches du Tout-Puissant sont sur moi, mon esprit en suce le venin~; les terreurs\FTNT{\vref{Job 30:15}~; \vref{Ps. 88:16-17}.} de Dieu se dressent en bataille contre moi\FTNT{\vref{Job 19:12}~; \vref{Ps. 38:2-3}.}.
\VS{5}L'âne sauvage\FTNT{\vref{Job 39:8}.} brait-il auprès de l'herbe~? Le bœuf mugit-il auprès de son fourrage~?
...
\VS{9}Qu'il plaise à Dieu de me réduire en poussière, qu'il laisse aller sa main pour m'achever\FTNT{\vref{Job 7:16}~; \vref{9:21}~; \vref{10:1}~; cp. \vref{No. 11:15}~; \vref{1 R. 19:4}~; \vref{Jon. 4:3,8}.}~!
...
\VS{14}Celui qui se fond sous l'ardeur des maux a droit à la compassion de son ami~; sinon il abandonne la crainte\FTNT{\vref{Ps. 19:10}.} du Tout-Puissant\FTNT{\vref{Pr. 17:17}.}.
\VS{15}Mes frères m'ont trahi comme un torrent, comme le cours impétueux des torrents qui passent\FTNT{\vref{Ps. 38:12}~; \vref{41:10}~; \vref{69:9}~; \vref{Jé. 15:19}.},
...
\VS{19}Les troupes des voyageurs de Théma\FTNT{\vref{Ge. 25:15}.} y pensaient, ceux qui vont à Séba\FTNT{\vref{1 R. 10:1}~; \vref{Ps. 72:10}~; \vref{Ez. 27:22-23}.} s'y attendaient~;
\VS{20}mais ils sont honteux d'y avoir espéré~; ils y sont allés, et ils ont rougi.
\VS{21}Certes, vous m'êtes devenus inutiles~; vous voyez ma calamité étonnante, et vous en avez horreur\FTNT{\vref{Job 19:13}~; \vref{Ps. 31:12}.}~!
...
\VS{26}Pensez-vous qu'il ne faille avoir que des paroles pour censurer~; et que les discours de celui qui est hors d'espérance, ne soient que du vent\FTNT{\vref{Ec. 9:16}.}~?
...
\VS{29}Revenez\FTNT{\vref{Job 17:10}.} donc, soyez sans injustice~; revenez, et reconnaissez mon innocence\FTNT{\vref{Job 27:5-6}~; \vref{34:5}~; cp. \vref{Job 23:10}~; \vref{42:1-6}.}.
...
\VS{2}Comme le serviteur soupire après l'ombre, comme un ouvrier\FTNT{\vref{Es. 16:14}.} attend son salaire\FTNT{\vref{Ps. 39:5}.}, 
\VS{3}ainsi il m'a été donné pour mon partage des mois qui ne m'apportent rien~; il m'a été assigné des nuits de travail\FTNT{\vref{Ps. 6:6}.}.
\VS{4}Si je suis couché, je dis: Quand me lèverai-je~? Et quand est-ce que la nuit aura achevé sa mesure~? Et je suis plein d'inquiétudes jusqu'au point du jour\FTNT{\vref{De. 28:67}.}.
\VS{5}Ma chair se couvre de vers et de monceaux de poussière, ma peau se crevasse et se dissout.
\VS{6}Mes jours passent plus légèrement que la navette d'un tisserand, et ils se consument sans espérance\FTNT{\vref{Es. 38:12}~; \vref{Job 9:25}~; \vref{17:11}~; \vref{Ja. 4:14}.}~!
\VS{7}Souviens-toi que ma vie est un souffle~! Et que mes yeux ne reverront plus le bonheur\FTNT{\vref{Es. 40:6}~; \vref{Ps. 78:39}~; \vref{Ps. 89:48}~; \vref{102:12}~; \vref{103:15}~; \vref{Job 8:9}~; \vref{14:1-2}~; \vref{1 Pi. 1:24}.}.
\VS{8}L'œil de ceux qui me regardent ne me verra plus~; tes yeux seront sur moi, et je ne serai plus.
\VS{9}La nuée se dissipe et s'en va, ainsi celui qui descend au scheol\FTNT{cp. \vref{Ha. 2:5}~; \vref{Lu. 16:23}.} ne remontera pas\FTNT{\vref{Job 10:21-22}~; \vref{Job 14:7-14}.}~;
\VS{10}il ne reviendra plus dans sa maison, et le lieu qu'il habitait ne le reconnaîtra plus\FTNT{\vref{Ps. 37:35-36}~; \vref{103:16}~; \vref{Job 10:21}.}.
\VS{11}C'est pourquoi je ne retiendrai pas ma bouche, je parlerai dans l'angoisse de mon esprit, je discourrai dans l'amertume de mon âme\FTNT{\vref{Job 10:1}.}.
...
\VS{16}Je suis ennuyé de la vie, aussi ne vivrai-je pas toujours. Retire-toi de moi, car mes jours ne sont que vanité\FTNT{\vref{Job 10:20}.}.
\VS{17}Qu'est-ce que l'homme mortel pour que tu le regardes comme quelque chose de grand, pour que tu l'affectionne\FTNT{\vref{Ps. 8:5}~; \vref{144:3}~; \vref{Hé. 2:6}.},
\VS{18}pour que tu le visites tous les matins, pour que tu l'éprouves\FTNT{\vref{Job 23:10}.} à chaque instant~?
\VS{19}Jusqu'à quand ne te retireras-tu pas de moi~? Ne me permettras-tu pas d'avaler ma salive\FTNT{\vref{Job 9:18}.}~?
\VS{20}J'ai péché~; que te ferai-je, gardien des hommes\FTNT{\vref{1 Ti. 4:10}.}~? Pourquoi m'as-tu mis en butte à tes coups, et pourquoi suis-je à charge à moi-même~?
...
\VS{2}Jusqu'à quand parleras-tu ainsi, et les paroles de ta bouche seront-elles un vent impétueux\FTNT{\vref{Job 15:2}.}~?
\VS{3}Dieu renverserait-il le droit\FTNT{Cp. \vref{Ge. 18:25}.}, et le Tout-Puissant renverserait-il la justice\FTNT{\vref{De. 32:4}~; \vref{Job 34:12}~; \vref{Da. 9:14}~; \vref{2 Ch. 19:7}.}~?
\VS{4}Si tes fils ont péché contre lui, il les a livrés à leur crime.
\VS{5}Mais toi, si tu cherches Dieu, si tu demandes grâce au Tout-Puissant\FTNT{Cp. \vref{Job 5:17-27}.}~;
\VS{6}si tu es pur et droit, certainement il se réveillera pour toi, et fera prospérer la demeure de ta justice.
\VS{7}Et ton commencement\FTNT{\vref{Za. 4:10}.} aura été petit, mais ta dernière condition sera bien plus grande\FTNT{\vref{Job 42:12}.}.
\VS{8}Car, je te prie, enquiers-toi des générations précédentes, et applique-toi à t'informer soigneusement de leurs pères\FTNT{\vref{De. 4:32}~; \vref{De. 32:7}.}.
\VS{9}Car nous sommes d'hier, et nous ne savons rien, parce que nos jours sont sur la terre comme une ombre\FTNT{\vref{Ps. 102:12}~; \vref{Ps. 144:41}~; Ch. \vref{29:15}.}.
...
\VS{12}Il est encore en sa verdure, sans qu'on le coupe, il sèche plus vite que toutes les herbes\FTNT{Cp. \vref{Jé. 17:5-8}~; \vref{Ps. 129:6}.}.
\VS{13}Ainsi est la voie de tous ceux qui oublient Dieu\FTNT{\vref{Ps. 9:18}.}, et l'espérance de l'hypocrite périra\FTNT{\vref{Ps. 1:4}~; \vref{112:10}~; \vref{Pr. 10:28}~; \vref{Job 11:20}~; \vref{27:8}.}.
...
\VS{20}Dieu ne rejette pas l'homme intègre, il ne soutient pas la main des méchants\FTNT{\vref{Job 4:7}.}.
\VS{21}Il remplira encore ta bouche de cris de joie, et tes lèvres de chants d'allégresse\FTNT{\vref{Ps. 126:2}.}.
\VS{22}Ceux qui te haïssent seront revêtus de honte, et la tente des méchants ne sera plus\FTNT{\vref{Ps. 35:26}~; \vref{109:29}.}.
\Chap{9}
\TextTitle{Réponse de Job}
\VerseOne{}Job prit la parole et dit~:
\VS{2}Certainement, je sais qu'il en est ainsi~; et comment l'homme mortel se justifierait-il\FTNT{\vref{Ha. 2:4}~; \vref{Ga. 3:11}~; \vref{Ro. 1:17}~; \vref{Hé. 10:38}.} devant Dieu\FTNT{\vref{Ps. 25:4}~; \vref{143:2}~; \vref{Job 15:14-16}~; \vref{Da. 9:11}~; \vref{Ro. 3:19}.}~?
\VS{3}Si Dieu veut plaider avec lui de mille articles, il ne saurait lui répondre sur un seul\FTNT{\vref{Es. 45:9-10}.}.
\VS{4} Dieu est sage de cœur, et puissant en force. Qui est-ce qui s'est opposé à lui, et s'en est bien trouvé\FTNT{\vref{Job 12:13}~; \vref{Job 36:5}~; \vref{Job 37:23}.}~?
\VS{5}Il transporte les montagnes, et quand il les renverse dans sa fureur, elles n'en connaissent rien\FTNT{\vref{Ps. 144:5}.}.
\VS{6}Il remue la terre de sa place, et ses piliers sont ébranlés\FTNT{\vref{Ag. 2:6,21}~; \vref{Hé. 12:26}.}.
\VS{7}Il parle au soleil, et le soleil ne se lève pas~; et il met un sceau sur les étoiles\FTNT{\vref{Jos. 10:12}.}.
\VS{8} C'est lui seul qui étend les cieux\FTNT{\vref{Ge. 1:6-8}~; \vref{Es. 44:24}~; \vref{Es. 51:13}~; \vref{Ps. 104:2}.}, qui marche sur les hauteurs de la mer\FTNT{Cp. \vref{Mt. 14:25}.}.
\VS{9}Il a fait la grande ourse, l'orion, les pléiades, et les étoiles des régions australes\FTNT{\vref{Ge. 1:16}~; \vref{Am. 5:8}~; \vref{Ps. 89:12}~; \vref{Job 38:31-32}.}.
\VS{10}Il fait de grandes choses qu'on ne peut sonder, des merveilles sans nombre\FTNT{\vref{Ps. 86:10}~; \vref{139:6,17-18}~; \vref{Job 5:9}~; \vref{37:5}.}.
\VS{11}Voici, il passe près de moi, et je ne le vois pas~; il passe encore, et je ne l'aperçois pas\FTNT{\vref{Job 23:8-9}~; \vref{35:14}.}.
\VS{12}Voilà, s'il ravit, qui le lui fera rendre~? Et qui lui dira~: Que fais-tu\FTNT{\vref{Es. 45}: \vref{9-10}~; \vref{Da. 4:35}~; \vref{Ro. 11:33-35}.}~?
\VS{13}Si Dieu ne retire pas sa colère, les orgueilleux qui viennent au secours s'inclinent sous lui\FTNT{\vref{Job 26:12}~; Cp. \vref{Es. 30:7}.}.
\VS{14}Combien moins lui répondrais-je, moi, et comment choisirais-je mes paroles contre lui~? 
\VS{15}Moi, je ne lui répondrai pas, quand bien même je serais juste, je demanderai grâce à mon juge\FTNT{\vref{Job 23:1-7}}.
\VS{16}Si je l'invoque et qu'il me réponde, je ne croirais pas qu'il ait écouté ma voix,
\VS{17}car il m'a écrasé du milieu d'un tourbillon, et il a ajouté plaie sur plaie, sans que je l'aie mérité\FTNT{\vref{Job 6:29}.}, 
\VS{18}il ne me permet pas de reprendre haleine~; il me rassasie d'amertume\FTNT{\vref{Job 7:19}.}.
...
\VS{21}Je suis innocent~! Je ne me soucie pas de vivre, je méprise ma vie\FTNT{\vref{Job 10:1}.}.
\VS{22}Tout revient à un~! C'est pourquoi j'ai dit: Il consume l'homme juste et le méchant\FTNT{Cp. \vref{Ez. 21:3}~; \vref{Ec. 9:2-3}~; \vref{Mt. 5:45}.}.
...
\VS{25}Or mes jours vont plus vite qu'un courrier~; ils s'enfuient sans avoir vu le bien\FTNT{\vref{Job 7:6-7}.}~;
...
\VS{28}je suis épouvanté de tous mes tourments. Je sais que tu ne me jugeras pas innocent\FTNT{Cp. \vref{Ps. 130:3}.}.
\VS{29}Je serai trouvé méchant~; pourquoi travaillerais-je en vain~?
\VS{30}Quand je me laverais dans de l'eau de neige, et que je nettoierais mes mains dans la pureté\FTNT{\vref{Jé. 2:22}.}, 
\VS{31}tu me plongerais dans le fossé et mes vêtements m'auraient en horreur.
\VS{32}Car il n'est pas comme moi un homme, pour que je lui réponde, et que nous allions ensemble en jugement\FTNT{\vref{Es. 45:9}~; \vref{Jé. 49:19}~; \vref{Ec. 6:10}~; \vref{Ro. 9:20}.}.
\VS{33}Mais il n'y a personne qui prend connaissance de la cause qui serait entre nous, et qui met la main sur nous deux\FTNT{Cp. \vref{1 S. 2:25}.}.
...
\VS{3}Te plais-tu à m'opprimer, et à dédaigner l'ouvrage de tes mains, et à bénir les desseins des méchants\FTNT{\vref{Es. 64:7-8}.}~?
...
\VS{8}Tes mains m'ont formé et elles ont rangé toutes les parties de mon corps~; et tu me détruirais\FTNT{\vref{Ge. 2:7}~; \vref{Ps. 119:73}~; \vref{139:14-15}.}~!
...
\VS{16}Si je redresse la tête, tu me poursuis comme un grand lion, et tu multiplies tes exploits contre moi\FTNT{\vref{Za. 38:13}~; \vref{La. 3:10}.}.
...
\VS{11}Car il connaît les hommes perfides, il discerne par le regard les coupables\FTNT{\vref{Ps. 10:11-14}~; \vref{35:22}.}.
\VS{12}Mais l'homme vide de sens devient intelligent, quoique l'homme naisse comme un ânon sauvage\FTNT{\vref{Ec. 3:18}.}.
...
\VS{17}La vie se lèvera pour toi plus brillante que le midi, et l'obscurité même sera comme le matin\FTNT{\vref{Ps. 37:6}~; \vref{112:4}.}.
\VS{18} Tu seras plein de confiance parce qu'il y aura de l'espérance pour toi~; tu creuseras, et tu reposeras sûrement\FTNT{\vref{Lé. 26:6}~; \vref{Ps. 3:6}~; \vref{Pr. 3:24}.}.
...
\VS{6}Ce sont les tentes des voleurs qui prospèrent, et ceux-là qui irritent Dieu sont assurés, et ils sont ceux à qui Dieu remet tout entre les mains\FTNT{\vref{Jé. 12:1}~; \vref{Ps. 73:12}.}.
...
\VS{13}Mais en Dieu est la sagesse et la force~; à lui appartient le conseil et l'intelligence\FTNT{\vref{Da. 2:20}.}.
\VS{14}Voici, il démolit, et on ne rebâtit pas~; il enferme un homme et on ne lui ouvre pas\FTNT{\vref{Es. 22:22}~; \vref{Ap. 3:7}.}.
...
\VS{17}il emmène dépouillés les conseillers et il met hors de sens les juges\FTNT{\vref{2 S. 15:31}~; \vref{17:14-23}~; \vref{Es. 19:12}~; \vref{29:14}~; \vref{1 Co. 1:19}.}.
...
\VS{21}Il répand le mépris sur les grands~; il relâche la ceinture des forts\FTNT{\vref{Es. 40:23}.}.
\VS{22}Il met en évidence les choses qui étaient cachées dans les ténèbres, et il met en lumière l'ombre de la mort\FTNT{\vref{Ps. 139:11-12}~; \vref{Ec. 12:16}~; \vref{Mt. 10:26}~; \vref{1 Co. 4:6}.}.
...
\VS{5}Plaît à Dieu que vous demeuriez entièrement dans le silence~; et cela vous sera réputé à sagesse\FTNT{\vref{Pr. 17:28}.}.
...
\VS{10}Il vous censurera, vous censurera\FTNT{voir commentaire en \vref{Ge. 2:16-17}}, même si en secret vous faites acception de personnes.
...
\VS{14}Pourquoi porterais-je ma chair entre mes dents et tiendrais-je mon âme entre mes mains\FTNT{\vref{Jg. 12:3}~; \vref{1 S. 19:5}.}~?
\VS{15}Voilà, qu'il me tue, je ne cesserai pas d'espérer en lui~; et je défendrai ma conduite en sa présence.
\VS{16}Et qui plus est, il sera lui-même ma délivrance~; mais l'hypocrite ne viendra pas devant sa face\FTNT{\vref{Ps. 1:5}.}.
...
\VS{25}Déploieras-tu tes forces contre une feuille que le vent emporte~? Poursuivras-tu du chaume tout sec\FTNT{\vref{1 S. 24:15}.},
\VS{26}pour que tu écrives contre moi des choses amères\FTNT{\vref{Ps. 25:7}.},
...
\Chap{14}
\VerseOne{}L'homme né de la femme est de courte vie, et rassasié d'agitations\FTNT{\vref{Ps. 102:12}~; \vref{103:15}~; \vref{144:4}~; \vref{Ja. 4:14}.}.
\VS{2}Il sort comme une fleur, puis il est coupé, et il s'enfuit comme une ombre qui ne s'arrête pas\FTNT{\vref{Es. 40:6}~; \vref{Ps. 90:61}~; \vref{1 Pi. 1:24}.}.
\VS{3}Cependant tu as ouvert tes yeux sur lui et tu me conduis en justice avec toi.
\VS{4}Qui est-ce qui tirera le pur de l'impur~? Personne\FTNT{\vref{Es. 48:8}~; \vref{Pr. 22:15}.}.
...
\VS{16}Mais maintenant tu comptes mes pas, et tu veilles sur mon péché\FTNT{\vref{Ps. 56:9}~; \vref{Ps. 139:2-4}~; \vref{Pr. 5:21}.}~;
\VS{17}mes péchés sont cachotés comme dans une sac, et tu as cousu ensemble mes iniquités\FTNT{\vref{Os. 13:12}.}.
...
\VS{7}Es-tu le premier homme né~? Ou as-tu été formé avant les montagnes\FTNT{\vref{Ps. 90:2}~; \vref{Pr. 8:25}.}~?
\VS{8}As-tu été instruit dans le conseil secret de Dieu, et renfermes-tu seul la sagesse\FTNT{\vref{Es. 40:13}~; \vref{Jé. 23:18}~; \vref{Ro. 11:34}.}~?
...
\VS{14}Qu'est-ce que l'homme mortel pour qu'il soit pur, et celui qui est né de femme pour qu'il soit juste\FTNT{\vref{Ps. 14:3}~; \vref{Pr. 20:9}~; \vref{Ec. 7:20}.}~?
...
\VS{20}Le méchant est comme en travail d'enfant tous les jours de sa vie, et un petit nombre d'années sont réservées à l'homme violent\FTNT{\vref{Es. 48:22}~; \vref{57:21}.}.
\VS{21}Un cri de frayeur est dans ses oreilles~; au milieu de la paix il croit que le destructeur se jette sur lui\FTNT{\vref{1 Th. 5:3}.}~;
\VS{22}il ne croit pas pouvoir sortir des ténèbres, car il est toujours regardé par l'épée.
\VS{23}Il court après le pain, en disant~: Où y en a-t-il~? Il sait que le jour de ténèbres est tout prêt, et il le touche comme avec la main\FTNT{\vref{Ps. 109:10}.}.
...
\VS{35}Ils conçoivent le travail, et ils enfantent la misère, et machinent dans le cœur des fraudes\FTNT{\vref{Es. 59:4}~; \vref{Os. 10:13}.}.
\Chap{16}
\TextTitle{Réponse de Job}
...
\VS{15}J'ai cousu un sac sur ma peau~; j'ai terni ma gloire dans la poussière\FTNT{\vref{Ps. 44:25}~; \vref{Ps. 119:25}.}.
...
\VS{19}Mais maintenant voilà, mon témoin est aux cieux, mon témoin est dans les lieux élevés\FTNT{\vref{Ap. 1:5}~; \vref{Ap. 3:14}.}.
...
\VS{3}Donne-moi, je te prie, donne-moi une caution auprès de toi~; qui donc me frappera dans la main\FTNT{\vref{Pr. 6:1}~; \vref{Pr. 17:18}}~?
\VS{4}Tu caches à leur cœur l'intelligence, c'est pourquoi tu ne les élèveras pas\FTNT{\vref{De. 29:4}~; \vref{Mt. 11:25}.}.
...
\VS{7}Mon œil est obscurci par le chagrin, et tous les membres de mon corps sont comme une ombre\FTNT{\vref{Ps. 6:7}~; \vref{31:10}.}.
...
\VS{5}Certainement, la lumière des méchants sera éteinte, et l'étincelle de leur feu ne reluira plus\FTNT{\vref{Ps. 37:9-10}.}.
...
\VS{11}De tous côtés des terreurs l'assiégeront et feront courir ses pieds çà et là\FTNT{\vref{Jé. 6:25}~; \vref{46:5}~; \vref{49:29}.}.
...
\VS{17}Sa mémoire périra sur la terre, et on ne parlera plus de son nom dans les places\FTNT{\vref{Ps. 109:13}~; \vref{Pr. 10:7}.}.
\VS{18}On le chassera de la lumière dans les ténèbres, et il sera exterminé du monde. 
\VS{19}Il n'aura ni fils ni petit-fils parmi son peuple, et il n'aura personne qui lui survive dans ses demeures\FTNT{\vref{Es. 14:20-22}~; \vref{Jé. 22:30}~; \vref{Ps. 37:28}~; \vref{109:13}.}. 
...
\VS{11}Il s'est enflammé de colère contre moi, et m'a traité comme l'un de ses ennemis\FTNT{\vref{La. 2:5}.}.
\VS{12}Ses troupes sont venues ensemble, et elles ont dressé leur chemin contre moi, et se sont campées autour de ma tente\FTNT{\vref{La. 2:22}.}.
\VS{13}Il a fait retirer loin de moi mes frères, et ceux qui me connaissaient se sont fort éloignés de moi comme des étrangers\FTNT{\vref{Ps. 88:9}.}~;
...
\VS{19}Tous ceux à qui je déclarais mes secrets, m'ont en abomination~; et tous ceux que j'aimais se sont tournés contre moi\FTNT{\vref{Ps. 55:13-14}.}.
\VS{20}Mes os sont attachés à ma peau et à ma chair, et il ne me reste d'entier que la peau de mes dents\FTNT{\vref{La. 4:8}.}.
\VS{21}Ayez pitié de moi, ayez pitié de moi, vous mes amis~; car la main de Dieu m'a frappé.
\VS{22}Pourquoi me poursuivez-vous comme Dieu me poursuit, sans pouvoir vous rassasier de ma chair\FTNT{\vref{Ps. 27:2}.}~?
...
\VS{26}Après que ma peau, ce reste aura été détruit, sans ma chair, je verrai Dieu\FTNT{\vref{Ps. 17:15}.}~!
...
\VS{5}le triomphe des méchants est de peu de durée, et que la joie de l'hypocrite n'est que pour un moment \FTNT{\vref{Ps. 37:35-36}.}~?
...
\VS{8}Il s'envolera comme un songe, et on ne le trouvera plus~; il s'enfuira comme une vision de nuit\FTNT{\vref{Ps. 73:19-20}.}~;
\VS{9}l'œil qui le regardait ne le verra plus, le lieu qu'il habitait ne le contemplera plus.
\VS{10}Ses enfants rechercheront la faveur des pauvres, et ses mains restitueront ce que sa violence a ravi\FTNT{\vref{Ps. 109:10}.}.
...
\VS{18}Il rendra le fruit de son travail, et ne l'avalera pas~; il le rendra selon sa juste valeur, et ne s'en réjouira pas\FTNT{\vref{So. 2:10}.}.
\VS{19}Parce qu'il aura foulé les pauvres et les aura abandonnés, il aura ruiné sa maison, bien loin de la bâtir. 
\VS{20}Certainement, il ne sentira pas de contentement en son ventre, et il ne sauvera rien de ce qu'il aura tant convoité\FTNT{\vref{Ec. 5:12}.}.
...
\VS{26}Toutes les ténèbres seront renfermées dans ses demeures les plus secrètes~; un feu qu'on n'aura point soufflé le consumera~; l'homme qui restera dans sa tente sera malheureux\FTNT{\vref{Ps. 12:6}.}.
...
\VS{7}Pourquoi les méchants vivent-ils, vieillissent-ils, et même pourquoi sont-ils les plus puissants\FTNT{\vref{Jé. 12:1}~; \vref{Ha. 1:3}~; \vref{Mal. 3:14-15}.}~?
...
\VS{10}Leur taureau engendre et n'y manque pas~; leur jeune vache se décharge de son veau et n'avorte pas\FTNT{\vref{Ps. 144:13-14}.}.
...
\VS{15}Qui est le Tout-Puissant pour que nous le servions~? Et quel bien nous reviendra-t-il de l'invoquer\FTNT{\vref{Ex. 5:2}.}~?
\VS{16}Voilà, leur bonheur n'est pas en leur puissance. Que le conseil des méchants soit loin de moi\FTNT{\vref{Ps. 1:1-2}.}~!
\VS{17}Combien de fois arrive-t-il que la lampe des méchants s'éteigne, et que l'orage vienne sur eux~! Dieu leur distribuera leurs portions dans sa colère\FTNT{\vref{Ps. 11:5-6}~; \vref{Pr. 13:9}.}.
\VS{18}Ils seront comme la paille exposée au vent, et comme la balle qui est enlevée par le tourbillon\FTNT{\vref{Ps. 1:4}}.
\VS{19}Dieu réservera aux enfants du méchant la punition de ses violences, il la leur rendra, et il le saura~!
\VS{20}Ses yeux verront sa ruine, et il boira la colère du Tout-Puissant\FTNT{\vref{Es. 51:17-22}~; \vref{Jé. 25:15}~; \vref{Ez. 23:31-32}~; \vref{Ap. 14:10}.}.
\VS{21}Et quel plaisir aura-t-il en sa maison qu'il laisse après lui, puisque le nombre de ses mois aura été retranché~? 
\VS{22}Est-ce à Dieu qu'on enseignera la science, à celui qui juge ceux qui sont élevés\FTNT{\vref{Ro. 11:34}~; \vref{1 Co. 2:16}.}~?
...
\VS{30}que le méchant est réservé pour le jour de la ruine, pour le jour où les fureurs sont envoyées\FTNT{\vref{Pr. 16:4}~; \vref{Ec. 9:12}.}~?
...
\VS{6}Car tu as pris sans raison le gage de tes frères~; tu as ôté la robe à ceux qui étaient nus\FTNT{\vref{Ex. 22:21}.}~;
...
\VS{13}Mais tu dis~: Qu'est-ce que Dieu connaît~? Jugera-t-il au travers des nuées obscures~?\FTNT{\vref{So. 1:12}~; \vref{Ps. 10:11-13}~; \vref{Ps. 94:7}.} 
...
\VS{19}Les justes le verront, se réjouiront, et l'innocent se moquera d'eux\FTNT{\vref{Ps. 107:42}.}.
\VS{20}Certainement, notre adversaire a péri, le feu a dévoré ce qui en restait\FTNT{\vref{Ps. 37:20}~; \vref{Ec. 8:12-13}.}~!
\VS{21}Attache-toi donc à Dieu, je te prie, tu demeureras en repos, tu atteindras ainsi le bonheur.
\VS{22}Reçois, je te prie, la loi de sa bouche, et mets ses paroles en ton cœur\FTNT{\vref{Ps. 119:72}.}.
...
\VS{27}tu le fléchiras par tes prières, et il t'exaucera, et tu lui accompliras tes vœux\FTNT{\vref{Ps. 50:14-15}.}.
\VS{28}Si tu as une résolution, elle tiendra~; la lumière brillera sur tes voies\FTNT{\vref{Ps. 97:11}.}.
\VS{29}Quand on aura abaissé quelqu'un et que tu auras dit qu'il soit élevé~; alors Dieu délivrera celui qui tenait les yeux abaissés\FTNT{\vref{Pr. 29:23}.}.
...
\VS{10}Il connaît la voie que j'ai suivie~; et s'il m'éprouvait, j'en sortirai pur comme l'or\FTNT{\vref{1 Pi. 1:7}.}.
...
\VS{13}Mais s'il a une pensée, qui l'en détournera~? Et ce que mon âme désire, il le fait\FTNT{\vref{Ps. 115:3}~; \vref{Ps. 135:6}.}.
...
\VS{2}Ils déplacent les bornes, ils ravissent des troupeaux, et ils les font paître\FTNT{\vref{De. 19:14}~; \vref{De. 27:17}~; \vref{Pr. 13:10}~; \vref{Pr. 22:28}.}~;
...
\VS{7}Ils font passer la nuit sans vêtements à ceux qu'ils ont dépouillés, et qui n'ont pas de quoi se couvrir durant le froid \FTNT{\vref{Lé. 19:13}~; \vref{De. 24:12-13}.}~;
...
\VS{14}Le meurtrier se lève au point du jour, et il tue le pauvre et l'indigent, et la nuit il est tel qu'un larron\FTNT{\vref{Ps. 10:8-9}.}.
\VS{15}L'œil de l'adultère épie le soir, en disant~: Aucun œil ne me verra~; et il se couvre le visage\FTNT{\vref{Ps. 64:6}~; \vref{Pr. 7:7-10}.}.
\VS{16}Ils percent durant les ténèbres les maisons qu'ils avaient marquées le jour, ils haïssent la lumière\FTNT{\vref{Jn. 3:20}.}.
...
\VS{19}Comme la sécheresse et la chaleur consument les eaux de neige, ainsi le scheol engloutit les pécheurs\FTNT{\vref{Ps. 49:15}.}~!
...
\VS{3} Ses armées peuvent-elles se compter~? Et sur qui sa lumière ne se lève-t-elle point\FTNT{\vref{Mt. 5:45}.}~?
...
\VS{6}Combien moins l'homme qui n'est qu'un ver~; et le fils d'un homme, qui n'est qu'un vermisseau \FTNT{\vref{Ps. 22:7}.}~!
\Chap{26}
\TextTitle{Réponse de Job}
\VerseOne{}Job répondit, et dit~:
...
\VS{6}devant lui le scheol est nu, l'abîme est sans voile\FTNT{\vref{Ps. 139:8-12}~; \vref{Pr. 15:11}~; \vref{Hé. 4:13}.}.
\VS{7}Il étend la direction nord sur le vide, il suspend la terre sur le néant.
\VS{8}Il renferme les eaux dans ses nuages, et la nuée n'éclate pas sous leur poids\FTNT{\vref{Ps. 104:2-3}.}.
\VS{9}Il couvre la face de son trône, et il étend sa nuée par dessus.
\VS{10}Il a entouré les eaux avec des bornes jusqu'à ce qu'il n'y ait plus ni lumière ni ténèbres\FTNT{\vref{Ge. 1:9}~; \vref{Jé. 5:22}~; \vref{Ps. 33:7}~; \vref{Ps. 104:9}~; \vref{Pr. 8:29}.}.
\VS{11}Les colonnes du ciel s'ébranlent et s'étonnent à sa menace.
\VS{12}Par sa force il soulève la mer, par son intelligence il en brise l'orgueil\FTNT{\vref{Ps. 89:10}.}.
\VS{13}Il a orné les cieux par son Esprit, et de sa main, il a formé le serpent fuyard.
\VS{14}Voilà, tels sont les bords de ses voies~; mais combien est petite la portion que nous en connaissons~? Et qui est ce qui pourra comprendre le bruit éclatant de sa puissance\FTNT{\vref{Ec. 3:10}.}~?
\Chap{27}
...
\VS{4}mes lèvres ne prononceront rien d'injuste, et ma langue ne dira pas de chose fausse\FTNT{\vref{Es. 33:15}~; \vref{Ps. 15:2}~; \vref{Ps. 24:4}.}.
...
\VS{8}Quelle attente reste-t-il à l'hypocrite quand Dieu lui retire son âme\FTNT{\vref{Mt. 16:26}~; \vref{Lu. 12:20}.}~?
\VS{9}Est-ce que Dieu entend ses cris quand l'angoisse vient sur lui\FTNT{\vref{Es. 1:15}~; \vref{Jé. 14:12}~; \vref{Ez. 8:18}~; \vref{Mi. 3:4}~; \vref{Ps. 18:41}~; \vref{Pr. 1:28}~; \vref{Jn. 9:31}~; \vref{Ja. 4:3}.}~?
...
\VS{15}ses survivants seront bien ensevelis par la peste, et leurs veuves ne les pleureront pas\FTNT{\vref{Ps. 78:64}.}.
...
\VS{18}Il se bâtira une maison comme celle de la teigne, comme la cabane que fait un gardien\FTNT{\vref{Ps. 49:18}.}.
...
\VS{15}Elle ne se donne pas contre de l'or pur, elle ne s'achète pas au poids de l'argent\FTNT{\vref{Pr. 3:14}~; \vref{Pr. 8:11}~; \vref{Pr. 16:16}.}.
...
\VS{24}car il regarde jusqu'aux extrémités de la terre, il voit tout sous les cieux\FTNT{\vref{Ps. 14:2}~; \vref{Ps. 33:13-14}~; \vref{Ps. 102:20}.}.
\VS{25}Quand il façonna le poids du vent, et qu'il estima la mesure des eaux\FTNT{\vref{Pr. 8:29}.},
...
\VS{28}Puis il dit à l'homme~: Voici, la crainte du Seigneur est la sagesse, et se détourner du mal c'est l'intelligence\FTNT{\vref{De. 4:6}~; \vref{Jé. 9:24}~; \vref{Ps. 111:10}~; \vref{Pr. 1:7}~; \vref{Pr. 9:10}~; \vref{Ec. 12:15}.}.
\Chap{29}
...
\VS{6}quand je lavais mes pieds dans le lait, et que le rocher répandait près de moi des torrents d'huile\FTNT{\vref{De. 32:13}.}~!
...
\VS{12}car je délivrais l'affligé qui criait au secours, et l'orphelin qui n'avait personne pour le secourir\FTNT{\vref{Ps. 72:12}~; \vref{Pr. 21:13}.}.
...
\VS{14}J'étais revêtu de la justice, elle me servait de vêtement, et mon équité m'était comme un manteau, et comme une tiare\FTNT{\vref{Es. 59:17}~; \vref{1 Th. 5:8}~; \vref{Ep. 6:14-17}.}.
\VS{15}J'étais les yeux de l'aveugle et les pieds du boiteux.
\VS{16}J'étais le père des pauvres, et je m'informais diligemment de la cause qui ne m'était pas connue\FTNT{\vref{Pr. 29:7}.}.
\VS{17}Je cassais les grosses dents de l'injuste, et je lui arrachais la proie d'entre ses dents\FTNT{\vref{Ps. 58:7}.}.
\VS{18}C'est pourquoi je disais~: Je mourrai dans mon lit, et je multiplierai mes jours comme les grains de sable~;
\VS{19}ma racine sera ouverte aux eaux, et la rosée demeurera toute la nuit sur mes branches\FTNT{\vref{Jé. 17:5-8}~; \vref{Ps. 1:3}.}. 
...
\VS{9}Et maintenant je suis le sujet de leur chanson, et la matière de leur entretien\FTNT{\vref{Ps. 69:12}~; \vref{La. 3:14}.}.
...
\VS{12}De jeunes gens, nouvellement nés, se placent à ma droite~; ils poussent mes pieds, et je suis en butte à leur malice\FTNT{\vref{Ps. 35:15}.}~;
...
\VS{15}Les frayeurs se tournent vers moi, et comme un vent elles poursuivent mon âme~; et ma délivrance s'est dissipée comme une nuée\FTNT{\vref{Os. 13:3}.}.
...
\VS{23}Je sais donc que tu me conduis à la mort et dans la maison assignée à tous les vivants\FTNT{\vref{Hé. 9:27}.}.
\VS{24}Mais il n'étendra pas sa main jusqu'au sépulcre. Quand il les aura tués, crieront-ils~? 
\VS{25}Ne pleurais-je pas pour l'amour de celui qui passait de mauvais jours~; et mon âme n'était-elle pas affligée à cause du pauvre\FTNT{\vref{Ro. 12:15}.}~?
...
\VS{29}Je suis devenu le frère des dragons, et le compagnon des hiboux\FTNT{\vref{Ps. 102:7-8}.}.
\VS{30}Ma peau est devenue noire sur moi, et mes os sont desséchés par l'ardeur qui me consume\FTNT{\vref{La. 4:8}~; \vref{La. 5:10}.}.
...
\VS{4}Dieu ne voit-il lui-même pas mes voies~? Ne compte-t-il pas tous mes pas\FTNT{\vref{Pr. 5:21}~; \vref{Pr. 15:3}~; \vref{2 Ch. 16:9}.}~?
...
\VS{9}Si mon cœur a été séduit après quelque femme, et si j'ai demeuré en embûche à la porte de mon prochain\FTNT{\vref{Pr. 7}.},
...
\VS{15}Celui qui m'a fait dans le ventre de ma mère ne l'a-t-il pas fait aussi~? Un même Dieu ne nous a-t-il pas formés dans le sein maternel\FTNT{\vref{Pr. 14:31}~; \vref{Pr. 17:5}.}~?
\VS{16}Si j'ai refusé aux pauvres leur désir, si j'ai laissé se consumer les yeux de la veuve\FTNT{\vref{Es. 10:2}~; \vref{Lu. 18:2-3}.},
...
\VS{19}si j'ai vu le malheureux périr faute de vêtements, le pauvre manquer de couverture\FTNT{\vref{Mt. 25:41-45}.},
\VS{20}si ses reins ne m'ont point béni, et s'il n'a pas été échauffé de la laine de mes agneaux~;
\VS{21}si j'ai levé la main contre l'orphelin, quand j'ai vu à la porte que je pouvais l'aider\FTNT{\vref{Pr. 22:22}.}~;
...
\VS{24}Si j'ai mis mon espérance en l'or, et si j'ai dit au fin or~: Tu es ma confiance\FTNT{\vref{Mc. 10:24}~; \vref{1 Ti. 6:17}.}~;
\VS{25}si je me suis réjoui de ce que mes biens étaient multiples, et de ce que ma main en avait trouvé abondamment\FTNT{\vref{Ps. 62:11}.}~;
...
\VS{29}Si je me suis réjoui du malheur de mon ennemi, si j'ai sauté d'allégresse quand le mal l'a atteint\FTNT{\vref{Mt. 5:43-44}.},
\VS{30}moi qui n'ai pas permis à ma langue de pécher en demandant sa mort par des malédictions~;
\VS{31}les gens de ma maison n'ont pas dit~: Qui nous donnera de sa chair, nous n'en saurions être rassasiés\FTNT{\vref{Ps. 27:2}.}~?
\VS{32}L'étranger n'a pas passé la nuit dehors~; j'ai ouvert ma porte au passant\FTNT{\vref{Ge. 19:1-2}~; \vref{De. 10:19}~; \vref{1 Pi. 4:9}~; \vref{Hé. 13:2}.}~;
\VS{33}si j'ai caché mon péché comme Adam, pour couvrir mon iniquité en me flattant\FTNT{\vref{Ge. 3:10-12}~; \vref{Pr. 28:13}.},
...
\VS{8}En vérité, il y a un esprit dans l'homme, mais c'est l'inspiration du Tout-Puissant qui le rend intelligent\FTNT{\vref{Da. 1:17}~; \vref{Da. 2:21}~; \vref{Pr. 2:6}~; \vref{Ec. 2:26}.}~;
...
\VS{19}Voici, mon ventre est comme un vin qui n'a pas été ouvert~; et il éclate comme des outres neuves\FTNT{\vref{Mt. 9:17}~; \vref{Mc. 2:22}~; \vref{Lu. 5:38}.}.
...
\VS{4}L'Esprit de Dieu m'a fait, et le souffle du Tout-Puissant m'a donné la vie\FTNT{\vref{Ge. 2:7}.}.
\VS{5}Si tu peux, réponds-moi, dresse-toi contre moi, demeure ferme~!
\VS{6}Voici, je suis pour Dieu, selon que tu en as parlé~; j'ai aussi été formé de la terre tout comme toi\FTNT{\vref{Ac. 14:15}.}.
...
\VS{19}L'homme est aussi châtié par des douleurs sur son lit, par l'agitation perpétuelle de ses os\FTNT{\vref{Ps. 38:4}.}.
\VS{20}Alors sa vie prend en horreur le pain et son âme la viande désirable\FTNT{\vref{Ps. 107:18}.}~;
...
\VS{26}Il fléchira Dieu par ses prières, et Dieu s'apaisera envers lui, et lui fera voir sa face avec joie, et lui rendra sa justice\FTNT{\vref{Es. 58:9}.}.
...
\VS{29}Voilà, Dieu fait toutes ces choses, deux et trois fois envers l'homme\FTNT{\vref{Ps. 62:11}.},
\VS{30}pour retiré son âme de la fosse, afin qu'elle soit éclairée de la lumière des vivants\FTNT{\vref{Ps. 56:14}.}.
...
\VS{9}Car il a dit~: Il ne sert à rien à l'homme de plaire à Dieu\FTNT{\vref{Mal. 3:14}.}.
\VS{10} C'est pourquoi, vous qui avez de l'intelligence, écoutez-moi~! A Dieu ne plaise qu'il y ait de la méchanceté en Dieu, et de l'injustice dans le Tout-Puissant\FTNT{\vref{De. 32:4}~; \vref{Ps. 92:16}~; \vref{Ro. 9:14}.}~!
\VS{11}Car il rendra à l'homme selon son œuvre, il fera trouver à chacun selon sa voie\FTNT{\vref{Jé. 17:10}~; \vref{Jé. 32:19}~; \vref{Ez. 7:27}~; \vref{Pr. 24:12}~; \vref{Mt. 16:27}~; \vref{Ro. 2:6}~; \vref{2 Co. 5:10}~; \vref{Ep. 6:8}~; \vref{Ap. 22:12}.}.
...
\VS{14}S'il ne pensait qu'à lui-même, il retirerait à lui son Esprit et son souffle\FTNT{\vref{Ps. 104:29}.},
\VS{15}toute chair périrait ensemble, et l'homme retournerait dans la poussière\FTNT{\vref{Ge. 3:19}~; \vref{Ec. 3:20}~; \vref{Ec. 12:9}.}.
...
\VS{19}Combien moins le dira-t-on à celui qui n'a point d'égard à la personne des grands, et qui ne connaît point les riches pour les préférer aux pauvres, parce qu'ils sont tous l'ouvrage de ses mains\FTNT{\vref{De. 10:17}~; \vref{2 Ch. 19:7}~; \vref{Ac. 10:34}~; \vref{Ga. 2:6}~; \vref{Ro. 2:11}~; \vref{Ep. 6:9}~; \vref{Col. 3:25}.}~?
...
\VS{28}de sorte qu'ils ont fait monter le cri du pauvre jusqu'à lui, et qu'il a entendu le cri des affligés\FTNT{\vref{Ja. 5:4}.}.
...
\FTNT{\vref{Es. 1:15}~; \vref{Ez. 8:18}~; \vref{Mi. 3:4}~; \vref{Jn. 9:31}.}.
...
\VS{7}Il ne détourne pas ses yeux de dessus les justes, il les place sur le trône avec les rois, il les y fait asseoir pour toujours, afin qu'ils soient élevés\FTNT{\vref{Ps. 33:18}~; \vref{Ps. 34:16}.}.
...
\VS{16}Il t'écartera aussi de la détresse, pour te mettre au large, loin de toute angoisse, et ta table sera chargée de viandes grasses\FTNT{\vref{Ps. 50:15}~; \vref{Ps. 63:6}.}.
\VS{17}Or tu remplis le jugement du méchant, mais le jugement et le droit subsisteront.
\VS{18}Certainement Dieu est irrité~; prends garde qu'il ne te plonge dans l'affliction, car il n'y aura pas alors de rançon si grande qui puisse te délivrer\FTNT{\vref{Ps. 49:8}.}~!
...
\VS{26}Dieu est grand, mais nous ne le connaissons pas~; quant au nombre de ses années, il est insondable\FTNT{\vref{Es. 63:16}~; \vref{Ps. 92:8}~; \vref{Ps. 93:2}~; \vref{Ps. 102:13}~; \vref{La. 5:19}.}.
...
\VS{2}Ecoutez attentivement et en tremblant le bruit de sa voix, le grondement qui sort de sa bouche\FTNT{\vref{Ps. 29:3-9}.}~!
\VS{3}Il le conduit dans toute l'étendue des cieux, et son éclair brille jusqu'aux extrémités de la terre\FTNT{\vref{Ps. 97:4}.}.
\VS{4}Après lui s'élève un grand bruit, il tonne de sa voix majestueuse~; et il ne tarde pas après que sa voix a été entendue\FTNT{\vref{Jé. 10:13}.}.
...
\VS{10}Par son souffle, Dieu donne la glace, et il réduit l'espace où se répandaient au large les eaux\FTNT{\vref{Ps. 147:17-18}.}.
...
\VS{13}Il les fait venir s'en servir soit comme une verge pour la terre, soit pour répandre ses bienfaits\FTNT{\vref{Ex. 9:18-23}~; \vref{1 S. 12:18-19}.}.
...
\VS{24}C'est pourquoi les hommes le craignent~; mais il ne les voit pas tous sages de cœur\FTNT{\vref{Ps. 92:7}~; \vref{Ro. 1:21}.}.
\Chap{38}
...
\VS{4}Où étais-tu quand je fondais la terre~? Dis-le, si tu as de l'intelligence\FTNT{\vref{Pr. 8:29}.}.
\VS{5}Qui en a réglé les mesures, le sais-tu~? Ou qui a appliqué sur elle le niveau~?
\VS{6}Sur quoi ses bases sont-elles plantées~? Ou qui en a posé la pierre angulaire pour la soutenir\FTNT{\vref{Ps. 104:5}.}~?
\VS{7}Quand les étoiles du matin se réjouissaient ensemble, et que tous les fils de Dieu poussaient des cris de joie \FTNT{\vref{Ps. 148:3}.}~?
...
\VS{15}pour que la lumière soit ôtée aux méchants, et que le bras qui se lève soit brisé\FTNT{\vref{Ps. 10:15}.}~?
...
\VS{23}que je réserve pour les temps de détresse, pour les jours de guerre et de bataille\FTNT{\vref{Ex. 9:23}~; \vref{Jos. 10:11}~; \vref{Ap. 8:7}.}~?
\VS{24}Par quel chemin la lumière se divise-t-elle, et le vent d'orient se répand-il sur la terre\FTNT{\vref{Jn. 3:8}.}~?
\VS{25}Qui a ouvert un conduit aux inondations, et tracé la route de l'éclair et du tonnerre,
\VS{26}pour qu'elle pleuve sur une terre sans habitants, sur un désert sans hommes\FTNT{\vref{Ps. 104:13-14}~; \vref{PS. 147:8}~; \vref{Ac. 14:17}.}~;
...
\VS{31}Peux-tu resserer les liens des pléiades ou détacher les chaînes d'orient\FTNT{\vref{Am. 5:8}.}~?
\VS{32}Fais-tu sortir en leur temps les signes du zodiaque, et conduis-tu la Grande Ourse avec ses petits~?
\VS{33}Connais-tu les lois du ciel~? Disposes-tu de son pouvoir sur la terre\FTNT{\vref{Jé. 31:35-36}~; \vref{Ps. 104:4}.}~?
...
\VS{36}Qui a mis la sagesse dans le cœur, ou qui a donné l'intelligence à l'esprit\FTNT{\vref{Ec. 2:26}.}~?
...
\VerseOne{}Chasses-tu de la proie pour la lionne, et apaises-tu la faim des lionceaux\FTNT{\vref{Ps. 104:21}.},
\VS{2}quand ils se tapissent dans leurs tanières et se tiennent aux aguets dans leur repaire~?
\VS{3}Qui est-ce qui apprête la nourriture au corbeau, quand ses petits crient à Dieu, et qu'ils vont errants, parce qu'ils n'ont point de quoi manger\FTNT{\vref{Ps. 104:27}~; \vref{Ps. 147:9}~; \vref{Mt. 6:26}.}~?
\VS{4}Sais-tu quand les boucs de rochers mettent bas~? Observes-tu les biches de rochers quand elles font leurs petits\FTNT{\vref{Ps. 29:9}.}~?
...
\VS{9}auquel j'ai donné le désert pour maison, et la terre inhabitée pour ses retraites\FTNT{\vref{Jé. 2:24}.}~?
...
\VS{30}Est-ce par ton commandement que l'aigle s'élève, et qu'il place son nid sur les hauteurs\FTNT{\vref{Jé. 49:16}~; \vref{Ab. 1:4}.}~?
...
\VS{33}Ses petits aussi sucent le sang~; et là où sont des cadavres, il s'y trouve aussitôt\FTNT{\vref{Mt. 24:28}~; \vref{Lu. 17:37}.}.
\TextTitle{Yahweh interroge Job}
...
\VS{37}Voici, je suis un homme vil~; que te répondrais-je~? Je mets ma main sur ma bouche\FTNT{\vref{Ps. 39:10}.}.
...
\VS{3}Anéantiras-tu mon jugement~? me condamneras-tu pour te justifier\FTNT{\vref{Ps. 51:6}~; \vref{Ro. 3:4}.}~?
...
\VS{2}Qui m'a donné le premier~? Je lui rendrai. Tout ce qui est sous tous les cieux est à moi\FTNT{\vref{Ex. 19:5}~; \vref{De. 10:14}~; \vref{Ps. 24:1}~; \vref{Ps. 50:12}~; \vref{1 Co. 10:26}~; \vref{Ro. 11:35}.}.
...
\VS{3}Qui est celui-ci, as-tu dit, qui étant sans science, entreprend d'obscurcir mes desseins~? J'ai donc parlé, et je n'y comprends rien~; ces choses sont trop merveilleuses pour moi, et je n'y connais rien\FTNT{\vref{Ps. 40:6}~; \vref{Ps. 131:1}~; \vref{Ps. 139:6}.}.
