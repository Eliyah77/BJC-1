...
\VS{12}On crie donc à cause des méchants.
\FTNT{Es. 1:15 ; Ez. 8:18 ; Mi. 3:4 ; Jn. 9:31.}.
\VS{13} .Et ceux qui sont hypocrites en leur cœur, attirent sur eux la colère, ils ne crient pas à lui quand il les a liés;
\VS{14}Encore moins dois-tu lui dire, tu ne le vois pas; car le jugement est devant lui, attends-le donc!
\VS{15}Mais maintenant, ce n'est rien ce que sa colère exécutée, et il n'est pas entré en profondeur , parce que sa colère ne punit pas encore, ce n'est pas à dire qu'il ait peu de connaissance du crime.
