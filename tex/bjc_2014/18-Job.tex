...
\VS{11}Dieu m'a enfermé chez l'injuste, il m'a fait tomber entre les mains des méchants. 
...
\VS{5}Celui qui trahit ses amis pour qu'ils soient pillés, les yeux de ses fils seront consumés.
...
\VS{8}Les hommes droits en seront étonnés, et l'innocent s'élèvera contre l'impie;
\VS{9}Mais le juste tiendra ferme dans sa voie, et celui qui a les mains pures croîtra en force. 
...
\VS{15}Où est donc mon espérance? Et mon espérance, qui pourrait la voir? \VS{16}Elle descendra aux portes du Sépulcre, quand nous irons ensemble reposer dans la poussière! 
\Chap{18}
...
\VS{8}Car il sera enlacé par ses pieds dans les filets, et il marchera sur le piège.
...
\VS{15}Qui est le Tout-puissant que nous le servions ? et quel bien nous reviendra-t-il de l'avoir invoqué ? \FTNT{Ex. 5:2.}
...
\VS{30}Qu'au jour de la calamité, le méchant est épargné, et qu'au jour des colères, il est éloigné?\FTNT{Pr. 16:4 ; Ec. 9:12.}.
