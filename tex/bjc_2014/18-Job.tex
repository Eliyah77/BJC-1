...
\VS{3}Te paraît-il bien de maltraiter, de repousser l'ouvrage de tes mains, et de faire briller ta faveur sur le conseil des méchants\FTNT{} ?
...
\VS{8}Tes mains m'ont formé, elles m'ont fait tout entier... Et tu me détruirais\FTNT{} !
...
\VS{16}Si j'ose redresser la tête, tu me poursuis comme un lion, tu me frappes encore par des prodiges\FTNT{}.
...
\VS{11}Car il connaît les hommes vicieux, il discerne par le regard les coupables\FTNT{}.
\VS{12}L'homme, au contraire, a l'intelligence d'un fou, il est né comme le petit d'un âne sauvage\FTNT{}.
...
\VS{17}Tes jours se lèveront comme le soleil à son midi, tes ténèbres seront comme la lumière du matin\FTNT{}.
\VS{18}Tu seras plein de confiance, et ton attente ne sera plus vaine; tu regarderas autour de toi, et tu te coucheras en sécurité\FTNT{}.
...
\VS{6}Il y a la paix sous la tente des pillards, sécurité pour ceux qui offensent Dieu, pour quiconque se fait un faux dieu de sa main\FTNT{}.
...
\VS{13}En Dieu résident la sagesse et la puissance. C'est à lui qu'appartiennent le conseil et l'intelligence\FTNT{}.
\VS{14}Voici, il démolit, et on ne rebâtit pas, celui qu'il enferme ne sera pas délivré\FTNT{}.
...
\VS{17}Il fait marcher pieds nus les conseillers ; il frappe de folie les juges\FTNT{}.
...
\VS{21}Il verse le mépris sur les nobles ; il relâche la ceinture des forts\FTNT{}.
\VS{22}Il met à découvert les profondeurs cachées dans les ténèbres, il amène à la lumière l'ombre de la mort\FTNT{}.
...
\VS{5}Puissiez-vous garder le silence, et que ce soit là votre sagesse\FTNT{}.
...
\VS{14}Pourquoi prendrais-je ma chair entre les dents ? J'exposerai plutôt ma vie\FTNT{}.
\VS{15}Voici, il me tuera ; je n'ai rien à espérer ; mais devant lui, je défendrai ma conduite.
\VS{16}Cela même peut servir à mon salut, car un impie ne viendrait pas devant lui\FTNT{}.
...
\VS{25}Veux-tu effrayer une feuille agitée ? Veux-tu poursuivre une paille desséchée\FTNT{} ?
...
\Chap{14}
\VerseOne{}L'homme né de la femme ! Sa vie est courte, sans cesse rassasiée de troubles\FTNT{}.
...
\VS{4}Comment d'un être souillé sortira-t-il un homme pur ? Il n'en peut sortir personne\FTNT{}.
...
\VS{16}Mais aujourd'hui tu comptes mes pas, tu observes mes péchés\FTNT{} ;
\VS{17}mes transgressions sont scellées dans un sac, et tu imagines des iniquités à ma charge\FTNT{}.
...
\VS{7}Es-tu le premier-né des hommes ? As-tu été enfanté avant les collines\FTNT{} ?
\VS{8}As-tu entendu le conseil de Dieu ? As-tu pris la sagesse à ton profit\FTNT{} ?
...
\VS{14}Qu'est-ce que l'homme, pour qu'il soit pur ? Celui qui est né de la femme peut-il être juste\FTNT{} ?
...
\VS{20}Le méchant passe dans l'angoisse tous les jours de sa vie, toutes les années qui sont le partage de l'impie\FTNT{}.
\VS{21}La voix de la terreur retentit à ses oreilles ; au sein de la paix, le dévastateur vient sur lui\FTNT{} ;
\VS{22}il ne croit pas échapper aux ténèbres, il se voit épié par l'épée qui le menace ;
\VS{23}il court çà et là pour chercher son pain, il sait que le jour des ténèbres l'attend\FTNT{}.
...
\VS{35}Il conçoit le mal, et il enfante le mal, il s'établit dans son sein des fruits qui le trompent\FTNT{}.
\Chap{16}
\TextTitle{Réponse de Job}
\VerseOne{}Job prit la parole et dit :
