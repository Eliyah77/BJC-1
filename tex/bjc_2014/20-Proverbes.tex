...
\VS{24}Ne sois pas l'ami de l'homme coléreux, et ne va pas avec l'homme furieux ;
\VS{25}de peur que tu n'apprennes leurs voies, et qu'ils n'emmènent captive ton âme.
\VS{26}Ne sois point de ceux qui frappent dans la main ni de ceux qui cautionnent pour des dettes.
...
\VS{2}Certainement je suis le plus abruti de tous les hommes, et il n'y a pas en moi l'intelligence humaine.
...
\VS{19}La trace de l'aigle dans le ciel, la trace du serpent sur un rocher, le chemin d'un navire au milieu de la mer, et la trace de l'homme chez la jeune fille.
