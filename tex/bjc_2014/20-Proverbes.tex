...
\VS{28}Alors ils crieront vers moi, mais je ne répondrai point ; ils me chercheront de grand matin, mais ils ne me trouveront pas.
...
\VS{27}Ne refuse pas le bien à celui à qui il est dû, quand il est au pouvoir de ta main de le faire.
...
\VS{21}Vu que les voies de l’homme sont devant les yeux de Yahweh, et qu’il pèse toutes ses voies.
...
\VS{17}savoir, les yeux hautains, la langue mensongère, les mains qui répandent le sang innocent,
...
\VS{25}Ne la convoite pas dans ton coeur pour sa beauté, et ne te laisse pas prendre par ses yeux.
...
\VS{11}Car la sagesse vaut mieux que les perles, et tout ce qu’on pourrait souhaiter ne la vaut pas.
...
\VS{7}La mémoire du juste est en bénédiction, mais la réputation des méchants tombe en pourriture.
...
\VS{18}Le méchant fait une oeuvre qui le trompe, mais la récompense est assurée à celui qui sème la justice.
...
\VS{4}La femme vertueuse est la couronne de son mari, mais celle qui fait honte est comme la pourriture dans ses os.
...
\VS{22}Les lèvres fausses sont une abomination à Yahweh, mais ceux qui agissent fidèlement lui sont agréables.
