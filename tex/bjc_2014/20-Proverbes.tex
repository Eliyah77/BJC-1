...
\VS{8}Celui qui médite de faire le mal, on l'appelle homme malicieux.
\VS{9}Le discours de la folie n'est que péché, et le moqueur est en abomination à l'homme.
\VS{10}Si tu perds courage au jour de la détresse, ta force diminue.
...
\VS{2}La gloire de Dieu est de dissimuler les choses, et la gloire des rois est de sonder les choses.
...
\VS{16}Quand tu auras trouvé du miel, manges-en juste ce qu'il t'en faut, de peur qu'en étant rassasié, tu ne le rendes.
...
\VS{12}Il est une race de gens qui croit être pure, et qui toutefois n'est pas lavée de son ordure.
