...
\VS{6}Afin que tu ne considères pas le chemin de la vie ; ses chemins en sont écartés, tu ne le connaîtra pas.
...
\VS{13}Celui qui va rapportant, révèle les secrets, mais celui qui a l'esprit qui supporte les parloes, les couvre.
...
\VS{17}L'homme doux fait du bien à son àme, mais le cruel trouble sa chair.
...
\VS{7}Quand Yahweh prend plaisir aux voies d'un homme, il apaise\FTNT{Apaiser vient de shalom qui signgifie : être dans une alliance de paix, être en paix, apaiser, vivre dans la paix etc.} envers lui même ses ennemis.
...
\VS{16}Combien vaut-il mieux acquérir la sagesse que l’or fin ? Combien est-il plus excellent d'acquérir la prudence que l'argent ?
...
\VS{21}On appelle intelligent le sage de cœur, et la douceur des lèvres augmente l'instruction.
...
\VS{26}Celui qui travaille se donne la peine pour lui-même, parce que sa bouche l’y contraint\FTNT{Ec. 6:7.}.
...
\VS{20}Le scheol et le gouffre ne sont jamais rassasiés ; de même, les yeux des hommes sont insatiables\FTNT{}.
...
\Chap{31}
\TextTitle{[Paroles de Lemuel : l'intempérance]}
