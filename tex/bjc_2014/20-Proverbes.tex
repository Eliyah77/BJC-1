...
\VS{11}S'ils disent~: Viens avec nous, dressons des embûches pour tuer~; épions secrètement l'innocent, quoiqu'il ne nous en ai point donné de sujet.
...
\VS{11}Car tes jours se multiplieront par moi, et des années vie te seront ajoutées.
...
\VS{13}Le paresseux dit~: Le lion est dehors~! Je serais tué dans les rues~!
...
\VS{26}La malice de celui qui la cache comme dans un lieu secret, sera révélé dans l'assemblée.
