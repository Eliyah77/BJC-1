...
\VS{9}Car elles sont une couronne de grâce sur ta tête, et des colliers autour de ton cou.
\VS{10}Mon fils, si les pécheurs veulent te séduire, n'accepte pas.
\VS{11}S'ils disent : Viens avec nous, dressons des embûches pour verser le sang ; tendons secrètement des pièges à l'innocent sans aucune raison.
...
\VS{15}Mon fils, ne te mets point en chemin avec eux ; retiens ton pied de leur sentier ;
...
\VS{25}et parce que vous rejetez tout mon conseil, et que vous n'acceptez pas mes réprimandes ;
...
\VS{28}alors ils crieront vers moi, mais je ne répondrai point ; ils me chercheront de grand matin, mais ils ne me trouveront pas\FTNT{De. 31:18 ; Job. 35:12.}.
...
\VS{14}qui se réjouissent à faire le mal, et qui mettent leur plaisir dans la perversion des méchants.
...
\VS{2}Car ils prolongeront les jours et les années de ta vie, et ils augmenteront ta paix\FTNT{La paix, de l'hébreu « shalowm », est un état complet de perfection, de bien-être et de paix. Le mot Shalom signifie « paix » en français. Mais il est employé dans le langage courant surtout pour se dire « bonjour » ou « salut ». C'est un mot qu'on apprend aux enfants dès qu'ils commencent à parler, c'est aussi un rêve pour les Hébreux. On l'emploie dès le vendredi soir pour se souhaiter un « Shabbat Shalom », un samedi de paix et de repos.}.
\VS{3}Que la bonté et la vérité ne t'abandonnent point : Lie-les à ton cou, et écris-les sur la table de ton coeur ;
...
\VS{18}Elle est l'arbre de vie pour ceux qui l'embrassent ; et tous ceux qui la possèdent sont heureux\FTNT{Ge. 2:9 ; Ap. 22:2.}.
\VS{19}C'est par la sagesse que Yahweh a fondé la terre, c'est avec intelligence qu'il a établi les cieux.
...
\VS{27}Ne refuse pas le bien à celui à qui il est dû, quand il est au pouvoir de ta main de le faire\FTNT{Ga. 6:10.}.
...
\VS{16}Car ils ne dormiraient pas, s'ils n'avaient fait quelque mal, et le sommeil leur serait ravi, s'ils n'avaient causé un préjudice à quelqu'un.
...
\VS{23}Garde ton coeur de tout ce dont il faut se garder ; car de lui viennent les sources de la vie\FTNT{Mt 12:35 ; Mt. 15:18-19.}.
...
\VS{6}Afin que tu ne considères pas le chemin de la vie ; ses chemins en sont écartés, tu ne le connaîtras pas.
...
\VS{22}Les lèvres fausses sont une abomination à Yahweh\FTNT{Ap. 22:15.}, mais ceux qui agissent fidèlement lui sont agréables.
\VS{23}L'homme prudent cache sa connaissance, mais le coeur des insensés proclame la folie.
\VS{24}La main des diligents dominera, mais la main nonchalante sera tributaire.
...
\VS{27}L'homme nonchalant ne rôtit pas son gibier, mais le précieux trésor d'un homme c'est la diligence.
...
\VS{2}Par le fruit de sa bouche l'homme jouit du bien, mais l'âme des perfides, la violence.
\VS{3}Celui qui veille sur sa bouche garde son âme, mais celui qui ouvre à tout propos ses lèvres court à sa perte\FTNT{Ps. 39:2.}.
\VS{4}L'âme du paresseux a des désirs qu'il ne peut satisfaire, mais l'âme des diligents sera engraissée.
\VS{5}Le juste hait la parole mensongère, mais le méchant se corrompt et tombe dans la confusion.
...
\VS{15}Le bon sens donne de la grâce ; mais la voie de ceux qui agissent perfidement est dur.
\VS{16}Tout homme bien avisé agira avec connaissance, mais l'insensé fera l'étalage de sa folie.
...
\VS{17}Celui qui est prompt à la colère fait des sottises\FTNT{Ps. 37:8.}, et l'homme plein de malice s'attire la haine.
\VS{18}Les stupides héritent la folie, mais les prudents sont couronnés de connaissance.
...
\VS{31}Celui qui opprime le pauvre outrage celui qui l'a fait, mais celui qui a pitié de l'indigent honore Yahweh\FTNT{De. 24:11 ; Ps. 107:41.}.
...
\VS{16}Mieux vaut peu avec la crainte de Yahweh, qu'un grand trésor où il y a du trouble\FTNT{Ps. 37:16.}.
...
\VS{3}Recommande tes affaires à Yahweh, et tes projets seront stables.
...
\VS{8}Il vaut mieux un peu de bien avec justice, que de grands revenus avec l'injustice.
\VS{9}Le cœur de l'homme médite sur sa conduite, mais c'est Yahweh qui conduit ses pas.
\VS{10}Des oracles sont sur les lèvres du roi : Sa bouche ne doit pas s'égarer du droit.
...
\VS{17}Le chemin des hommes droits c'est de se détourner du mal ; celui qui garde son âme veille sur sa voie.
\VS{18}L'orgueil précède la ruine, et la fierté d'esprit précède la chute.
...
\VS{21}On appellera intelligent le sage de cœur, et la douceur des lèvres augmente l'instruction.
\VS{22}La prudence est à ceux qui la possèdent une source de vie ; mais le châtiment des insensés c'est leur folie.
...
\VS{25} II y a telle voie qui semble droite à l'homme, mais dont la fin est la voie de la mort.
\VS{26}Celui qui travaille, travaille pour lui-même, parce que sa bouche se courbe devant lui\FTNT{Ec. 6:7.}.
\VS{27}L'homme de Bélial creuse le mal, et il y a comme un feu brûlant sur ses lèvres.
\VS{28}L'homme pervers sème des querelles, et le rapporteur divise les grands amis.
\VS{29}L'homme violent trompe son compagnon et le fait marcher dans une voie qui n'est pas bonne.
\VS{30}Celui qui ferme les yeux pour méditer des choses perverses en remuant ses lèvres a déjà consommé le mal.
\VS{31}Les cheveux blancs sont une couronne d'honneur ; elle se trouvera dans la voie de la justice.
\VS{32}Celui qui est lent à la colère vaut mieux qu'un homme fort, et celui qui est maître de son esprit, que celui qui prend des villes.
...
\VS{3}Le creuset est pour éprouver l'argent, et le fourneau pour l'or ; mais Yahweh éprouve les coeurs\FTNT{Jé. 17:10 ; Mal. 3:3 ; Ps. 26:2.}.
...
\VS{15}Celui qui absout le coupable et celui qui condamne le juste sont tous deux en abomination à Yahweh\FTNT{Ex. 23:7 ; Es. 5:23.}.
...
\VS{4}Les paroles de la bouche d'un homme sage sont comme des eaux profondes ; la source de la sagesse est un torrent qui jaillit\FTNT{Jn. 4:14.}.
...
\VS{11}Les biens du riche sont sa ville forte et comme une haute muraille, selon son imagination.
...
\VS{21}Il y a dans le cœur de l'homme beaucoup de projets, mais c'est le dessein de Yahweh qui s'accomplit\FTNT{Es. 46:10 ; Ps. 33:11.}.
