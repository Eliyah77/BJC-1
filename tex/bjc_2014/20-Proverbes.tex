...
\VS{6}Travailler à avoir des trésors acquis par une langue mensongère, c'est une vanité qu'on ne peut retenir par ceux qui cherchent la mort.
...
\VS{23}Celui qui garde bouche et sa langue garde son âme de la détresse.
...
\VS{21}pour te faire connaître la certitude des paroles de vérité, afin que tu répondes par des paroles véritables à ceux qui envoient vers toi ?
...
\VS{6}Ne mange pas le pain de celui a l’œil malin, et ne désire pas ses mets,
...
\VS{9}Ne parle pas aux oreilles du fou, car il méprise la sagesse de ton discours.
...
\VS{20}Le feu s'éteint faute de bois, ainsi quand il n'y a plus de rapporteurs les querell e s'apaisent.
...
\VS{15}Une gouttière continuelle au temps de le grosse pluie, et une femme querelleuse sont semblables.
...
\VS{9}Un homme sage qui conteste avec un insensé, qu'il se fâche ou qu'il rie, la paix n'aura pas de repos.
...
\VS{19}savoir la trace de l'aigle dans le ciel, la trace du serpent sur un rocher, le chemin d'un navire au milieu de la mer, et la trace de l'homme chez vierge.
