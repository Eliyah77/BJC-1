...
\VS{21}Qu'ils ne s'écartent pas de tes yeux ; garde-les dans le fond de ton coeur.
...
\VS{3}Lie-les à tes doigts, écris-les sur la table de ton coeur.
\VS{4}Dis à la sagesse : Tu es ma soeur ; et appelle l'intelligence, ta parente.
...
\VS{10}Celui qui fait signe de l'oeil cause du chagrin, et celui qui a les lèvres insensées sera renversé.
...
\VS{20}La langue du juste est un argent choisi, mais le coeur des méchants est bien peu de chose.
...
\VS{2}Chaque voie de l'homme lui semble droite ; mais Yahweh pèse les coeurs.
...
\VS{6}Instruis le jeune enfant à l'entrée de sa voie qu'il doit suivre, et quand il sera vieux, il ne s'en détournera pas.
...
\VS{9}Celui qui a l'oeil bienveillant sera béni, parce qu'il donne de son pain au pauvre.
