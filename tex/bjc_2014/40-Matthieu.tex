...
\VS{5}Salmon engendra Boaz, de Rahab\FTNT{Rahab était une prostituée cananéenne qui est devenue l'ancêtre du Messie (\vref{Jos. 6}).}~; Boaz engendra Obed, de Ruth\FTNT{Ruth était une Moabite, son peuple était issu de la relation incestueuse de Lot et sa fille aînée (\vref{Ge. 19:36-37}). Elle est devenue l'ancêtre du Messie (\vref{Ru. 4:17}).}~; Obed engendra Isaï~;
...
\VS{16}Jacob engendra Joseph, l'époux de Marie, de laquelle est né Jésus, qui est appelé Christ\FTNT{Christ~: Du grec «~christos~», ce qui signifie «~oint~», est l'équivalent grec du mot hébreu «~mashiyach~», traduit par «~messie~» en français (\vref{Da. 9:25-26}). C'est le titre officiel du Seigneur Jésus.}.
...
\TextTitle{Naissance miraculeuse de Jésus-Christ\FTNTT{\vref{Lu. 1:26-38}~; \vref{2:1-7}~; \vref{Jn. 1:1-2,14}.}}
...
\VS{23}Voici, la vierge deviendra enceinte, elle enfantera un fils~; et on lui donnera le Nom d'Emmanuel\FTNT{\vref{Es. 7:14}.}, ce qui signifie, Dieu est avec nous.
...
\VS{6}Et toi, Bethléhem, terre de Juda, tu n'es nullement la plus petite parmi les gouverneurs de Juda, car de toi sortira le Chef qui paîtra mon peuple d'Israël\FTNT{\vref{Mi. 5:1}.}.
...
\VS{9}Après avoir entendu le roi, ils partirent. Et voici, l'étoile\FTNT{Le Seigneur Jésus-Christ s'est révélé à Jean comme l'étoile brillante du matin (\vref{Ap. 22:16}).} qu'ils avaient vue en orient allait devant eux, jusqu'au moment où, arrivée au-dessus du lieu où était le petit enfant, elle s'arrêta.
...
\VS{15}Il y resta là jusqu'à la mort d'Hérode afin que s'accomplisse ce que le Seigneur avait annoncé par le prophète~: J'ai appelé mon Fils hors d'Egypte\FTNT{\vref{Os. 11:1}.}.
\TextTitle{Hérode envoie tuer des enfants}
...
\VS{18}On a entendu à Rama des cris, des lamentations, des plaintes, et des grands gémissements~: Rachel pleure ses enfants et n'a pas voulu être consolée, parce qu'ils ne sont plus\FTNT{\vref{Jé. 31:15}.}.
\TextTitle{Joseph revient en Israël et s'installe à Nazareth\FTNTT{\vref{Lu. 2:39-52}.}}
...
\Chap{3}
\TextTitle{Le ministère de Jean-Baptiste\FTNTT{\vref{Mc. 1:1-8}~; \vref{Lu. 3:1-20}~; \vref{Jn. 1:6-8,15-37}.}}
...
\VS{11}Pour moi, je vous baptise d'eau en signe de repentance~; mais celui qui vient après moi est plus puissant que moi, et je ne suis pas digne de porter ses souliers. Celui-là vous baptisera du Saint-Esprit et de feu\FTNT{Le baptême du Saint-Esprit ne doit pas être confondu avec la plénitude du Saint-Esprit. Le baptême est un acte définitif qui nous greffe au corps du Christ lors de la conversion (\vref{1 Co. 12:13}). La plénitude consiste quant à elle en un constant renouvellement que nous devons impérativement rechercher (\vref{Ep. 5:18}). Certains courants chrétiens charismatiques enseignent que le parler en langues est le signe distinctif du baptême du Saint-Esprit. Cette doctrine est basée sur au moins trois passages~: \vref{Ac. 2:4}~; \vref{Ac. 10:44-46} et \vref{Ac. 19:1-7}. Si cela était vraiment le cas, plusieurs chrétiens seraient encore dans leurs péchés et n'appartiendraient pas au Seigneur Jésus-Christ. En effet, \vref{Ro. 8:9} déclare ceci~: «~Si quelqu'un n'a pas l'Esprit de Christ, il ne lui appartient pas~». Or il est manifeste que bon nombre de chrétiens nés d'en haut ne parlent pas en langues, ce qui est d'ailleurs attesté par Paul (\vref{1 Co. 12:30}). Il n'y a aucun verset dans les Ecritures qui nous ordonne de chercher le baptême du Saint-Esprit pour la bonne et simple raison que nous le recevons à la conversion.}.
...
\TextTitle{Jean baptise Jésus-Christ\FTNTT{\vref{Mc. 1:9-11}~; \vref{Lu. 3:21-22}~; \vref{Jn. 1:31-34}.}}
...
\Chap{4}
\TextTitle{La tentation de Jésus-Christ\FTNTT{\vref{Ge. 3:6}~; \vref{Mc. 1:12-13}~; \vref{Lu. 4:1-13}~; \vref{1 Jn. 2:16}.}}
...
\VS{4}Mais Jésus répondit, et dit~: Il est écrit~: L'homme ne vivra point de pain seulement, mais de toute parole qui sort de la bouche de Dieu\FTNT{\vref{De. 8:3}.}.
\VS{5}Alors le diable le transporta dans la sainte ville, et le mit sur le haut du temple
\VS{6}et il lui dit~: Si tu es le Fils de Dieu, jette-toi en bas~; car il est écrit~: Il ordonnera à ses anges de te porter sur leurs mains de peur que ton pied ne heurte contre une pierre\FTNT{\vref{Ps. 91:12-13}.}.
\VS{7}Jésus lui dit~: Il est aussi écrit~: Tu ne tenteras point le Seigneur, ton Dieu\FTNT{\vref{De. 6:16}.}.
...
\VS{10}Mais Jésus lui dit~: Retire-toi, Satan~! Car il est écrit~: Tu adoreras le Seigneur, ton Dieu, et tu le serviras lui seul\FTNT{\vref{De. 6:13}~; \vref{De. 10:20}.}.
\VS{11}Alors le diable le laissa. Et voici, des anges s'approchèrent et le servirent.
\TextTitle{Etablissement de Jésus à Capernaüm\FTNTT{\vref{Mc. 1:14-15}~; \vref{Lu. 4:14-15}.}}
...
\VS{16}ce peuple, assis dans les ténèbres, a vu une grande lumière~; et pour ceux qui étaient assis dans la région et dans l'ombre de la mort, la lumière elle-même s'est levée\FTNT{\vref{Es. 9:1}.}.
\VS{17}Dès lors, Jésus commença à prêcher, et à dire~: Repentez-vous, car le Royaume des cieux est proche.
\TextTitle{Appel de Pierre, André, Jacques et Jean\FTNTT{\vref{Mc. 1:16-20}~; \vref{Lu. 5:1-11}~; \vref{Jn. 1:35-51}.}}
...
\Chap{5}
\TextTitle{L'enseignement de Jésus sur la montagne\FTNTT{\vref{Lu. 6:20-49}.}}
...
\TextTitle{Le sel de la terre et la lumière du monde\FTNTT{\vref{Mc. 4:21-23}~; \vref{Lu. 8:16-18}~; \vref{11:33-36}.}}
...
\VS{22}Mais moi, je vous dis que quiconque se met en colère sans cause contre son frère sera puni par les juges~; et celui qui dira à son frère~: Raca\FTNT{Raca~: Expression de mépris utilisée parmi les Juifs au temps de Jésus signifiant vide, indigne ou encore vaurien.}~! Sera puni par le conseil~; et celui qui lui dira~: Insensé~! Sera puni par le feu de la géhenne\FTNT{La géhenne ou le lac de feu~: Voir commentaire en \vref{Ap. 20:14}.}.
...
\VS{26}En vérité je te dis, tu ne sortiras point de là, jusqu'à ce que tu aies payé le dernier quart de sou.
\TextTitle{Convoitise, adultère et divorce\FTNTT{\vref{Mt. 19:3-11}~; \vref{Mc. 10:2-12}~; \vref{1 Co. 7:1-16}.}}
...
\TextTitle{Aimer ses ennemis\FTNTT{\vref{Lu. 6:27-36}.}}
...
\VS{12}et remets nous nos dettes\FTNT{Du grec «~opheilema~»~: «~ce qui est légalement dû, une dette~». Les Ecritures considèrent le péché comme une dette. Voir \vref{Mt. 18:21-35}.}, comme nous aussi nous remettons les dettes à nos débiteurs~;
...
\VS{15}Mais si vous ne pardonnez pas aux hommes leurs offenses, votre Père ne vous pardonnera point non plus vos offenses.
...
\Chap{7}
\TextTitle{Le jugement hypocrite\FTNTT{\vref{Lu. 6:37-42}.}}
...
\TextTitle{L'enseignement de la loi et des prophètes \FTNTT{\vref{Lu. 6:31}~; \vref{Ep. 4:32}.}}
...
\TextTitle{Les deux chemins\FTNTT{\vref{Ps. 1}.}}
...
\TextTitle{Les faux prophètes, reconnaissables à leurs fruits\FTNTT{\vref{Lu. 6:43-45}.}}
...
\TextTitle{Fausse confession\FTNTT{\vref{Lu. 6:46}.}}
...
\TextTitle{Parabole des deux bâtisseurs et des deux fondements\FTNTT{\vref{Lu. 6:47-49}.}}
...
\VS{25}La pluie est tombée, les torrents sont venus, les vents ont soufflé contre cette maison. Elle n'est point tombée, parce qu'elle était fondée sur le roc\FTNT{Jésus-Christ le Rocher~: voir \vref{Es. 8:13-17}.}.
...
\Chap{8}
\TextTitle{Guérison d'un lépreux\FTNTT{\vref{Mc. 1:40-45}.}}
...
\TextTitle{Guérison du serviteur d'un centenier\FTNTT{\vref{Lu. 7:1-10}.}}
...
\TextTitle{Guérison de la belle-mère de Pierre\FTNTT{\vref{Mc. 1:29-34}~; \vref{Lu. 4:38-41}.}}
...
\VS{17}afin que s'accomplisse ce qui avait été annoncé par Esaïe, le prophète, en disant~: Il a pris nos faiblesses et a porté nos maladies\FTNT{\vref{Es. 53:4}.}.
\TextTitle{Le prix de la consécration du disciple\FTNTT{\vref{Lu. 9:57-62}.}}
...
\TextTitle{Les vents et la mer obéissent à Jésus\FTNTT{\vref{Mc. 4:35-41}~; \vref{Lu. 8:22-25}.}}
...
\TextTitle{Guérison de deux démoniaques\FTNTT{\vref{Mc. 5:1-20}~; \vref{Lu. 8:26-40}.}}
...
\Chap{9}
\TextTitle{Jésus a le pouvoir de pardonner les péchés\FTNTT{\vref{Mc. 2:3-12}~; \vref{Lu. 5:18-26}.}}
...
\TextTitle{L'appel de Matthieu\FTNTT{\vref{Mc. 2:14}~; \vref{Lu. 5:27-28}.}}
...
\TextTitle{Jésus est venu appeler les pécheurs à la repentance\FTNTT{\vref{Mc. 2:15-20}~; \vref{Lu. 5:29-35}.}}
...
\VS{13}Mais allez, et apprenez ce que veulent dire ces paroles~: Je prends plaisir à la miséricorde, et non aux sacrifices\FTNT{\vref{Os. 6:6}.}. Car je ne suis pas venu appeler à la repentance les justes, mais les pécheurs.
...
\TextTitle{Parabole du drap neuf et des outres neuves\FTNTT{\vref{Mc. 2:21-22}~; \vref{Lu. 5:36-39}.}}
...
\TextTitle{Résurrection de la fille de Jaïrus et guérison de la femme à la perte de sang\FTNTT{\vref{Mc. 5:21-43}~; \vref{Lu. 8:41-56}.}}
...
\TextTitle{Jésus ému de compassion par la foule\FTNTT{\vref{Mc. 6:34}.}}
...
\Chap{10}
\TextTitle{Appel et mission des douze apôtres\FTNTT{\vref{Mc. 6:7-13}~; \vref{Lu. 9:1-6}.}}
...
\VS{5}Tels sont les douze que Jésus envoya. Il leur donna ses ordres, en disant~: N'allez point vers les Gentils et n'entrez point dans aucune ville des Samaritains~;
...
\VS{8}Guérissez les malades, rendez purs les lépreux, ressuscitez les morts, chassez les démons hors des possédés. Vous l'avez reçu gratuitement, donnez-le gratuitement\FTNT{Vous avez reçu gratuitement~: Aucun chrétien, quel que soit son appel ou son don ne peut prétendre qu'il a payé pour avoir les talents qu'il a reçus du Seigneur. Dans \vref{1 Co. 4:7} Paul nous pose une question~: «~Qu'as-tu que tu n'aies reçu et si tu l'as reçu pourquoi te glorifies-tu~?~» Dieu interroge également Job~: «~De qui suis-je le débiteur~?~» (\vref{Job 41:2}). Vendre quelque chose qu'on a reçu gratuitement n'est rien d'autre que du vol. Donnez gratuitement~: C'est la suite logique des choses, on reçoit gratuitement et on donne gratuitement. Si nous aimons Dieu, nous devons garder sa Parole et marcher comme lui a marché (\vref{Jn. 14:15}~; \vref{1 Jn. 2:6}). Il a donné ses enseignements et nourri les gens gratuitement. Dans \vref{Ap. 21:6} et \vref{22:17}, le Seigneur invite toutes les personnes qui ont soif à venir s'abreuver gratuitement. Alors pourquoi vendre la Parole qu'on a reçue gratuitement~? Le Seigneur a envoyé les douze en mission et leur a demandé d'apporter l'Evangile du Royaume, de guérir les malades et de délivrer les possédés gratuitement (\vref{Ac. 8:18-24}~; \vref{Ac. 20:33-35}~; \vref{Ap. 21:6}~; \vref{Ap. 22:17}).}.
...
\TextTitle{Jésus annonce que ses disciples seront persécutés}
...
\Chap{11}
\TextTitle{Jean-Baptiste le plus grand des prophètes\FTNTT{\vref{Lu. 7:19-35}.}}
...
\VS{5}Les aveugles recouvrent la vue, les boiteux marchent, les lépreux sont purifiés, les sourds entendent, les morts sont ressuscités, et l'Evangile est annoncé aux pauvres\FTNT{Jésus-Christ est le Dieu véritable dont la venue a été annoncée par Esaïe (\vref{Es. 35:4-6}).}.
\VS{6}Mais, béni est celui qui n'aura point été scandalisé en moi~!
...
\VS{10}Car c'est celui dont il est écrit~: Voici, j'envoie mon messager\FTNT{\vref{Mal. 3:1}.} devant ta face, pour préparer ton chemin devant toi.
...
\VS{14}Et si vous voulez recevoir mes paroles, c'est lui qui est l'Elie\FTNT{\vref{Mal. 4:5-6}.} qui devait venir.
...
\VS{23}Et toi, Capernaüm, qui as été élevée jusqu'au ciel, tu seras précipitée jusqu'en enfer\FTNT{Voir commentaire en \vref{Mt. 16:18}.}~; car si les miracles qui ont été faits au milieu de toi, avaient été faits dans Sodome, elle subsisterait encore.
...
\Chap{12}
\TextTitle{Jésus, le Maître du sabbat\FTNTT{\vref{Mc. 2:23-28}~; \vref{Lu. 6:1-5}.}}
...
\VS{7}Si vous saviez ce que signifient ces paroles~: Je veux la miséricorde, et non pas le sacrifice, vous n'auriez pas condamné ceux qui ne sont pas coupables\FTNT{\vref{1 S. 15:22}~; \vref{Os. 6:6}.}.
\VS{8}Car le Fils de l'homme est Maître même du sabbat.
\TextTitle{Guérison de l'homme à la main sèche le jour du sabbat\FTNTT{\vref{Mc. 3:1-5}~; \vref{Lu. 6:6-11}.}}
...
\TextTitle{Les pharisiens complotent contre Jésus ; Le Messie annoncé par Esaïe}
...
\VS{21}Et les nations espéreront en son Nom\FTNT{\vref{Es. 42:1-4}.}.
...
\TextTitle{Le blasphème contre le Saint-Esprit\FTNTT{\vref{Mc. 3:22-30}~; \vref{Lu. 11:15-23}.}}
...
\VS{32}Quiconque parlera contre le Fils de l'homme, il lui sera pardonné~; mais quiconque parlera contre le Saint-Esprit, il ne lui sera pardonné ni dans ce siècle, ni dans le siècle à venir\FTNT{Le blasphème est un outrage, une calomnie à l'encontre de Dieu. En attribuant l'œuvre de Dieu à Satan, les pharisiens ont commis l'impardonnable. Beaucoup de personnes craignent d'avoir commis ce péché par inadvertance, en ayant par exemple un doute sur l'origine d'un miracle. La Parole nous recommande de ne pas ajouter foi à tout esprit, mais d'éprouver les esprits pour savoir s'ils sont de Dieu (\vref{1 Jn. 4:1}). On ne pèche donc pas lorsqu'on exerce son discernement. De plus, si l'on a commis une erreur de jugement par ignorance, le Seigneur ne nous en tiendra pas rigueur (\vref{Ac. 17:30}). Le blasphème contre le Saint-Esprit est commis par des personnes qui, bien qu'ayant la connaissance et la capacité de différencier le bien du mal, font preuve de mauvaise foi. Ainsi, les pharisiens avaient constaté les bons fruits portés par Jésus, mais ils ont hypocritement qualifié de mal le bien qu'il faisait (\vref{Es. 5:20}). Ceux qui blasphèment contre le Saint-Esprit sont loin d'être ignorants. Comme nous l'atteste \vref{Hé. 6:4-6}, parmi ces gens, certains «~ont goûté le don céleste~», «~ont eu part au Saint-Esprit, et ont goûté la bonne parole de Dieu, et les puissances du siècle à venir~». En choisissant sciemment de pécher, alors qu'ils ont expérimenté la grâce de Dieu, ils retournent à ce qu'ils ont vomi et outragent ainsi le Seigneur (\vref{2 Pi. 2:18-22}). Leur cœur endurci à l'extrême rejette volontairement la vérité pour s'attacher au mensonge. Constatant leur refus définitif de se repentir, le Saint-Esprit finit par se retirer pour laisser la place à l'esprit d'égarement qui les maintiendra dans l'erreur (\vref{2 Th. 2:9-12}). Enfin, il est à noter qu'en \vref{Ap. 14:9-11}, ceux qui ont reçu la marque de la bête sont condamnés d'office. Il ne faut nullement conclure que le Seigneur leur a refusé son pardon, mais plutôt que les personnes ayant reçu cette marque ont aussi blasphémé contre le Saint-Esprit. Voir commentaire en \vref{Ap. 13:16}.}.
...
\TextTitle{Le miracle du prophète Jonas\FTNTT{\vref{Jon. 2:1}~; \vref{Lu. 11:29-32}.}}
...
\TextTitle{La condamnation de cette génération par la reine du Midi\FTNTT{\vref{2 Ch. 9:1-12}.}}
...
\TextTitle{Le retour de l'esprit impur\FTNTT{\vref{Lu. 11:24-26}.}}
...
\TextTitle{La famille spirituelle\FTNTT{\vref{Mc. 3:31-35}~; \vref{Lu. 8:19-21}.}}
...
\Chap{13}
\TextTitle{Parabole des quatre terrains\FTNTT{\vref{Mc. 4:1-20}~; \vref{Lu. 8:4-15}.}}
...
\VS{15}Car le cœur de ce peuple est engraissé, et ils ont endurci leurs oreilles, et ils ont fermé leurs yeux de peur qu'ils ne voient de leurs yeux, qu'ils n'entendent de leurs oreilles, qu'ils ne comprennent de leur cœur, qu'ils ne se convertissent et que je ne les guérisse\FTNT{\vref{Es. 6:9-10}.}.
...
\TextTitle{Parabole du grain de sénevé\FTNTT{\vref{Mc. 4:30-32}~; \vref{Lu. 13:18-19}.}}
...
\TextTitle{Parabole du levain\FTNTT{\vref{Lu. 13:20-21}.}}
...
\VS{35}afin que s'accomplisse ce qui avait été annoncé par le prophète~: J'ouvrirai ma bouche en paraboles, je déclarerai les choses qui ont été cachées dès la fondation du monde\FTNT{\vref{Ps. 78:2}.}.
...
\TextTitle{Jésus à Nazareth\FTNTT{\vref{Mc. 6:1-6}.}}
...
\Chap{14}
\TextTitle{Mort de Jean-Baptiste\FTNTT{\vref{Mc. 6:14-29}~; \vref{Lu. 9:7-9}.}}
...
\TextTitle{Multiplication des pains pour les cinq mille hommes\FTNTT{\vref{Mc. 6:32-44}~; \vref{Lu. 9:12-17}~; \vref{Jn. 6:1-14}.}}
...
\TextTitle{Jésus marche sur les eaux ; les disciples adorent Jésus\FTNTT{\vref{Mc. 6:45-56}~; \vref{Jn. 6:15-21}.}}
...
\TextTitle{Jésus guérit des malades à Génésareth\FTNTT{\vref{Mc. 6:53-56}.}}
...
\Chap{15}
\TextTitle{Jésus-Christ condamne les traditions\FTNTT{\vref{Mc. 7:1-13}.}}
...
\VS{9}Mais ils m'honorent en vain, en enseignant des doctrines qui ne sont que des commandements d'hommes\FTNT{\vref{Es. 29:13}.}.
\TextTitle{Le cœur de l'homme\FTNTT{\vref{Mc. 7:14-23}.}}
...
\TextTitle{Jésus, adoré par la femme cananéenne\FTNTT{\vref{Mc. 7:24-30}.}}
...
\TextTitle{Seconde multiplication des pains\FTNTT{\vref{Mc. 8:1-9}.}}
...
\Chap{16}
\TextTitle{Les pharisiens et les sadducéens: Une génération méchante et adultère \FTNTT{\vref{Mc. 8:10-14}.}}
...
\TextTitle{Le levain des pharisiens et des sadducéens, une doctrine corrompue\FTNTT{\vref{Mc. 8:15-21}~; \vref{Lu. 12:1-15}.}}
...
\TextTitle{Pierre reconnaît Jésus comme étant le Messie\FTNTT{\vref{Mc. 8:27-30}~; \vref{Lu. 9:18-21}.}}
...
\TextTitle{Le renoncement à soi-même\FTNTT{\vref{Mc. 8:34-38}~; \vref{Lu. 9:23-26}.}}
...
\VS{28}Je vous le dis en vérité, quelques-uns de ceux qui sont ici présents, ne mourront point, qu'ils n'aient vu le Fils de l'homme venir dans son règne\FTNT{Ce passage doit être lu de concert avec \vref{Mt. 24:32-34}. Jésus utilise un langage prophétique pour expliquer deux réalités. La première réalité est spirituelle et concerne ses contemporains qui allaient vivre l'effusion de l'Esprit pour rétablir le Royaume de Dieu dans le cœur des gens. En effet, le Seigneur ne les a pas laissés orphelins, mais il est revenu sous la forme de l'Esprit (\vref{Jn. 14:17-18}~; \vref{Ac. 2}~; \vref{Ac. 16:7}). Aussi, les apôtres ont pu proclamer ce Royaume partout où ils allaient (\vref{Ac. 20:25}). La deuxième réalité est matérielle et concerne le fleurissement du figuier, c'est-à-dire Israël. L'histoire atteste le fleurissement de ce figuier tant sur le plan géographique que sur le plan numérique. Depuis le 14 mai 1948, date de la naissance officielle de l'Etat Hébreu, Israël ne cesse de s'étendre. Cette nation est l'horloge des temps car le Messie gouvernera le monde entier depuis Jérusalem (\vref{Mi. 4}~; \vref{Za. 14}).}.
\Chap{17}
\TextTitle{Transfiguration de Jésus-Christ\FTNTT{\vref{Mc. 9:1-8}~; \vref{Lu. 9:27-36}.}}
...
\TextTitle{L'incrédulité des disciples\FTNTT{\vref{Mc. 9:14-29}~; \vref{Lu. 9:37-43}.}}
...
\TextTitle{Jésus annonce à nouveau sa mort et sa résurrection\FTNTT{\vref{Mc. 9:30-32}~; \vref{Lu. 9:44-45}.}}
...
\TextTitle{Un statère dans la bouche d'un poisson\FTNTT{\vref{Mc. 12:13-17}.}}
...
\Chap{18}
\TextTitle{L'humilité, le secret de la vraie grandeur\FTNTT{\vref{Mc. 9:33-37}~; \vref{Lu. 9:46-48}.}}
...
\TextTitle{Parabole de la brebis égarée\FTNTT{\vref{Lu. 15:3-7}.}}
...
\VS{16}Mais s'il ne t'écoute pas, prends encore avec toi une ou deux personnes, afin que par la bouche de deux ou trois témoins toute parole soit ferme\FTNT{\vref{De. 19:15}.}.
\VS{17}S'il refuse de les écouter, dis-le à l'Eglise~; et s'il refuse aussi d'écouter l'Eglise, qu'il soit pour toi comme un Gentil et comme un publicain.
\VS{18}En vérité je vous dis que tout ce que vous lierez sur la terre, sera lié dans le ciel~; et tout ce que vous délierez sur la terre sera délié dans le ciel\FTNT{Voir commentaire en \vref{Mt. 16:19}.}.
...
\Chap{19}
\TextTitle{Enseignement de Jésus sur le mariage et le divorce\FTNTT{\vref{Mt. 5:31-32}~; \vref{Mc. 10:2-12}~; \vref{Lu. 16:18}~; \vref{Ro. 7:1-3}~; \vref{1 Co. 7:10-16}.}}
...
\VS{6}Ainsi ils ne sont plus deux, mais une seule chair\FTNT{\vref{Ge. 2:24}.}. Que l'homme donc ne sépare pas ce que Dieu a mis ensemble sous un joug\FTNT{La majorité des traducteurs traduisent ce verset par «~Que l'homme donc ne sépare pas ce que Dieu a joint~». Or le terme grecque «~suzeugnumi~» qu'ils ont traduit par «~joint~» signifie plutôt «~attacher un joug à quelqu'un, mettre ensemble sous un joug~». Un joug est une pièce de bois servant à atteler une paire d'animaux. De ce fait, les animaux sont contraints d'avancer dans la même direction, côte à côte (\vref{Ge. 2:22}). En \vref{De. 22:10}, Dieu interdit d'atteler un âne avec un bœuf ensemble. L'adverbe «~ensemble~» vient de l'hébreu «~Yachad~» et signifie «~union d'une façon unitaire~». Ce verset fait référence symboliquement aux paroles de Paul en \vref{2 Co. 6:14-16} qui nous mettent en garde contre le mariage avec des infidèles. Le mariage est donc semblable à un joug qui nous contraint à marcher à l'unisson dans la même direction. Ainsi, si on se lie à un inconverti, ce dernier risque de nous entraîner sur la voie de la perdition. En \vref{Mt. 11:29}, Christ nous invite à nous mettre sous son joug, qui est doux et léger. Quelle belle demande en mariage~!}.
\VS{7}Ils lui dirent~: Pourquoi donc, Moïse a-t-il commandé de donner la lettre de divorce, et de répudier sa femme\FTNT{\vref{De. 24:1}.}~?
...
\TextTitle{Le Royaume des cieux pour ceux qui ressemblent aux petits enfants\FTNTT{\vref{Mc. 10:13-16}~; \vref{Lu. 18:15-17}.}}
...
\TextTitle{Le jeune homme riche\FTNTT{\vref{Mc. 10:17-31}~; \vref{Lu. 10:25-37}~; \vref{Lu. 18:18-27}.}}
...
\VS{19}Honore ton père et ta mère~; et tu aimeras ton prochain comme toi-même\FTNT{\vref{Ex. 20:12-16}~; \vref{Lé. 19:18}.}.
...
\TextTitle{Récompenses actuelles et dans le Royaume à venir\FTNTT{\vref{Mc. 10:28-31}~; \vref{Lu. 18:28-30}.}}
...
\TextTitle{Jésus annonce à nouveau sa mort et sa résurrection\FTNTT{\vref{Mt. 12:38-42}~; \vref{16:21-28}~; \vref{17:22-23}~; \vref{Mc. 10:32-34}~; \vref{Lu. 18:31-34}.}}
...
\TextTitle{Réponse de Jésus à la requête de la mère de Jacques et Jean\FTNTT{\vref{Mc. 10:35-45}.}}
...
\TextTitle{Jésus guérit deux aveugles\FTNTT{\vref{Mc. 10:46-53}~; \vref{Lu. 18:35-43}.}}
...
\Chap{21}
\TextTitle{Jésus-Christ se présente publiquement comme Roi\FTNTT{\vref{Za. 9:9}~; \vref{Mc. 11:1-11}~; \vref{Lu. 19:28-40}~; \vref{Jn. 12:12-19}.}}
...
\VS{5}Dites à la fille de Sion~: Voici, ton Roi vient à toi, plein de douceur, et monté sur un âne, sur un ânon, le petit d'une ânesse\FTNT{\vref{Za. 9:9}.}.
...
\TextTitle{Jésus chasse les marchands du temple\FTNTT{\vref{Mc. 11:15-18}~; \vref{Lu. 19:45-46}~; \vref{Jn. 2:13-16}.}}
...
\VS{13}et il leur dit~: Il est écrit~: Ma maison sera appelée une maison de prière, mais vous en avez fait une caverne de voleurs\FTNT{\vref{Es. 56:7}~; \vref{Jé. 7:11}.}.
...
\VS{16}Et ils lui dirent~: Entends-tu ce qu'ils disent~? Oui, leur répondit Jésus. N'avez-vous jamais lu ces paroles~: Tu as tiré des louanges de la bouche des enfants, et de ceux qui sont à la mamelle\FTNT{\vref{Ps. 8:3}.}~?
\VS{17}Et, les ayant laissés, il sortit de la ville, pour aller à Béthanie, où il passa la nuit.
\TextTitle{Le figuier stérile\FTNTT{\vref{Mc. 11:12-14}~; \vref{20-26}.}}
...
\TextTitle{L'incrédulité des principaux prêtres et des anciens\FTNTT{\vref{Mc. 11:27-33}~; \vref{Lu. 20:1-8}.}}
...
\TextTitle{Parabole des vignerons\FTNTT{\vref{Es. 5:1-7}~; \vref{Mc. 12:1-12}~; \vref{Lu. 20:9-18}.}}
...
\VS{42}Et Jésus leur dit~: N'avez-vous jamais lu dans les Ecritures~: La pierre qu'ont rejetée ceux qui bâtissaient, est devenue la principale de l'angle. C'est du Seigneur que cela est venu, et c'est un prodige à nos yeux\FTNT{\vref{Es. 8:13-17}~; \vref{Es. 28:16}.}~?
...
\Chap{22}
\TextTitle{Parabole des noces\FTNTT{\vref{Lu. 14:16-24}.}}
...
\VS{11}Et le roi étant entré pour voir ceux qui étaient à table, il aperçut là un homme qui n'avait pas revêtu un habit de noces\FTNT{\vref{Ap. 19:7-8}.}.
...
\TextTitle{Le tribut dû à César\FTNTT{\vref{Mc. 12:13-17}~; \vref{Lu. 20:19-26}.}}
...
\TextTitle{Enseignement de Jésus sur la résurrection\FTNTT{\vref{Mc. 12:18-27}~; \vref{Lu. 20:27-38}.}}
...
\VS{32}Je suis le Dieu d'Abraham, le Dieu d'Isaac et le Dieu de Jacob\FTNT{\vref{Ge. 17:7}~; \vref{Ge. 26:24}~; \vref{Ge. 28:21}.}. Or Dieu n'est pas le Dieu des morts, mais des vivants.
\VS{33}Les foules, ayant entendu cela, admirèrent sa doctrine.
\TextTitle{Le plus grand commandement de la loi\FTNTT{\vref{Mc. 12:28-34}~; \vref{Lu. 10:25-28}.}}
...
\TextTitle{Jésus interroge les pharisiens au sujet du Messie\FTNTT{\vref{Mc. 12:35-37}~; \vref{Lu. 20:39-44}.}}
...
\VS{44}Le Seigneur a dit à mon Seigneur, assieds-toi à ma droite, jusqu'à ce que j'aie mis tes ennemis pour le marchepied de tes pieds\FTNT{\vref{Ps. 110:1}.}.
...
\Chap{23}
\TextTitle{Caractéristiques des scribes et des pharisiens\FTNTT{\vref{Mc. 12:38-40}~; \vref{Lu. 11:39-54}~; \vref{Lu. 20:45-47}.}}
...
\VS{23}Malheur à vous, scribes et pharisiens hypocrites~! Parce que vous payez la dîme\FTNT{Voir commentaire en \vref{Mal. 3:10}.} de la menthe, de l'aneth et du cumin~; et vous laissez les choses les plus importantes de la loi, c'est-à-dire la justice, la miséricorde et la fidélité. Il fallait pratiquer ces choses-là, sans négliger les autres choses.
...
\TextTitle{Lamentations de Jésus sur Jérusalem\FTNTT{\vref{Jé. 22:5}~; \vref{Lu. 13:34-35}~; \vref{19:41-44}.}}
...
\VS{39}Car je vous dis, que désormais vous ne me verrez plus, jusqu'à ce que vous disiez~: Béni soit celui qui vient au Nom du Seigneur\FTNT{\vref{Ps. 118:26}.}~!
\Chap{24}
\TextTitle{Prophétie sur la destruction du temple de Jérusalem\FTNTT{\vref{Mc. 13:1-2}~; \vref{Lu. 21:5-6}.}}
...
\TextTitle{Le signe de l'accomplissement\FTNTT{\vref{Mc. 13:3-4}~; \vref{Lu. 21:7}.}}
...
\TextTitle{Les temps de la fin\FTNTT{\vref{Da. 9:27}~; \vref{Mc. 13:5-13}~; \vref{Lu. 21:8-11}.}}
...
\TextTitle{L'abomination de la désolation\FTNTT{\vref{Da. 9:27}~; \vref{Da. 11:32-35}~; \vref{Mc. 13:14-18}~; \vref{Lu. 21:20-23}.}}
\VS{15}Or quand vous verrez l'abomination qui causera la désolation, qui a été prédite par Daniel, le prophète\FTNT{Daniel fut le premier à prophétiser au sujet de l'abomination de la désolation (\vref{Da. 9:24-27}). Cette prophétie trouva un premier accomplissement lorsqu'en 168 av. J.-C. le roi de Syrie, Antiochus Epiphane (215-163 av. J.-C.), consacra le temple de Jérusalem aux dieux grecs et dédia l'autel des holocaustes à Zeus l'Olympien. En décembre 167 av. J.-C., il sacrifia dessus des porcs, animaux éminemment abominables aux yeux des Juifs, fit interdire la circoncision, la lecture de la Torah et l'observance des fêtes de Yahweh. Par cet acte, ce type d'Antichrist espérait changer les temps (le calendrier Juif) et la Torah (la loi selon \vref{Da. 7:25}) en Israël. En l'an 70 de notre ère, la prophétie de Daniel s'accomplit une seconde fois lorsque le temple fut de nouveau profané en étant détruit par Titus (\vref{39-81} ap. J.-C.). Actuellement, nous vivons la réalisation finale de cette parole qui se manifeste par le progrès de l'apostasie parmi les chrétiens et la diffusion d'un évangile erroné, mondain, expurgé de son caractère christocentrique dans un nombre croissant d'églises. Ainsi, les chrétiens séduits par les fausses doctrines, ayant abandonné leur premier amour (\vref{Ap. 2:5}), sont désormais des temples de Dieu profanés par l'action néfaste des faux prophètes (\vref{1 Co. 6:19}). Cette situation ira en s'empirant et conduira à l'accomplissement parfait de la prophétie de Daniel en la personne de l'homme impie qui s'introduira dans le futur temple de Jérusalem pour usurper l'adoration qui revient à Dieu (\vref{2 Th. 2}~:4).}, être établie dans le lieu saint, que celui qui lit ce prophète y fasse attention~!
...
\VS{20}Priez pour que votre fuite n'arrive pas en hiver, ni un jour de sabbat\FTNT{Sous la loi mosaïque, il était interdit aux Juifs de parcourir plus de 2 000 coudées du lieu où ils se trouvaient pendant le sabbat (\vref{Ex. 16:29}).}.
\TextTitle{La grande tribulation\FTNTT{\vref{Ps. 2:5}~; \vref{Jé. 30:5-8}~; Da.\vref{12:1}~; \vref{Mc. 13:19-23}~; \vref{Lu. 21:23-24}.}}
...
\TextTitle{Retour du Roi sur la terre\FTNTT{\vref{Mc. 13:24-27}~; \vref{Lu. 21:25-28}.}}
...
\TextTitle{Parabole du figuier\FTNTT{\vref{Mc. 13:28-31}~; \vref{Lu. 21:29-33}.}}
...
\TextTitle{Exhortation à la vigilance\FTNTT{\vref{Mc. 13:32-37}~; \vref{Lu. 21:34-38}.}}
...
\VS{7}Alors toutes ces vierges se réveillèrent\FTNT{Réveiller~: Du grec «~egeiro~». Ce terme signifie également ressusciter. Les saints qui attendent le retour du Seigneur connaîtront un réveil après un temps de sommeil spirituel (\vref{Ro. 13:11}).} et préparèrent leurs lampes.
...
\TextTitle{Séparation et jugement des brebis et des boucs\FTNTT{\vref{1 Co. 6:2}.}}
...
\Chap{26}
\TextTitle{Le complot\FTNTT{\vref{Mc. 14:1-2}~; \vref{Lu. 22:1-2}.}}
...
\TextTitle{Geste prophétique de Marie de Béthanie\FTNTT{\vref{Mc. 14:3-9}~; \vref{Jn. 12:1-8}.}}
...
\TextTitle{La trahison de Judas\FTNTT{\vref{Mc. 14:10-11}~; \vref{Lu. 22:3-6}.}}
\VS{14}Alors l'un des douze, appelé Judas Iscariot, alla vers les principaux prêtres,
\VS{15}et leur dit~: Que voulez-vous me donner, et je vous le livrerai~? Et ils lui comptèrent trente pièces d'argent\FTNT{\vref{Za. 11:12-13}.}.
\VS{16}Et dès lors, il cherchait une occasion favorable pour le livrer.
\TextTitle{La dernière Pâque\FTNTT{\vref{Mc. 14:12-21}~; \vref{Lu. 22:7-20}~; \vref{Jn. 13:1-12}.}}
...
\TextTitle{Le repas de la Pâque\FTNTT{\vref{Mc. 14:22-25}~; \vref{Lu. 22:17-20}~; \vref{Jn. 13:12-30}~; \vref{1 Co. 11:23-26}.}}
...
\TextTitle{Jésus informe Pierre de son triple reniement\FTNTT{\vref{Mc. 14:26-31}~; \vref{Lu. 22:31-34}~; \vref{Jn. 13:36-38}.}}
...
\VS{31}Alors Jésus leur dit~: Vous serez tous cette nuit scandalisés à cause de moi~; car il est écrit~: Je frapperai le Berger, et les brebis du troupeau seront dispersées\FTNT{\vref{Za. 13:7}.}.
...
\TextTitle{Jésus dans le jardin de Gethsémané\FTNTT{\vref{Mc. 14:32-42}~; \vref{Lu. 22:39-46}~; \vref{Jn. 18:1}.}}
...
\TextTitle{Première prière de Jésus\FTNTT{\vref{Mc. 14:35-38}~; \vref{Lu. 22:41-42}.}}
...
\TextTitle{Jésus trouve les disciples endormis\FTNTT{\vref{Mc. 14:37-40}~; \vref{Lu. 22:45-46}.}}
...
\TextTitle{Deuxième prière\FTNTT{\vref{Mc. 14:39}~; \vref{Lu. 22:44}.}}
...
\TextTitle{Troisième prière\FTNTT{\vref{Mc. 14:41}.}}
...
\TextTitle{Jésus trahi et arrêté\FTNTT{\vref{Mc. 14:43-50}~; \vref{Lu. 22:47-53}~; \vref{Jn. 18:2-11}.}}
...
\TextTitle{Jésus devant Caïphe et le sanhédrin\FTNTT{\vref{Mc. 14:53-65}~; \vref{Jn. 18:12-14,19-24}.}}
...
\TextTitle{Le triple reniement de Pierre\FTNTT{\vref{Mc. 14:66-72}~; \vref{Lu. 22:55-62}~; \vref{Jn. 18:15-18,25-27}.}}
...
\Chap{27}
\TextTitle{Jésus devant le gouverneur Pilate~; suicide de Judas\FTNTT{\vref{Ac. 1:16-19}.}}
...
\VS{10}et ils les ont données pour acheter le champ d'un potier, selon ce que le Seigneur m'avait ordonné\FTNT{Ce verset se réfère certainement à \vref{Za. 11:12-13}, avec une allusion à \vref{Jé. 18:1-4}.}.
...
\TextTitle{Jésus ou Barabbas~?\FTNTT{\vref{Mc. 15:6-15}~; \vref{Lu. 23:17-25}~; \vref{Jn. 18:39-40}.}}
...
\TextTitle{Le Roi couronné d'épines\FTNTT{\vref{Mc. 15:16-23}~; \vref{Lu. 23:26-32}~; \vref{Jn. 19:16-17}.}}
...
\TextTitle{Jésus accomplit la loi par sa mort\FTNTT{\vref{Mc. 15:33-41}~; \vref{Lu. 23:44-49}~; \vref{Jn. 19:30-37}~; \vref{Hé. 9:3-8}~; \vref{10:19-20}.}}
...
\VS{51}Et voici, le voile du temple se déchira en deux, depuis le haut jusqu'en bas\FTNT{C'est ici que s'achève la Première Alliance. Cette dernière était relative à la loi de Moïse, c'est-à-dire aux ordonnances liées au culte, qui reposait sur le sacerdoce lévitique et les sacrifices d'animaux, et au sanctuaire terrestre, à savoir le temple de Jérusalem (\vref{Hé. 9:1}). Le Seigneur ayant offert une fois pour toutes le sacrifice parfait, les exigences de la justice divine ont été pleinement satisfaites (\vref{Hé. 9:11-12}~; \vref{25-26}). Désormais, la Première Alliance n'a plus de raison d'être et peut donc disparaître (\vref{Hé. 8:13}). Non seulement la déchirure du voile séparant le lieu saint du Saint des saints atteste la fin de la Première Alliance, mais invite aussi tout homme à s'approcher de Dieu en esprit, sans intermédiaires (Lévites, prêtres, pasteurs, prophètes…) ni nécessité de se rendre dans un temple (\vref{Jn. 4:23}). La Nouvelle Alliance est aussi un testament puisque Jésus-Christ, notre légataire, est passé par la mort (\vref{Hé. 9:16-18}). Voir aussi commentaire en \vref{Ex. 19:5}.}, et la terre trembla, et les pierres se fendirent.
...
\TextTitle{Jésus enseveli\FTNTT{\vref{Mc. 15:42-47}~; \vref{Lu. 23:50-56}~; \vref{Jn. 19:38-42}.}}
...
\Chap{28}
\TextTitle{Résurrection et apparition de Jésus-Christ\FTNTT{\vref{Mc. 16:1-14}~; \vref{Lu. 24:1-49}~; \vref{Jn. 20:1-23}.}}
...
\TextTitle{Mission des apôtres\FTNTT{\vref{Mc. 16:15-18}~; \vref{Lu. 24:46-48}~; \vref{Jn. 17:18}~; \vref{20:21}~; \vref{Ac. 1:8}~; \vref{1 Co. 15:6}.}}
