...
\Chap{3}
\TextTitle{Ministère de Jean-Baptiste\FTNTT{\vref{Mc. 1:1-8}~; \vref{Lu. 3:1-20}~; \vref{Jn. 1:6-8,15-37}.}}
...
\Chap{4}
\TextTitle{La tentation\FTNTT{\vref{Ge. 3:6}~; \vref{Mc. 1:12-13}~; \vref{Lu. 4:1-13}~; \vref{1 Jn. 2:16}.}}
...
\TextTitle{Le standard de l'Amour\FTNTT{\vref{Lu. 6:27-36}.}}
...
\TextTitle{La règle d'or de la loi et des prophètes\FTNTT{\vref{Lu. 6:31}~; \vref{Ep. 4:32}.}}
...
\Chap{8}
\TextTitle{Le lépreux guérit\FTNTT{\vref{Mc. 1:40-45}.}}
...
\TextTitle{Autorité de Jésus face à la tempête\FTNTT{\vref{Mc. 4:35-41}~; \vref{Lu. 8:22-25}.}}
...
\TextTitle{Deux aveugles et un démoniaque guéris\FTNTT{\vref{Mc. 5:1-20}~; \vref{Lu. 8:26-40}.}}
...
\Chap{9}
\TextTitle{Un paralytique guéri\FTNTT{\vref{Mc. 2:3-12}~; \vref{Lu. 5:18-26}.}}
...
\TextTitle{L'appel des pécheurs\FTNTT{\vref{Mc. 2:15-20}~; \vref{Lu. 5:29-35}.}}
...
\TextTitle{Jésus ému de compassion pour la foule\FTNTT{\vref{Mc. 6:34}.}}
...
\TextTitle{Jésus guérit l'homme à la main sèche le jour du sabbat\FTNTT{\vref{Mc. 3:1-5}~; \vref{Lu. 6:6-11}.}}
...
\VS{3}Alors les principaux prêtres, les scribes et les anciens du peuple, se réunirent dans la cour du premier prêtre, appelé Caïphe~;
...
\VS{51}Et voici, l'un de ceux qui étaient avec Jésus, étendit la main et tira son épée~; il frappa le serviteur du premier prêtre, et lui emporta l'oreille.
...
\VS{57}Ceux qui avaient saisi Jésus l'amenèrent chez Caïphe, le premier prêtre, où les scribes et les anciens étaient assemblés.
\VS{58}Pierre le suivit de loin jusqu'à la cour du premier prêtre, y entra et s'assit avec les officiers pour voir comment cela finirait.
...
\VS{62}Alors le premier prêtre se leva et lui dit~: Ne réponds-tu rien~? Qu'est-ce que ces hommes déposent contre toi~?
\VS{63}Jésus garda le silence. Et le premier prêtre prenant la parole, lui dit~: Je te somme par le Dieu vivant, de nous dire si tu es le Christ, le Fils de Dieu.
...
\VS{65}Alors le premier prêtre déchira ses vêtements, en disant~: Il a blasphémé~! Qu'avons-nous encore besoin de témoins~? Voici, vous avez entendu maintenant son blasphème. Que vous en semble~?
