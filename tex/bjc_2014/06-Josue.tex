...
\begin{multicols}{2}
\Chap{1}
\TextTitle{Josué succède à Moïse à sa mort\FTNTT{\vref{De. 34:9}.}}
...
\VS{3}Tout lieu que foulera la plante de votre pied, je vous l'ai donné, comme je l'ai déclaré à Moïse\FTNT{\vref{De. 11:24}.}.
...
\VS{5}Nul ne tiendra devant toi, tous les jours de ta vie. Je serai avec toi comme j'ai été avec Moïse~; je ne te délaisserai point, et je ne t'abandonnerai point\FTNT{\vref{De. 31:6}~; \vref{Hé. 13:5-6}.}.
...
\\- Murmurer la Parole de Dieu~: Partout où nous sommes, nous pouvons dans nos cœurs murmurer les promesses du Seigneur (\vref{Ps. 63:5-8}~; \vref{Ps. 119:11}).
\\- Proclamer à haute voix~: Il est intéressant de noter que le mot hébreu traduit dans \vref{Jos. 1:8} par méditer est traduit par «~proclamer~» ou «~dire~» dans \vref{Pr. 8:7}~; \vref{Ps. 35:8}~; \vref{Ps. 77:13}. 
\\- Réfléchir profondément~: Il faut être dans le lieu secret (\vref{Mt. 6:5-6}). En Israël il est de coutume d'aller étudier la Torah à l'ombre d'un figuier. Voir \vref{Jn. 1:43-51}.}~; car c'est alors que tu auras du succès dans tes entreprises, c'est alors que tu réussiras.
...
\VS{14}Vos femmes, vos petits-enfants, et vos bêtes resteront dans le pays que Moïse vous a donné de l'autre côté du Jourdain~; mais vous tous, hommes vaillants, vous passerez en armes devant vos frères, et vous les aiderez\FTNT{\vref{Ex. 13:18}.}~;
...
\Chap{2}
\TextTitle{Josué envoie deux espions à Jéricho~; ils sont reçus par Rahab\FTNTT{\vref{Ja. 2:25}.}}
\VerseOne{}Or, Josué fils de Nun, envoya secrètement de Sittim deux hommes, pour épier secrètement le pays, et il leur dit~: Allez, examinez le pays, et Jéricho. Ils partirent donc et entrèrent dans la maison d'une femme prostituée, nommée Rahab\FTNT{Rahab avait entendu parler du Dieu des Hébreux et avait placé son espérance de salut en lui (\vref{Ro. 10:11}). Par cet acte de foi, sa destinée a changé. Cette femme qui était vouée à une double condamnation du fait de sa condition de prostituée (\vref{De. 23:17}) et de son appartenance à une nation païenne qui devait être dévouée à la façon de l'interdit (\vref{Jos. 6}), a été sauvée avec sa famille (\vref{Ac. 2:21}~; \vref{Ac. 16:31} ). Ainsi, bien des siècles plus tard, on ne la mentionnera plus comme une prostituée, mais comme une ancêtre du Sauveur et une héroïne de la foi (\vref{Mt. 1:5}~; \vref{Hé. 11:21}). Rahab est donc l'archétype des païens qui sont rentrés dans l'alliance de Dieu par la foi.}, et ils y couchèrent.
...
\VS{9}et leur dit~: Je sais que Yahweh vous a donné ce pays, et que la terreur de votre nom nous a saisis, et que tous les habitants du pays perdent courage à cause de vous\FTNT{\vref{Ex. 23:27}.}.
...
\VS{11}Nous l'avons entendu, et notre cœur a fondu, et depuis aucun homme n'a eu le courage à cause de vous. Car Yahweh, votre Dieu, est le Dieu des cieux en haut et de la terre\FTNT{\vref{De. 4:39}.} en bas.
...
\VS{5}Josué dit au peuple~: Sanctifiez-vous, car Yahweh fera demain des choses merveilleuses au milieu de vous\FTNT{\vref{Ex. 19:10-11}.}.
...
\VS{13}Et il arrivera qu'aussitôt que les plantes des pieds des prêtres qui portent l'arche de Yahweh, le Seigneur de toute la terre, seront posés dans les eaux du Jourdain, les eaux du Jourdain seront coupées, les eaux, dis-je, qui descendent d'en haut, et elles s'arrêteront en un monceau\FTNT{\vref{Ps. 114:3}.}.
...
\VS{15}Aussitôt que ceux qui portaient l'arche furent arrivés au Jourdain, et que les pieds des prêtres qui portaient l'arche furent mouillés au bord de l'eau. Le Jourdain regorge par-dessus toutes ses rives durant tout le temps de la moisson\FTNT{\vref{1 Ch. 12:15}}.
...
\VS{12}Et les fils de Ruben, les fils de Gad, et la demi-tribu de Manassé passèrent en armes devant les enfants d'Israël, comme Moïse le leur avait dit\FTNT{\vref{No. 32:20-29}.}.
...
\VS{10}Ainsi les enfants d'Israël campèrent à Guilgal, et célébrèrent la Pâque le quatorzième jour du mois, sur le soir, dans les plaines de Jéricho\FTNT{\vref{Ex. 12:6}.}.
\VS{11}Et dès le lendemain de la Pâque, ils mangèrent du blé du pays, savoir, des pains sans levain et du grain rôti, en ce même jour\FTNT{\vref{Ex. 12:39}~; \vref{Lé. 2:14}}.
\VS{12}Et la manne cessa dès le lendemain de la Pâque, après qu'ils eurent manger du blé du pays~; les enfants d'Israël n'eurent plus de manne, mais ils mangèrent les récoltes de la terre de Canaan cette année-là\FTNT{\vref{Ex. 16:35}.}.
...
\VS{15}Et le Chef de l'armée de Yahweh dit à Josué~: Délie tes souliers de tes pieds~; car le lieu sur lequel tu te tiens est saint\FTNT{\vref{Ex. 3:5}.}. Et Josué fit ainsi.
\Chap{6}
...
\VS{17}La ville sera dévouée par le moyen de l'interdit à Yahweh, elle et toutes les choses qui y sont~; seulement Rahab, la prostituée\FTNT{Rahab sauva sa famille par sa foi en Dieu (\vref{Ac. 16:31}). Voir Josué 2.}, vivra, elle et tous ceux qui seront avec elle dans la maison, parce qu'elle a caché soigneusement les messagers que nous avions envoyés.
\VS{18}Mais quoi qu'il en soit gardez-vous de l'interdit, de peur que vous ne vous mettiez en interdit, et que vous ne mettriez le camp d'Israël en interdit et que vous le troubliez\FTNT{\vref{De. 7:26}.}.
\VS{19}Mais tout l'argent et tout l'or, tous les objets d'airain et de fer seront consacrés à Yahweh, ils entreront dans le trésor de Yahweh\FTNT{\vref{No. 31:54}.}.
\VS{20}Le peuple donc poussa de cris de joie et on sonna des shofars. Et quand le peuple entendit le son des shofars, il poussa de grands cris de joie et la muraille tomba sur elle-même\FTNT{\vref{Hé. 11:30}.}. Alors le peuple monta dans la ville, les hommes devant le peuple. Et ils prirent la ville. 
...
\VS{26}Et en ce temps-là Josué jura, en disant~: Maudit soit devant Yahweh l'homme qui se mettra à rebâtir cette ville de Jéricho~! Il la fondera sur son premier-né, et il posera ses portes sur son plus jeune fils\FTNT{Cette parole s'est accomplie en \vref{1 R. 16:34}.}.
...
\VS{21}J'ai vu parmi le butin un beau manteau de Schinear\FTNT{\vref{Ge. 10:6-12}.}, deux cents sicles d'argent et un lingot d'or du poids de cinquante sicles~; je les ai convoités, je les ai pris et voilà, ces choses sont cachées dans la terre au milieu de ma tente, et l'argent est sous le manteau.
...
\VS{26}Et ils dressèrent sur lui un grand monceau de pierres, qui dure jusqu'à ce jour. Et Yahweh apaisa l'ardeur de sa colère. C'est pourquoi ce lieu-là a été appelé jusqu'à aujourd'hui, la vallée d'Acor\FTNT{\vref{2 S. 18:17}.}.
\Chap{8}
\TextTitle{Victoire d'Israël à Aï}
\VerseOne{}Puis Yahweh dit à Josué~: Ne crains point, et ne t'effraie de rien\FTNT{\vref{De. 1:21}~; \vref{De. 7:18}.}~! Prends avec toi tout le peuple propre à la guerre et lève-toi, et monte contre Aï. Regarde, j'ai livré entre tes mains le roi d'Aï et son peuple, sa ville et son pays.
...
\VS{22}Les autres aussi sortirent de la ville contre eux, et ils furent enveloppés par les Israélites ayant les uns d'un côté et les autres de l'autre. Ils furent tellement battus qu'il n'en laissa aucun qui resta en vie ou qui échappât\FTNT{\vref{De. 7:2}.}~;
...
\VS{27}Seulement les Israélites pillèrent pour eux les bêtes et le butin de cette ville-là, suivant ce que Yahweh avait prescrit à Josué\FTNT{\vref{No. 31:22-26}.}.
...
\VS{21}Ils vivront, leur dirent les chefs. Mais ils furent employés à couper le bois et à puiser l'eau pour toute l'assemblée, comme les chefs le leur avaient dit\FTNT{\vref{2 S. 21:1-14}. La présence des Gabaonites en plein centre de Canaan tendait à isoler les tribus du nord de celles du sud, favorisant ainsi le schisme des deux royaumes (\vref{1 R. 12}).}.
...
\VS{13}Et le soleil s'arrêta, et la lune aussi s'arrêta, jusqu'à ce que le peuple ait tiré vengeance de ses ennemis. Cela n'est-il pas écrit dans le livre du Juste~? Le soleil s'arrêta au milieu du ciel et ne se hâta point de se coucher environ un jour entier\FTNT{\vref{Ha. 3:11}.}.
...
\VS{27}Et comme le soleil se couchait, Josué ordonna qu'on les descende de ces arbres, et on les jeta dans la caverne où ils s'étaient cachés, et on mit à l'entrée de la caverne de grosses pierres qui y sont demeurées jusqu'à ce jour\FTNT{\vref{De. 21:23}.}.
...
\VS{40}Josué donc frappa tout ce pays, la montagne et le midi, la plaine et les coteaux, et tous leurs rois~; il n'en laissa échapper aucun, et il dévoua par le moyen de l'interdit toutes les personnes qui y respiraient, comme Yahweh, le Dieu d'Israël, l'avait ordonné\FTNT{\vref{De. 20:16-17}.}.
...
\VS{6}Et Yahweh dit à Josué~: Ne les crains point, car demain, à cette même heure, je les livrerai tous, blessés à mort, devant Israël. Tu couperas les jarrets à leurs chevaux, et brûleras au feu leurs chars\FTNT{\vref{2 S. 8:4}.}.
...
\VS{20}Car cela venait de Yahweh, qu'ils endurcissent leur cœur pour qu'ils sortent en bataille contre Israël, afin qu'il les dévoue à la façon de l'interdit, sans qu'il y ait pour eux de miséricorde, et qu'il les extermine, comme Yahweh l'avait ordonné à Moïse\FTNT{\vref{Ex. 4:21}~; \vref{De. 2:30}~; \vref{1 R. 12:15}.}.
...
\VS{22}Il ne resta aucun Anakim dans le pays des enfants d'Israël~; il n'en resta seulement qu'à Gaza, à Gath et à Asdod\FTNT{\vref{2 S. 21:20}.}.
...
\VS{2}Savoir, Sihon, roi des Amoréens, qui habitait à Hesbon, et qui dominait depuis Aroër, qui est sur le bord du torrent de l'Arnon, et depuis le milieu du torrent, sur la moitié de Galaad, jusqu'au torrent de Jabbok, qui est la frontière des enfants d'Ammon\FTNT{\vref{De. 3:8-16}.}~;
...
\VS{6}Moïse, serviteur de Yahweh, et les enfants d'Israël, les battirent~; et Moïse, serviteur de Yahweh, en donna la possession aux Rubénites, aux Gadites, et à la demi-tribu de Manassé\FTNT{\vref{No. 32:33}.}.
...
\VS{14}Seulement il ne donna point d'héritage à la tribu de Lévi~; les sacrifices consumés par le feu devant Yahweh, le Dieu d'Israël, tel fut son héritage, comme il le lui avait dit\FTNT{\vref{No. 18:20-24}~; \vref{De. 10:9}~; \vref{De. 18:2}~; \vref{Ez. 44:28}.}.
...
\VS{22}Les enfants d'Israël firent passer aussi par l'épée Balaam\FTNT{Voir \vref{No. 22}. Balaam était l'exemple type du prophète corrompu, soucieux de tirer profit de son service.}, fils de Beor, le devin, avec les autres qui y furent tués.
\VS{23}Et les frontières des enfants d'Israël fut le Jourdain et sa frontière. Tel fut l'héritage des fils de Ruben, selon leurs familles~; savoir, ces villes-là et leurs villages\FTNT{\vref{No. 34:14-15}.}.
...
\VS{2}Selon le sort de leur héritage~; comme Yahweh l'avait ordonné par le moyen de Moïse~; savoir, à neuf tribus et à la demi-tribu\FTNT{\vref{No. 26:55}.}.
...
\VS{6}Or les fils de Juda s'approchèrent de Josué à Guilgal~; et Caleb, fils de Jephunné, le Kenizien, lui dit~: Tu sais la parole que Yahweh a déclarée à Moïse, homme de Dieu, à mon sujet et au tien à Kadès-Barnéa\FTNT{\vref{No. 14:24}~; \vref{No. 32:12}~; \vref{De. 1:36}.}.
...
\VS{16}Et Caleb dit~: Je donnerai ma fille Acsa pour femme à celui qui battra Kirjath-Sépher, et la prendra\FTNT{\vref{Jg. 1:12-14}.}.
...
\VS{10}Or ils ne chassèrent point les Cananéens qui habitaient à Guézer, c'est pourquoi les Cananéens ont habité parmi Ephraïm jusqu'à ce jour, mais ils furent réduits à la servitude et assujettis à un tribut\FTNT{\vref{Jg. 1:29}~; \vref{1 R. 9:16}.}.
\Chap{17}
...
\VS{4}Elles vinrent se présenter devant le prêtre Eléazar, devant Josué, fils de Nun, et devant les princes, en disant~: Yahweh a ordonné à Moïse de nous donner un héritage parmi nos frères. C'est pourquoi on leur donna un héritage parmi les frères de leur père, selon l'ordre de Yahweh\FTNT{\vref{No. 27:7}~; \vref{No. 36:2}.}.
...
\VS{16}Et les fils de Joseph répondirent~: Cette montagne ne sera pas suffisante pour nous, et tous les Cananéens qui habitent la vallée ont des chars de fer, et ceux qui sont à Beth-Schean, et dans les villes de son ressort, et ceux qui habitent dans la vallée de Jizreel\FTNT{\vref{Jg. 1:19}~; \vref{Jg. 4:3}.}.
...
\VerseOne{}La deuxième part échut par le sort à Siméon, pour la tribu des fils de Siméon, selon leurs familles. Leur héritage était parmi l'héritage des fils de Juda\FTNT{\vref{Ge. 49:5-7}.}.
...
\Chap{20}
\TextTitle{Les six villes de refuge\FTNTT{\vref{No. 35}.}}
\VerseOne{}Puis Yahweh parla à Josué et dit :
\VS{2}Parle aux enfants d'Israël et dis-leur : Etablissez-vous des villes de refuge dont je vous ai parlé par le moyen de Moïse,
\VS{3}afin le meurtrier qui aura tué quelqu'un involontairement sans y penser, s'y enfuie ; et elles seront pour vous un refuge devant celui qui a le droit de venger le sang.
...
\VS{5}Et quand celui qui a le droit de venger le sang le poursuivra, ils ne livreront pas le meurtrier entre ses mains ; puisque c'est sans y poenser qu'il a tué son prochain, et qu'il ne le haïssait point auparavant.
\VS{6}Mais il demeurera dans cette ville-là, jusqu'à ce qu'il comparaisse devant l'assemblée en jugement, même jusqu'à la mort du grand-prêtre qui sera en ce temps-là. Alors le meurtrier s'en retournera, et reviendra dans sa ville et dans sa maison, dans la ville d'où il s'était enfui\FTNT{\vref{Ex. 21:13}~; \vref{No. 35:9-34}~; \vref{De. 19}.}.
...
\VS{8}Et au delà du Jourdain, à l'orient de Jéricho, ils choisirent Betser, dans la tribu de Ruben, dans le désert, dans la plaine~; Ramoth en Galaad, dans la tribu de Gad ; et Golan en Basan, dans la tribu de Manassé\FTNT{\vref{De. 4:43}.}.
...
\VS{2}Et leur parlèrent à Silo, dans le pays de Canaan, en disant~: Yahweh a ordonné par le moyen de Moïse qu'on nous donne des villes pour habiter, et leurs faubourgs pour nos bêtes\FTNT{\vref{No. 35:2-3}.}.
...
\VS{20}Or quand aux familles des enfants de Kehath, Lévites, qui étaient le reste des enfants de Kehath, il y eut dans leur sort des villes de la tribu d'Ephraïm.
...
\VS{43}Yahweh donna donc à Israël tout le pays qu'il avait juré de donner à leurs pères~; ils le possédèrent, et y habitèrent\FTNT{Dieu accomplit toujours ses promesses (\vref{Jé. 1:12}).}.
...
\VS{17}Regardons-nous comme peu de chose l'iniquité de Peor\FTNT{Peor~: \vref{No. 25:1-9}.}, dont nous ne nous sommes pas encore bien nettoyés jusqu'à présent, malgré la plaie qu'il attira sur l'assemblée de Yahweh,
...
\VS{20}Acan\FTNT{Acan~: \vref{Jos. 7:1-26}.}, fils de Zérach, ne commit-il pas une infidélité en prenant des choses dévouées par le moyen de l'interdit, et la colère de Yahweh ne s'enflamma-t-elle pas contre toute l'assemblée d'Israël~? Cependant, cet homme ne fut pas le seul qui périt à cause de son iniquité.
...
\VS{25}Puisque Yahweh a mis le Jourdain pour frontière entre nous et vous, enfants de Ruben, et enfants de Gad~; vous n'avez point de part à Yahweh~! Et ainsi vos enfants feraient qu'un jour nos enfants cesseraient de craindre Yahweh\FTNT{\vref{Né. 2:20}~; \vref{Ac. 8:21}.}.
...
\VS{27}mais afin qu'il serve de témoignage entre nous et vous, et entre nos descendants et les vôtres, que nous voulons servir Yahweh devant sa face par nos holocaustes et nos sacrifices d'expiation et d'offrande de paix, afin que vos fils ne disent pas un jour à nos fils~: Vous n'avez point de part à Yahweh\FTNT{\vref{Ge. 31:48}.}~!
...
\VS{5}Yahweh, votre Dieu, les repoussera devant vous et les chassera~; et vous posséderez leur pays en héritage, comme Yahweh, votre Dieu, vous l'a dit\FTNT{\vref{Ex. 14:14}~; \vref{Ex. 23:27}~; \vref{No. 33:53}~; \vref{De. 6:18-19}.}.
\VS{6}Fortifiez-vous donc de plus en plus pour garder et faire tout ce qui est écrit dans le livre de la loi de Moïse, afin que vous ne vous détourniez ni à droite ni à gauche\FTNT{\vref{De. 5:32}~; \vref{De. 28:14}.}.
\VS{7}Et que vous ne vous mêliez point avec ces nations qui sont restées parmi vous~; et que vous ne fassiez point mention de leurs dieux ; et que vous ne fassiez jurer personne par eux, et que vous ne les serviez pas, ne les servez point, et ne vous prosterniez point devant eux\FTNT{\vref{Ex. 23:13}~; \vref{De. 12:3}~; \vref{Jé. 5:7}~; \vref{De. 6:14}.}.
\VS{8}Mais attachez-vous à Yahweh, votre Dieu, comme vous l'avez fait jusqu'à ce jour\FTNT{\vref{De. 11:22}.}.
...
\VS{10}Un seul homme d'entre vous en poursuivait mille~; car Yahweh votre Dieu est celui qui combat pour vous, comme il vous l'a dit\FTNT{\vref{Lé. 26:8}~; \vref{De. 32:30}.}.
...
\VS{3}Mais j'ai pris votre père Abraham de l'autre côté du fleuve, je lui fis parcourir tout le pays de Canaan, je multipliai sa postérité, et lui donnai Isaac\FTNT{\vref{Ge. 12}~; \vref{Ge. 21:2}.}.
\VS{4}Je donnai à Isaac, Jacob et Esaü~; et je donnai à Esaü le mont de Séir, pour le posséder~; mais Jacob et ses fils descendirent en Egypte\FTNT{\vref{Ge. 25:24}~; \vref{Ge. 36:6}.}.
\VS{5}Puis j'envoyai Moïse et Aaron, et je frappai l'Egypte, par les prodiges que j'opérai au milieu d'elle~; puis je vous en fis sortir\FTNT{\vref{Ex. 3:10}.}.
\VS{6}Je fis donc sortir vos pères hors de l'Egypte, et vous arrivâtes à la mer. Les Egyptiens poursuivirent vos pères avec des chars et des cavaliers, jusqu'à la Mer Rouge\FTNT{\vref{Ex. 14:9}.}.
...
\VS{9}Balak\FTNT{Balaak~: Voir \vref{No. 22:2-14}.} aussi, fils de Tsippor, roi de Moab, se leva, et fit la guerre à Israël. Il fit appeler Balaam\FTNT{Balaam~: Voir \vref{No. 22}.}, fils de Beor, pour qu'il vous maudisse.
...
\VS{12}et j'envoyai devant vous des frelons qui les chassèrent loin de votre face, comme les deux rois des Amoréens~: Ce ne fut ni par ton épée, ni par ton arc\FTNT{\vref{Ex. 23:28}~; \vref{De. 7:20}.}.
\VS{13}Je vous donnai une terre que vous n'aviez point cultivée, des villes que vous n'aviez point bâties, et que vous habitez, et vous mangez les fruits des vignes et des oliviers que vous n'avez point plantés\FTNT{\vref{De. 6:10}~; \vref{Ps. 105:44}~; \vref{Né. 9:25}.}.
\TextTitle{Le peuple choisit de servir Yahweh}
\VS{14}Maintenant, craignez Yahweh, et servez-le avec intégrité et avec fidélité. Ôtez les dieux que vos pères ont servis de l'autre côté du fleuve et en Egypte, et servez Yahweh\FTNT{\vref{1 S. 12:23-24}~; \vref{Ez. 20:7-44}.}.
...
\VS{26}Josué écrivit ces paroles dans le livre de la loi de Dieu. Il prit aussi une grande pierre\FTNT{Cette Pierre entend selon Josué, elle est également appelée «~témoin~». Jésus-Christ, la Pierre angulaire (\vref{Es. 8:13-16}) est le témoin fidèle (\vref{Ap. 19:11}). Cette Pierre suivait les Hébreux dans le désert (\vref{1 Co. 10:1-3}).}, qu'il dressa là sous le chêne qui était dans le lieu consacré à Yahweh.
...
\TextTitle{Mort de Josué et d'Eléazar~; ensevelissement des os de Joseph (\vref{Ge. 50:26})}
...
\VS{32}Les os de Joseph\FTNT{(\vref{Ge. 50:25}~; \vref{Ex. 13:19}~; \vref{Hé. 11:22}).}, que les enfants d'Israël avaient rapportés d'Egypte, furent ensevelis à Sichem, dans la portion du champ que Jacob avait achetée des fils de Hamor, père de Sichem, pour cent kesita, et qui appartint à l'héritage des fils de Joseph.
