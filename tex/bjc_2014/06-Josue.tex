...
\VS{26}Josué écrivit ces paroles dans le livre de la loi de Dieu. Il prit aussi une grande pierre\FTNT{Cette Pierre est une préfiguration de Jésus-Christ, le «~témoin fidèle~» (\vref{Ap. 19:11}). Voir en commentaire en (\vref{Es. 8:13-16}).}, qu'il dressa là sous le chêne qui était dans le lieu consacré à Yahweh.
