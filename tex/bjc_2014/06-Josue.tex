...
\VS{3}Mais les habitants de Gabaon\FTNT{Les Gabaonites étaient rusés. Ils poussèrent les Hébreux à faire alliance avec eux, comme le font les faux chrétiens aujourd'hui (\vref{Esd. 4} ; \vref{Es. 30:1}). Il n'y a pas de rapport entre la lumière et les ténèbres (\vref{2 Co. 6:14-18}). Combien de chrétiens ne se font-ils pas avoir par des loups ravisseurs dans le domaine du mariage ?}, ayant entendu ce que Josué avait fait à Jéricho et à Aï,
...
\VS{8}Et de l'autre côté du Jourdain, à l'orient de Jéricho, ils choisirent Betser, dans la tribu de Ruben, dans le désert, dans la plaine ; Ramoth en Galaad, dans la tribu de Gad ; et Golan en Basan, dans la tribu de Manassé\FTNT{\vref{De. 4:43}.}.
...
\VS{2}Et leur parlèrent à Silo, dans le pays de Canaan, et dirent : Yahweh a ordonné par Moïse qu'on nous donne des villes pour habiter, et leurs faubourgs pour nos bêtes\FTNT{\vref{No. 35:2-3}.}.
...
\VS{4}Maintenant que Yahweh, votre Dieu, a donné du repos à vos frères, comme il le leur avait dit, retournez et allez dans vos tentes, dans le pays qui vous appartient, et que Moïse, serviteur de Yahweh, vous a donné de l'autre côté du Jourdain\FTNT{\vref{No. 32:33} ; \vref{De. 3:13} ; \vref{De. 29:8}.}.
\VS{5}Prenez seulement bien garde d'observer les ordonnances et les lois que Moïse, serviteur de Yahweh, vous a prescrites : Aimez Yahweh votre Dieu, marchez dans toutes ses voies, gardez ses commandements, attachez-vous à lui, et servez-le de tout votre cœur et de toute votre âme\FTNT{\vref{De. 10:12}.}.
...
\VS{17}Regardons-nous comme peu de chose l'iniquité de Peor\FTNT{Peor : \vref{No. 25:1-9}.}, dont nous ne nous sommes pas encore bien purifiés jusqu'à présent, malgré la plaie qu'il attira sur l'assemblée de Yahweh ?
...
\VS{25}Puisque Yahweh a mis le Jourdain pour frontière entre nous et vous, fils de Ruben, et fils de Gad ; vous n'avez point de part à Yahweh ! Et ainsi vos fils feraient qu'un jour nos fils cesseraient de craindre Yahweh\FTNT{\vref{Né. 2:20} ; \vref{Ac. 8:21}.}.
...
\VS{6}Appliquez-vous avec force à observer et à mettre en pratique tout ce qui est écrit dans le livre de la loi de Moïse, sans vous en détourner ni à droite ni à gauche\FTNT{\vref{De. 5:32} ; \vref{De. 28:14}.}.
\VS{7}Ne vous mêlez point avec ces nations qui sont restées parmi vous ; et ne faites point mention du nom de leurs dieux, et ne faites jurer personne par eux, ne les servez point, et ne vous prosternez point devant eux\FTNT{\vref{Ex. 23:13} ; \vref{De. 12:3} ; \vref{Jé. 5:7} ; \vref{De. 6:14}.}.
