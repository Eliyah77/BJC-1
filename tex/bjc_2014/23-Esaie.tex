...
\VS{11}Qu'ai-je à faire, dit Yahweh, de la multitude de vos sacrifices ? Je suis rassasié des holocaustes de béliers et de la graisse des veaux ; je ne prends point plaisir au sang des taureaux, ni des agneaux, ni des boucs\FTNT{\vref{1 S. 15:22} ; \vref{Os. 8:13} ; \vref{Mt. 9:13}.}.
...
\VS{15}C'est pourquoi, quand vous étendez vos mains, je cache mes yeux de vous ; quand vous multipliez vos prières, je ne les exauce pas ; vos mains sont pleines de sang\FTNT{\vref{Es. 59:1-3} ; \vref{Mi. 3:4}.}.
...
\VS{26}mais je rétablirai tes juges, tels qu'ils étaient autrefois, et tes conseillers, tels qu'ils étaient au commencement\FTNT{Dans le royaume messianique, le gouvernement théocratique sera restauré et la fonction des juges sera rétablie (voir livre des Juges ; \vref{Mt. 19:28} ; \vref{1 Co. 6:2-3}).}. Après cela, on t'appellera cité de la justice, ville fidèle.
...
\VS{29}Car on sera honteux à cause des térébinthes que vous avez désirés, et vous rougirez à cause des jardins que vous avez choisis\FTNT{Des cultes idolâtres avaient lieu autour des térébinthes et dans des jardins (\vref{De. 16:21} ; \vref{Es. 57:4-5} ; \vref{Es. 65:3} ; \vref{Jé. 2:20} ; \vref{Ez. 20:28} ; \vref{Os. 4:13}).}.
...
\VS{2}Or il arrivera, dans les derniers jours\FTNT{Voir \vref{Ge. 49:1-2}.}, que la montagne de la maison de Yahweh sera affermie au sommet des montagnes, qu'elle sera élevée par-dessus les collines et que toutes les nations y afflueront.
...
\VS{6}Certes tu as rejeté ton peuple, la maison de Jacob, parce qu'ils se sont remplis d'orient et adonnés à la divination comme les Philistins, et parce qu'ils s'allient aux enfants des étrangers\FTNT{\vref{De. 18:8-13} ; \vref{Os. 13:2} ; \vref{Mi. 5:11-13}.}.
...
\VS{10}Entre dans les rochers et cache-toi dans la poussière, à cause de la frayeur de Yahweh, et à cause de la gloire de sa majesté\FTNT{\vref{Ap. 6:15-16}.}.
...
\Chap{4}
\TextTitle{Vision du règne messianique\FTNTT{\vref{Es. 11:1-16}.}}
...
\VS{2}En ce temps-là, le germe de Yahweh\FTNT{Jésus est le « germe » de Yahweh (\vref{Es. 4:2}) et le germe de David (\vref{Jé. 23:5} ; \vref{Za. 3:8} ; \vref{Za. 6:12}). Ce germe a été placé par la vertu du Saint-Esprit dans le sein d'une vierge (\vref{Es. 7:14} ; \vref{Lu. 1:34-35}) et l'enfant qui naquit d'elle fut appelé « Fils de Dieu » tout en étant le Dieu Tout-Puissant. Il existe de toute éternité en forme de Dieu (\vref{Jn. 1:1} ; \vref{Es. 9:5}), mais il a été fait chair pour nous sauver (\vref{Jn. 1:14}. \vref{1 Ti. 3:16}). C'est le plus grand des miracles et la démonstration de sa divinité, de sa sagesse et de son amour envers les hommes.} sera plein de noblesse et de gloire, et le fruit de la terre plein de grandeur et d'excellence pour les réchappés d'Israël.
\VS{3}Et il arrivera que les restes de Sion, et les restes de Jérusalem, seront appelés saints ; et ceux de Jérusalem seront inscrits parmi les vivants\FTNT{\vref{Es. 10:20-22} ; \vref{Ro. 9:27} ; \vref{Ro. 11:5}}.
...
\VS{6}Et il y aura un tabernacle pour donner de l'ombre contre la chaleur du jour, pour servir de refuge et d'asile contre la tempête et la pluie\FTNT{\vref{Ap. 21:3}.}.
\Chap{5}
...
\VS{2}Il l'environna d'une haie, en ôta les pierres, et y planta des ceps exquis ; il bâtit une tour au milieu d'elle, et il y creusa aussi une cuve. Puis il espéra qu'elle produirait des raisins, mais elle a produit des grappes sauvages\FTNT{\vref{Lu. 13:6-9}.}.
...
\VS{13}C'est pourquoi mon peuple sera emmené captif, parce qu'il n'a pas de connaissance\FTNT{\vref{2 R. 24:14-16} ; \vref{Os. 4:6}.} ; et les plus honorables parmi eux seront des pauvres qui mourront de faim, et leur multitude sera asséchée par la soif.
...
\VS{20}Malheur à ceux qui appellent le mal bien et le bien mal\FTNT{\vref{Mi. 7:2}.} ; qui font les ténèbres lumière, et la lumière ténèbres ; qui font l'amertume douceur, et la douceur amertume.
...
\VerseOne{}L'année de la mort du roi Ozias, je vis le Seigneur assis sur un trône haut et élevé, et les pans de sa robe remplissaient le temple\FTNT{\vref{2 Ch. 26:23}.}.
...
\VS{5}Alors je dis : Malheur à moi ! Je suis perdu, car je suis un homme dont les lèvres sont impures, j'habite au milieu d'un peuple dont les lèvres sont impures et mes yeux ont vu le Roi, Yahweh des armées\FTNT{\vref{Jg. 13:21-22}.}.
...
\VS{10}Engraisse le cœur de ce peuple, et rends ses oreilles pesantes, et bouche-lui les yeux ; de peur qu'il ne voie de ses yeux, et qu'il n'entende de ses oreilles, et que son cœur ne comprenne, et qu'il ne se convertisse, et qu'il ne recouvre la santé\FTNT{\vref{Mt. 13:15} ; \vref{Mc. 4:12} ; \vref{Jn. 12:40} ; \vref{Ac. 28:27}.}.
...
\VS{13}Toutefois s'il y reste un dixième des habitants, ils reviendront pour être la proie des flammes. Mais comme le térébinthe et le chêne conservent leur tronc quand ils sont abattus, une sainte postérité renaîtra de ce peuple\FTNT{\vref{Ro. 11:17-25}.}.
\Chap{7}
...
\TextTitle{Prophétie sur l'imminente invasion de Juda\FTNTT{\vref{2 Ch. 28:1-20}.}}
...
\VS{20}En ce jour-là, le Seigneur rasera avec le rasoir pris à louage au-delà du fleuve, avec le roi d'Assyrie, la tête et les poils des pieds, et il enlèvera aussi la barbe\FTNT{\vref{2 R. 16:5-9}.}.
...
\VS{14}Et il sera un sanctuaire, mais aussi une pierre d'achoppement\FTNT{Yahweh s'est présenté comme une pierre d'achoppement et un rocher de scandale. En \vref{Es. 44:8} il affirme d'ailleurs ne pas connaître d'autre rocher que lui. Esaïe n'est pas le seul prophète à qui le Seigneur s'est révélé comme étant une pierre et un rocher. Dans le \vref{Ps. 118:22-23}, il est dit : « La pierre qu'ont rejetée ceux qui bâtissaient est devenue la principale de l'angle ». Daniel et Zacharie ont également prophétisé au sujet de cette pierre : « Tu regardais, lorsqu'une pierre se détacha sans le secours d'aucune main, frappa les pieds de fer et d'argile de la statue, et les mit en pièces. Mais la pierre qui avait frappé la statue devint une grande montagne, et remplit toute la terre » (\vref{Da. 2:34-35}). « Car voici, pour ce qui est de la pierre que j'ai placée devant Josué, il y a sept yeux sur cette seule pierre ; voici, je graverai moi-même ce qui doit y être gravé, dit Yahweh des armées ; et j'enlèverai l'iniquité de ce pays, en un jour » (\vref{Za. 3:9}). Ces prophéties se sont accomplies en Jésus-Christ, l'Agneau de Dieu qui ôte le péché du monde (\vref{Jn. 1:29}). Le Seigneur s'est d'ailleurs clairement identifié à la pierre angulaire, affirmant ainsi sa divinité (\vref{Lu. 20:17-19}). En \vref{Mt. 16:18}, il s'est présenté comme le rocher inébranlable sur lequel il allait bâtir son Eglise. De plus, il est à noter que dans le livre de l'Apocalypse, l'Agneau possède sept yeux comme la pierre vue par Zacharie (\vref{Ap. 5:6}). Ces sept yeux sont aussi les sept lampes du chandelier d'or que Zacharie et Jean avaient également vues (\vref{Za. 4:2} ; \vref{Ap. 4:5} ). Or le chiffre sept symbolise la plénitude et la perfection divines. Esaïe prophétisa encore en ces termes : « Voici, j'ai mis pour fondement en Sion une pierre, une pierre éprouvée, une pierre angulaire de prix, solidement posée ; celui qui la prendra pour appui n'aura point hâte de fuir » (\vref{Es. 28:16}). Les écrits de la Nouvelle Alliance attestent l'accomplissement de cette prophétie en Jésus-Christ, notamment par la bouche de Paul et de Pierre : « Vous avez été édifiés sur le fondement des apôtres et des prophètes, Jésus-Christ lui-même étant la pierre angulaire » (\vref{Ep. 2:20}). « Car personne ne peut poser un autre fondement que celui qui a été posé, savoir Jésus-Christ » (\vref{1 Co. 3:11}). « Approchez-vous de lui, pierre vivante, rejetée par les hommes, mais choisie et précieuse devant Dieu ; et vous-mêmes, comme des pierres vivantes, édifiez-vous pour former une maison spirituelle, un saint sacerdoce, afin d'offrir des victimes spirituelles, agréables à Dieu, par Jésus-Christ ». (\vref{1 Pi. 2:4-5}).}, un rocher de scandale pour les deux maisons d'Israël, un filet et un piège pour les habitants de Jérusalem.
...
\VerseOne{}Le peuple qui marchait dans les ténèbres voit une grande lumière, et la lumière resplendit sur ceux qui habitaient le pays de l'ombre de la mort\FTNT{\vref{Mt. 4:15-16}.}.
...
\VS{5}Car un enfant nous est né, un Fils nous a été donné\FTNT{Jésus-Christ est 100\% Dieu et 100\% homme. Il existe depuis toute éternité en tant que Dieu. Il est devenu homme au moment de son incarnation (\vref{Ph. 2:5-7}).}, et l'empire reposera sur son épaule : On l'appellera l'Admirable, le Conseiller, le Dieu Puissant, le Père d'éternité\FTNT{Philippe, disciple de Jésus-Christ voulait rencontrer le Père. Il posa au Seigneur cette question « Seigneur, montre-nous le Père, et cela nous suffit » (\vref{Jn. 14:8}). Jésus lui répondit : « Il y a si longtemps que je suis avec vous, et tu ne m'as pas connu, Philippe ! » (\vref{Jn. 14:9}).}, le Prince de paix,
\VS{6}pour accroître l'empire, et une paix sans fin au trône de David et à son royaume, pour l'affermir et le soutenir par le droit et par la justice, dès maintenant et à toujours\FTNT{\vref{Lu. 1:32-33}.}. Voilà ce que fera le zèle de Yahweh des armées.
\TextTitle{Jugement sur le royaume du nord}
\VS{7}Le Seigneur envoie une parole à Jacob, et elle tombe sur Israël\FTNT{\vref{Ge. 32:28}.}.
...
\VS{15}Ceux donc qui font croire à ce peuple qu'il est heureux sont des séducteurs\FTNT{\vref{1 Ti. 4:1} ; \vref{Tit. 1:10}.} ; et ceux qui se laissent diriger par eux se perdent.
...
\VS{3}Et que ferez-vous au jour de la visitation, et de la ruine éclatante qui viendra de loin ? Vers qui fuirez-vous pour avoir du secours et où laisserez-vous votre gloire\FTNT{\vref{Os. 9:7} ; \vref{Mt. 24:17-21} ; \vref{Lu. 19:41-44}.} ?
...
\TextTitle{Défaite des Assyriens\FTNTT{\vref{Es. 35-36} ; \vref{37:7}.}}
...
\VerseOne{}Mais il sortira un rameau du tronc d'Isaï, et un rejeton naîtra de ses racines\FTNT{\vref{Mt. 1:6-16} ; \vref{Lu. 1:31-32} ; \vref{Ro. 15:12} ; \vref{Ap. 5:5}.}.
\VS{2}L'Esprit de Yahweh reposera sur lui, Esprit de sagesse et d'intelligence, Esprit de conseil et de force, Esprit de connaissance et de crainte de Yahweh\FTNT{\vref{Es. 61:1} ; \vref{Lu. 4:18}}.
\VS{3}Il respirera la crainte de Yahweh, il ne jugera point sur l'apparence et il ne reprendra point sur un ouï-dire\FTNT{\vref{Jé. 11:20} ; \vref{Mt. 22:16} ; \vref{Ap. 2:23}.}.
\VS{4}Mais il jugera les pauvres avec justice, et il prononcera avec droiture un jugement sur les malheureux de la terre, et il frappera la terre par la verge de sa bouche, et il fera mourir le méchant par le souffle de ses lèvres\FTNT{\vref{Job 4:9} ; \vref{Job 15:30} ; \vref{2 Th. 2:8}.}.
\VS{5}La justice sera la ceinture de ses reins, et la fidélité, la ceinture de ses flancs\FTNT{\vref{Ep. 6:14}.}.
...
\VS{7}La jeune vache paîtra avec l'ourse, leurs petits auront un même gîte, et le lion, comme le bœuf, mangera de la paille\FTNT{\vref{Es. 65:25}.}.
...
\VS{10}En ce jour-là, les nations rechercheront le rejeton d'Isaï qui sera comme une bannière\FTNT{Jésus, notre bannière doit être élevé afin que les pécheurs soient sauvés (\vref{Jn. 3:14-15}). Le livre du Cantique des cantiques est une superbe image de l'amour de Dieu manifesté en Jésus-Christ, pour nous son Église, qui sommes sa bien-aimée. « Il m'a fait entrer dans la maison du vin ; et la bannière qu'il déploie sur moi, c'est l'amour » (\vref{Ca. 2:4}). Le vin dont il est question c'est le Saint-Esprit que le Seigneur déverse sur nous jour après jour et qui nous désaltère spirituellement. « Moïse bâtit un autel, et lui donna pour nom : Yahweh ma bannière » (\vref{Ex. 17:15}). Autrefois, lors des combats, les différentes armées portaient bien haut leur bannière en tête des troupes pour témoigner de leur appartenance et pour indiquer pour quel pays elles combattaient. En portant en nous Jésus, nous proclamons notre appartenance à Dieu et à son Royaume. Le \vref{Ps. 20:6} dit ceci : « Nous nous réjouirons de ton salut, nous lèverons la bannière au nom de notre Dieu ; Yahweh exaucera tous tes vœux ». Et dans le \vref{Ps. 60:6} il est dit : « Tu as donné à ceux qui te craignent une bannière pour qu'elle s'élève à cause de la vérité ». La vérité se trouve en Jésus-Christ qui est le chemin, la vérité et la vie (\vref{Jn. 14:6}). En élevant Jésus comme notre bannière, nous proclamons l'œuvre parfaite accomplie à la croix. Jésus, notre bannière, est le point de rassemblement des chrétiens de tous horizons. Ce rassemblement forme le corps de Christ, l'Eglise dont nous sommes les membres. Tout comme les douze tribus d'Israël se réunissaient pour combattre, nous nous réunissons tous sous la même bannière. Jésus, notre bannière, est le signe de la victoire contre les puissances des ténèbres. En élevant le nom de Jésus comme une bannière, nous faisons fuir toute l'armée de Satan. Dans \vref{Jn. 12:32} le Seigneur nous dit : « Et moi, quand j'aurai été élevé de la terre, j'attirerai tous les hommes à moi ». Jésus a été élevé comme étant la bannière qui a réconcilié Dieu avec les pécheurs. Lorsque cette bannière est élevée, les pécheurs sont attirés vers Dieu, ils passent des ténèbres à la lumière, de la mort à la vie.} pour les peuples, et son séjour ne sera que gloire.
...
\VS{3}Et vous puiserez de l'eau avec joie aux sources du salut\FTNT{\vref{Jn. 4:10-14}.},
...
\VS{9}Voici, le jour de Yahweh arrive, jour cruel, jour de colère et d'ardente fureur\FTNT{\vref{Mal. 4:1} ; \vref{Ap. 19:15}}, qui réduira le pays en désolation, et en exterminera les pécheurs.
\VS{10}Même les étoiles des cieux et leurs astres ne feront plus briller leur lumière ; le soleil s'obscurcira dès son lever, et la lune ne fera plus resplendir sa lueur\FTNT{\vref{Joë. 2:31} ; \vref{Mt. 24:29} ; \vref{Mc. 13:24}.}.
...
\VS{13}C'est pourquoi j'ébranlerai les cieux, et la terre sera secouée de sa base\FTNT{\vref{Ag. 2:6}}, à cause de la fureur de Yahweh des armées, et à cause du jour de son ardente colère.
...
\VS{16}Et leurs petits enfants seront écrasés sous leurs yeux\FTNT{\vref{Na. 3:10}.}, leurs maisons seront pillées, et leurs femmes violées.
...
\VS{15}Et cependant tu as été précipité dans le scheol, dans les profondeurs de la fosse\FTNT{Voir commentaire \vref{Ge. 1:1-2}.}.
...
\VS{22}Je m'élèverai contre eux, dit Yahweh des armées, et je retrancherai à Babylone le nom et le reste qu'elle a, ses descendants et sa postérité\FTNT{\vref{Ap. 14:8} ; \vref{Ap. 18:2}.}, dit Yahweh.
...
\VS{27}Car Yahweh des armées l'a arrêté en son conseil : Qui l'empêchera ? Sa main est étendue : Qui la détournera\FTNT{\vref{Ec. 7:13}.} ?
...
\VS{3}On sera couvert de sacs dans les rues ; chacun hurle, fondant en larmes sur ses toits et dans ses places\FTNT{\vref{Jé. 48:38}.}.
...
\VS{5}Et le trône s'affermira par la clémence ; et sur ce trône sera assis en vérité, dans le tabernacle de David, un juge recherchant le droit, et se hâtant de faire justice\FTNT{\vref{Mi. 4:7} ; \vref{Da. 7:14} ; \vref{Lu. 1:33} ; \vref{Ap. 11:15}}.
...
\VS{10}Et la joie et l'allégresse se sont retirées du champ fertile ; on ne se réjouit plus et on ne s'égaye plus dans les vignes, le vendangeur ne foule plus dans les cuves, j'ai fait cesser la chanson de la vendange\FTNT{\vref{Jé. 48:31-34}.}.
...
\VerseOne{}Prophétie sur Damas. Voici, Damas est détruite pour ne plus être une ville, et elle ne sera qu'un monceau de ruines\FTNT{\vref{Jé. 49:23-27}.}.
...
\VS{5}Il en sera comme quand le moissonneur cueille les blés, et qu'il moissonne les épis avec son bras\FTNT{\vref{Joë. 3:13} ; \vref{Mt. 13:24-30}.} ; comme quand on ramasse les épis dans la vallée de Rephaïm.
...
\VS{8}Et il ne regardera plus vers les autels, qui sont l'ouvrage de ses mains, et il ne regardera plus ce que ses doigts ont fabriqué, ni les images d'Asherah\FTNT{Voir commentaire en \vref{Ex. 34:13}.}, ni les statues du soleil.
...
\VS{10}Parce que tu as oublié le Dieu de ton salut, et que tu ne t'es pas souvenue du rocher\FTNT{Voir commentaire \vref{Es. 8:13-14}.} de ta force, à cause de cela tu as transplanté des plantes de plaisance, et tu as planté des ceps étrangers.
...
\VerseOne{}Prophétie sur l'Egypte. Voici, Yahweh est monté sur une nuée rapide, il entre en Egypte ; et les idoles d'Egypte s'enfuient de toutes parts devant sa face, et le cœur des Egyptiens se fond au milieu d'elle\FTNT{\vref{Jé. 43:12}.}.
...
\VS{5}Les eaux de la mer tariront, le fleuve séchera et tarira\FTNT{\vref{Jé. 51:36}.}.
...
\VS{14}Yahweh a versé au milieu d'elle un esprit de vertige\FTNT{\vref{1 R. 22:18-22}.}, pour qu'ils fassent chanceler les Egyptiens dans toutes leurs actions, comme un homme ivre se vautre dans son vomissement.
...
\VS{20}Et ce sera un signe et un témoignage pour Yahweh des armées dans le pays d'Egypte ; car ils crieront à Yahweh à cause des oppresseurs, il leur enverra un sauveur, quelqu'un de grand, et il les délivrera\FTNT{\vref{Es. 43:11}.}.
...
\VS{4}de même le roi d'Assyrie emmènera de l'Egypte et de l'Ethiopie prisonniers et captifs les jeunes et les vieux, nus et déchaussés, ayant les hanches découvertes, ce qui sera l'opprobre de l'Egypte\FTNT{\vref{2 S. 10:4} ; \vref{Es. 3:17} ; \vref{Jé. 13:22-26}.}.
...
\VS{6}Car ainsi m'a parlé le Seigneur : Va, place la sentinelle, et qu'elle rapporte ce qu'elle verra\FTNT{\vref{Ez. 33:1-19}.}.
...
\VS{9}et voici venir le char d'un homme et un couple de cavaliers ! Alors elle parla et dit : Elle est tombée, elle est tombée, Babylone\FTNT{Prophétie sur la chute de Babylone. Voir \vref{Jé. 50-51} ; \vref{Ap. 18}.}, et toutes les images taillées de ses dieux sont brisées par terre.
...
\VS{5}Car c'est le jour de trouble, d'oppression et de confusion\FTNT{\vref{La. 1:5} ; \vref{La. 2:2}.}, envoyé par le Seigneur, Yahweh des armées, dans la vallée des visions. Il démolit la muraille et les cris retentissent jusqu'à la montagne.
...
\VS{12}Le Seigneur, Yahweh des armées, vous appelle ce jour-là aux pleurs et au deuil, à vous raser la tête, et à ceindre le sac\FTNT{\vref{Ez. 7:18} ; \vref{Joë. 1:13}}.
\VS{13}Et voici il y a de la joie et de l'allégresse ! On égorge des bœufs et l'on tue des moutons, on mange la viande et l'on boit du vin ; puis on dit : Mangeons et buvons, car demain nous mourrons\FTNT{\vref{Es. 56:12} ; \vref{1 Co. 15:32}.} !
...
\VS{22}Et je mettrai la clef de la maison de David sur son épaule ; et il ouvrira, et il n'y aura personne qui ferme ; et il fermera, et il n'y aura personne qui ouvre\FTNT{La clé de David est le symbole de l'autorité du Messie (\vref{Es. 9:5} ; \vref{Mt. 28:18} ; \vref{Ap. 3:7-8})}.
...
\VS{3}A travers les grandes eaux, les grains de Shichor, la moisson du Nil était pour elle son revenu ; elle était le marché des nations\FTNT{\vref{Ez. 27}.}.
...
\VS{8}Qui a pris ce conseil contre Tyr, celle qui couronnait les siens, dont les marchands étaient des princes, et dont les trafiquants étaient les plus honorables de la terre\FTNT{\vref{Ap. 18:9-18}.} ?
...
\VS{13}Voilà le pays des Chaldéens ; ce peuple-là n'était pas autrefois ; Assur\FTNT{Assur : Le second fils de Sem (\vref{Ge. 10:22}). L'ancêtre des Assyriens.} l'a fondé pour les gens du désert ; on a dressé ses forteresses, on a élevé ses palais, et il l'a mis en ruines.
\VS{14}Hurlez, navires de Tarsis ! Car votre force est détruite !
\VS{15}Et il arrivera en ce jour-là que Tyr tombera dans l'oubli durant soixante-dix ans, selon les jours d'un roi. Mais au bout de soixante-dix ans\FTNT{\vref{Jé. 25:11-12}.}, on chantera une chanson à Tyr comme à une femme prostituée :
...
\VerseOne{}Voici, Yahweh s'en va rendre le pays vide et l'épuiser, il en renverse le dessus, et disperse ses habitants\FTNT{\vref{Ge. 11:1-8}.}.
...
\VS{5}Le pays était profané par ses habitants qui marchent sur lui ; car ils ont transgressé les lois, ils ont changé les ordonnances et ont enfreint l'alliance éternelle\FTNT{\vref{Da. 7:25}.}.
...
\VS{23}La lune rougira et le soleil sera honteux quand Yahweh des armées régnera sur la montagne de Sion et à Jérusalem, resplendissant de gloire en présence de ses anciens\FTNT{\vref{Mt. 24:29-30} ; \vref{2 Pi. 3:10-12} ; \vref{Ap. 6:12}.}.
\Chap{25}
...
\VS{6}Et Yahweh des armées prépare à tous les peuples sur cette montagne un banquet de choses grasses, un banquet de vins vieux, un banquet, dis-je, de choses grasses et mœlleuses, et de vins vieux bien purifiés\FTNT{\vref{Mt. 22:2} ; \vref{Ap. 3:20}.}.
...
\VS{8}Il détruit la mort par sa victoire\FTNT{\vref{1 Co. 15:54}.} ; et le Seigneur Yahweh essuie les larmes de tous les visages\FTNT{\vref{Ap. 7:17}.}, et il ôte l'opprobre de son peuple de toute la terre\FTNT{\vref{Lu. 1:25}.}, car Yahweh a parlé.
...
\VerseOne{}En ce jour-là, ce cantique sera chanté dans le pays de Juda : Nous avons une ville forte ; le salut\FTNT{Le mot salut vient du mot « Yeshuw'ah ». Cette même racine a donné le prénom Jésus qui signifie Yahweh sauve. Jésus est notre muraille et notre rempart. Dans \vref{Ex. 15:2}, Moïse identifie Yahweh à « Yeshuw'ah » c'est-à-dire à Jésus. Dans \vref{1 Ch. 16:23}, il est dit que « Yeshuw'ah » doit être annoncé tous les jours. Dans \vref{Ps. 62:2}, il est présenté comme Dieu et le Rocher. Dans \vref{Es. 12:2}, il est le Dieu qui sauve. Jacob et David avaient mis en lui leur espoir (\vref{Ge. 49:18} ; \vref{Ps. 119:166}). Dans \vref{Es. 49:6}, il est dit que le salut (« Yeshuw'ah » ou Jésus) doit être annoncé aux extrémités de la terre, et cela est répété et confirmé en \vref{Mt. 28:18-20}. \vref{Es. 56:1} nous apprend que celui qui vient s'appelle « Yeshuw'ah ». \vref{Es. 59:17} le présente comme notre casque, ce qui fait écho au casque du salut en \vref{Ep. 6:17}. Les murs de la Nouvelle Jérusalem portent son Nom (\vref{Es. 60:18}). \vref{Ha. 3:8} nous dit que « Yeshuw'ah » montera sur ses chevaux, corroborant le récit de son retour en gloire dans \vref{Ap. 19:11-20}. « Yeshuw'ah » est notre flambeau selon \vref{Es. 62:1} et \vref{Ap. 21:23}.} y sera mis pour muraille et pour rempart.
\VS{2}Ouvrez les portes, et la nation juste, celle qui garde la fidélité, y entrera.
\VS{3}Tu gardes dans la paix, dans la paix\FTNT{Voir commentaire en Gn. \vref{2:16-17}.}, celui dont les desseins s'appuient sur toi, parce qu'il se confie en toi\FTNT{\vref{Es. 57:19} ; \vref{Ph. 4:6-7}.}.
\VS{4}Confiez-vous en Yahweh à perpétuité, car le Rocher \FTNT{Voir commentaire en \vref{Es. 8:13-14}.} des siècles est en Yahweh Dieu.
...
\VS{14}Ils sont morts, ils ne revivront plus, ils sont trépassés, ils ne se relèveront pas ; car tu les as châtiés et exterminés, et tu as fait périr toute mémoire d'eux\FTNT{\vref{Ec. 9:5}.}.
...
\VS{19}Tes morts vivront ! Même mon corps mort vivra ! Ils se relèveront. Réveillez-vous et réjouissez-vous avec des chants de triomphe, vous, habitants de la poussière ; car ta rosée est comme la rosée des herbes, et la terre jettera dehors les morts\FTNT{\vref{Os. 13:14} ; \vref{Da. 12:2} ; \vref{1 Co. 15:52}.}.
\VS{20}Va, mon peuple, entre dans tes cabinets et ferme ta porte derrière toi\FTNT{\vref{Mt. 6:6}.} ; cache-toi pour un petit moment, jusqu'à ce que l'indignation soit passée.
...
\VerseOne{}En ce jour-là, Yahweh frappera de sa dure, grande et forte épée le Léviathan\FTNT{\vref{Ps. 104:26} ; \vref{Job 40:20}}, le serpent fuyard, le Léviathan, dis-je, le serpent tortueux, et il tuera le monstre qui est dans la mer.
\VS{2}En ce jour-là, chantez sur la vigne désirable\FTNT{Esaïe annonce ici le rétablissement d'Israël. Voir également \vref{Ro. 11:1-24}.}.
...
\VS{11}Quand son branchage est sec, il est brisé ; et les femmes y venant en allument un feu. Car c'est un peuple sans intelligence\FTNT{\vref{De. 32:28} ; \vref{Es. 1:3}.}, c'est pourquoi celui qui l'a fait n'a point eu pitié de lui, et celui qui l'a formé ne lui a point fait grâce.
...
\VS{10}Car il faut leur donner précepte après précepte, précepte après précepte, règle après règle, règle après règle, un peu ici, un peu là\FTNT{\vref{Hé. 5:12}.}.
...
\VS{16}C'est pourquoi ainsi parle le Seigneur Yahweh : Voici, je mettrai pour fondement en Sion une pierre\FTNT{Voir commentaire en \vref{Es. 8:13-16}.}, une pierre éprouvée, la pierre angulaire la plus précieuse, pour être un fondement solide ; celui qui croira ne se hâtera point.
...
\VS{6}Elle sera visitée par Yahweh des armées avec des tonnerres, des tremblements de terre, et un grand bruit\FTNT{\vref{Za. 14:13-14} ; \vref{Ap. 16:18-19}.} ; avec la tempête, le tourbillon, et avec la flamme d'un feu dévorant.
...
\VS{10}Car Yahweh a répandu sur vous un esprit d'un profond sommeil\FTNT{\vref{Ro. 11:8}.} ; il a fermé vos yeux, il a bandé ceux de vos prophètes et de vos principaux voyants.
...
\VS{13}C'est pourquoi le Seigneur dit : Parce que ce peuple s'approche de moi de sa bouche et qu'il m'honore de ses lèvres, mais que son cœur est éloigné de moi ; et parce que la crainte qu'il a de moi lui a été enseigné par un commandement d'hommes\FTNT{\vref{Mt. 15:8-9} ; \vref{Mc. 7:6-7}.}.
...
\VS{15}Malheur à ceux qui cachent profondément leurs desseins, pour les dissimuler à Yahweh, et dont les œuvres sont dans les ténèbres, et qui disent : Qui nous voit, et qui nous connaît\FTNT{\vref{Es. 47:10} ; \vref{Ez. 8:12} ; \vref{Ps. 10:11} ; \vref{Ps. 94:7}.} ?
\VS{16}Ce que vous renversez ne sera-t-il pas réputé comme l'argile d'un potier ? Même l'ouvrage dira-t-il de celui qui l'a fait : Il ne m'a point fait ? Et la chose formée dira-t-elle de celui qui l'a formée : Il n'a point d'intelligence\FTNT{\vref{Ps. 100:3}.} ?
...
\VS{18}En ce jour-là, les sourds entendront les paroles du livre, et les yeux des aveugles, étant délivrés de l'obscurité et des ténèbres, verront\FTNT{\vref{Mt. 11:5} ; \vref{Lu. 7:22}.}.
\VS{19}Les humbles auront joie sur joie en Yahweh, et les pauvres d'entre les hommes se réjouiront dans le Saint d'Israël\FTNT{\vref{Mt. 5:3-11}.}.
\VS{20}Car l'oppresseur prendra fin, le moqueur sera consumé, et tous ceux qui veillaient pour commettre l'iniquité seront retranchés\FTNT{\vref{Ap. 20:10}.},
...
\VS{2}Qui sans avoir interrogé ma bouche, marchent pour descendre en Egypte, afin de se fortifier de la force de Pharaon et se retirer sous l'ombre de l'Egypte\FTNT{\vref{Jé. 42:19}}.
...
\VS{9}que c'est ici un peuple rebelle, des enfants menteurs, des enfants qui ne veulent point écouter la loi de Yahweh\FTNT{\vref{No. 20:3-5} ; \vref{De. 9:7} ; \vref{Ac. 7:51}.} ;
\VS{10}qui disent aux voyants : Ne voyez pas ! Et aux prophètes : Ne nous prophétisez pas des choses droites, mais dites-nous des choses agréables, voyez des choses trompeuses\FTNT{\vref{2 Ti. 4:3-4} ; \vref{Mi. 2:6}.} !
\VS{11}Retirez-vous du chemin, détournez-vous du sentier, éloignez de notre présence le Saint d'Israël\FTNT{\vref{Jn. 14:6}.}.
...
\VS{23}Alors il donnera la pluie sur la semence que tu auras semées en terre, et le grain du revenu de la terre sera abondant et bien nourri ; en ce jour-là, ton bétail paîtra dans un pâturage spacieux\FTNT{\vref{Jn. 14:6}.}.
...
\VS{5}Comme les oiseaux volent, ainsi Yahweh des armées défendra Jérusalem, la défendant et la délivrant, passant outre et la sauvant\FTNT{\vref{De. 32:11} ; \vref{Ps. 91:4} ; \vref{Mt. 23:37}.}.
...
\VS{6}Car l'homme vil dira des choses viles, et son cœur ne machine qu'iniquité, pour exécuter son hypocrisie et pour proférer des faussetés contre Yahweh, pour rendre vide l'âme de celui qui a faim, et faire tarir la boisson de celui qui a soif\FTNT{\vref{Jn. 10:10}.}.
\VS{7}Les instruments de l'avare sont pernicieux ; il prend des conseils pleins de machinations, pour attraper par des paroles de mensonge les affligés, même quand la cause du pauvre est juste\FTNT{\vref{2 Pi. 2:3}.}.
...
\VS{15}jusqu'à ce que l'Esprit soit répandu d'en haut sur nous\FTNT{\vref{Joë. 2:28} ; \vref{Za. 12:10} ; \vref{Ac. 2:17-18}.}, et que le désert devienne un Carmel et que Carmel soit considéré comme une forêt.
...
\VS{5}Yahweh est élevé, car il habite dans les lieux élevés ; il remplit Sion de jugement et de justice\FTNT{\vref{Ps. 97:9}.}.
...
\VS{14}Les pécheurs sont effrayés dans Sion, et le tremblement saisit les hypocrites, tellement qu'ils disent : Qui de nous pourra séjourner avec le feu dévorant\FTNT{\vref{Hé. 12:29}.} ? Qui de nous pourra séjourner avec les flammes éternelles ?
...
\VS{16}Celui-là habitera dans des lieux élevés, des forteresses assises sur des rochers seront sa haute retraite ; son pain lui sera donné, et ses eaux ne lui manqueront point\FTNT{\vref{Jn. 4:14} ; \vref{Jn. 6:33-35} ; \vref{Ap. 21:6}.}.
...
\VS{20}Regarde Sion, la ville de nos fêtes solennelles ! Que tes yeux voient Jérusalem, séjour tranquille, tabernacle qui ne sera pas transportée, et dont les pieux ne seront jamais ôtés, et dont les cordages ne seront point rompus\FTNT{\vref{Ap. 21:2}.}.
...
\Chap{34}
\TextTitle{Le jugement des nations\FTNTT{\vref{Ap. 19:17-21}.}}
...
\VS{4}Et toute l'armée des cieux se fond ; les cieux sont roulés comme un livre\FTNT{\vref{Ap. 6:14}.}, et toute leur armée tombe, comme tombe la feuille de la vigne, et comme tombe celle du figuier\FTNT{\vref{Mt. 24:28} ; \vref{Mc. 13:25}.}.
...
\VS{8}Car c'est un jour de vengeance pour Yahweh, une année de rétribution pour maintenir la cause de Sion\FTNT{\vref{Jé. 46:10} ; \vref{Joë. 2:2} ; \vref{So. 1:15}.}.
...
\VS{8}Il y aura là un sentier et un chemin, qu'on appellera le chemin de sainteté ; celui qui est souillé n'y passera point, mais il sera pour ceux-là ; celui qui va son chemin, et les insensés ne s'y égareront point\FTNT{\vref{Mt. 7:13-14} ; \vref{Jn. 14:6}.}.
...
\VS{10}Ceux dont Yahweh a payé la rançon\FTNT{Jésus-Christ est Yahweh qui a payé notre rançon (\vref{Mc. 10:45}).}, retourneront, et viendront en Sion avec chant de triomphe, et une joie éternelle sera sur leur tête ; ils obtiendront la joie et l'allégresse ; la douleur et le gémissement s'enfuiront.
\Chap{36}
\TextTitle{Invasion de Sanchérib, menaces de Rabschaké\FTNTT{\vref{2 R. 18:9-37} ; \vref{2 Ch. 32:1-19}.}}
\VerseOne{}La quatorzième année du roi Ezéchias, Sanchérib, roi d'Assyrie, monta contre toutes les villes fortes de Juda et les prit\FTNT{\vref{2 R. 18:17}.}.
...
\Chap{37}
\TextTitle{Ezéchias recherche Yahweh auprès d'Esaïe\FTNTT{\vref{2 R. 19:1-7} ; \vref{2 Ch. 32:20}.}}
\VerseOne{}Et il arriva qu'aussitôt que le roi Ezéchias eut entendu ces choses, il déchira ses vêtements, se couvrit d'un sac, et entra dans la maison de Yahweh\FTNT{\vref{2 R. 19:1-7} ; \vref{2 Ch. 32:20}.}.
...
\TextTitle{Provocation et menace de Sanchérib\FTNTT{\vref{2 R. 19:8-13} ; \vref{2 Ch. 32:17-19}.}}
...
\TextTitle{Prière d'Ezéchias à Yahweh\FTNTT{\vref{2 R. 19:14-19} ; \vref{2 Ch. 32:20}.}}
...
\TextTitle{Esaïe transmet la réponse de Yahweh\FTNTT{\vref{2 R. 19:20-34}.}}
...
\VS{28}Mais je sais quand tu t'assieds, quand tu sors et quand tu entres, et comment tu es furieux contre moi\FTNT{\vref{Ps. 139:2}.}.
...
\TextTitle{Yahweh frappe Sanchérib\FTNTT{\vref{2 R. 19:35-37} ; \vref{2 Ch. 32:21}.}}
\VS{36}L'ange de Yahweh\FTNT{\vref{Ge. 16:7}.} sortit et frappa cent quatre-vingt-cinq mille hommes dans le camp des Assyriens. Et quand on se leva le matin, voici, ils étaient tous morts.
...
\Chap{38}
\TextTitle{Maladie et guérison d'Ezéchias\FTNTT{\vref{2 R. 20:1-11} ; \vref{2 Ch. 32:24-30}.}}
\VerseOne{}En ces jours-là, Ezéchias fut malade à la mort\FTNT{\vref{2 R. 20:1-11} ; \vref{2 Ch. 32:24-30}.}. Et Esaïe le prophète, fils d'Amots, vint auprès de lui, et lui dit : Ainsi parle Yahweh : Donne tes ordres à ta maison, car tu vas mourir et tu ne vivras plus.
...
\VS{18}Car le scheol ne te loue point, la mort ne te célèbre point ; ceux qui sont descendus dans la fosse ne s'attendent plus à ta vérité\FTNT{\vref{Ps. 115:17}.}.
\VS{19}Mais le vivant, le vivant est celui qui te célèbre, comme moi aujourd'hui ; le père conduira ses enfants à la connaissance de ta vérité\FTNT{\vref{Pr. 22:6} ; \vref{Ep. 6:4}.}.
...
\Chap{39}
\TextTitle{Ezéchias montre toutes ses richesses aux Babyloniens\FTNTT{\vref{2 R. 20:12-19}}}
\VerseOne{}En ce temps-là\FTNT{\vref{2 R. 20:12-19}.}, Mérodac-Baladan, fils de Baladan, roi de Babylone, envoya des lettres avec un présent à Ezéchias, parce qu'il avait entendu qu'il avait été malade, et qu'il était guéri.
...
\VS{6}Voici, les jours viennent où l'on emportera à Babylone tout ce qui est dans ta maison, et ce que tes pères ont amassé dans leurs trésors jusqu'à aujourd'hui ; il n'en restera rien, dit Yahweh\FTNT{\vref{2 R. 24:13} ; \vref{2 R. 25:13-15} ; \vref{Jé. 20:5}.}.
\VS{7}Même on prendra de tes fils qui sortiront de toi, et que tu auras engendrés afin qu'ils soient eunuques dans le palais du roi de Babylone\FTNT{\vref{Da. 1:3-4}.}.
...
\TextTitle{Mission de Jean-Baptiste\FTNTT{\vref{Mt. 3:3}.}}
\VS{3}La voix de celui qui crie au désert\FTNT{L'accomplissement de cette prophétie se trouve en \vref{Mt. 3:3}, où il nous est dit que la voix qui devait crier ces choses était celle de Jean-Baptiste (voir aussi \vref{Mal. 3:1} ; \vref{Mal. 4:5-6} ; \vref{Mt. 17:10-13}).} est : Préparez le chemin de Yahweh\FTNT{Les évangiles nous enseignent que Jean-Baptiste a été envoyé pour préparer le chemin du Seigneur Jésus (\vref{Jn. 1:19-27} ; \vref{Jn. 1:29-34} ; \vref{Jn. 3:28-31}).}, aplanissez parmi les lieux arides un chemin pour notre Dieu.
...
\VS{6}La voix dit : Crie ! Et on a répondu : Que crierai-je ? Toute chair est comme l'herbe, et toute sa grâce est comme la fleur d'un champ\FTNT{\vref{Ja. 1:10} ; \vref{1 Pi. 1:24-25}.}.
...
\VS{10}Voici, le Seigneur Yahweh\FTNT{Jésus-Christ est Yahweh qui vient (\vref{Es. 35:4} ; \vref{Es. 40:10-11} ; \vref{Es. 60:1} ; \vref{Es. 62:11-12} ; \vref{Es. 66:15-16} ; \vref{Za. 14:1-7} ; \vref{Mt. 24} ; \vref{Jn. 14:1-3} ; \vref{Ac. 1:10-12} ; \vref{Ap. 3:11} ; \vref{Ap. 19:11-12} ; \vref{Ap. 22:7} ; \vref{Ap. 22:12} ; \vref{Ap. 22:20}).} viendra contre le fort, et son bras dominera sur lui ; voici son salaire est avec lui, et ses rétributions sont devant lui.
\VS{11}Il paîtra son troupeau comme un berger, il rassemblera les agneaux dans ses bras, il les placera dans son sein ; il conduira celles qui allaitent\FTNT{\vref{Jn. 10}.}.
...
\VS{13}Qui a dirigé l'Esprit de Yahweh, ou qui a été son conseiller pour l'enseigner\FTNT{\vref{1 Co. 2:16} ; \vref{Ro. 11:34}.} ?
...
\VS{20}Celui qui est si pauvre qu'il n'a pas de quoi faire une offrande, choisit un bois qui ne pourrisse point ; il se cherche un habile ouvrier pour faire une image taillée qui ne bouge pas\FTNT{\vref{Es. 44:9-20}.}.
...
\VS{4}Qui est celui qui a opéré et fait ces choses ? C'est celui qui a appelé les âges dès le commencement. Moi, Yahweh, JE SUIS le premier, et JE SUIS avec les derniers\FTNT{\vref{Ap. 1:8} ; \vref{Ap. 21:6} ; \vref{Ap. 22:13}.}.
...
\VS{9}Car je t'ai pris aux extrémités de la terre, je t'ai appelé en te préférant aux plus excellents qui sont en elle, et je t'ai dit : C'est toi qui est mon serviteur, je t'ai élu, et je ne te rejette point\FTNT{\vref{De. 7:6} ; \vref{Ps. 77:8}.}.
...
\VS{16}Tu les vanneras, et le vent les emportera, et le tourbillon les dispersera. Mais toi, tu te réjouiras en Yahweh, tu te glorifieras au Saint d'Israël.
\VS{17}Quant aux affligés et aux misérables qui cherchent des eaux, et n'en ont point ; dont la langue est tellement altérée qu'elle n'en peut plus ; moi, Yahweh, je les exaucerai ; moi, le Dieu d'Israël, je ne les abandonnerai pas\FTNT{\vref{Ge. 28:15} ; \vref{Jos. 1:5} ; \vref{Hé. 13:5}.}.
...
\VS{27}Le premier sera pour Sion, disant : Voici, les voici ! Et je donnerai quelqu'un à Jérusalem qui annoncera de bonnes nouvelles\FTNT{\vref{Es. 52:7} ; \vref{Ap. 14:6}.}.
...
\VerseOne{}Voici mon serviteur, que je soutiens, c'est mon élu, en qui mon âme prend son bon plaisir ; j'ai mis mon Esprit sur lui, il manifestera le jugement aux nations\FTNT{\vref{Mt. 3:17} ; \vref{Mt. 17:5} ; \vref{Mc. 9:7}.}.
\VS{2}Il ne criera point, et il ne haussera, ni ne fera entendre sa voix dans les rues.
\VS{3}Il ne brisera point le roseau cassé, et il n'éteindra point le lumignon qui fume\FTNT{\vref{Mt. 12:18-20}.} ; il mettra en avant le jugement en vérité.
...
\VS{6}Moi Yahweh, je t'ai appelé en justice, et je prendrai ta main et te garderai, et je te ferai être l'alliance du peuple et la lumière des nations\FTNT{Voir commentaire en \vref{Ge. 1:3-5}.},
...
\VS{8}Je suis Yahweh, c'est là mon Nom ; et je ne donnerai pas ma gloire à un autre, ni ma louange aux images taillées\FTNT{\vref{Es. 48:11}.}.
...
\VS{24}Qui est-ce qui a livré Jacob au pillage, et Israël aux pillards\FTNT{\vref{Jg. 2:13-16}.} ? N'est-ce pas Yahweh, contre lequel nous avons péché ? Car on n'a point voulu marcher dans ses voies et on n'a point obéi à sa loi.
...
\VS{7}savoir tous ceux qui s'appellent de mon Nom\FTNT{Dans les Ecritures, le Nom de Dieu le plus cité est YHWH. Jésus, dont le nom signifie « YHWH est salut » correspond au nom et à l'identité que Dieu a révélé à tous ceux qui l'ont rencontré quand il était sur cette terre. Dans sa dernière prière à Gethsémané, Jésus dit : « J'ai fait connaître ton Nom » (\vref{Jn. 17:6}), et « Je leur ai fait connaître ton Nom » (\vref{Jn. 17:26}). Ce nom n'est autre que le sien puisque Jésus (YHWH est salut) était et est le Nom de Dieu. Moïse n'avait pas reçu la révélation de ce Nom (\vref{Ex. 3:13-14}) car cette révélation était réservée à l'Eglise. En tant qu'épouse de Christ, l'Eglise porte le Nom du Seigneur et bénéficie de l'autorité qu'il confère. Ainsi, Jésus est le seul Nom par lequel nous pouvons être sauvés (\vref{Ac. 4:12}). C'est aussi en son Nom que nous devons être baptisés (\vref{Ac. 8:16} ; \vref{Ac. 19:5}), que nous recevons l'exaucement de nos prières (\vref{Jn. 14:13-14} ; \vref{Jn. 16:24}), que nous sommes délivrés de l'ennemi et que nous obtenons la victoire sur le camp de l'ennemi (\vref{Mc. 16:17} ; \vref{Ph. 2:9-11}).} ; car je les ai créés pour ma gloire ; je les ai formés et les ai faits.
...
\VS{10}Vous êtes mes témoins\FTNT{\vref{Ac. 1:8}.}, dit Yahweh, et mon serviteur que j'ai élu, afin que vous connaissiez, que vous me croyiez et que vous compreniez que JE SUIS. Avant moi il n'a pas été formé de Dieu, et il n'y en aura point après moi.
\VS{11}Moi, JE SUIS Yahweh, et à part moi il n'y a point de Sauveur\FTNT{Yahweh dit qu'à part lui, il n'y a pas d'autres sauveurs. Or les écrits de la nouvelle alliance affirment que Jésus-Christ est le seul Sauveur (\vref{Lu. 1:67-80} ; \vref{Ac. 4:11-12}).}.
...
\VS{14}Ainsi parle Yahweh, votre Rédempteur\FTNT{\vref{Es. 60:16} ; \vref{1 Co. 1:30} ; \vref{Ro. 3:24} ; \vref{Ep. 1:7}.}, le Saint d'Israël : J'envoie pour l'amour de vous contre Babylone, et je les fais descendre tous fugitifs, et le cri des Chaldéens sera dans les navires.
...
\VS{19}Voici, je m'en vais faire une chose nouvelle\FTNT{\vref{2 Co. 5:17}.}, qui paraîtra bientôt, ne la connaîtrez-vous pas ? Je mettrai un chemin dans le désert, et des fleuves dans le lieu de désolation.
...
\VS{8}Ne soyez point effrayés et ne soyez point troublés ; ne te l'ai-je pas fait entendre et déclarer dès ce temps-là ? Vous êtes mes témoins ; y a-t-il un autre Dieu que moi ? Certes il n'y a pas d'autre Rocher\FTNT{Yahweh dit qu'il ne connaît pas d'autre rocher. Jésus-Christ est ce rocher qui suivait les Hébreux dans le désert (\vref{Mt. 16:18} ; \vref{1 Co. 10:1-4}. Voir aussi commentaire en \vref{Es. 8:14}).}, je n'en connais pas.
...
\VS{19}Nul ne rentre en lui-même\FTNT{\vref{So. 2:1} ; \vref{2 Co. 13:5}.}, et il n'a ni la connaissance ni l'intelligence pour dire : J'en ai brûlé une partie au feu, et même j'ai cuit du pain sur les charbons, j'ai rôti de la viande et je l'ai mangée ; et avec le reste ferais-je une abomination ? Adorerais-je une branche de bois ?
...
\VerseOne{}Ainsi parle Yahweh à son oint, à Cyrus\FTNT{Cyrus le Grand (580 av. J.-C. - 530 av. J.-C.). Voir \vref{Esd. 1}.},
...
\VS{9}Malheur à celui qui conteste avec celui qui l'a façonné ! Vase parmi des vases de terre ! L'argile dit-elle à celui qui la façonne : Que fais-tu ? Et l'œuvre dit-elle à l'ouvrier : Tu n'as point de mains\FTNT{\vref{Jé. 18:6} ; \vref{Ro. 9:21}.} ?
...
\VS{13}C'est moi qui ai suscité Cyrus dans ma justice, et j'aplanirai toutes ses voies ; il rebâtira ma ville, et libérera mes captifs\FTNT{Cyrus le grand libéra les Juifs après 70 ans de captivité (\vref{Esd. 1}).}, sans rançon ni présents, dit Yahweh des armées.
...
\VS{18}Car ainsi parle Yahweh qui a créé les cieux, Dieu lui-même qui a formé la terre, qui l'a faite et qui l'a affermie ; qui l'a créée pour qu'elle ne soit pas informe\FTNT{Informe : de l'hébreu « tohuw » qui signifie « informe, confusion, solitude, désert, néant ». On retrouve ce mot dès \vref{Ge. 1:2}.}, qui l'a formée pour qu'elle soit habitée ; je suis Yahweh, et il n'y en a point d'autre.
...
\VS{23}Je le jure par moi-même, la parole sort en justice de ma bouche, et elle ne sera point révoquée : Tout genou fléchira devant moi, et toute langue jurera par moi\FTNT{\vref{Ph. 2:9-11}.}.
...
\VS{9}Mais ces deux choses t'arriveront en un moment, en un même jour, la privation d'enfants et le veuvage ; elles viendront sur toi dans leur perfection, pour le grand nombre de tes sortilèges, et pour la grande abondance de tes enchantements\FTNT{\vref{Ap. 18:7-8}.}.
...
\VerseOne{}Ecoutez ceci, maison de Jacob, qui êtes appelés du nom d'Israël, et qui êtes sortis des eaux de Juda ; qui jurez par le nom de Yahweh, et qui faites mention du Dieu d'Israël, mais non pas conformément à la vérité et à la justice\FTNT{\vref{Jé. 5:2}.}.
\VS{2}Car ils prennent leur nom de la sainte cité, et ils s'appuient sur le Dieu d'Israël, dont le nom est Yahweh des armées\FTNT{\vref{Ex. 20:7}.}.
...
\VS{18}Ô ! Si tu étais attentif à mes commandements, ta paix serait comme un fleuve, et ta justice comme les flots de la mer\FTNT{\vref{Jos. 1:8} ; \vref{Ps. 1:2} ; \vref{Jn. 14:21} ; \vref{Ja. 1:22}.},
\VS{19}ta postérité serait comme le sable, et ceux qui sortent de tes entrailles comme les grains de sable\FTNT{\vref{Ge. 15:5} ; \vref{Ge. 22:17} ; \vref{Ge. 32:12}.} ; son nom ne serait point retranché ni effacé de devant ma face.
...
\VerseOne{}Iles, écoutez-moi ! Soyez attentifs, vous peuples éloignés ! Yahweh m'a appelé dès le ventre, il a fait mention de mon nom dès les entrailles de ma mère\FTNT{\vref{Jé. 1:5} ; \vref{Ps. 139:16}.}.
...
\VS{10}Ils n'auront pas faim et ils n'auront pas soif ; la chaleur et le soleil ne les frapperont plus, car celui qui a pitié d'eux sera leur guide, et les conduira vers des sources d'eaux\FTNT{\vref{Ps. 121:6} ; \vref{Lu. 1:67-79}.}.
...
\VS{23}Et les rois seront tes nourriciers et leurs princesses, leurs femmes, tes nourrices ; ils se prosterneront devant toi le visage contre terre, et ils lécheront la poussière de tes pieds ; et tu sauras que je suis Yahweh, et que ceux qui se confient en moi ne seront point confus\FTNT{\vref{Ps. 22:5-6} ; \vref{Ps. 69:7} ; \vref{Ro. 9:33} ; \vref{1 Pi. 2:6}.}.
...
\VerseOne{}Ainsi parle Yahweh : Où est la lettre de divorce par laquelle j'ai répudié votre mère\FTNT{\vref{De. 24:1} ; \vref{Jé. 3:8} ; \vref{Mt. 5:31}.} ? Ou bien, auquel de mes créanciers vous ai-je vendus ? Voici, vous avez été vendus à cause de vos iniquités, et votre mère a été répudiée à cause de vos transgressions.
\VS{2}Je suis venu : Pourquoi ne s'est-il trouvé personne ? J'ai appelé : Pourquoi personne n'a-t-il répondu ? Ma main est-elle trop courte pour racheter\FTNT{\vref{No. 11:23} ; \vref{Es. 59:1}.} ? Ou n'y a-t-il plus de force en moi pour délivrer ? Voici, par ma menace, je dessèche la mer, je réduis les fleuves en désert ; leurs poissons se corrompent faute d'eau, et ils meurent de soif.
\VS{3}Je revêts les cieux de noirceur, et je fais d'un sac leur couverture.
\VS{4}Le Seigneur Yahweh m'a donné la langue des savants, pour que je sache soutenir par la parole celui qui est accablé de maux\FTNT{\vref{Job 6:14} ; \vref{1 Th. 5:14}.} ; chaque matin il me réveille soigneusement afin que je prête l'oreille aux discours des sages.
\VS{5}Le Seigneur Yahweh m'a ouvert l'oreille et je n'ai pas été rebelle, et je ne me suis pas retiré en arrière.
\VS{6}J'ai exposé mon dos à ceux qui me frappaient et mes joues à ceux qui me tiraient le poil ; je n'ai pas caché mon visage aux opprobres et aux crachats\FTNT{\vref{Mt. 5:39} ; \vref{Mt. 26:67} ; \vref{Lu. 6:29} ; \vref{Lu. 18:32}.}.
\VS{7}Mais le Seigneur, Yahweh m'a aidé, c'est pourquoi je n'ai point été confus, et ainsi j'ai rendu mon visage semblable à un caillou\FTNT{\vref{Ez. 3:8-9}.}, car je sais que je ne serais point rendu honteux.
...
\VS{2}Regardez à Abraham, votre père, et à Sara qui vous a enfantés ; car lui seul je l'ai appelé, je l'ai béni et multiplié\FTNT{\vref{Ro. 4:1-16} ; \vref{Hé. 11:8-12}.}.
...
\VS{8}Car la teigne les rongera comme un vêtement\FTNT{\vref{Mt. 6:19} ; \vref{Lu. 12:33} ; \vref{Ja. 5:2}.}, et la gerce les dévorera comme de la laine ; mais ma justice demeurera toujours, et mon salut d'âge en âge.
...
\VS{17}Réveille-toi, réveille-toi ! Lève-toi, Jérusalem, qui as bu de la main de Yahweh la coupe de sa fureur ; tu as bu, tu as sucé la lie de la coupe d'étourdissement\FTNT{\vref{Ps. 60:5} ; \vref{Ap. 14:10}.} !
...
\VS{7}Combien sont beaux sur les montagnes les pieds de celui qui apporte de bonnes nouvelles, qui publie la paix\FTNT{\vref{Na. 2:1} ; \vref{Ro. 10:15}.}, qui apporte de bonnes nouvelles concernant le bien, qui publie le salut, qui dit à Sion : Ton Dieu règne !
...
\VS{10}Yahweh manifeste le bras de sa sainteté aux yeux de toutes les nations\FTNT{\vref{Es. 53:1}.}, et toutes les extrémités de la terre verront le salut\FTNT{Toutes les extrémités de la terre verront le salut de Yahweh, c'est-à-dire Jésus (\vref{Mt. 28:18-20}).} de notre Dieu.
\VS{11}Retirez-vous, retirez-vous, sortez de là ! Ne touchez rien d'impur ! Sortez du milieu d'elle\FTNT{\vref{Jé. 51:45} ; \vref{2 Co. 6:17} ; \vref{Ap. 18:4}.} ! Nettoyez-vous, vous qui portez les vases de Yahweh.
...
\VerseOne{}Qui a cru à notre prédication ? Et à qui le bras de Yahweh\FTNT{Jésus-Christ homme est le bras de Yahweh. Le bras de Yahweh est le symbole de la puissance divine. Cette puissance s'est manifestée dans l'œuvre du Messie accomplissant le salut du monde. Le prophète est transporté au moment où le peuple juif, après avoir rejeté son Messie, ouvrira enfin les yeux et acceptera celui qu'il a percé (\vref{Za. 12:10} ; \vref{Ap. 1:7}). Voir aussi \vref{Jé. 27:4-5} ; \vref{Jé. 32:17}.} a-t-il été révélé ?
...
\VS{3}Il était le méprisé et le rejeté des hommes\FTNT{\vref{Ps. 22:6-7} ; \vref{Mt. 27:27-31} ; \vref{Mc. 9:12} ; \vref{Jn. 16:32}.}, homme de douleur, et sachant ce que c'est que la maladie ; et nous avons comme caché notre visage arrière de lui, tant il était méprisé ; et nous ne l'avons pas estimé.
\VS{4}En vérité, il a porté nos maladies, et il s'est chargé de nos douleurs\FTNT{\vref{Mt. 8:17} ; \vref{1 Pi. 2:24}.} ; et nous l'avons considéré comme frappé, battu par Dieu et humilié.
...
\VS{6}Nous avons tous été errants\FTNT{Pierre, apôtre de l'Agneau, confirme que le Messie est bel et bien le Bon Berger (\vref{1 Pi. 2:25}).} comme des brebis, nous nous sommes détournés, chacun suivait son propre chemin, et Yahweh a fait venir sur lui l'iniquité de nous tous.
\VS{7}Opprimé et humilié, il n'a point ouvert sa bouche\FTNT{\vref{Mt. 26:62-63} ; \vref{Mc. 15:3-5} ; \vref{Jn. 19:9} ; \vref{Ac. 8:32-33}.}, semblable à un agneau qu'on mène à la boucherie, à une brebis muette devant celui qui la tond, et il n'a point ouvert sa bouche.
...
\VS{9}On a mis son sépulcre parmi les méchants, et dans sa mort, il a été avec le riche, quoiqu'il n'ait point commis de violence, et qu'il n'y ait point eu de fraude dans sa bouche\FTNT{\vref{Mc. 15:28} ; \vref{Lu. 23:32-33}.}.
\VS{10}Toutefois il a plu à Yahweh de le briser ; il l'a mis dans la souffrance. Après avoir mis son âme en sacrifice pour le péché, il verra une postérité et prolongera ses jours ; et le bon plaisir de Yahweh prospérera en sa main\FTNT{\vref{Jé. 23:5}.}.
...
\VS{9}Car il en sera pour moi comme les eaux de Noé : De même que j'avais juré que les eaux de Noé ne se répandraient plus sur la terre\FTNT{\vref{Ge. 9:11} ; \vref{Ge. 8:21}.} ; je jure de ne plus m'irriter contre toi, et de ne plus te menacer.
...
\VS{15}Voici, on ne manquera pas de comploter contre toi, cela ne viendra pas de moi ; quiconque complotera contre toi tombera pour l'amour de toi\FTNT{\vref{Ps. 91:7} ; \vref{Ge. 37}.}.
...
\VS{17}Aucune arme forgée contre toi ne réussira, et toute langue qui se lèvera en jugement contre toi, tu la condamneras\FTNT{\vref{Ps. 23:4}.}. Tel est l'héritage des serviteurs de Yahweh, et telle est la justice qui leur viendra de moi, dit Yahweh.
\Chap{55}
...
\VS{2}Pourquoi dépensez-vous de l'argent pour ce qui ne nourrit pas ? Pourquoi travaillez-vous pour ce qui ne rassasie pas\FTNT{\vref{Ro. 14:17}.} ? Ecoutez-moi attentivement, et vous mangerez de ce qui est bon, et votre âme se délectera de la graisse.
\VS{3}Inclinez l'oreille, et venez à moi\FTNT{\vref{Mt. 11:28}.}, écoutez, et votre âme vivra ; et je traiterai avec vous une alliance éternelle, les miséricordes immuables promises à David.
...
\VS{7}Que le méchant abandonne sa voie, et l'homme injuste ses pensées ; et qu'il retourne à Yahweh, qui aura pitié de lui, et à notre Dieu qui pardonne abondamment\FTNT{\vref{Jé. 18:11} ; \vref{Ez. 33:11} ; \vref{Jon. 3:10} ; \vref{1 Ti. 2:1-4} ; \vref{2 Pi. 3:9}.}.
...
\VS{5}je leur donnerai dans ma maison et dans mes murailles une place et un nom meilleur que le nom de fils ou de filles ; je leur donnerai à chacun un nom éternel qui ne périra jamais\FTNT{\vref{Ap. 2:17}.}.
\VS{6}Et les enfants des étrangers qui se joindront à Yahweh pour le servir, pour aimer le Nom de Yahweh, pour être ses serviteurs, savoir tous ceux qui garderont le sabbat pour ne pas le profaner et qui tiendront dans mon alliance\FTNT{\vref{Ex. 31:14}.},
\VS{7}je les amènerai sur ma montagne sainte, et je les réjouirai dans ma maison de prière ; leurs holocaustes et leurs sacrifices seront agréés sur mon autel, car ma maison sera appelée une maison de prière\FTNT{\vref{Mt. 21:13} ; \vref{Mc. 11:17} ; \vref{Lu. 19:46}.} pour tous les peuples.
...
\VS{11}Ce sont des chiens voraces et insatiables ; ce sont des pasteurs qui ne savent rien comprendre ; tous suivent leur propre voie, chacun à son gain injuste dans son quartier, en disant\FTNT{\vref{Mt. 23:24} ; \vref{Tit. 1:7-11} ; \vref{1 Pi. 5:2}.} :
...
\VerseOne{}Le juste périt, et nul ne le prend à cœur ; et les gens de bien sont recueillis, sans qu'on y soit attentif, sans qu'on considère que le juste a été recueilli devant le mal\FTNT{\vref{Mi. 7:2} ; \vref{Ec. 7:15}.}.
\VS{2}Il entrera en paix, il reposera sur sa couche, celui qui aura marché dans la droiture\FTNT{\vref{Mt. 25:23} ; \vref{Lu. 19:17}.}.
...
\VS{5}S'échauffant près des faux dieux, sous tout arbre vert ; égorgeant les enfants dans les vallées, sous les fentes des rochers\FTNT{\vref{Lé. 18:21} ; \vref{1 R. 14:23} ; \vref{Jé. 2:20} ; \vref{Jé. 32:35}.}.
...
\VS{13}Quand tu crieras, que ceux que tu assembles te délivrent ! Mais le vent les emmènera tous, la vanité les enlèvera ; mais celui qui met sa confiance en moi, héritera la terre et possédera ma montagne sainte\FTNT{\vref{Es. 2:3} ; \vref{Ps. 2:6} ; \vref{Hé. 12:22}.}.
...
\VS{15}Car ainsi parle celui qui est haut et élevé, qui habite dans l'éternité et dont le nom est le Saint : J'habiterai dans les lieux hauts et saints, avec celui qui a le cœur brisé et qui est humble d'esprit, afin de vivifier l'esprit des humbles, et afin de vivifier ceux qui ont le cœur brisé\FTNT{\vref{Ps. 34:19} ; \vref{Ps. 51:19}.}.
\VS{16}Parce que je ne veux pas contester à toujours, et que je ne serai pas irrité à jamais ; car devant moi tombent en défaillance les esprits, et les âmes que j'ai faites\FTNT{\vref{Mi. 7:18} ; \vref{Ps. 85:6} ; \vref{Ps. 103:9}.}.
...
\VS{11}Et Yahweh te conduira continuellement, il rassasiera ton âme dans les grandes sécheresses, il fortifiera tes os, et tu seras comme un jardin arrosé, et comme une source dont les eaux ne tarissent pas\FTNT{\vref{Jn. 4:14} ; \vref{Ap. 21:6}.}.
...
\VS{2}Mais ce sont vos iniquités qui mettent une séparation entre vous et votre Dieu ; ce sont vos péchés qui vous cachent sa face, afin qu'il ne vous entende point\FTNT{\vref{De. 31:17-18} ; \vref{Ez. 39:23-24}.}.
...
\VS{8}Ils ne connaissent point le chemin de la paix, et il n'y a point de jugement dans leurs voies, ils se sont pervertis dans leurs sentiers, tous ceux qui y marchent ignorent la paix\FTNT{\vref{Pr. 1:16} ; \vref{Pr. 6:16-19}.}.
...
\VS{16}Il voit aussi qu'il n'y a aucun homme, il s'étonne que personne ne se tienne à la brèche ; c'est pourquoi son bras lui vient en aide, et sa propre justice lui sert d'appui\FTNT{\vref{Es. 53:1} ; \vref{Es. 63:5} ; \vref{Ps. 77:15-16} ; \vref{Ac. 13:17}.}.
\VS{17}Car il se revêt de la justice comme d'une cuirasse, et le casque du salut est sur sa tête\FTNT{\vref{Ep. 6:14-17}.} ; il se revêt de la vengeance comme d'un vêtement, et se couvre de la jalousie comme d'un manteau.
\VS{18}Selon leurs actes, il rendra à chacun la pareille\FTNT{\vref{Jé. 17:10} ; \vref{Job 34:11} ; \vref{Mt. 16:27} ; \vref{Ap. 2:23} ; \vref{Ap. 20:13}.}, la fureur à ses adversaires, la rétribution à ses ennemis ; il rendra ainsi la rétribution aux îles.
\VS{19}Et on craindra le Nom de Yahweh depuis l'occident, et sa gloire depuis le soleil levant ; car l'ennemi viendra comme un fleuve, mais l'Esprit de Yahweh lèvera la bannière\FTNT{En hébreu « Yahweh Nissi », c'est-à-dire « Yahweh est ma bannière ». C'est le nom donné par Moïse à l'autel qu'il construisit pour célébrer la défaite d'Amalek (\vref{Ex. 17:15}). En \vref{No. 21:8-9}, Moïse éleva une bannière sur laquelle il avait fixé un serpent d'airain pour la guérison des malades.} contre lui.
\VS{20}Et le Rédempteur\FTNT{Le Rédempteur qui viendra pour Sion est le Seigneur Jésus-Christ (\vref{Ro. 11:26}). Voir aussi \vref{Es. 60:16}.} viendra en Sion, et vers ceux de Jacob qui se convertiront de leur péché, dit Yahweh.
...
\VS{3}Des nations marchent à ta lumière, et des rois à la splendeur qui se lève sur toi\FTNT{\vref{Ap. 21:24}.}.
...
\VS{11}Tes portes seront continuellement ouvertes, elles ne seront fermées ni nuit ni jour, afin que les forces des nations te soient amenées et que leur roi y soient conduits\FTNT{\vref{Ap. 21:25-26}.}.
...
\VS{16}Et tu suceras le lait des nations, et tu suceras la mamelle des rois, et tu sauras que je suis Yahweh, ton Sauveur, ton Rédempteur\FTNT{Le verbe « ga'al » et le nom correspondant « go'el », ont été traduits respectivement en français par « racheter » et « rédempteur ». Selon la loi de Moïse, si quelqu'un perdait son héritage à cause d'une dette ou s'il se vendait comme esclave, lui et ses biens pouvaient être rachetés par un proche parent qui devait payer le prix de la rédemption (\vref{Lé. 25:23-55}). Yahweh se présente comme le Rédempteur par excellence (\vref{Es. 49:26} ; \vref{Es. 60:16} ; \vref{Ps. 78:35} ; \vref{Ps. 130:7} ; \vref{Job 19:25}). Or Jésus-Christ « […] a été fait pour nous sagesse, justice, sanctification et rédemption » (\vref{1 Co. 1:30}). Les épîtres nous révèlent la rédemption qu'il a acquise pour nous : « nous avons la rédemption par son sang » (\vref{Ep. 1:7}). La rédemption est le paiement d'une rançon, or il est écrit : « Jésus-Christ s'est donné en rançon pour nous tous » (\vref{1 Ti. 2:6}). « Vous avez été rachetés à grand prix » (\vref{1 Co. 6:20}).}, le Puissant de Jacob.
...
\VS{19}Tu n'auras plus le soleil pour la lumière du jour, et la lueur de la lune ne t'éclairera plus, mais Yahweh sera pour toi la lumière éternelle\FTNT{Voir le commentaire en \vref{Ge. 1:3}.}, et ton Dieu sera ta gloire.
...
\VS{21}Quant à ton peuple, ils seront tous justes, ils posséderont la terre à toujours ; savoir le germe de mes plantes, l'œuvre de mes mains pour y être glorifié\FTNT{\vref{Es. 11:1} ; \vref{Ro. 15:12} ; \vref{Ap. 5:5} ; \vref{Ap. 22:16}.}.
...
\VS{2}pour publier une année de grâce de Yahweh, et le jour de vengeance de notre Dieu ; pour consoler tous ceux qui mènent deuil\FTNT{\vref{Lu. 4:14-19}.} ;
\VS{3}pour annoncer à ceux de Sion qui mènent deuil, que la magnificence leur sera donnée au lieu de la cendre, une huile de joie au lieu du deuil, un manteau de louange au lieu d'un esprit abattu\FTNT{Job. \vref{29:14} ; \vref{Ja. 1:12} ; 1 Co.\vref{9:25} ; \vref{2 Ti. 4:8}.}, afin qu'on les appelle des térébinthes de la justice, une plantation de Yahweh, pour servir à sa gloire.
...
\VS{6}Mais vous, vous serez appelés prêtres de Yahweh, et on vous nommera serviteurs de notre Dieu\FTNT{\vref{Ap. 1:6} ; \vref{Ap. 5:10}.} ; vous mangerez les richesses des nations, et vous vous glorifierez de leur gloire.
...
\VS{10}Je me réjouirai extrêmement en Yahweh, et mon âme se réjouira en mon Dieu ; car il m'a revêtu des vêtements du salut, il m'a couvert du manteau de la justice, comme un époux qui se pare de magnificence, et comme une épouse qui s'orne de ses joyaux\FTNT{\vref{Os. 2:21-22} ; \vref{Ap. 19:7-8}.}.
...
\VS{2}Alors les nations verront ta justice, et tous les rois ta gloire ; et on t'appellera d'un nouveau nom\FTNT{\vref{Ap. 2:17}.}, que la bouche de Yahweh aura expressément déclaré.
...
\VS{11}Voici ce que Yahweh proclame aux extrémités de la terre : Dites à la fille de Sion : Voici, ton Sauveur vient\FTNT{De nombreux passages, notamment dans le livre d'Esaïe, présentent Dieu comme le sauveur, le seul sauveur (\vref{Es. 43:3} ; \vref{Es. 43:11} ; \vref{Os. 13:4}) qui viendra pour délivrer son peuple (\vref{Es. 35:4} ; \vref{Es. 60:1} ; \vref{Za. 14:1-7}). Jésus-Christ a accompli en tous points les prophéties relatives à la venue de Yahweh. Dieu est bel et bien venu sur terre il y a plus de 2000 ans et ce même Dieu revient bientôt (\vref{Ac. 1:11} ; \vref{Ap. 1:7}).} ; voici, son salaire est avec lui, et sa récompense marche devant lui.
\VS{12}Et on les appellera le peuple saint, les rachetés de Yahweh\FTNT{\vref{1 Pi. 2:9} ; \vref{Ap. 5:9}.} ; et toi, on t'appellera la recherchée, la ville non abandonnée.
\Chap{63}
\TextTitle{Le jour de vengeance du Messie\FTNTT{\vref{Es. 2:10-22} ; \vref{Ap. 19:11-21}.}}
...
\VS{9}Et dans toutes leurs détresses, il a été en détresse, et l'ange qui est devant sa face les a délivrés\FTNT{\vref{Ge. 16:7-10} ; \vref{Jg. 6:11-14} ; \vref{Za. 1:11}.} ; lui-même les a rachetés dans son amour et sa miséricorde, et il les a soutenus et portés, tous les jours d'autrefois.
\VS{10}Mais ils ont été rebelles, et ils ont attristé son Esprit saint\FTNT{\vref{Ep. 4:30}.}, c'est pourquoi il est devenu leur ennemi, et il a lui-même combattu contre eux.
...
\VS{3}Jamais on n'a appris ni entendu dire, et jamais l'œil n'a vu qu'un autre dieu que toi fît de telles choses pour ceux qui s'attendent à lui\FTNT{\vref{1 Co. 2:9}.}.
...
\VS{5}Or nous sommes tous devenus comme une chose souillée, et toute notre justice est comme le linge le plus souillé\FTNT{\vref{Ap. 19:8}.} ; nous sommes tous flétris comme la feuille, et nos iniquités nous emportent comme le vent.
...
\VS{7}Cependant, ô Yahweh, tu es notre Père ; nous sommes l'argile, et c'est toi qui nous as formés, et nous sommes tous l'ouvrage de ta main\FTNT{\vref{Es. 29:16} ; \vref{Es. 45:9} ; \vref{Jé. 18:6} ; \vref{Ro. 9:20-21}.}.
...
\VerseOne{}Je me suis fait recherché de ceux qui ne me demandaient point, et je me suis laissé trouver par ceux qui ne me cherchaient pas\FTNT{\vref{Mt. 7:7} ; \vref{Lu. 11:9}.} ; j'ai dit à la nation qui ne s'appelait pas de mon Nom : Me voici, me voici !
...
\VS{17}Car voici, je vais créer de nouveaux cieux et une nouvelle terre\FTNT{\vref{Es. 66:22} ; \vref{2 Pi. 3:13} ; \vref{Ap. 21:1}.} ; et on ne se souviendra plus des choses précédentes, elles ne reviendront plus au cœur.
...
\VS{25}Le loup et l'agneau paîtront ensemble, le lion comme le bœuf mangeront de la paille, et la poussière sera la nourriture du serpent\FTNT{\vref{Es. 2:4} ; \vref{Es. 11:6-7}.}. On ne nuira point et on ne fera aucun dommage sur toute ma montagne sainte, dit Yahweh.
\Chap{66}
\TextTitle{Yahweh réprouve l'hypocrisie et agrée ceux qui le craignent}
\VerseOne{}Ainsi parle Yahweh : Le ciel est mon trône, et la terre est le marchepied de mes pieds\FTNT{\vref{Mt. 5:34-35} ; \vref{Ac. 7:49}.}. Quelle maison me bâtiriez-vous, et quel serait le lieu de mon repos ?
...
\VS{24}Et quand ils sortiront dehors, ils verront les cadavres des hommes qui se sont rebellés contre moi ; car leur ver ne mourra point, et leur feu ne s'éteindra point\FTNT{\vref{Mc. 9:48}.} ; et ils seront méprisés de tout le monde.
\PPE{}
\end{multicols}
