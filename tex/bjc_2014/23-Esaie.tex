...
\VS{10}Même les étoiles des cieux et leurs astres ne feront plus briller leur lumière~; le soleil s'obscurcira dès son lever, et la lune ne fera plus resplendir sa lueur\FTNT{\vref{Joë. 2:31}~; Mt. 24:29~; Mc. 13:24.}.
...
\VS{5}Il en sera comme quand le moissonneur cueille les blés, et qu'il moissonne les épis avec son bras\FTNT{\vref{Joë. 3:13}~; Mt. 13:24-30.}~; comme quand on ramasse les épis dans la vallée de Rephaïm.
...
\VS{12}Le Seigneur, Yahweh des armées, vous appelle ce jour-là aux pleurs et au deuil, à vous raser la tête, et à ceindre le sac\FTNT{Ez. 7:18~; \vref{Joë. 1:13}}.
...
\VS{15}jusqu'à ce que l'Esprit soit répandu d'en haut sur nous\FTNT{\vref{Joë. 2:28}~; Za. 12:10~; Ac. 2:17-18.}, et que le désert devienne un Carmel et que Carmel soit considéré comme une forêt.
...
\VS{8}Car c'est un jour de vengeance pour Yahweh, une année de rétribution pour maintenir la cause de Sion\FTNT{Jé. 46:10~; \vref{Joë. 2:2}~; So. 1:15.}.
