...
\VerseOne{}Oracle sur Tyr. Hurlez, navires de Tarsis ! Car elle est détruite, il n'y a plus de maisons, on n'y entre plus ! Ceci leur a été découvert du pays de Kittim.
...
\VS{11}Et il étend ses mains, comme le nageur les étend pour nager ; et Yahweh abat son orgueil, ainsi que l'artifice de ses mains.
...
\VS{6}Les bêtes sont chargées pour aller au midi, ils portent leurs richesses sur les dos des ânons, et leurs trésors sur la bosse des chameaux, vers le peuple qui ne leur profitera point dans le pays de détresse et d'angoisse, d'où viennent le vieux lion et la lion, la vipère et le dragon volant ; .
...
\VS{14}Il la brise donc comme on brise un vase de terre cassé, que l'on n'épargne point, et des pièces de laquelle ne trouve pas un morceau pour prendre du feu au foyer, ou pour puiser de l'eau à la fosse.
...
\VS{6}Car le chiche ne prononce que chicheté, et son cœur ne machine qu'iniquité, pour exécuter son hypocrisie et pour proférer des faussetés contre Yahweh, pour rendre vide l'âme de celui qui a faim, et faire tarir la boisson de celui qui a soif\FTNT{Jn. 10:10.}.
...
\VS{14}Les bêtes sauvages des déserts rencontreront les bêtes sauvages des îles ; et les boucs s'y appelleront les uns les autres ; là, la Lilith\FTNT{Lilith est le nom d'une déesse de la nuit connue pour être un démon nocturne qui hantait les lieux déserts d'Edom.} aura sa demeure et trouvera son lieu de repos ;
...
\VS{7}Voici, je vais mettre en lui un esprit tel que, sur une rumeur qu'il recevra, il retournera dans son pays, et je le ferai tomber par l'épée dans son pays.
...
\VS{11}Voila, tu as appris ce que les rois d'Assyrie ont fait à tous les pays, en les détruisant entièrement ; et toi, tu échapperais ?
...
\VS{14}Ezéchias reçut les lettres de la main des messagers et les lut. Et il monta à la maison de Yahweh, et Ezéchias les déploya devant Yahweh.
...
\VS{24}Tu as outragé le Seigneur par le moyen de tes serviteurs, et tu as dit : Je suis monté avec la multitude de mes chariots sur le haut des montagnes, aux côtés du Liban, je couperai les plus hauts cèdres et les plus beaux cyprès qui y soient, et j'entrerai jusqu'en son plus haut bout, et en la forêt de son Carmel.
...
\VS{26}N'as-tu pas appris que déjà dès longtemps j'ai préparé cette ville, et que dès les temps anciens je l'ai ainsi formée ? Et maintenant l'aurais-je conservée pour être réduite en désolation, et les villes fortes en monceaux de ruines ?
...
\VS{14}Ainsi parle Yahweh, votre Rédempteur\FTNT{Es. 60:16 ; 1 Co. 1:30 ; Ro. 3:24 ; Ep. 1:7.}, le Saint d'Israël : Par amour pour vous, j'envoie l'ennemi contre Babylone, et je fais descendre tous les fugitifs, et le cri des Chaldéens sera sur les navires.
