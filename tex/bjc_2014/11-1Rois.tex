...
\VS{19}Il a fait tuer des bœufs, des veaux gras et des brebis en grand nombre, il a convié tous les fils du roi, avec Abiathar le prêtre et Joab chef de l'armée, mais il n'a point convié ton serviteur Salomon.
...
\VerseOne{}Ce fut la quatre cent quatre-vingtième année après la sortie des enfants d'Israël du pays d'Egypte que Salomon bâtit la maison de Yahweh\FTNT{Voir les annexes «~Le temple de Salomon~».}, la quatrième année du règne de Salomon sur Israël, au mois de Ziv, qui est le second mois.
...
\VS{4}Ils transportèrent l'arche de Yahweh, la tente d'assignation, et tous les ustensiles qui étaient dans le tabernacle~; les prêtres et les Lévites les emportèrent.
...
\VS{10}Au moment où les prêtres sortirent du lieu saint, la nuée remplit la maison de Yahweh.
\VS{11}Les prêtres ne purent pas y rester pour faire le service, à cause de la nuée~; car la gloire de Yahweh remplissait la maison de Yahweh.
...
\VS{19}Fais maintenant se rassembler tout Israël auprès de moi, sur le mont Carmel, les quatre cent cinquante prophètes de Baal et les quatre cents prophètes d'Asherah qui mangent à la table de Jézabel.
...
\VS{12}Lorsque Ben-Hadad entendit cette réponse, il buvait sous les tentes avec les rois  et il dit à ses serviteurs~: Rangez-vous en bataille~! Et ils se rangèrent en bataille contre la ville.
