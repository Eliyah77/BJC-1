...
\VS{7}ainsi que vous en avez été instruits aussi par Epaphras, notre cher compagnon de service, qui est pour vous un fidèle ministre de Christ,
...
\VS{21}Et vous, qui étiez autrefois éloignés de lui, et qui étiez ses ennemis dans votre entendement, et dans les mauvaises œuvres, mais il vous a maintenant réconciliés 
\VS{22}par sa mort dans le corps de sa chair, pour vous présenter saints, et sans tache, et irrépréhensibles devant lui,
