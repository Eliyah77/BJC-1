...
\VS{6}qui est parvenu jusqu'à vous, comme il l'est aussi dans le monde entier. Il porte des fruits, comme aussi parmi vous, depuis le jour où vous avez entendu et connu la grâce de Dieu dans la vérité,
...
\VS{8}et qui nous a fait connaître votre charité selon par le Saint-Esprit.
...
\VS{11}étant fortifiés en toute force selon la puissance de sa gloire en toute patience, et tranquillité d’esprit, avec joie.
...
\VS{18}Et c'est lui qui est le Chef du corps de l'Eglise ; il est le commencement et le premier-né d'entre les morts, afin qu'il tienne le premier rang en toutes choses.
...
\VS{21}Et vous qui étiez autrefois éloignés de lui, et qui étiez ses ennemis dans votre entendement, et dans les mauvaises œuvres, il vous a maintenant réconciliés 
\VS{22}par sa mort dans le corps de sa chair, pour vous présenter saints, sans tache, et irrépréhensibles devant lui.
...
\TextTitle{L’église : un mystère manifesté aux saints\FTNTT{Ep. 3:1-11}}
...
\VS{25}C’est d’elle que j'ai été fait le ministre, selon la dispensation de Dieu qui m'a été donnée envers vous, pour accomplir la parole de Dieu,
...
\VS{29}A quoi aussi je travaille, en combattant selon son efficacité\FTNTT{le terme "efficacité" vient du grec "energeia" qui signifie "action", "fonctionnement", compétence", ou encore force à l'oeuvre dans". Ce mot est utilisé seulement pour parler du pouvoir surhumain que ce soit de Dieu ou du diable. (Ep. 1:19 ; Ph. 3:21 ; 2 Ti. 2:9)}, qui agit puissamment en moi.
\Chap{2}
...
\TextTitle{Mise en garde contre les discours séduisants\FTNTT{1 Co. 2:4 ; Ro. 16:17-18; 2 Pi. 2:3}}
...
\TextTitle{Les œuvres de la loi accomplies en Christ\FTNTT{Mt. 5:17 ; Jn. 19:30}}
...
\VS{22}Lesquels sont toutes périssables par l'usage, et établies suivant les commandements et les doctrines des hommes.
...
\TextTitle{La vie chrétienne en pratique}
...
\VS{16}Et quand cette lettre aura été lue entre vous, faites en sorte qu'elle soit aussi lue dans l'église des Laodiciens, et que vous lisiez aussi celle qui viendra de Laodicée.
