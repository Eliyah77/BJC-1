...
\TextTitle{Prière de Paul : La croissance spirituelle des Colossiens}
...
\VS{15}Lequel est l'image de Dieu invisible, le premier-né\FTNT{Dans les Ecritures, l'expression « premier-né » est appliquée au Seigneur pour exprimer trois réalités. Tout d'abord, on parle de Jésus en tant que premier-né de Marie, c'est-à-dire son fils aîné (\vref{Lu. 2:6-7}). Ensuite, on trouve cette expression au sens figuré, pour marquer une distinction (par exemple concernant Israël ; \vref{Ex. 4:2}) ou désigner la particularité et la suprématie d'une personne. Ainsi, bien que David était le dernier-né de son père Isaï (\vref{Ps. 89:28}), Dieu en fit un premier-né, « le plus élevé des rois de la terre » (\vref{Ps. 89:28}). Il en va de même pour Jésus-Christ. Il n'est pas le premier-né de la création dans le sens de rang de naissance ou de création, autrement l'apôtre Paul aurait employé le terme grec « prôtoktisis » qui signifie « premier-créé », au lieu de « prôtotokos », c'est-à-dire « premier-né ». Il faut donc voir dans cette expression un titre de supériorité et d'hiérarchie, pour marquer sa prééminence. En effet, la Parole de Dieu déclare clairement que le Seigneur Jésus-Christ est l'Alpha et le Commencement de toutes choses (\vref{Ap. 1:8} ; \vref{Ap. 21:6} ; \vref{Ap. 22:13}), le Créateur suprême (\vref{Ge. 1:1} ; \vref{Ge. 2:7} ; \vref{Es. 45:11-18} ; \vref{Ps. 104:30} ; Job. \vref{33:4} ; \vref{Jn. 1:3} ; \vref{1 Co. 8:6} ; \vref{Col. 1:12-16} ; \vref{Ap. 22:3} ; \vref{Ap. 14:6}). D'ailleurs il l'a lui-même affirmé sans ambigüité : « Avant qu'Abraham fût, Je suis » (\vref{Jn. 8:58}). Enfin, Jésus-Christ est aussi appelé le premier-né d'entre les morts (\vref{Col. 1:18}). Cela ne signifie pas qu'il a été le premier à ressusciter, car il y a eu plusieurs résurrections avant la sienne, mais il fut le premier à ressusciter avec un corps glorieux. Sa résurrection est donc le gage de la promesse de la résurrection de tous ceux qui ont foi en lui (\vref{Jn. 3:16}).} de toute la création.
...
\TextTitle{La réconciliation avec Dieu par la mort du Christ}
...
\TextTitle{L'Eglise : Un mystère manifesté aux saints\FTNTT{\vref{Ep. 3:1-11}.}}
...
\VS{29}A quoi aussi je travaille, en combattant selon son efficacité\FTNTT{le terme « efficacité » vient du grec « energeia » qui signifie « action », « fonctionnement », « compétence », ou encore « force à l'œuvre dans ». Ce mot est utilisé seulement pour parler du pouvoir surhumain que ce soit de Dieu ou du diable. (\vref{Ep. 1:19} ; \vref{Ph. 3:21} ; \vref{2 Ti. 2:9})}, qui agit puissamment en moi.
\Chap{2}
\TextTitle{Le combat de Paul pour faire connaître Christ}
...
\TextTitle{Mise en garde contre les discours séduisants\FTNTT{\vref{1 Co. 2:4} ; \vref{Ro. 16:17-18} ; \vref{2 Pi. 2:3}.}}
...
\TextTitle{Danger de la philosophie et du légalisme}
...
\TextTitle{La divinité du Messie ; la véritable circoncision}
...
\TextTitle{Les œuvres de la loi accomplies en Christ\FTNTT{\vref{Mt. 5:17} ; \vref{Jn. 19:30}.}}
...
\TextTitle{Avertissement contre les doctrines de source humaine}
...
\VS{18}Femmes, soyez soumises à vos maris, comme il convient dans le Seigneur\FTNT{\vref{Ep. 5:22}.}.
\VS{19}Maris, aimez vos femmes, et ne vous aigrissez pas contre elles\FTNT{\vref{Ep. 5:25}.}.
\VS{20}Enfants, obéissez à vos pères et à vos mères en toutes choses, car cela est agréable au Seigneur\FTNT{\vref{Ep. 6:1-2}}..
\VS{21}Pères, n'irritez pas vos enfants\FTNT{\vref{Ep. 6:4}.}, afin qu'ils ne se découragent pas.
\TextTitle{Les rapports entre serviteurs et maîtres selon Dieu}
\VS{22}Serviteurs, obéissez en toutes choses à ceux qui sont vos maîtres selon la chair, ne servant point seulement sous leurs yeux, comme voulant complaire aux hommes, mais en simplicité de cœur, craignant Dieu\FTNT{\vref{Ep. 6:5-6}.}.
