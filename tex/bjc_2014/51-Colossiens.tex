...
\VS{18}Il est le Chef corps de l'Eglise ; il est le commencement, le premier-né d'entre les morts, afin qu'il tienne le premier rang en toutes choses.
...
\VS{22}pour vous rendre saints, sans tache, et irrépréhensibles devant lui.
\VS{23}Si toutefois vous demeurez dans la foi, étant fondés et fermes, et n’étant point transportés hors de l’espérance de l’Evangile que vous avez entendu, lequel est prêché à toute créature qui est sous le ciel, dont moi Paul, j’ai été fait ministre.
