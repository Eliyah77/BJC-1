...
\VS{8}C'est pourquoi, voici, je vais fermer son chemin avec des épines, j'y élèverai un mur, afin qu'elle ne trouve plus ses sentiers.
...
\VS{2}Et maintenant ils continuent de pécher et se sont fait avec leur argent des images de fonte, des idoles selon leurs pensées, toutes un travail d'artisans, desquelles ils disent : Que les hommes qui sacrifient baisent\FTNT{C'est une expression d'hommage.} les veaux !
