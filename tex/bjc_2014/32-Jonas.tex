...
\begin{multicols}{2}
\Chap{1}
\TextTitle{[I. Désobéissance et fuite de Jonas : Introduction]}
...
\TextTitle{[II. Jonas et le poisson : Jonas englouti par le poisson]}
...
\Chap{3}
\TextTitle{[III. Le plus grand réveil de l'histoire : Ninive se repent et est épargnée]}
...
\Chap{4}
\TextTitle{[IV. Miséricorde infinie de Dieu : Mécontentement de Jonas]}
