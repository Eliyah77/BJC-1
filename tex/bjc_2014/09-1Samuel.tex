\ShortTitle{1 S.}\BookTitle{1 Samuel}\BFont
\noindent\hrulefill
{\footnotesize
\textit{
\bigskip
...
\VS{3}Or cet homme-là montait tous les ans, de sa ville à Silo\FTNT{\vref{Jos. 18:1}.}, pour adorer Yahweh des armées, et lui offrir des sacrifices. Là étaient les deux fils d'Eli, Hophni et Phinées, prêtres de Yahweh.
...
\VS{16}Ne mets pas ta servante au rang d'une fille de Bélial\FTNT{Voir commentaire en \vref{1 S. 2:12}.}, car c'est l'excès de ma douleur et de mon affliction qui m'a fait parler jusqu'à présent.
...
\VerseOne{}Alors Anne pria, et dit~: Mon cœur se réjouit en Yahweh, ma force\FTNT{Littéralement «~corne~».} a été relevée par Yahweh~; ma bouche s'est ouverte contre mes ennemis, parce que je me suis réjouie de ton salut\FTNT{Le mot «~salut~» vient de l'hébreu «~yeshuw'ah~» c'est-à-dire «~Jésus~». Voir commentaire en \vref{Es. 26:1}.}.
\VS{2}Nul n'est saint comme Yahweh~; car il n'y en a pas d'autre que toi~; et il n'y a pas de rocher\FTNT{Voir commentaire en \vref{Es. 8:13-17}.} tel que notre Dieu.
...
\VS{25}Si un homme a péché contre un autre homme, le Juge\FTNT{Ici, le mot «~juge~» signifie aussi «~Dieu~» («~elohim~» en hébreux). Dieu est le juste juge (\vref{Ec. 3:17}~; \vref{Ac. 10:42}).} interviendra~; mais si quelqu'un pèche contre Yahweh, qui interviendra pour lui~? Mais ils n'obéirent pas à la voix de leur père parce que Yahweh voulait les faire mourir.
...
\VS{35}Et je m'établirai un prêtre fidèle\FTNT{\vref{Hé. 2:17}~; \vref{7:26-28}.}, qui agira selon mon cœur, et selon mon âme~; et je lui édifierai une maison stable\FTNT{La maison stable fait premièrement allusion à Israël (\vref{Mi. 4}) et ensuite à l'Eglise (\vref{Mt. 16:18}). Cette prophétie sera pleinement réalisée lors du millénium (\vref{Za. 14}).}, et il marchera à toujours devant mon Messie.
...
\VS{3}Et avant que les lampes\FTNT{Le chandelier d'or à sept branches du tabernacle et du temple de Jérusalem a été décrit avec une extrême minutie dans plusieurs passages de la Bible. Il a été réalisé selon le modèle imposé par Dieu à Moïse au Sinaï (\vref{Ex. 25:31-40}~; \vref{Ex. 37:17-24}~; \vref{No. 8:4}).} de Dieu soient éteintes, Samuel était aussi couché dans le temple de Yahweh, où était l'arche de Dieu.
...
\VS{8}Malheur à nous~! Qui nous délivrera de la main de ces dieux puissants\FTNT{Le terme hébreu «~elohim~», généralement traduit par «~dieu~» ou «~dieux~», signifie également «~dirigeants~», «~juges~» ou encore «~anges~». Dans les textes bibliques, «~Elohim~» est employé pour désigner Moïse, qui a été fait «~dieu~» («~elohim~») pour Pharaon (\vref{Ex. 7:1}), ainsi que pour les dieux païens Baal, Kemosh et Dagaon (\vref{Jg. 6:31}~; \vref{Jg. 11:24}~; \vref{1 S. 5:7}) Les Philistins avaient une vision polythéiste de la divinité et n'avaient pas la révélation du Dieu des Hébreux qui est Un (\vref{De. 6:4}).}~? C'est le Dieu qui a frappé les Egyptiens de toutes sortes de plaies dans le désert.
...
\VS{8}Puis tu descendras devant moi à Guilgal~; et voici, je descendrai vers toi pour offrir des holocaustes, et des sacrifices d'offrande de paix\FTNT{Voir commentaire en \vref{Lé. 3:1}.}. Tu m'attendras là sept jours, jusqu'à ce que je vienne, et que je te déclare ce que tu devras faire.
...
\VS{27}Mais il y eut des fils de Bélial\FTNT{\vref{1 S. 2:12}.} qui dirent~: Comment celui-ci nous délivrerait-il~? Et ils le méprisèrent, et ne lui apportèrent pas de présent. Mais Saül fit le sourd.
\Chap{11}
...
\VS{19}Pendant que Saül parlait au prêtre, le tumulte venant du camp des Philistins augmentait de plus en plus~; et Saül dit au prêtre~: Retire ta main~!
...
\VS{44}Et Saül dit~: Que Dieu agisse à mon égard comme il le veut, tu mourras, tu mourras\FTNT{Répétition des mots «~tu mourras, tu mourras~», voir commentaire en \vref{Ge. 2:17}.}, Jonathan.
...
\VS{9}Saül et le peuple épargnèrent Agag, les meilleures brebis, les meilleurs bœufs, les bêtes grasses, les agneaux, ce qu'il y avait de meilleur~; ils ne voulurent pas les dévouer par interdit, détruisant seulement tout ce qui est chétif et méprisable.
...
\VS{14}L'Esprit de Yahweh se retira de Saül, et un mauvais esprit\FTNT{Saül a été frappé d'un esprit d'égarement (\vref{2 Th. 2:9-12}). Voir commentaires en \vref{Ge. 6:3} et \vref{Mt. 12:31}.} envoyé par Yahweh le terrifiait.
...
\VS{4}Le prêtre répondit à David, et dit~: Je n'ai pas de pain ordinaire sous la main, mais du pain sacré\FTNT{\vref{Mt. 12:4}.}~; pourvu que tes gens se soient abstenus de femmes~!
...
\VS{6}Alors le prêtre lui donna du pain sacré, car il n'y avait pas là d'autre pain que les pains de proposition qui avaient été ôtés de devant Yahweh, pour le remplacer par du pain chaud le jour où on l'avait pris.
...
\VS{9}Et le prêtre dit~: Voici l'épée de Goliath, le Philistin, que tu as tué dans la vallée du chêne~; elle est enveloppée d'un drap, derrière l'éphod~; si tu veux la prendre pour toi, prends-la, car il n'y en a pas ici d'autre que celle-là. Et David dit~: Il n'y en a pas de pareille~; donne-la-moi.
...
\Chap{22}
\TextTitle{David se réfugie dans la caverne d'Adullam\FTNTT{\vref{1 Ch. 12:16-18}.}}
...
\VS{16}Le roi lui dit~: Tu mourras, tu mourras\FTNT{Le mot est répété deux fois. Voir commentaire en \vref{Ge. 2:16}.}, Achimélec, toi et toute la maison de ton père.
...
\VS{2}Et David consulta Yahweh\FTNT{La clé du succès de David était Yahweh. Il consultait régulièrement Dieu avant de s'engager dans une guerre (\vref{Ps. 60:14}.).} en disant~: Irai-je, et frapperai-je ces Philistins~? Et Yahweh répondit à David~: Va, et tu frapperas les Philistins, et tu délivreras Keïla.
...
\VS{17}Sache maintenant et vois ce que tu as à faire, car le mal est résolu contre notre maître et contre toute sa maison, et il est si méchant\FTNT{Littéralement «~Fils de Bélial~»} qu'on n'ose lui parler.
...
\VS{15}Samuel dit à Saül~: Pourquoi m'as-tu troublé en me faisant monter~? Et Saül répondit~: Je suis dans une grande angoisse~; car les Philistins me font la guerre, et Dieu s'est retiré de moi, et ne m'a plus répondu ni par les prophètes ni par des songes~; c'est pourquoi je t'ai invoqué\FTNT{Dieu interdit formellement ces pratiques (\vref{De. 18:9-14}~; \vref{Es. 8:19}.).}, afin que tu me fasses entendre ce que j'aurai à faire.
...
\Chap{31}
\TextTitle{Les Philistins battent Israël~; Saül et ses fils meurent\FTNTT{\vref{1 Ch. 10:1-14}.}}
