...
\begin{multicols}{2}
\Chap{1}
\TextTitle{[Rappel de l’infidélité d’Israël\FTNT{No. 14}]}
...
\TextTitle{[Loi sur les esclaves\FTNT{Ps. 40:6-8}]}
...
\Chap{19}
\TextTitle{[Les villes de refuge\FTNT{No. 35:1-34}]}
...
\TextTitle{[Le fils indocile sous la loi\FTNT{cp. Lu. 15:11-23}]}
...
\Chap{26}
\TextTitle{[La loi des prémices\FTNT{cp. Ex. 23:16-19}]}
