...
\VS{10}Les champs sont ravagés, la terre est dans le deuil ; parce que le blé est détruit, le moût est tari et l'huile est desséchée.
...
\VS{3}Devant lui est un feu dévorant, et derrière lui une flamme brûle ; devant lui le pays est comme le jardin d'Éden, et après lui, la désolation d'un désert ; et rien ne lui échappe. 
