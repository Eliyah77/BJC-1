...
\TextTitle{La gloire à venir\FTNTT}
\VS{18}Car tout bien compté, j'estime que les souffrances du temps présent ne sont pas comparables à la gloire à venir qui doit être révélée en nous.
\VS{19}En effet, la création attend avec un ardent désir, que les enfants de Dieu soient révélés.
...
\VS{28}O,r nous savons aussi que toutes choses concourent au bien de ceux qui aiment Dieu, c'est-à-dire de ceux qui sont appelés selon son dessein.
...
\TextTitle{[L'attitude du chrétien face aux divergences d'opinion]
\\(cp. 1 Co. 8:1-10:33}
\Chap{14}
...
\VS{8}Or, je dis que Jésus-Christ a été Ministre des circoncis pour la vérité de Dieu, afin de ratifier les promesses faites aux pères,
...
\VS{16}afin que je sois ministre de Jésus Christ parmi les Gentils, m'employant au sacrifice de l'Evangile de Dieu, afin que l'offrande des Gentils lui soit agréable, étant sanctifiée par le Saint-Esprit.
...
\VS{25}Mais maintenant je vais à Jérusalem pour assister les saints.
