...
\VS{2}Tout à coup, il se fit un bruit du ciel, comme est le bruit d'un vent qui souffle avec véhémence, et il remplit toute la maison où ils étaient assis.
\VS{3}Et il leur apparut des langues divisées, comme de feu, qui se posèrent sur chacun d'eux.
\VS{4}Ils furent tous remplis du Saint-Esprit, et commencèrent à parler des langues étrangères selon que l'Esprit leur donnait de parler.
