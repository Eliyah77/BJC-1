...
\VS{9}Et ayant dit ces choses, il fut élevé, comme ils le regardaient, une nuée le pris et l'emporta de devant leurs yeux.
...
\VS{11}et leur dirent : Hommes Galiléens, pourquoi vous arrêtez-vous à regarder au ciel ? Ce Jésus qui a été élevé d'avec vous au ciel, en descendra de la même manière que vous l'avez contemplé montant au ciel\FTNT{Jésus-Christ est monté au ciel depuis la Montagne des Oliviers et lors de son retour, ses pieds se poseront sur cette montagne. Voir Za. 14.}.
\TextTitle{Attente du Saint-Esprit promis\FTNTT{v. 5}}
\VS{12}Alors ils retournèrent à Jérusalem de la montagne appelée la Montagne des Oliviers, qui est près de Jérusalem, le chemin d'un sabbat\FTNT{Chemin de sabbat : C'est la distance qu'il est permis à un juif de parcourir le jour de sabbat (Ex. 16:29). Elle correspond à deux mille coudées ou 1100 m.}.
...
\VS{17}Car il était compté parmi nous, et il avait reçu en partage ce même ministère.
...
\VS{25}afin qu'il prenne part à ce ministère et à cette apostolat que Judas a abandonné pour aller en son lieu.
...
\Chap{2}
\TextTitle{Effusion de l'Esprit à la Pentecôte ; naissance de l'Eglise}
...
\VS{5}Or, il y avait séjournant à Jérusalem des Juifs, hommes pieux, de toutes les nations qui sont sous le ciel.
\VS{6}Et ce bruit s'étant répandu, une multitude vint ensemble, qui fut confondue de ce que chacun les entendait parler dans sa propre langue. 
...
\TextTitle{Prédication de Pierre ; explication de l'effusion de l'Esprit\FTNTT{Joë. 2:28-32}}
...
\VS{21}Mais il arrivera que quiconque invoquera le Nom du Seigneur sera sauvé\FTNT{Jo. 2:28-32.}.
\TextTitle{Proclamation de la résurrection du Messie\FTNTT{v. 25-31 ; Ps. 16:8-11}}
...
\VS{23}ayant été livré selon le dessein arrêté et selon la prescience de Dieu, vous l'avez prie et mis à la croix, vous l'avez fait mourir par les mains des impies.
...
\VS{27}Car tu ne laisseras point mon âme en enfer\FTNT{Voir commentaire Mt. 16:18} et tu ne permettras point que ton Saint voie la corruption.
\VS{28}Tu m'as fait connaître le chemin de la vie, tu me rempliras de joie pdans ta présence\FTNT{Ps. 16:11.}.
...
\VS{2}Un homme boiteux dès sa naissance, y était porté, lequel on portait et qu'on plaçait tous les jours à la porte du temple appelée la Belle, pour demander l'aumône à ceux qui entraient au temple.
...
\TextTitle{Christ, celui que les prophètes ont annoncé}
...
\VS{21}lequel il faut que le ciel recoive, jusqu'au temps du rétablissement de toutes les choses que Dieu a prononcées par la bouche de tous ses saints prophètes, dès le commencement du monde.
...
\VerseOne{}Mais comme ils parlaient au peuple, survinrent les sacrificateurs, et le commandant du temple, et les sadducéens,
...
\VS{7}IEt ayant fait comparaître devant eux Pierre et Jean, ils leur demandèrent : Par quelle puissance, ou au Nom de qui avez-vous fait cette guérison ?
...
\VS{15}Alors ils leur ordonnèrent sortir hors du sanhédrin, et ils délibérèrent entre eux, disant : Que ferons-nous à ces gens ?
...
\VS{17}Mais afin qu'il ne soit plus divulgué parmi le peuple, défendons-leur avec menaces expresses, qu'ils n'aient plus de parler à qui que ce soit en ce Nom.
...
\VS{28}pour faire toutes les choses que ta main et ton conseil avaient auparavant déterminé de voir être faites.
...
\TextTitle{Les chrétiens unis comme un seul corps\FTNTT{Ac. 2:42-47}}
...
\VS{4}Si tu l'avais gardée, ne te restait-elle pas ? Et après qu'il ait été vendu, le prix n'était-il pas à ta disposition ? Comment as-tu pu mettre en ton cœur un pareil dessein ? tu n'as pas menti aux hommes mais à Dieu.
...
\VS{7}Et il arriva environ trois heures après, sa femme entra, sans savoir ce qui était arrivé.
...
\VS{28}disant : Ne vous avons-nous pas défendu expressément d'enseigner en ce Nom-là ? Et cependant voici, vous avez rempli Jérusalem de votre doctrine, et vous voulez faire retomber sur nous le sang de cet homme.
...
\VS{16}et ils furent transportés à Sichem, et mis dans le sépulcre qu'Abraham avait acheté à prix d'argent des fils d'Hamor, fils de Sichem.
...
\VS{42}C'est pourquoi aussi Dieu se détourna {d'eux }, et les abandonna à servir l'armée du ciel, ainsi qu'il est écrit dans le livre des prophètes : Maison d'Israël, m'avez-vous offert des sacrifices et des victimes pendant quarante ans au désert ?
...
\VS{54}En entendant ces choses, leur coeur s'enflamma de colère, et ils grinçaient des dents contre lui.
...
\TextTitle{Le déploiement des chrétiens\FTNTT{Ac. 11 : 19-21}}
...
\VS{7}Car les esprits impures sortaient, en criant à haute voix, hors de plusieurs qui en étaient possédés, et beaucoup de paralytiques et de boiteux furent guéris.
...
\VS{10}Auquel tous étaient attentifs, depuis le plus petit jusqu'au plus grand, disant : celui-ci est la grande puissance de Dieu.
...
\VS{27}Il se leva donc, s'en alla. Et voici, un homme Ethiopien, un eunuque, qui était un des principaux seigneurs de la cour de Candace, reine des Ethiopiens, surintendant de toutes ses richesses, venu à Jérusalem pour adorer,
...
\VS{3}Or il arriva qu'en marchant, il approcha de Damas, tout à coup une lumière resplendit du ciel comme un éclair autour de lui.
...
\TextTitle{Saul à Jérusalem ; rencontre avec Barnabas}
...
\VS{29}Et parlant sans déguisement au Nom du Seigneur Jésus, il disputait contre les Hellénistes, mais ils tâchaient de le faire mourir.
\TextTitle{Retour à Tarse}
\VS{30}Les frères l'ayant découvert, l'emmenèrent à Césarée, et le firent partir à Tarse.
\VS{31}Les Eglises étaient en paix dans toute la Judée, la Galilée, et la Samarie, étant édifiées et marchant dans la crainte du Seigneur ; et elles s'accroissaient par le rafraîchissement du Saint-Esprit.
...
\Chap{10}
\TextTitle{Vision de Corneille : L'Evangile parvient aux Gentils}
...
\Chap{11}
\TextTitle{Pierre : Le salut est aussi accordé aux Gentils}
...
\TextTitle{A Antioche, les disciples appelés « chrétiens » pour la première fois}
...
\VS{2}Comme ils servaient le Seigneur dans leur ministère et qu'ils jeûnaient, le Saint-Esprit dit : Séparez-moi Barnabas et Saul pour l'œuvre à laquelle je les ai appelés.
\VS{3}Alors après avoir jeûné et prié, ils leur imposèrent les mains, et les laissèrent partir\FTNT{Voir annexe « Les voyages missionaires de Paul ».}.
...
\TextTitle{Bar-Jésus aveuglé ; conversion du proconsul Sergius Paulus}
...
\TextTitle{Les juifs d'Antioche rejettent la Parole ; l'évangile annoncé aux Gentils\FTNTT{Ac. 18:6 ; 28:25}}
...
\TextTitle{Certains veulent imposer la circoncision aux Gentils}
\Chap{15}
...
\TextTitle{Témoignage de l'action de Dieu au milieu des Gentils}
...
\TextTitle{Vision de Paul ; départ pour la Macédoine}
...
\TextTitle{EEmeutes à Thessalonique : fuite à Bérée}
...
\TextTitle{Les chrétiens de Bérée}
...
\TextTitle{Paul fait un voeu\FTNTT{Ro. 6:14 ; 2 Co. 3:7-14 ; Ga. 3:23-28}}
...
\VS{23}Et ayant séjourné là quelque temps, il s'en alla, et traversa tout de suite la contrée de Galatie et de Phrygie, fortifiant tous les disciples\FTNT{Voir annexe « Les voyages missionaires de Paul ».}.
...
\VS{26}et vous voyez et entendez que, non seulement à Ephèse, mais dans presque toute l'Asie, ce Paul par ces persuasions a détourné beaucoup de monde, en disant que les dieux faits de main d'hommes ne sont pas des dieux.
...
\VS{15}Quelques jours après, nous fîmes nos préparatifs et nous montâmes à Jérusalem \FTNT{Voir annexe « Les voyages missionaires de Paul ».}.
...
\Chap{22}
\TextTitle{Paul raconte son témoignage de conversion\FTNTT{Ac. 9:1-18 ; 26:9-18}}
...
\VS{30}Le lendemain, voulant savoir avec certitude de quoi les Juifs l'accusaient, le tribun lui fit ôter ses liens, et donna l'ordre aux principaux sacrificateurs et à tout le sanhédrin de se réunir ; puis, il fit descendre Paul, et il le présenta devant eux.
\Chap{23}
...
\VS{21} Mais n'y consens point : car plus de quarante hommes d'entre eux sont en embûches contre lui, qui ont fait un voeu avec exécration de serment, de ne manger ni boire jusqu'à ce qu'ils l'aient tué ; et ils sont maintenant tous prêts, attendant ce que tu leur permettras.
...
\TextTitle{Lettre de Claude Lysias au gouverneur Félix}
...
\VS{10}Et après que le gouverneur eut fait signe à Paul de parler, il répondit : Sachant qu'il y déjà plusieurs années que tu es lejuge de cette nation je réponds pour moi avec plus de courage:
\VS{11}Puisque tu peux savoir qu'il n'y a pas plus de douze jours que je suis monté à Jérusalem pour adorer Dieu.
...
\VS{7}Et comme nous naviguions lentement pendant plusieurs jours, et que nous n'étions arrivés qu'avec peine vis-à-vis de Gnide, parce que le vent ne nous permettait pas d'avancer, nous naviguâmes en dessous de la Crète, vers Salmone.
...
\TextTitle{Paul annonce Christ aux des Juifs de Rome}
...
\VS{23}Et après lui avoir assigné un jour, plusieurs vinrent auprès de lui dans son logis ; et il leur expliquait par plusieurs témoignage le royaume de Dieu, et depuis le matin jusqu'au soir, il cherchait à les persuader de ce qui concerne Jésus, tant par la loi de Moïse que par les prophètes.
\VS{24}Et les uns furent persuadés par les choses qu'il disait ; et les autres n'y crurent point.
\TextTitle{Incrédulité des Juifs : Paul se tourne vers les Gentils\FTNTT{Ap. 13:44 ; 18:6}}
