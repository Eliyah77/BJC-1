...
\VS{9}Je vous ai écrit dans ma lettre de ne pas vous mêlez\FTNT{Mêler vient du grec « sunanamignumi » qui signifie : « mêler ensemble, se tenir en compagnie avec, être intime avec quelqu'un. Avoir des relations, être en communication » (Ps. 1:1 ; 1 Co. 15:33 ; Ro. 16:17-18 ; Tit. 3:10).} avec les fornicateurs,
...
\Chap{9}
\TextTitle{Défense de Paul\FTNTT{Ga. 1:11 ; 2:21}}
...
\VS{5}N'avons-nous pas le droit de mener avec nous une sœur,0 notre femme, comme font les autres apôtres, et les frères du Seigneur, et Céphas ?
...
\VS{18}Car premièrement, lorsque vous vous réunissez en assemblée, j'apprends qu'il y a des divisions parmi vous et je le crois une partie,
...
\TextTitle{Les dons de l'Esprits\FTNTT{Ep. 4:7-16}}
