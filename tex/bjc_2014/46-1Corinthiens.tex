...
\VS{9}Mais comme il est écrit : Ce sont des choses que l'œil n'a point vues, que l'oreille n'a point entendues, et qui ne sont point montées au cœur de l'homme, des choses que Dieu a préparées pour ceux qui l'aiment\FTNT{Es. 64:3.}.
...
\VS{5}Qu'est-ce donc Paul, et qui est Apollos ? Des serviteurs, par le moyen desquels vous avez cru, selon que le Seigneur l'a donné à chacun.
