...
\VS{7}Elle couvre\FTNT{Dans ce passage, le grec utilisé, «~stego~», signifie «~toit, couverture, protéger ou garder en recouvrant, préserver~» (Pr. 10:12 ; . La charité ne rappelle pas sans cesses les erreurs des uns et des autres, mais sait préserver dans le secret quand la faute est expiée. Par contre, en aucun cas elle ne permet la compromission du péché en ne dénonçant pas les oeuvres des ténèbres (Mt. 18:15-18).} tout, elle croit tout, elle espère tout, elle supporte tout.
