...
\VS{9}Mais ainsi qu'il est écrit~: Ce sont des choses que l'œil n'a point vues, que l'oreille n'a point entendues, et qui ne sont point montées au cœur de l'homme, des choses que Dieu a préparées pour ceux qui l'aiment\FTNT{Es. 64:3.}.
...
\TextTitle{Le chrétien~: Temple de Dieu}
...
\VS{7}Et que vous ne deveniez point idolâtres, comme quelques-uns d'entre eux, selon qu'il est écrit~: Le peuple s'assit pour manger et pour boire, puis ils se levèrent pour jouer\FTNT{Ex. 32:6.}.
...
\VS{10}Et que vous ne murmuriez point, comme quelques-uns d'entre eux murmurèrent et périrent par le destructeur\FTNT{No. 14:2-29~; No. 26:63-65.}.
...
\VS{36}Ô insensé~! Ce que tu sèmes ne reprend point vie s'il ne meurt pas\FTNT{Jn. 12:24.}.
...
\TextTitle{La mort détruite dans la victoire}
