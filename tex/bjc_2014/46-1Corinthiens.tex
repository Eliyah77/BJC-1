...
\VS{26}Que faire donc mes frères ? C'est que toutes les fois que vous vous assemblez, les uns ou les autres parmi vous ont-ils un cantique, une instruction, une langue étrangère, une révélation, une interprétation? Que tout se fasse pour l'édification.
