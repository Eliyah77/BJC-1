...
\Chap{2}
\TextTitle{Paul et Barnabas montent à Jérusalem\FTNTT{Ac. 15}}
...
\VS{12}Car avant l’arrivée de quelques personnes envoyées par Jacques, il mangeait avec les Gentils, mais quand elles furent venues, il s’esquiva et se sépara de Gentils, craignant les circoncis.
...
\VS{17}Or si en cherchant d’être justifiés par Christ, nous sommes aussi trouvés pécheurs, Christ est-il pourtant ministre du péché ? A Dieu ne plaise !
...
\TextTitle{La vie chrétienne est le reflet de la vie du Messie\FTNTT{Ga. 5:15-23}}
...
\TextTitle{L'alliance avec Abraham\FTNTT{Ro. 4}}
...
\TextTitle{La chair et ses oeuvres s'opposent à l'Esprit de Dieu\FTNTT{Ro. 8:2}}
