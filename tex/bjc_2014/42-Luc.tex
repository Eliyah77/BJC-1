...
\VS{26}Il avait été Turban

       Turban. Il est assez difficile de distinguer les 3 termes : turban, tiare, diadème (voir ces 2 mots). Dans #Esa 62:3, SEGOND et COLOMBE traduisent turban, DARBY tiare, et SYNODALE diadème. Le fait est que ces coiffures étaient généralement faites d’une bande de tissu enroulée autour de la tête. Le mot mitsnephet d’#Ez 21:31 signifie « enroulé tout autour ». Le Talmud dit que le turban sacerdotal était fait d’une longue écharpe de fin lin, mesurant 16 coudées (cf. #Ex 28:39). Ailleurs il est question d’attacher ou d’enrouler son turban (#Ez 24:17, SEGOND, DARBY), ou d’en avoir un de plusieurs couleurs flottant sur la tête (#Ez 23:15). Le turban était aussi une coiffure féminine (#Esa 3:23).

averti divinement par le Saint-Esprit qu'il ne mourrait point, avant d'avoir vu le Christ du Seigneur.
...
\TextTitle{Une pécheresse oint Jésus}
