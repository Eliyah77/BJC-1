...
\VS{7}te montrant toi-même un modèle de bonnes œuvres en toutes choses, en une doctrine exempte de toute altération, en pureté, en sainteté,
...
\VS{15}Enseigne ces choses, exhorte et reprends avec une pleine autorité. Que personne ne te méprise.
\Chap{3}
...
\VS{2}de ne médire de personn, de n'être point querelleurs, mais doux, et montrant une parfaite douceur envers tous les hommes.
