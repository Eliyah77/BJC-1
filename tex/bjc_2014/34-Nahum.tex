...
\begin{multicols}{2}
\Chap{1}
\VerseOne{}Oracle sur Ninive\FTNT{Ninive était la capitale de l’ancien empire assyrien. Voir Jon. 1:1-2.}, qui est le livre de la vision de Nahum d’Elkosch.
...
\VS{9}Que pourriez-vous machiner contre Yahweh ? C’est lui qui réduit à néant ; la détresse ne se lèvera pas deux fois ;
...
\VS{8}Vaux-tu mieux que No-Amon, qui est assise au milieu des fleuves, des eaux autour d'elle, dont la mer est le rempart, à qui la mer sert de murailles ?
\VS{9}Sa force était l’Ethiopie et l'Egypte, et une infinité d'autres peuples ; Puth et les Lybiens sont allés à son secours.
\VS{10}Elle-même aussi fut transportée hors de sa terre, elle s'en est allée en captivité ; ses enfants furent écrasés aux carrefours de toutes les rues, et on a jeté le sort sur ses gens honorables, et tous ses grands ont été liés de chaînes.
