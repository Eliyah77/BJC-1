...
\VS{4}pour un héritage incorruptible, qui ne peut ni se souiller, ni se flétrir ; qui est conservé dans les cieux pour nous,
...
\VS{8}Vous l'aimez sans l'avoir vu, vous croyez en lui sans le voir encore, vous réjouissant d'une joie ineffable et glorieuse,
\VS{9}remportant la fin\FTNT{Le mot « fin » vient du grec « telos » qui signifie « terminaison », « la limite à laquelle cesse une chose », « but », « le dernier dans toute succession ou séries », ou encore « ce par quoi se termine une chose ». Mc. 13:13 ; 1 Ti. 1:5} de votre foi, savoir le salut de vos âmes.
...
\Chap{2}
\VerseOne{}Ayant donc renoncé à toute sorte de malice, de toute fraude, de dissimulation, d'envie et de toutes médisances,
...
\VS{5}et vous-mêmes, comme des pierres vivantes, entrez dans la structure de l'édifice pour être une maison spirituelle, et de saints sacrificateurs, pour offrir des sacrifices spirituels, agréables à Dieu par Jésus-Christ.
...
\VS{7}Elle est donc précieuse pour vous qui croyez. Mais, quant aux rebelles, il est dit : La pierre qu'ont rejetée ceux qui bâtissaient est devenue la principale de l'angle, 
...
\VS{9}Mais vous, au contraire, vous êtes la race élue, vous êtes la sacrificature royale, la nation sainte, le peuple acquis, afin que vous annonciez les vertus de celui qui vous a appelés des ténèbres à sa merveilleuse lumière,
...
\VS{15}Car c'est la volonté de Dieu qu'en faisant le bien vous fermiez la bouche des hommes ignorants et insensés. \VS{16}Comme libres, et non pas comme ayant la liberté pour servir de voile à la méchanceté, mais agissant comme des serviteurs de Dieu.
...
\VS{24}lui qui a porté lui-même nos péchés en son corps sur le bois, afin que morts aux péchés, nous vivions pour la justice ; lui par la meurtrissure\FTNT{Es. 53:5.} duquel vous avez été guéris.
...
\VS{6}comme Sara, qui obéissait à Abraham et l'appelait son seigneur, de laquelle vous êtes devenues les filles, en faisant ce qui est bien, sans vous laisser troubler par aucune crainte.
\VS{7}Et vous, maris, de même conduisez-vous avec sagesse envers vos femmes, comme un vase\FTNT{Vase plus fragile. Le « Vase » était une métaphore grecque commune pour parler du corps car les Grecs pensaient que l'âme vivait temporairement dans les corps.} plus fragile, c'est-à-dire, féminin ; honorez-les, comme devant aussi hériter avec vous de la grâce de vie, afin que vos prières ne soient point interrompues.
...
\VS{10}Si quelqu'un, en effet, veut aimer sa vie et voir des jours heureux, qu'il préserve sa langue du mal, et ses lèvres de prononcer aucune fraude,
...
\VS{18}Car aussi Christ aussi a souffert une fois pour les péchés, lui juste pour les injustes, afin de nous amener à Dieu, étant mort selon la chair, mais vivifié par l'Esprit,
...
\VS{20}qui autrefois avaient été incrédules, quand la patience de Dieu se prolongeait, aux jours de Noé, pendant la construction de l'arche, dans laquelle un petit nombre de personnes, c'est-à-dire huit, furent sauvées à travers l'eau.
...
\VS{22}lequel est à la droite de Dieu, depuis qu'il est allé au ciel, et auquel sont assujettis les anges, et les dominations et les autorités.
\Chap{4}
...
\VS{6}Car l'Evangile a aussi été annoncé aux morts, afin que, après avoir été jugés comme les hommes dans la chair, maintenant ils vivent selon Dieu par l'Esprit.
...
\VS{9}Résistez-lui, étant ferme dans la foi, sachant que les mêmes souffrances sont imposées à vos frères qui sont dans le monde.
