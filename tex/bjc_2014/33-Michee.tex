...
\VS{3}Car voici, Yahweh sortira de son lieu, il descendra, et marchera sur les hauts lieux de la terre\FTNT{Cette prophétie annonce à la fois la destruction du royaume du nord par Salmanasar V (régna de 727-722 av. J.-C.) en 722 av. J.-C. (\vref{2 R. 17:1-23}), l'invasion de Sanchérib (régna de 705 à 681 av. J.-C.), (\vref{2 R. 18:13} à \vref{2 R. 19:37}) ainsi que celle de Nebucadnetsar (régna de 604 à 562 av. J.-C.), (\vref{2 R. 24} et 25).} ;
...
\VS{11}Passe habitante de Schaphir, dans la nudité et la honte ! L'habitante de Tsaanan n'est pas sortis ; le deuil de Beth-Haëtsel vous prive de son abri.
...
\VS{13}Celui qui fera la brèche\FTNT{« Celui qui fera la brèche » est Jean-Baptiste qui fut appelé à une époque, où la gloire de Dieu ne se manifestait plus depuis quatre cents ans. En effet, Dieu n'avait plus suscité de prophètes ou de messagers pour parler à son peuple. Le ciel était comme fermé. Il est donc venu ouvrir une brèche, c'est-à-dire préparer le chemin du Seigneur selon \vref{Es. 40:3-5}, \vref{Mal. 3:1} et \vref{4:5-6}.} montera devant eux, on brisera, et on passera outre, et ils sortiront par la porte ; et leur Roi marchera devant eux\FTNT{Le Roi qui marchera devant eux est bien Jésus-Christ. Le message de Jean-Baptiste était clair : « Repentez-vous car le Royaume des cieux arrive », or ce royaume est celui du Messie (\vref{Mt. 3:1-3}).}, Yahweh sera à leur tête.
\Chap{3}
...
\VS{5}Ainsi parle Yahweh contre les prophètes qui égarent mon peuple, qui mordent de leurs dents, et qui crient : Paix ! Et si quelqu'un ne leur donne rien dans leur bouche, ils publient la guerre contre lui.
...
\VerseOne{}Mais il arrivera dans les derniers jours\FTNT{Voir commentaire en \vref{Ge. 49:1-2}.}, que la montagne de la maison de Yahweh\FTNT{Dans les Ecritures, les montagnes symbolisent parfois une grande puissance terrestre, et les collines celles de moindre importance. Cette prophétie confirme l'établissement du Royaume messianique dont la capitale sera Jérusalem (\vref{2 S. 7:14-16}). Esaïe avait reçu la même prophétie que l'on peut découvrir au chapitre 2 de son livre.} sera affermie au sommet des montagnes, et sera élevée par-dessus les collines ; les peuples y afflueront.
\VS{2}Et plusieurs nations iront et diront : Venez, et montons à la montagne de Yahweh, à la maison du Dieu de Jacob ; et il nous enseignera touchant ses voies, et nous marcherons dans ses sentiers ; car la loi sortira de Sion, et la parole de Yahweh de Jérusalem.
\VS{3}Il exercera le jugement parmi plusieurs peuples, et il censurera fortement les grandes nations jusqu'aux pays les plus élognés ; et de leurs épées, elles forgeront des hoyaux ; et de leurs lances, des serpes ; une nation ne lèvera plus l'épée contre une autre, et elles ne s'adonneront plus à la guerre.
...
\VS{11}Maintenant plusieurs nations se sont rassemblées contre toi\FTNT{Il est ici question de la guerre d'Harmaguédon. Voir commentaire en \vref{Ap. 16:12-16}.} et disent : Qu'elle soit profanée ! Et que notre œil voie en Sion ce qu'il y voudrait voir\FTNT{Jérusalem est une horloge de Dieu. Le Seigneur a fait en sorte que les nations aient les yeux toujours tournés vers ce bout de terre, car c'est là que débutera la troisième guerre mondiale, l'Harmaguédon (\vref{Mt. 24:15-28} ; \vref{Ap. 16:12-16} ; \vref{Ap. 19:11-21}). Là aura lieu le jugement des nations, dans la vallée de Josaphat (\vref{Joë. 3:2-12}). Le Messie reviendra (\vref{Es. 59:20-21} ; \vref{Za. 14:1-8} ; \vref{Ac. 1:10-11}) et gouvernera le monde depuis Jérusalem (\vref{Za. 14:9-21}). L'actuel conflit israélo-palestinien nous confirme bien ces prophéties. Il ne se passe pas un jour sans que les informations nous rapportent des événements venant de cet endroit du monde. D'ailleurs le Seigneur lui-même nous invite à suivre de près ce qu'il s'y passe (\vref{Mt. 24:32-34}).}.
...
\VS{13}J'arracherai aussi du milieu de toi les poteaux d'Asherah\FTNT{\vref{Ex. 34:13}.}, et détruirai tes ennemis.
...
\VS{4}Car je t'ai fait sortir du pays d'Egypte et t'ai délivré de la maison de servitude, et j'ai envoyé devant toi Moïse, Aaron et Marie.
...
\VS{7}Yahweh prendra-t-il plaisir à des milliers de béliers ou à des myriades de torrents d'huile ? Donnerai-je pour mon crime mon premier-né\FTNT{Selon la loi (\vref{Ex. 13:2} ; \vref{Ex. 13:12}), les premiers-nés de l'homme et des animaux appartenaient au Seigneur. Ceux des animaux étaient offerts en sacrifice alors que le sacrifice des enfants était formellement interdit sous peine de mort (\vref{Lé. 18:21} ; \vref{Lé. 20:2-5} ; \vref{De. 12:31} ; \vref{De. 18:10}).}, le fruit de mes entrailles pour le péché de mon âme ?
...
\VS{3}Pour faire du mal avec les deux mains : Le gouverneur exige, le juge demande un salaire, le grand déclare ce qu'il convoite, et ils s'unissent.
...
\VS{20}Tu feras voir ta fidélité à Jacob, et ta miséricorde à Abraham, comme tu l'as juré à nos pères dès les temps anciens\FTNT{Les versets 18 à 20 de \vref{Mi. 7} sont lus chaque année dans les synagogues le jour des expiations.}.
\PPE{}
\end{multicols}
