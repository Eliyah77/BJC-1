\ShortTitle{Ha.}\BookTitle{Habakuk}\BFont
\noindent\hrulefill
{\footnotesize
\textit{
\bigskip
...
\VS{3}Pourquoi me fais-tu voir la méchanceté\FTNT{La perplexité d'Habakuk était la même que celle de Job (\vref{Job 21:7}), d'Asaph (\vref{Ps. 73}) et de Jérémie (\vref{Jé. 12:1-2}). Les méchants semblent prospérer tandis que les justes pleurent et sont persécutés (\vref{Mal. 3:12-15}).}, et vois-tu la perversité~? Pourquoi y a-t-il de l'oppression et de la violence devant moi, et des gens qui excitent des procès et des querelles~?
\VS{4}Parce que la loi est sans force, et que la justice ne se fait jamais, à cause de cela le méchant environne le juste, et à cause de cela on rend des jugements corrompus\FTNT{\vref{Jé. 5:26}~; \vref{Am. 5:7}.}.
\TextTitle{La réponse de Yahweh}
\VS{5}Regardez parmi les nations, voyez, soyez étonnés et stupéfaits~! Car je vais faire en vos jours une œuvre que vous ne croiriez pas si on vous la racontait\FTNT{\vref{Ac. 13:41}.}.
...
\VS{8}Ses chevaux sont plus légers que les léopards, et ils ont la vue plus aiguë que les loups du soir~; et ses cavaliers se répandront çà et là, même ses cavaliers viendront de loin~; ils voleront comme un aigle qui fond sur sa proie\FTNT{\vref{Jé. 5:6}~; \vref{So. 3:3}.}.
...
\VS{12}N'es-tu pas de toute éternité, ô Yahweh~! Mon Dieu~! Mon Saint~? Nous ne mourrons pas~! Ô Yahweh, tu l'as établi pour exécuter tes jugements~; et toi, mon rocher\FTNT{Voir commentaire en \vref{Es. 8:13-14}.}, tu l'as fondé pour punir.
...
\VS{14}Or tu as fait les hommes comme les poissons de la mer, et comme le reptile qui n'a pas de maître.
\VS{15}Il a tout enlevé avec l'hameçon~; il l'a amassé avec son filet, et l'a assemblé dans son rets~; c'est pourquoi il se réjouira et s'égayera\FTNT{\vref{Am. 4:2}.}.
\VS{16}A cause de cela, il sacrifie à son filet, et il offre de l'encens à ses rets, parce qu'il aura eu par leur moyen une grasse portion, et que sa viande est une chose mœlleuse.
...
\VerseOne{}Je me tenais en sentinelle\FTNT{\vref{Es. 21:1-6}~; \vref{Jé. 6:17}~; \vref{Ez. 33:1-19}.}, j'étais debout dans la forteresse et je faisais le guet, pour voir ce qu'il me dirait, et ce que je répondrais après ma plainte.
...
\VS{3}Car la vision est encore différée jusqu'à un certain temps, et Yahweh parlera de ce qui arrivera à la fin, et il ne mentira pas. S'il tarde, attends-le~; car il viendra, il viendra\FTNT{Voir commentaire en \vref{Ge. 2:17}.}, et il ne tardera pas\FTNT{\vref{Hé. 10:37}.}.
\VS{4}Voici, l'âme de celui qui s'élève n'est pas droite en lui~; mais le juste vivra de sa foi\FTNT{\vref{Ro. 1:17}~; \vref{Hé. 10:38}.}.
\VS{5}Et combien plus l'homme adonné au vin est-il perfide, et l'homme puissant est-il orgueilleux, ne se tenant pas tranquille chez lui~; il élargit son âme comme le scheol, et il est insatiable comme la mort, il rassemble vers lui toutes les nations, et réunit à lui tous les peuples.
\VS{6}Tous ceux-là ne feront-ils pas de lui un sujet de railleries et d'énigmes~? Et ne dira-t-on pas~: Malheur à celui qui accumule ce qui ne lui appartient pas~; jusqu'à quand le fera-t-il, et entassera-t-il sur lui de la boue épaisse~?
...
\VS{8}Parce que tu as pillé beaucoup de nations, tout le reste des peuples te pillera, et aussi à cause des meurtres des hommes, et de la violence faite dans le pays, contre la ville, et contre tous ses habitants\FTNT{\vref{Es. 33:1}~; \vref{Na. 3:1}.}.
...
\VS{14}Car la terre sera remplie de la connaissance de la gloire de Yahweh\FTNT{\vref{Es. 11:9}.}, comme le fond de la mer par les eaux qui le couvrent.
\VS{15}Malheur à celui qui fait boire son compagnon en lui approchant sa bouteille, et qui l'enivre afin qu'on voie sa nudité\FTNT{\vref{Ge. 9:21-24}~; \vref{Es. 5:22}.}.
...
\VerseOne{}Prière d'Habakuk, le prophète, sur le mode des shiggaïons\FTNT{Le terme «~shiggaïon~» veut certainement dire «~chant lyrique~»}.
...
\VS{9}Ton arc est mis à nu et tire toutes les flèches, selon le serment fait aux tribus, à savoir ta parole. Sélah. Tu fends la terre et tu en fais sortir des fleuves\FTNT{\vref{Ps. 78:15-16}~; \vref{Ps. 105:41}.}.
\VS{10}Les montagnes te voient et elles tremblent\FTNT{\vref{Ps. 114:4-7}.}~; des torrents d'eau se précipitent, l'abîme fait retentir sa voix de la profondeur, il élève ses mains en haut.
\VS{11}Le soleil et la lune s'arrêtent dans leur habitation\FTNT{\vref{Jos. 10:12}~; \vref{Ap. 22:5}.}, ils marchent à la lueur de tes flèches, et à l'éclat de ta lance étincelante.
...
\VS{17}Car le figuier ne fleurira pas, et il n'y aura pas de fruit dans les vignes~; ce que l'olivier produit mentira, et aucun champ ne produira rien à manger~; les brebis seront retranchées du parc, et il n'y aura pas de bœufs dans les étables.
\VS{18}Mais moi, je me réjouis en Yahweh, et je me réjouis dans le Dieu de ma délivrance.
\VS{19}Yahweh, le Seigneur, est ma force, et il rend mes pieds semblables à ceux des biches, et me fait marcher sur mes lieux élevés\FTNT{\vref{De. 32:13}~; \vref{Ps. 18:33-34}.}. Au chef des chantres avec instruments à cordes.
\PPE{}
\end{multicols}
