...
\VS{9}Tu as aimé la justice, et tu as haï l'iniquité ; c'est pourquoi, ô Dieu ! Ton Dieu t'a oint d'une huile de joie par-dessus de tous tes semblables\FTNT{Ps. 45:7-8.}.
...
\VS{11}Ils périront, mais tu es permanent ; ils vieilliront tous comme un vêtement ;
...
\VS{2}Car si la parole prononcée par les anges a été ferme, et si toute transgression et toute désobéissance ont reçu une juste rétribution,
...
\VS{15}Ainsi, il délivre tous ceux qui par crainte de la mort étaient assujettis toute leur vie à la servitude.
