...
\VS{2}nous a parlé dans ces derniers jours\FTNT{Les derniers jours ont commencé avec la naissance de l'Eglise. Voir \vref{Joë. 2:28}~; \vref{Ac. 2:14-17}.} par son Fils, qu'il a établi héritier de toutes choses, et par lequel il a aussi créé l'univers~;
...
\VS{5}Car auquel des anges a-t-il jamais dit~: Tu es mon Fils, je t'ai engendré aujourd'hui\FTNT{\vref{Ps. 2:7}.}~? Et encore~: Je serai pour lui un Père, et il sera pour moi un Fils\FTNT{\vref{2 S. 7:14}.}~?
\VS{6}Et quand il introduit de nouveau dans le monde son Fils premier-né\FTNT{Voir commentaire en \vref{Col. 1:15}.}, il est dit~: Et que tous les anges de Dieu l'adorent\FTNT{\vref{Ps. 97:7}.}~!
\VS{7}Car quant aux anges, il est dit~: Il fait de ses anges des vents, et de ses serviteurs des flammes de feu\FTNT{\vref{Ps. 104:4}.}.
...
\VS{9}tu as aimé la justice, et tu as haï l'iniquité~; c'est pourquoi, ô Dieu, ton Dieu t'a oint d'une huile de joie par-dessus tous tes semblables\FTNT{\vref{Ps. 45:7-8}.}~!
...
\VS{12}et tu les rouleras comme un manteau et ils seront changés~; mais toi, tu restes le même, et tes années ne finiront point\FTNT{\vref{Es. 50:9}~; \vref{Es. 51:6}~; \vref{Ps. 102:27-28}.}.
\VS{13}Et auquel des anges a-t-il jamais dit~: Assieds-toi à ma droite, jusqu'à ce que j'aie mis tes ennemis pour le marchepied de tes pieds\FTNT{\vref{Ps. 110:1}.}~?
...
\VS{8}Tu as assujetti toutes choses sous ses pieds\FTNT{\vref{Ps. 8:5-7}.}. En effet, en lui assujettissant toutes choses, il n'a rien laissé qui ne lui soit assujetti. Mais, nous ne voyons pourtant pas encore que toutes choses lui soient assujetties.
...
\VS{12}disant~: J'annoncerai ton Nom à mes frères, et je te louerai au milieu de l'assemblée\FTNT{\vref{Ps. 22:23}.}.
\VS{13}Et encore~: Je me confierai en lui. Et encore~: Me voici, moi et les enfants que Dieu m'a donnés\FTNT{\vref{Es. 8:17-18}.}.
...
\VS{17}C'est pourquoi il a fallu qu'il soit semblable en toutes choses à ses frères, afin qu'il soit un premier prêtre miséricordieux et fidèle dans les choses qui doivent être faites envers Dieu, pour faire la propitiation pour les péchés du peuple~;
...
\VS{9}où vos pères me tentèrent et m'éprouvèrent, et ils virent mes œuvres pendant quarante ans\FTNT{\vref{Ps. 95:8-11}.}.
...
\VS{3}Pour nous qui avons cru, nous entrons dans le repos, suivant ce qui a été dit~: C'est pourquoi je jurai dans ma colère, ils n'entreront pas dans mon repos\FTNT{\vref{Hé. 3:11}.}~! Il dit cela, quoique ses œuvres aient été achevées depuis la fondation du monde.
\VS{4}Car il a parlé quelque part ainsi du septième jour~: Et Dieu se reposa de toutes ses œuvres le septième jour\FTNT{\vref{Ge. 2:2}.}.
...
\VS{7}Dieu détermine de nouveau un certain jour, qu'il appelle aujourd'hui, en disant par David si longtemps après, selon ce qui a été dit~: Aujourd'hui, si vous entendez sa voix, n'endurcissez point vos cœurs\FTNT{\vref{Ps. 95:8-11}.}.
...
\VS{14}Ainsi, puisque nous avons un Grand Premier Prêtre, Jésus, le Fils de Dieu, qui a traversé les cieux, tenons ferme notre profession.
\VS{15}Car nous n'avons pas un premier prêtre qui ne puisse avoir compassion de nos infirmités~; mais, nous avons celui qui a été tenté comme nous en toutes choses, mais sans pécher.
...
\Chap{5}
\TextTitle{Le service du premier prêtre}
...
\VS{5}De même, aussi Christ ne s'est point glorifié lui-même d'être fait premier prêtre, mais celui qui lui a dit~: C'est toi qui es mon Fils, je t'ai engendré aujourd'hui\FTNT{\vref{Ps. 2:7}.}~!
\VS{6}Comme il dit encore ailleurs~: Tu es prêtre éternellement, selon l'ordre de Melchisédek\FTNT{\vref{Ps. 110:4}.}.
...
\VS{10}étant appelé de Dieu à être premier prêtre selon l'ordre de Melchisédek~;
\TextTitle{Du lait à la nourriture solide\FTNTT{jusqu'à \vref{Hé. 6:12}}}
...
\VS{14}en disant~: Certainement, je te bénirai abondement et je te multiplierai merveilleusement\FTNT{\vref{Ge. 22:16-17}.}.
...
\VS{20}où Jésus est entré comme notre précurseur, ayant été fait premier prêtre éternellement, selon l'ordre de Melchisédek\FTNT{Voir \vref{Ge. 14}.}.
\Chap{7}
\TextTitle{Melchisédek, type de Christ\FTNTT{\vref{Ge. 14}}}
\VerseOne{}En effet, ce Melchisédek était Roi de Salem et Prêtre du Dieu Très-Haut\FTNT{\vref{Ge. 14:18}.}. Il alla au-devant d'Abraham lorsqu'il revenait de la défaite des rois, et il le bénit,
\VS{2}et auquel Abraham donna pour sa part la dîme de tout\FTNT{\vref{Ge. 14:20}. Pour en savoir plus sur la dîme, voir les commentaires en \vref{De. 14:22}, \vref{No. 18:21} et \vref{Mal. 3:10}.}. Son nom signifie premièrement Roi de justice, et puis il a été Roi de Salem, c'est-à-dire, Roi de paix.
...
\VS{11}Si donc la perfection s'était trouvée dans la sacrificature lévitique, (car c'est sous elle que le peuple a reçu la loi) quel besoin était-il après cela qu'un autre prêtre se lève selon l'ordre de Melchisédek, et qui ne soit point nommé selon l'ordre d'Aaron~?
...
\VS{14}car il est évident que notre Seigneur est descendu de la tribu de Juda\FTNT{\vref{Mt. 1:2}.}, à l'égard de laquelle Moïse n'a rien dit de la sacrificature.
...
\VS{21}car les Lévites sont devenus prêtres sans serment, mais celui-ci l'est devenu avec serment par celui qui lui a dit~: Le Seigneur l'a juré, et il ne s'en repentira pas\FTNT{Voir \vref{Ps. 110:4}}~: Tu es prêtre éternellement, selon l'ordre de Melchisédek.
...
\VS{25}C'est pourquoi aussi il peut sauver parfaitement ceux qui s'approchent de Dieu par lui, étant toujours vivant pour intercéder\FTNT{Le Seigneur Jésus-Christ est le modèle parfait en ce qui concerne la prière d'intercession. Il se tient devant le Père pour nous. En tant qu'homme (\vref{1 Ti. 2:5}) et premier prêtre, il se tient entre le Père et l'homme pécheur, comme le faisaient les prêtres sous la loi mosaïque. Voir \vref{Lu. 22:31-32}~; \vref{Ro. 8:34}~; \vref{1 Jn. 2:1-2}.} pour eux.
\VS{26}Or, il nous était convenable d'avoir un tel premier prêtre, saint, innocent, sans tache, séparé des pécheurs, et élevé au-dessus des cieux,
...
\VS{3}Car tout premier prêtre est établi pour offrir des offrandes et des sacrifices~; c'est pourquoi il est nécessaire que celui-ci ait aussi quelque chose à offrir.
...
\VS{5}lesquels font le service dans le lieu qui n'est que l'image et l'ombre des choses célestes, selon que Dieu le dit à Moïse, quand il devait achever le tabernacle~: Or prends garde, lui dit-il, de faire toutes choses selon le modèle qui t'a été montré sur la montagne\FTNT{\vref{Ex. 25:40}.}.
\TextTitle{Christ, le Médiateur d'une alliance plus excellente}
\VS{6}Mais maintenant, notre premier prêtre a obtenu un service d'autant supérieur qu'il est le Médiateur d'une alliance plus excellente, qui a été établie sur de meilleures promesses.
...
\VS{12}car je serai miséricordieux par rapport à leurs injustices, et je ne me souviendrai plus de leurs péchés, ni de leurs iniquités\FTNT{\vref{Jé. 31:31-34}.}.
...
\VerseOne{}En vérité, la Première Alliance avait aussi des ordonnances touchant le service divin, et un sanctuaire terrestre.\FTNT{\vref{Ex. 25:1-9}.}.
\VS{2}Car il fut construit un premier tabernacle, appelé le lieu saint, dans lequel étaient le chandelier, et la table, et les pains de proposition\FTNT{\vref{Ex. 25:30}.}.
\VS{3}Et après le second voile\FTNT{\vref{Ex. 26:31-35}.} était le tabernacle, qui était appelé le Saint des saints,
\VS{4}ayant un encensoir d'or\FTNT{Encensoir ou autel d'or pour les parfums~: \vref{Lé. 16:12}.}, et l'arche de l'alliance\FTNT{\vref{Ex. 25:10}.}, entièrement couverte d'or tout autour, dans laquelle était le vase d'or\FTNT{\vref{Ex. 16:33}.} où était la manne, et la verge d'Aaron\FTNT{\vref{No. 17:1-10}.} qui avait fleuri, et les tables de l'alliance\FTNT{Les tables de l'alliance ou tables du témoignage~: \vref{Ex. 34:29}~; \vref{De. 10:2-5}.}.
\VS{5}Et au-dessus de l'arche étaient les chérubins de la gloire, couvrant de leur ombre le propitiatoire\FTNT{Propitiatoire ou couvercle de l'arche de l'alliance~: \vref{Lé. 9:7}~; \vref{Lé. 16:15-17}.}. Ce n'est pas le moment de parler en détail là-dessus.
\VS{6}Or ces choses étant ainsi disposées, les prêtres qui font le service entrent en tout temps dans le premier tabernacle\FTNT{\vref{No. 28:3}.}~;
\VS{7}mais seul le premier prêtre entre dans le second une fois par an, non sans y porter du sang, qu'il offre pour lui-même et pour les péchés du peuple\FTNT{\vref{Lé. 16:34}.}.
...
\VS{11}Mais Christ est venu comme premier prêtre des biens à venir~; il a traversé un tabernacle plus excellent et plus parfait, qui n'est pas un tabernacle construit de main d'homme, c'est-à-dire, qui n'est pas de cette création~;
...
\VS{13}Car si le sang des taureaux et des boucs, et la cendre de la génisse\FTNT{\vref{No. 19:1-12}.}, répandue sur ceux qui sont souillés, sanctifient et procurent la pureté de la chair,
...
\VS{20}Ceci est le sang de l'Alliance que Dieu vous a ordonné d'observer\FTNT{\vref{Ex. 24:3-8}.}.
\VS{21}Puis il fit aussi aspersion avec du sang sur le tabernacle et sur tous les ustensiles du service\FTNT{\vref{Ex. 29:12}~; \vref{Ex. 29:36}.}.
...
\TextTitle{Un sacrifice plus excellent\FTNTT{\vref{Lé. 16:33}}}
...
\VS{25}Et ce n'est pas pour s'offrir lui-même plusieurs fois qu'il y est entré, ainsi que le premier prêtre entre dans le Saint des saints, chaque année, avec un autre sang~;
...
\VS{6}tu n'as pas pris plaisir aux holocaustes, ni aux sacrifices pour le péché\FTNT{\vref{Ps. 40:7-9}.}.
...
\VS{16}Voici l'alliance que je ferai avec eux, après ces jours-là, dit le Seigneur\FTNT{Voir \vref{Jé. 31:31-34}.}~: C'est que je mettrai mes lois dans leur cœur, et je les écrirai dans leur esprit~;
...
\VS{20}qui est le chemin\FTNT{Jésus est le chemin qui conduit au Saint des saints, à la vie (Voir \vref{Jn. 14:6}), et ce chemin n'était pas encore manifesté avant sa naissance. \vref{Hé. 9:8}.} nouveau et vivant qu'il a inauguré pour nous à travers le voile, c'est-à-dire sa propre chair,
\VS{21}et ayant un premier prêtre établi sur la maison de Dieu,
...
\VS{28}Si quelqu'un avait méprisé la loi de Moïse, il mourait sans miséricorde, sur la déposition de deux ou de trois témoins\FTNT{\vref{De. 17:6}.}~;
...
\VS{30}Car nous connaissons celui qui a dit~: C'est à moi que la vengeance appartient, et je le rendrai~! Dit le Seigneur. Et encore~: Le Seigneur jugera son peuple.\FTNT{\vref{De. 32:35-36}.}
...
\VS{38}Or le juste vivra de la foi~; mais si quelqu'un se retire, mon âme ne prend point de plaisir en lui\FTNT{\vref{Ha. 2:4}.}.
...
\VS{4}Par la foi, Abel\FTNT{\vref{Ge. 4:3-5}.} offrit à Dieu un sacrifice plus excellent que Caïn~; et par elle il obtînt le témoignage d'être juste, parce que Dieu rendait témoignage de ses offrandes~; et c'est par elle qu'il parle encore, quoique mort.
\VS{5}Par la foi, Hénoc\FTNT{\vref{Ge. 5:22-24}.} fut enlevé pour ne pas voir la mort, et il ne parut plus parce que Dieu l'avait enlevé~; car, avant qu'il soit enlevé, il avait obtenu le témoignage d'avoir été agréable à Dieu.
...
\VS{7}Par la foi, Noé\FTNT{\vref{Ge. 6:14-22}.}, ayant été divinement averti des choses qui ne se voyaient point encore, craignit, et bâtit l'arche pour la conservation de sa famille~; et par cette arche, il condamna le monde, et devint héritier de la justice qui est selon la foi.
\VS{8}Par la foi, Abraham\FTNT{Ge \vref{12:1-4}.}, étant appelé, obéit, pour aller sur la terre, qu'il devait recevoir en héritage, et il partit sans savoir où il allait.
...
\VS{11}Par la foi, aussi Sara\FTNT{\vref{Ge. 21:1-2}.} reçut la force de concevoir un enfant, et elle enfanta hors d'âge, parce qu'elle fut persuadée que celui qui le lui avait promis, était fidèle.
\VS{12}C'est pourquoi d'un seul homme, et qui était déjà affaibli, il est né une multitude aussi nombreuse que les étoiles du ciel, et que le sable du bord de la mer, qui ne peut se compter\FTNT{\vref{Ge. 22:17}.}.
\VS{13}Tous ceux-ci sont morts dans la foi, sans avoir reçu les choses dont ils avaient eu les promesses, mais ils les ont vues de loin, crues, et saluées, et ils ont fait profession qu'ils étaient étrangers et voyageurs sur la terre\FTNT{\vref{1 Pi. 2:11}.}.
...
\VS{16}Mais maintenant, ils en désirent une meilleure, c'est-à-dire une céleste. C'est pourquoi Dieu n'a pas honte d'être appelé leur Dieu, parce qu'il leur a préparé une cité\FTNT{\vref{Jn. 14:2}~; \vref{Ap. 21:2}.}.
\VS{17}Par la foi, Abraham étant éprouvé, offrit Isaac~; celui qui avait reçu les promesses offrit même son fils unique\FTNT{\vref{Ge. 22:1}.},
\VS{18}à l'égard duquel il lui avait été dit~: Les descendants d'Isaac seront ta véritable postérité\FTNT{\vref{Ge. 21:12}.}.
...
\VS{20}Par la foi, Isaac bénit Jacob et Esaü, en vue des choses à venir\FTNT{\vref{Ge. 27:26-40}.}.
\VS{21}Par la foi, Jacob mourant bénit chacun des fils de Joseph\FTNT{\vref{Ge. 48:1-22}.}, et adora Dieu, appuyé sur l'extrémité de son bâton\FTNT{\vref{Ge. 47:31}.}.
\VS{22}Par la foi, Joseph mourant fit mention de la sortie des enfants d'Israël, et il donna des ordres au sujet de ses os\FTNT{\vref{Ge. 50:24-25}.}.
\VS{23}Par la foi, Moïse\FTNT{\vref{Ex. 2:1-3}.}, à sa naissance, fut caché pendant trois mois par son père et sa mère, parce qu'ils virent que l'enfant était beau, et ils ne craignirent pas l'ordre du roi.
...
\VS{28}Par la foi, il fit la Pâque et l'aspersion du sang, afin que le destructeur qui tuait les premiers-nés, ne touche pas aux premiers-nés des Israélites\FTNT{\vref{Ex. 12:1-51}.}.
\VS{29}Par la foi, ils traversèrent la Mer Rouge, comme un lieu sec, ce que les Egyptiens essayèrent de tenter, ils furent engloutis dans les eaux\FTNT{\vref{Ex. 14:13-31}.}.
\VS{30}Par la foi, les murs de Jéricho tombèrent, après qu'on en eut fait le tour pendant sept jours\FTNT{\vref{Jos. 6:1-20}.}.
\VS{31}Par la foi, Rahab, la prostituée, ne périt pas avec les incrédules, parce qu'elle avait reçu les espions et les avait renvoyés en paix\FTNT{\vref{Jos. 2:1-21}~; \vref{Jos. 6:23}.}.
\VS{32}Et que dirai-je encore~? Car le temps me manquerait si je voulais parler de Gédéon\FTNT{\vref{Jg. 6:11}.}, et de Barak\FTNT{\vref{Jg. 4:6}.}, et de Samson\FTNT{\vref{Jg. 13:24}.}, et de Jephté\FTNT{\vref{Jg. 11:1}.}, et de David\FTNT{\vref{1 S. 16-17}.}, et de Samuel\FTNT{1 S. et 2 S.}, et des prophètes,
...
\VS{6}car le Seigneur châtie celui qu'il aime, et il frappe de la verge tous ceux qu'il reconnaît pour ses fils\FTNT{\vref{Pr. 3:11-12}.}.
...
\VS{16}que nul de vous ne soit fornicateur, ou profane comme Esaü, qui pour un aliment vendit son droit d'aînesse\FTNT{\vref{Ge. 25:33}}.
...
\VS{18}Vous ne vous êtes pas approchés d'une montagne qu'on pouvait toucher avec la main\FTNT{\vref{Ex. 19:12}.}, ni du feu brûlant, ni de la nuée épaisse, ni des ténèbres, ni de la tempête,
\VS{19}ni du retentissement de la trompette, ni du son des paroles, au sujet duquel ceux qui l'entendirent prièrent que la parole ne leur soit plus adressée\FTNT{\vref{Ex. 20:18-26}.},
\VS{20}car ils ne pouvaient pas supporter ce qui était ordonné, que si même une bête touche la montagne, elle sera lapidée ou percée d'un dard\FTNT{\vref{Ex. 19:13}.}.
...
\VS{26}lui, dont la voix ébranla alors la terre, mais à l'égard du temps présent, il a fait cette promesse, disant~: J'ébranlerai encore une fois non seulement la terre, mais aussi le ciel\FTNT{\vref{Ag. 2:6}.}.
...
\VS{29}car notre Dieu est aussi un feu dévorant\FTNT{\vref{De. 4:24}.}.
\Chap{13}
...
\VS{5}Que votre conduite soit sans avarice, étant contents de ce que vous avez présentement~; car lui-même a dit~: Je ne te délaisserai point, et je ne t'abandonnerai point\FTNT{\vref{De. 31:6}.}.
\VS{6}De sorte que nous pouvons dire avec assurance~: Le Seigneur est mon aide, et je ne craindrai point ce que l'homme pourrait me faire\FTNT{\vref{Ps. 118:6}.}.
...
\VS{11}Car les corps des animaux, dont le sang est porté dans le sanctuaire par le premier prêtre pour le péché, sont brûlés hors du camp.
\VS{12}C'est pourquoi aussi Jésus, afin de sanctifier le peuple par son propre sang, a souffert hors de la porte\FTNT{\vref{Ex. 29:14}. Jésus a souffert hors de Jérusalem (\vref{Jn. 19:17-18}).}.
