...
\VS{16}Ils habitèrent en Galaad, et en Basan, dans les villes de son ressort, et dans toutes les faubourgs de Saron, jusqu'à leurs limites.
...
\VS{55}on leur donna Hébron dans le pays de Juda, et sa faubourg tout autour.
\VS{56}Mais on donna à Caleb, fils de Jephunné, le territoire de la ville et ses villages.
\VS{57}On donna donc aux fils d'Aaron, d'entre les villes de refuge, Hébron, Libna et sa faubourg, Jatthir et Eschthemoa, avec leurs faubourgs,
\VS{58}Hilen, avec sa faubourg, Debir avec sa faubourg,
\VS{59}Aschan avec sa faubourg, et Beth-Schémesch avec sa faubourg.
...
\VS{67}Car on leur donna entre les villes de refuge, Sichem avec sa faubourg, dans la montagne d'Ephraïm, Guézer avec sa faubourg,
\VS{68}Jokmeam avec sa faubourg, Beth-Horon avec sa faubourg,
\VS{69}Ajalon avec sa faubourg, et Gath-Rimmon avec sa faubourg.
\VS{70}De la demi-tribu de Manassé, Aner avec sa faubourg, et Bileam avec sa faubourg, on donna ces villes-là aux familles qui restaient des fils de Kehath.
\VS{71}Aux fils de Guerschon, on donna, des familles de la demi-tribu de Manassé, Golan en Basan avec sa faubourg, et Aschtaroth, avec sa faubourg.
\VS{72}De la tribu d'Issacar, Kédesch avec sa faubourg, Dobrath avec sa faubourg,
\VS{73}Ramoth avec sa faubourg, et Anem avec sa faubourg.
\VS{74}Et de la tribu d'Aser, Maschal, avec sa faubourg, Abdon, avec sa faubourg,
\VS{75}Hukok avec sa faubourg, et Rehob avec sa faubourg.
\VS{76}De la tribu de Nephthali, Kédesch en Galilée avec sa faubourg, Hammon avec sa faubourg, et Kirjathaïm avec sa faubourg.
\VS{77}Aux fils de Merari, qui étaient le reste d'entre les Lévites, on donna, de la tribu de Zabulon, Rimmono avec sa faubourg, et Thabor avec sa faubourg.
\VS{78}Au-delà du Jourdain, vis-à-vis de Jéricho, vers l'orient du Jourdain, de la tribu de Ruben, Betser au désert avec sa faubourg, Jahtsa avec sa faubourg,
\VS{79}Kedémoth avec sa faubourg, et Méphaath avec sa faubourg.
\VS{80}De la tribu de Gad, Ramoth en Galaad avec sa faubourg, Mahanaïm avec sa faubourg,
\VS{81}Hesbon avec sa faubourg, et Jaezer avec sa faubourg.
\Chap{7}
...
\VS{18}du côté de la faubourg vers l'occident, il y en avait quatre au chemin, et deux vers la faubourg.
