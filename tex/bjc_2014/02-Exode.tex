...
\VS{18}Or tout le peuple apercevait les tonnerres, les éclairs, le son du shofar, la montagne fumante. Et le peuple voyant cela tremblait et se tenait loin.
...
\VS{26}Tu ne monteras point à mon autel par des marches, de peur que ta nudité ne soit découverte en y montant.
\Chap{21}
...
\VS{36}Tu sacrifieras pour le péché tous les jours un veau pour faire l’expiation, et tu offriras pour l'autel un sacrifice pour le péché en faisant la propitiation pour lui, et tu l'oindras pour le sanctifier\FTNT{Ez. 43:19-20.}.
\VS{37}Pendant sept jours, tu feras la propitiation sur l'autel, et tu le sanctifieras ; l'autel sera une chose très sainte ; tout ce qui touchera l'autel sera saint\FTNT{No. 28:3.}.
...
\VS{10}Aaron fera une fois l'an la propitiation sur les cornes de cet autel ; il fera, dis-je, la propitiation une fois l'an sur cet autel parmi vos descendants, avec le sang de l'offrande pour le péché, faite pour les propitiations. C'est une chose très sainte à Yahweh.
...
\VS{30}Le lendemain Moïse dit au peuple : Vous avez commis un grand péché ; mais je monterai maintenant vers Yahweh, et je ferai peut-être la propitiation pour votre péché.
