...
\VS{7}Les enfants d'Israël fructifièrent et s'accrurent abondamment, et se multiplièrent et devinrent extrêmement puissants, de sorte que le pays en fut rempli\FTNT{\vref{De. 26:5}~; \vref{Ac. 7:17}.}.
...
\VS{12}Mais plus ils l'affligeaient et plus il multipliait et croissait en toute abondance~; c'est pourquoi ils haïssaient les enfants d'Israël\FTNT{\vref{Ps. 105:24}.}.
\VS{13}Et les Egyptiens assujettirent les enfants d'Israël à une rude servitude\FTNT{\vref{Ge. 15:13}.}.
...
\Chap{2}
\TextTitle{Naissance de Moïse\FTNTT{\vref{Hé. 11:23-27}.}}
\VerseOne{}Un homme de la maison de Lévi s'en alla et prit une fille de Lévi\FTNT{\vref{No. 26:59}.}.
\VS{2}Cette femme conçut et enfanta un fils. Voyant qu'il était beau, elle le cacha pendant trois mois\FTNT{\vref{Hé. 11:23}}.
...
\VS{11}Or il arriva, en ce temps-là, que Moïse, étant devenu grand, sortit vers ses frères et vit leurs travaux~; il vit aussi un Egyptien qui frappait un Hébreu d'entre ses frères\FTNT{\vref{Hé. 11:24-25}.}.
...
\VS{23}Or il arriva longtemps après que le roi d'Egypte mourut, et les enfants d'Israël soupirèrent à cause de la servitude, et ils crièrent~; et leur cri monta jusqu'à Dieu, à cause de la servitude\FTNT{\vref{No. 20:15-16}.}.
...
\VS{6}Il dit aussi~: Je suis le Dieu de ton père, le Dieu d'Abraham, le Dieu d'Isaac et le Dieu de Jacob\FTNT{\vref{Mt. 22:32}~; \vref{Mc. 12:26}~; \vref{Lu. 20:37}~; \vref{Ac. 7:32}.}~; Moïse cacha son visage, parce qu'il craignait de regarder vers Dieu.
...
\VS{10}Maintenant donc viens, et je t'enverrai vers Pharaon~; et tu retireras mon peuple, les enfants d'Israël, hors d'Egypte\FTNT{\vref{Os. 12:14}~; \vref{Mi. 6:4}.}.
...
\VS{14} Et Dieu dit à Moïse~: JE SUIS CELUI QUI SUIS. Il dit aussi~: Tu diras ainsi aux enfants d'Israël~: Celui qui s'appelle JE SUIS\FTNT{Je suis («~Ehyeh~» en hébreu), c'est de là que vient le Nom de Yahweh. Or le Nom de Jésus signifie «~Yahweh est Salut~». Dieu révèle son Nom à Moïse~: «~Je suis celui qui suis~». Or Jésus-Christ s'est ouvertement attribué ce Nom en \vref{Jn. 8:58}. N'ayant compris ni le plan de Dieu ni qui était celui qui les visitait, les religieux Juifs ont voulu le lapider car ils estimaient qu'il blasphémait. Car en déclarant être «~Je suis~», Jésus-Christ proclamait ouvertement sa divinité (\vref{Ro. 9:5}), chose que les Juifs ne pouvaient concevoir. Dans l'évangile de Jean, Jésus déclare clairement qu'il est le «~JE SUIS~» d'\vref{Ex. 3:14}. «~Je suis le pain de vie~» (\vref{Jn. 6:35}), «~Je suis la lumière du monde~» (\vref{Jn. 8:12}), «~Je suis le bon berger~» (\vref{Jn. 10:11}), «~Je suis la porte~» (\vref{Jn. 10:7}), «~Je suis la résurrection~» (\vref{Jn. 11:25}), «~Je suis le chemin, la vérité et la vie~» (\vref{Jn. 14:6}), «~Je suis la vraie vigne~» (\vref{Jn. 15:1}).}, m'a envoyé vers vous.
...
\VS{11}Et Yahweh lui dit~: Qui a fait la bouche de l'homme~? Ou qui a fait le muet, ou le sourd, ou le voyant, ou l'aveugle~? N'est-ce pas moi Yahweh\FTNT{\vref{Ps. 94:9}.}~?
\VS{12}Va donc maintenant, je serai avec ta bouche et je t'enseignerai ce que tu auras à dire\FTNT{\vref{Lu. 12:12}~; \vref{Mt. 10:19}~; \vref{Mc. 13:11}.}.
...
\VS{22}Tu diras donc à Pharaon, ainsi parle Yahweh~: Israël est mon fils, mon premier-né\FTNT{\vref{Os. 11:1}.}.
...
\Chap{5}
\TextTitle{Pharaon s'oppose à Moïse\FTNTT{\vref{Ex. 5-14}.}}
...
\VS{14}Voici les chefs des pères~: Les fils de Ruben, premier-né d'Israël~: Hénoc et Pallu, Hetsron et Carmi~; ce sont là les familles de Ruben\FTNT{\vref{Ge. 46:9}~; \vref{No. 26:5}~; \vref{1 Ch. 5:3}.}.
...
\VS{5}Les Egyptiens connaîtront\FTNT{Les nations reconnaîtront que Jésus-Christ est le Dieu d'Israël lorsqu'il reviendra en Sion pour délivrer et restaurer son peuple (\vref{Za. 14}).} que je suis Yahweh quand j'aurai étendu ma main sur l'Egypte, et que j'aurai retiré du milieu d'eux les enfants d'Israël.
...
\VS{15}Alors les magiciens dirent à Pharaon~: C'est ici le doigt de Dieu\FTNT{\vref{Lu. 11:20}.}~! Toutefois, le cœur de Pharaon s'endurcit et il ne les écouta point, selon ce que Yahweh avait dit.
...
\VS{17}Car si tu ne laisses pas aller mon peuple, voici, je m'en vais envoyer contre toi, contre tes serviteurs, contre ton peuple et contre tes maisons, un mélange d'insectes~; et les maisons des Egyptiens seront remplies de ce mélange, et la terre aussi sur laquelle ils seront \FTNT{\vref{Ps. 105:31}~; \vref{Ps. 78:43}.}.
...
\VS{16}Mais certainement, je t'ai fait subsister pour te faire voir ma puissance, afin que mon Nom soit célébré sur toute la terre\FTNT{\vref{Ro. 9:17}.}.
...
\VS{29}Alors Moïse dit~: Aussitôt que je sortirai de la ville, j'étendrai mes mains vers Yahweh et les tonnerres cesseront. Il n'y aura plus de grêle, afin que tu saches que la terre est à Yahweh\FTNT{\vref{Ps. 24:1}.}.
...
\VS{22}Moïse étendit donc sa main vers les cieux, et il y eut d'épaisses ténèbres dans tout le pays d'Egypte, pendant trois jours\FTNT{\vref{Ps. 105:28}.}.
...
\VS{29}Alors Moïse répondit~: Tu as bien dit, je ne reverrai plus ta face\FTNT{\vref{Hé. 11:27}.}.
\Chap{11}
...
\VS{5}Or le petit d'entre les brebis ou d'entre les chèvres sera sans défaut, et sera un mâle ayant un an\FTNT{La Pâque juive était célébrée le 14ème jour du premier mois de l'année juive soit le 14 du mois de Nissan (\vref{Ex. 12:2}~; \vref{No. 9:1-5}). L'agneau pascal était une préfiguration de Jésus-Christ, l'agneau de Dieu qui ôte le péché du monde (\vref{Jn. 1:29}). Ses caractéristiques sont les suivantes~: 
\\- L'agneau devait nécessairement être un mâle sans défaut (\vref{Ex. 12:5}). Jésus est l'enfant mâle mis au monde par une vierge, il n'a pas été affecté par le sang corrompu d'Adam, il est donc sans défaut (\vref{Es. 7:14}~; \vref{Mt. 1:20-21}). Pour être certains de la perfection de l'animal, les hébreux devaient l'examiner pendant quatre jours avant de l'immoler (\vref{Ex. 12:3-6}). Il est à noter que la loi juive exigeait que deux ou trois témoins soient présents pour constater un crime ou un péché (\vref{De. 17:6}~; \vref{De. 19:15}). Ces quatre jours font donc office de quatre témoins pour attester de la pureté de l'animal. De même, les quatre auteurs de l'évangile attestent la sainteté du Seigneur. De plus, avant sa mise à mort, le Seigneur a été examiné par deux législations~: juive (le sanhédrin) et romaine (Ponce Pilate). Ces deux législations attestèrent, malgré elles, son innocence (\vref{Mt. 25:60}~; \vref{Mt. 27:24}~; \vref{Mc. 14:55-56}~; \vref{Mc. 15:14}~; \vref{Lu. 23:4}~; \vref{Jn. 18:31}~; \vref{Jn. 19:6}) et confirmèrent qu'il était sans défaut et donc digne d'être offert en sacrifice.
\\- Yahweh avait prescrit aux hébreux d'immoler l'agneau entre les deux soirs (\vref{Ex. 12:6}), c'est-à-dire avant le crépuscule, entre la neuvième et la onzième heure. Jésus fut arrêté la nuit de Pâque (\vref{Mc. 14:12-41}). Sa crucifixion eut lieu le lendemain, à la troisième heure (\vref{Mc. 15:25}), et sa mort survint à la neuvième heure (\vref{Mt. 27:45}). L'agneau devait être rôti au feu puis consommé avec du pain sans levain et des herbes amères (\vref{Ex. 12:8}). Le feu symbolise le jugement que le Seigneur a pris sur lui à cause de nos péchés (\vref{Es. 53:5}~; \vref{Ro. 4:25}~; \vref{1 Pi. 1:18-20}). Le pain sans levain est une autre image de Jésus, le pain de vie (\vref{Jn. 6:35}) sans aucun péché (\vref{1 Co. 5:8}). Les herbes amères préfigurent, quant à elles, l'affliction et la souffrance du Seigneur (\vref{Hé. 2:10}).}~; vous le prendrez d'entre les brebis ou d'entre les chèvres~;
...
\VS{30}Et Pharaon se leva de nuit, lui et ses serviteurs, et tous les Egyptiens~; et il y eut un grand cri en Egypte, parce qu'il n'y avait point de maison où il n'y ait eu un mort\FTNT{\vref{Hé. 11:28}~; \vref{No. 8:17}~; \vref{Ps. 78:51}~; \vref{Ps. 105:36}.}.
...
\VS{40}Or le séjour des enfants d'Israël en Egypte fut de quatre cent trente ans\FTNT{\vref{Ge. 15:13}~; \vref{Ac. 7:6}~; \vref{Ga. 3:17}.}.
...
\VS{42}C'est la nuit qui doit être soigneusement observée en l'honneur de Yahweh, parce qu'alors il les retira du pays d'Egypte~; cette nuit-là est à observer en l'honneur de Yahweh, par tous les enfants d'Israël de génération en génération\FTNT{\vref{De. 16:1-6}.}.
...
\VS{2}Sanctifie-moi tout premier-né, tout premier-né issu du sein maternel parmi les fils d'Israël, tant des hommes que des bêtes, car il est à moi\FTNT{\vref{Lé. 27:26-27}~; \vref{No. 3:13}~; \vref{No. 8:17}~; \vref{Lu. 2:22-23}.}.
...
\VS{9}Et ceci te sera pour signe sur ta main, et comme un rappel entre tes yeux, afin que la loi de Yahweh soit dans ta bouche, car Yahweh t'aura retiré d'Egypte par sa main puissante\FTNT{\vref{De. 6:8}~; \vref{De. 11:18}.}.
...
\VS{19}Et Moïse avait pris avec lui les ossements de Joseph, parce que Joseph avait expressément fait jurer les enfants d'Israël, en leur disant~: Dieu vous visitera très certainement, et vous transporterez donc avec vous mes ossements d'ici\FTNT{\vref{Ge. 50:25}~; \vref{Jos. 24:32}.}.
\VS{20}Et ils partirent de Succoth, et campèrent à Etham, qui est à l'extrémité du désert.
\VS{21}Et Yahweh allait devant eux, de jour dans une colonne de nuée pour les conduire par le chemin~; et de nuit dans une colonne de feu pour les éclairer, afin qu'ils marchent jour et nuit\FTNT{\vref{No. 9:13-23}~; \vref{No. 10:43}~; \vref{De. 1:33}~; \vref{Né. 9:12-19}~; \vref{1 Co. 10:1}.}.
...
\VerseOne{}Et Yahweh parla à Moïse et dit~:
\VS{2}Parle aux enfants d'Israël et dis-leur: Qu'ils se détournent, et qu'ils campent devant Pi-Hahiroth, entre Migdol et la mer, vis-à-vis de Baal-Tsephon. Vous camperez vis-à-vis de ce lieu-là près de la mer\FTNT{\vref{No. 33:7}.}.
...
\VS{8}Et Yahweh endurcit le cœur de Pharaon, roi d'Egypte, qui poursuivit les enfants d'Israël. Or les fils d'Israël étaient sortis à main levée\FTNT{\vref{Lé. 26:13}~; \vref{No. 33:3}.}.
...
\VS{21}Or Moïse avait étendu sa main sur la mer, et Yahweh fit reculer la mer toute la nuit par un vent d'orient qui souffla avec puissance~; il mit la mer à sec, et les eaux se fendirent\FTNT{\vref{Jos. 4:23}~; \vref{Ps. 66:6}~; \vref{Ps. 106:9}~; \vref{Hé. 11:29}.}.
...
\VS{5}Les gouffres les ont couverts, ils sont descendus au fond des eaux comme une pierre\FTNT{\vref{Né. 9:11}.}.
\VS{6}Ta droite, ô Yahweh, s'est montrée magnifique en force~! Ta droite, ô Yahweh, a brisé l'ennemi\FTNT{\vref{Ps. 118:15-16}~; \vref{Ps. 77:16}.}~!
...
\VS{16}La frayeur et l'épouvante tomberont sur eux~; ils seront rendus muets comme une pierre par la grandeur de ton bras, jusqu'à ce que ton peuple soit passé, ô Yahweh~! Jusqu'à ce que ce peuple que tu as acquis soit passé\FTNT{\vref{De. 2:25}~; \vref{De. 11:25}~; \vref{Jos. 2:9}.}.
...
\VS{26}et lui dit~: Si tu écoutes attentivement la voix de Yahweh, ton Dieu, si tu fais ce qui est droit devant lui, si tu prêtes l'oreille à ses commandements, si tu gardes toutes ses ordonnances, je ne ferai venir sur toi aucune des infirmités que j'ai fait venir sur l'Egypte, car je suis Yahweh qui te guérit\FTNT{\vref{De. 7:12-15}.}.
...
\VS{3}Et les enfants d'Israël leur dirent~: Ah~! Pourquoi ne sommes-nous point morts par la main de Yahweh dans le pays d'Egypte, quand nous étions assis près des pots de viande, et que nous mangions du pain à satiété~? Car vous nous avez amenés dans ce désert pour faire mourir de faim toute cette assemblée\FTNT{\vref{1 Co. 10:10}~; \vref{No. 11:4}.}.
...
\VS{15}Ce que les enfants d'Israël ayant vu, ils se dirent l'un à l'autre~: Qu'est-ce~? Car ils ne savaient ce que c'était. Et Moïse leur dit~: C'est le pain que Yahweh vous donne à manger\FTNT{\vref{Ps. 105:40}.}.
...
\TextTitle{Le sabbat\FTNTT{\vref{Né. 9:13-14}~; \vref{Mt. 12:1}.}}
...
\VS{31}Et la maison d'Israël nomma ce pain manne\FTNT{Le mot «~manne~» vient de l'hébreu «~man~» et veut dire «~Qu'est-ce que cela~?~». La manne est une image de Jésus, le Pain de vie descendu du ciel (\vref{Jn. 6:32-52}). La consommation quotidienne du Pain de vie, qui est aussi la Parole de Dieu, apporte la vie éternelle.}. Elle était comme de la semence de coriandre blanche, et ayant le goût d'un gâteau au miel.
...
\VS{2}Et le peuple se souleva contre Moïse et ils lui dirent~: Donnez-nous de l'eau à boire. Et Moïse leur dit~: Pourquoi vous soulevez-vous contre moi~? Pourquoi tentez-vous Yahweh\FTNT{\vref{No. 20:2-5}.}~?
...
\VS{6}Voici, je vais me tenir là devant toi sur le rocher d'Horeb~; et tu frapperas le rocher, et il en sortira des eaux, et le peuple en boira. Moïse donc fit ainsi aux yeux des anciens d'Israël\FTNT{\vref{De. 9:8}~; \vref{Ps. 78:15}~; \vref{1 Co. 10:4}.}.
...
\VS{8}Alors Amalek vint et livra bataille contre Israël à Rephidim\FTNT{\vref{De. 25:17-18}.}.
...
\Chap{19}
\TextTitle{Yahweh veut un royaume de prêtres}
...
\VS{5}Maintenant donc, si vous obéissez exactement à ma voix, et si vous gardez mon alliance, vous serez aussi d'entre tous les peuples mon plus précieux joyau, car toute la terre m'appartient\FTNT{C'est ici que débute la période de la Loi ou Première Alliance. Le fait d'avoir réuni les textes de Genèse à Malachie sous l'appellation «~Ancien Testament~» a induit beaucoup de personnes en erreur quant à leur compréhension du plan de Dieu pour nos vies. Tout d'abord, l'emploi du mot «~testament~» est inapproprié puisqu'on ne peut parler de testament sans qu'il y ait au préalable la mort du testateur (\vref{Hé. 9:16-17}). Certes, des animaux étaient tués sous la Loi pour couvrir les péchés. Toutefois, ces sacrifices étaient imparfaits et par conséquent prévus pour ne durer qu'un temps, en attendant le sacrifice parfait de Jésus-Christ (\vref{Hé. 10:1-14}). De plus, il est évident que les animaux sacrifiés ne nous ont rien légué.
\\ Ensuite, il est à noter que tous les textes classés dans ce que l'on appelle à tort «~Ancien Testament~» ne se rapportent pas exclusivement et nécessairement à la Loi. Ainsi, des prophètes, en commençant par Moïse en personne, ayant vécu sous la Loi, ont prophétisé et écrit sur d'autres sujets que la Loi, notamment sur la grâce et la fin des temps. N'oublions pas non plus que Jésus-Christ est né et a vécu sous la Loi (\vref{Ga. 4:4}). En tant que juif, il l'a scrupuleusement respectée de telle sorte qu'elle fut totalement accomplie en Lui (\vref{Mt. 5:17-18}~; \vref{Jn. 19:30}). En conséquence, la fin de la Loi mosaïque eut lieu après la mort du Seigneur, précisément au moment où le Seigneur a dit «~Tout est accompli~», et lorsque le voile du temple s'est déchiré de haut en bas (\vref{Mt. 27:50-51}~; \vref{Jn. 19:30}). La Nouvelle Alliance, ou le Testament de Jésus débuta avec l'effusion de l'Esprit (\vref{Ac. 2}). De la mort du Seigneur à la Pentecôte, une période de transition de cinquante jours s'est écoulée. Jésus-Christ s'est présenté pendant ce temps dans le sanctuaire céleste pour présenter son sang dans le Saint des saints. Une fois son sacrifice examiné et accepté, le Saint-Esprit qui avait été retiré de l'homme (\vref{Ge. 6:3}) put de nouveau revenir habiter les cœurs des croyants. 
...
\VS{4}Tu ne te feras point d'image taillée, ni aucune ressemblance des choses qui sont là-haut aux cieux, ni ici-bas sur la terre, ni dans les eaux sous la terre\FTNT{\vref{Lé. 26:1}.}.
...
\VS{7}Tu ne prendras point le Nom de Yahweh, ton Dieu, en vain~; car Yahweh ne tiendra point pour innocent celui qui aura pris son Nom en vain\FTNT{\vref{Lé. 19:12}~; \vref{Mt. 5:33}.}.
...
\VS{11}Car Yahweh a fait en six jours les cieux, la terre, la mer, et tout ce qui est en eux, et s'est reposé le septième jour~; c'est pourquoi Yahweh a béni le jour du repos et l'a sanctifié\FTNT{\vref{Ge. 2:3}~; \vref{Ex. 31:14}~; \vref{Ez. 20:12}.}.
\VS{12}Honore ton père et ta mère, afin que tes jours soient prolongés sur la terre que Yahweh, ton Dieu, te donne\FTNT{\vref{Lé. 19:3}~; \vref{De. 5:16}~; \vref{Mt. 15:4}~; \vref{Ep. 6:2}.}.
\VS{13}Tu ne commettras pas de meurtre\FTNT{\vref{Mt. 5:21}.}.
\VS{14}Tu ne commettras pas d'adultère\FTNT{\vref{Lé. 20:10}~; \vref{De. 5:18}~; \vref{Pr. 6:32}~; \vref{Mt. 5:32}~; \vref{Ro. 7:3}.}.
...
\VS{19}Et ils dirent à Moïse~: Parle, toi, avec nous, et nous écouterons~; mais que Dieu ne parle point avec nous, de peur que nous ne mourrions\FTNT{\vref{De. 5:23-24}~; \vref{Hé. 12:18-19}.}.
...
\VS{24}Tu me feras un autel de terre, sur lequel tu sacrifieras tes holocaustes, et tes offrandes de paix\FTNT{Voir commentaire en \vref{Lé. 3:1}.}, ton menu et ton gros bétail. En quelque lieu que ce soit où je mettrai la mémoire de mon Nom, je viendrai là à toi, et je te bénirai.
...
\VS{2}Si tu achètes un esclave Hébreu, il te servira six ans, et au septième il sortira pour être libre, sans rien payer\FTNT{\vref{Lé. 25:39-43}~; \vref{De. 15:12}~; \vref{Jé. 34:14}.}.
...
\VS{12}Si quelqu'un frappe un homme et qu'il en meure,on le fera mourir de mort \FTNT{\vref{Lé. 24:17}~; \vref{No. 35:11-16}~; \vref{De. 19:2-11}~; \vref{Jos. 20:2}.}.
...
\VS{15}Celui qui aura frappé son père ou sa mère sera puni de mort\FTNT{\vref{Lé. 20:9}~; \vref{De. 27:16}~; \vref{Mt. 15:4}.}.
...
\VS{24}œil pour œil, dent pour dent, main pour main, pied pour pied\FTNT{\vref{Lé. 24:20}~; \vref{De. 19:21}~; \vref{Mt. 5:38}.},
...
\VS{7}Si quelqu'un donne à son prochain de l'argent ou des vases à garder, et qu'on le dérobe de sa maison, et si l'on trouve le voleur, il rendra le double\FTNT{\vref{Lé. 5:20-26}.}.
...
\VS{11}le serment de Yahweh interviendra entre les deux parties\FTNT{\vref{Hé. 6:16}.}, pour savoir s'il n'a point mis sa main sur le bien de son prochain, et le maître de la bête se contentera du serment, et l'autre ne la rendra point.
...
\VS{16}Si un homme séduit une vierge non fiancée, et couche avec elle, il faut qu'il la dote, et qu'il la prenne pour femme\FTNT{\vref{De. 22:28}.}.
...
\VS{18}Tu ne laisseras point vivre la sorcière\FTNT{\vref{De. 18:10-11}~; \vref{Lé. 20:27}.}.
\VS{19}Celui qui couche avec une bête sera puni de mort\FTNT{\vref{Lé. 18:23}~; \vref{Lé. 20:15}~; \vref{De. 27:21}.}.
\VS{20}Celui qui sacrifie à d'autres dieux qu'à Yahweh seul sera dévoué à la façon de l'interdit\FTNT{\vref{Lé. 17:7}~; \vref{De. 13:6-16}~; \vref{De. 17:2-5}.}.
\VS{21}Tu ne fouleras ni n'opprimeras point l'étranger~; car vous avez été étrangers au pays d'Egypte\FTNT{\vref{Lé. 19:34}.}.
\VS{22}Vous n'affligerez point la veuve ni l'orphelin\FTNT{\vref{De. 24:17-18}~; \vref{Za. 7:10}.}.
...
\VS{26}Si tu prends en gage le vêtement de ton prochain, tu le lui rendras avant que le soleil soit couché\FTNT{\vref{De. 24:10-13}.}.
...
\VS{28}Tu ne maudiras point les juges, et tu ne maudiras point le prince de ton peuple\FTNT{\vref{Lé. 24:15-16}.}.
\VS{29}Tu ne différeras point de m'offrir de ton abondance et de tes liqueurs~; tu me donneras le premier-né de tes fils\FTNT{\vref{Ex. 13:12-15}~; \vref{De. 26:2-11}.}.
...
\VerseOne{}Tu ne léveras point de faux bruit, et tu ne te joindras point au méchant pour être un faux témoin, afin que violence soit faite\FTNT{\vref{Ex. 20:16}~; \vref{De. 19:16-21}.}.
...
\VS{3}Tu n'honoreras point le pauvre dans son procès\FTNT{\vref{De. 1:17}.}.
...
\VS{13}Vous prendrez garde à toutes les choses que je vous ai ordonnées. Vous ne ferez point mention du nom des dieux étrangers, on ne l'entendra point de ta bouche\FTNT{\vref{Jos. 23:7}~; \vref{Ps. 16:4}.}.
\TextTitle{Les fêtes solennelles}
\VS{14}Trois fois l'an, tu me célébreras une fête solennelle\FTNT{\vref{Lé. 23:4-44}.}.
\VS{15}Tu garderas la fête solennelle des pains sans levain\FTNT{\vref{Ex. 29:2}.}~; tu mangeras des pains sans levain pendant sept jours, comme je t'ai ordonné, en la saison et au mois où les épis mûrissent~; car c'est en ce mois-là que tu es sorti d'Egypte~; et nul ne se présentera devant ma face à vide.
\VS{16}Et la fête solennelle de la moisson des premiers fruits de ton travail, de ce que tu auras semé au champ~; et la fête de la récolte, après la fin de l'année, quand tu auras recueilli du champ les fruits de ton travail\FTNT{\vref{Ex. 34:22}.}.
\VS{17}Trois fois l'an, tous les mâles d'entre vous se présenteront devant le Seigneur Yahweh.
\VS{18}Tu ne sacrifieras point le sang de mon sacrifice avec du pain levé~; et la graisse de ma fête solennelle ne passera point la nuit jusqu'au matin\FTNT{\vref{Ex. 34:25-26}.}.
...
\VS{24}Tu ne te prosterneras point devant leurs dieux, et tu ne les serviras point, et tu ne feras point selon leurs œuvres, mais tu les détruiras entièrement, et tu briseras entièrement leurs statues\FTNT{\vref{Ex. 20:5}~; \vref{Ex. 34:13}~; \vref{No. 33:52}.}.
\VS{25}Vous servirez Yahweh, votre Dieu. Et il bénira ton pain et tes eaux~; et j'ôterai les maladies du milieu de toi\FTNT{\vref{Ex. 15:26}~; \vref{De. 6:13}~; \vref{De. 7:15-16}~; \vref{Mt. 4:10}.}.
\VS{26}Il n'y aura point dans ton pays de femme qui avorte, ou qui soit stérile~; j'accomplirai le nombre de tes jours.
\VS{27}J'enverrai la terreur de mon Nom devant toi, et j'effrayerai tout peuple vers lequel tu arriveras, et je ferai que tous tes ennemis tourneront le dos devant toi\FTNT{\vref{De. 7:23}.}.
\VS{28}Et j'enverrai des frelons devant toi, qui chasseront les Héviens, les Cananéens, et les Héthiens, de devant ta face\FTNT{\vref{De. 7:20}~; \vref{Jos. 24:12}.}.
...
\VS{8}Moïse donc prit le sang, et le répandit sur le peuple, en disant~: Voici le sang de l'Alliance que Yahweh a traitée avec vous, selon toutes ces paroles\FTNT{\vref{Mt. 26:28}~; \vref{Mc. 14:24}~; \vref{Lu. 22:20}~; \vref{1 Co. 11:25}~; \vref{Hé. 9:20}.}.
...
\VS{15}Moïse donc monta sur la montagne, et une nuée couvrit la montagne\FTNT{\vref{Ex. 19:9-16}.}.
...
\VS{17}Et ce qu'on voyait de la gloire de Yahweh au sommet de la montagne, était comme un feu dévorant aux yeux des enfants d'Israël\FTNT{\vref{De. 4:24}~; \vref{De. 9:3}~; \vref{Hé. 12:29}.}.
...
\VS{8}Et ils me feront un sanctuaire, et j'habiterai au milieu d'eux\FTNT{\vref{Ex. 29:45-46}.}.
...
\VS{11}Et tu la couvriras d'or pur, tu l'en couvriras en dehors et en dedans~; et tu feras sur elle un couronnement d'or tout autour\FTNT{\vref{Ex. 37:1-9}.}.
...
\VS{16}Et tu mettras dans l'arche le témoignage que je te donnerai\FTNT{\vref{Hé. 9:4}.}.
...
\VS{20}Et les chérubins étendront les ailes en haut, couvrant de leurs ailes le propitiatoire, et leurs faces seront vis-à-vis l'une de l'autre~; et le regard des chérubins sera vers le propitiatoire\FTNT{\vref{1 R. 8:6-7}~; \vref{Hé. 9:5}.}.
\VS{21}Et tu poseras le propitiatoire au-dessus de l'arche, et tu mettras dans l'arche le témoignage que je te donnerai.
\VS{22}Et je me rencontrerai là avec toi, et je te dirai de dessus le propitiatoire, d'entre les deux chérubins qui seront sur l'arche du témoignage, toutes les choses que je t'ordonnerai pour les enfants d'Israël\FTNT{\vref{Ex. 29:42-43}~; \vref{No. 7:89}.}.
...
\VS{29}Tu feras aussi ses plats, ses tasses, ses gobelets, et ses bassins, avec lesquels on fera les aspersions~; tu les feras d'or pur\FTNT{\vref{Ex. 37:10-16}.}.
\VS{30}Et tu mettras sur cette table le pain de proposition continuellement devant moi\FTNT{\vref{Lé. 24:5-9}.}.
\TextTitle{Le chandelier d'or pur}
\VS{31}Tu feras aussi un chandelier d'or pur\FTNT{Le chandelier avait un double symbolique. D'une part, il préfigurait Jésus-Christ, notre Lumière (\vref{Jn. 1:4-5}~; \vref{Jn. 8:12}). Les sept lampes évoquaient l'omniscience de l'Esprit de Jésus-Christ (\vref{Za. 3:9}~; \vref{Jn. 16:29-30}~; \vref{Ap. 1:4}~; \vref{Ap. 3:1}~; \vref{Ap. 4:5}~; \vref{Ap. 5:6}). Il est à noter que ce chandelier comportait des calices en forme de fleurs, de pommes et d'amandes (\vref{Ex. 25:33}) qui symbolisaient les fruits de l'Esprit que nous devons nécessairement porter (\vref{Ga. 5:22}). D'autre part, il est une image de l'Eglise (\vref{Ap. 1:20}). Voir commentaire \vref{Ex. 37:17-24}~; \vref{Es. 8:13-17}.}. Le chandelier sera étendu au marteau~; son pied, sa tige et ses branches, ses plats, ses pommeaux et ses fleurs seront tirés de lui.
...
\VerseOne{}Tu feras aussi le tabernacle de dix tapis de fin lin retors, de pourpre, d'écarlate, et de cramoisi~; et tu les feras semés de chérubins d'un ouvrage exquis\FTNT{\vref{Ex. 36:8-38}.}.
...
\VS{14}Tu feras aussi pour ce tabernacle une couverture de peaux de béliers teintes en rouge, et une couverture de peaux de taissons par-dessus\FTNT{\vref{Ex. 35:7}~; \vref{Ex. 35:23}~; \vref{Ex. 36:19}~; \vref{Ex. 39:34}.}.
\TextTitle{Les planches et leurs bases}
\VS{15}Et tu feras pour le tabernacle, des planches de bois d'acacia, qu'on fera tenir debout\FTNT{\vref{Ex. 36:20-34}.}.
...
\VS{31}Et tu feras un voile\FTNT{Le voile intérieur symbolisait la chair de Jésus-Christ qui a été brisée à cause de nos péchés (\vref{Es. 53:5}~; \vref{Hé. 10:20}). \vref{Ex. 36:35-38}~; \vref{Mt. 27:51}~; \vref{Hé. 9:3}.} de pourpre, d'écarlate, de cramoisi, et de fin lin retors~; on le fera d'ouvrage exquis, avec des chérubins.
...
\VS{2}Tu feras ses cornes à ses quatre coins~; ses cornes seront tirées de lui, et tu le couvriras d'airain\FTNT{C'est sur l'autel d'airain que les animaux étaient sacrifiés. Il préfigurait la croix et le jugement que Jésus-Christ a pris sur lui à notre place (\vref{Es. 53:5}~; \vref{2 Co. 13:4}~; \vref{Ph. 2:8}).}.
...
\VS{8}Tu le feras creux avec des planches~; ils le feront ainsi qu'il t'a été montré sur la montagne\FTNT{\vref{Ex. 38:1-7}.}.
\TextTitle{Le parvis}
...
\VS{19}Que tous les ustensiles du tabernacle, pour tout son service, et tous ses pieux, avec les pieux du parvis, soient d'airain\FTNT{\vref{Ex. 38:9-20}.}.
\TextTitle{L'huile d'olive vierge pour les lampes}
\VS{20}Tu ordonneras aux fils d'Israël qu'ils t'apportent de l'huile d'olive vierge pour le luminaire, afin de faire luire les lampes continuellement\FTNT{\vref{Ex. 35:8-28}~; \vref{Lé. 24:1-4}.}.
...
\VerseOne{}Et toi, fais approcher de toi Aaron, ton frère, et ses fils avec lui, d'entre les enfants d'Israël, pour m'exercer la sacrificature, à savoir Aaron, Nadab et Abihu, Eléazar et Ithamar, fils d'Aaron.
...
\VS{39}Tu feras aussi une tunique de fin lin qui s'appliquera sur le corps, et tu feras aussi la tiare de fin lin~; mais tu feras la ceinture d'ouvrage de broderie\FTNT{\vref{Ex. 39:1-32}.}.
\VS{40}Tu feras aussi aux fils d'Aaron des tuniques, des ceintures, et des bonnets, pour leur gloire et leur ornement.
\VS{41}Et tu en revêtiras Aaron, ton frère, et ses fils avec lui~; tu les oindras, tu les consacreras et tu les sanctifieras~; puis ils m'exerceront la sacrificature\FTNT{\vref{Lé. 8:12}~; \vref{Lé. 16:32}~; \vref{No. 3:3}.}.
...
\VerseOne{}Or c'est ici ce que tu leur feras, quand tu les sanctifieras pour m'exercer la sacrificature~: Prends un veau du troupeau, et deux béliers sans tare\FTNT{\vref{Lé. 8:2}~; \vref{Lé. 9:2}~; \vref{Hé. 7:26-28}.}~;
\VS{2}et des pains sans levain, et des gâteaux sans levain pétris à l'huile, et des beignets sans levain, oints d'huile~; et tu les feras de fine farine de froment\FTNT{\vref{Lé. 6:13}.}.
...
\VS{4}Puis, tu feras approcher Aaron et ses fils à l'entrée de la tente d'assignation, et tu les laveras avec de l'eau\FTNT{\vref{Ex. 40:12}.}.
...
\VS{9}Et tu les ceindras des ceintures, Aaron, dis-je, et ses fils\FTNT{\vref{Es. 11:5}~; \vref{Ep. 6:14}.}, et tu leur attacheras des bonnets, et ils posséderont la sacrificature par ordonnance perpétuelle. Et tu consacreras ainsi Aaron et ses fils.
...
\VS{14}Mais tu brûleras au feu la chair du veau, sa peau, et ses excréments, hors du camp. C'est un sacrifice pour le péché\FTNT{\vref{Lé. 1:3-13}~; \vref{Hé. 9:11}~; \vref{Hé. 13:11}.}.
...
\VS{24}Et tu mettras toutes ces choses sur les mains d'Aaron et sur les mains de ses fils, et tu les agiteras de côté et d'autre devant Yahweh\FTNT{\vref{No. 6:19}.}.
...
\VS{27}Tu sanctifieras donc la poitrine de l'offrande agitée, et l'épaule de l'offrande élevée, tant ce qui aura été agité que ce qui aura été élevé du bélier de consécration, de ce qui est pour Aaron et de ce qui est pour ses fils. \FTNT{\vref{Lé. 10:14}~; \vref{No. 18:18}.}.
...
\VS{35}Tu feras donc ainsi à Aaron et à ses fils, selon toutes les choses que je t'ai ordonnées~; tu les consacreras durant sept jours\FTNT{\vref{Lé. 8:31-35}.}.
\VS{36}Et tu offriras comme sacrifice pour l'expiation tous les jours un veau pour faire l'expiation, et tu purifieras l'autel par cette propitiation, et tu l'oindras pour le sanctifier\FTNT{\vref{Ez. 43:19-20}.}.
\VS{37}Pendant sept jours, tu feras propitiation pour l'autel, et tu le sanctifieras~; l'autel sera une chose très sainte~; tout ce qui touchera l'autel sera saint\FTNT{\vref{No. 28:3}.}.
...
\VS{8}Et quand Aaron allumera les lampes entre les deux soirs, il y fera aussi le parfum, à savoir le parfum perpétuel devant Yahweh dans vos générations\FTNT{\vref{Ex. 37:25-29}~; \vref{2 Ch. 13:11}.}.
...
\TextTitle{L'offrande du rachat\FTNTT{\vref{Ex. 15:1-21}~; \vref{Ps. 107:1-2}.}}
\VS{11}Yahweh parla aussi à Moïse, et lui dit~:
\VS{12}Quand tu feras le dénombrement des fils d'Israël, selon leur nombre, ils donneront chacun à Yahweh le rachat de sa personne, quand tu en feras le dénombrement, et il n'y aura point de plaie sur eux quand tu en feras le dénombrement\FTNT{\vref{No. 1:2}.}.
\VS{13}Tous ceux qui passeront par le dénombrement donneront un demi-sicle, selon le sicle du sanctuaire, qui est de vingt guéras~; le demi-sicle donc sera l'offrande que l'on donnera à Yahweh\FTNT{\vref{Lé. 27:25}~; \vref{No. 3:47}~; \vref{Ez. 45:12}.}.
...
\TextTitle{Purification par l'eau de la cuve d'airain\FTNTT{\vref{Jn. 13:3-10}~; \vref{Hé. 10:22}~; \vref{1 Jn. 1:9}.}}
...
\TextTitle{L'huile pour l'onction sainte\FTNTT{\vref{Jn. 4:23}~; \vref{Ep. 2:18}, \vref{5:18-19}.}}
...
\VS{3}Et je l'ai rempli de l'Esprit de Dieu, en sagesse, en intelligence, en science, et en toutes sortes d'ouvrages,
\VS{4}afin d'inventer des dessins pour travailler en or, en argent et en airain~;
\VS{5}dans la sculpture des pierres précieuses, pour les mettre en œuvre, et dans la menuiserie pour travailler en toutes sortes d'ouvrages.
...
\VS{10}et les vêtements du service~; les saints vêtements pour le prêtre Aaron, et les vêtements de ses fils pour exercer la sacrificature~;
...
\VS{17}C'est un signe entre moi et les enfants d'Israël à perpétuité~; car Yahweh a fait en six jours les cieux et la terre, et il a cessé au septième, et s'est reposé\FTNT{\vref{Ge. 2:2}~; \vref{Ez. 20:12}.}.
\VS{18}Et Dieu donna à Moïse, après qu'il eut achevé de parler avec lui sur la montagne de Sinaï, les deux tables du témoignage~; tables de pierre, écrites du doigt de Dieu\FTNT{\vref{De. 9:10}.}.
\Chap{32}
\TextTitle{Le culte du veau d'or}
\VerseOne{}Mais le peuple, voyant que Moïse tardait tant à descendre de la montagne, s'assembla autour d'Aaron, et lui dit~: Lève-toi, fais-nous des dieux qui marchent devant nous, car quant à ce Moïse, cet homme qui nous a fait monter du pays d'Egypte, nous ne savons ce qui lui est arrivé\FTNT{\vref{Ac. 7:40}.}.
\VS{2}Et Aaron leur répondit~: Mettez en pièces les anneaux d'or qui sont aux oreilles de vos femmes, de vos fils, et de vos filles, et apportez-les-moi\FTNT{\vref{Ex. 35:22}.}.
\VS{3} Et incontinent, tout le peuple mit en pièces les anneaux d'or qui étaient à leurs oreilles, et ils les apportèrent à Aaron, 
...
\VS{6}Ainsi, ils se levèrent le lendemain, dès le matin, et ils offrirent des holocaustes, et présentèrent des offrandes de paix. Et le peuple s'assit pour manger et pour boire, puis ils se levèrent pour jouer\FTNT{\vref{1 Co. 10:7}.}.
\TextTitle{Yahweh condamne l'idolâtrie d'Israël}
\VS{7}Alors Yahweh dit à Moïse~: Va, descends, car ton peuple que tu as fait monter du pays d'Egypte s'est corrompu\FTNT{\vref{De. 32:5}.}.
\VS{8}Ils se sont promptement détournés de la voie que je leur avais ordonnée, et ils se sont fait un veau en métal fondu, et se sont prosternés devant lui, ils lui ont offert des sacrifices, puis ont dit~: Ce sont ici tes dieux, ô Israël, qui t'ont fait monter du pays d'Egypte\FTNT{\vref{1 R. 12:28}.}.
...
\VS{11}Alors Moïse supplia Yahweh, son Dieu, et dit~: Ô Yahweh, pourquoi ta colère s'embraserait-elle contre ton peuple, que tu as retiré du pays d'Egypte par une grande puissance et par une main forte\FTNT{\vref{Ps. 106:23}.}~?
\VS{12}Pourquoi les Egyptiens diraient~: Il les a retirés dans de mauvaises vues, pour les tuer sur les montagnes, et pour les consumer de dessus la terre~? Reviens de l'ardeur de ta colère, et repens-toi de ce mal que tu veux faire à ton peuple\FTNT{\vref{No. 14:11-15}~; \vref{De. 9:28}.}.
\VS{13}Souviens-toi d'Abraham, d'Isaac et d'Israël, tes serviteurs, auxquels tu as juré par toi-même en leur disant~: Je multiplierai votre postérité comme les étoiles des cieux, et je donnerai à votre postérité tout ce pays, dont j'ai parlé, et ils l'hériteront à jamais\FTNT{\vref{De. 34:4}.}.
...
\VS{20}Il prit ensuite le veau qu'ils avaient fait, et le brûla au feu, et le moulut jusqu'à ce qu'il fut en poudre, puis il répandit cette poudre dans de l'eau, et il en fit boire aux enfants d'Israël\FTNT{\vref{De. 9:17-21}.}.
...
\VS{33}Et Yahweh répondit à Moïse~: C'est celui qui aura péché contre moi que j'effacerai de mon livre\FTNT{\vref{Ap. 3:5}~; \vref{Ap. 20:15}~; \vref{Ap. 21:27}.}.
...
\VS{11}Et Yahweh parlait à Moïse face à face, comme un homme parle avec son intime ami. Puis Moïse retournait au camp, mais son serviteur Josué, fils de Nun, jeune homme, ne bougeait point de la tente\FTNT{\vref{No. 12:8}~; \vref{De. 34:10}~; \vref{Jn. 15:14-15}.}.
...
\VS{13}Or maintenant, je te prie, si j'ai trouvé grâce devant tes yeux, fais-moi connaître ton chemin, et je te connaîtrai, afin que je trouve grâce devant tes yeux~; considère aussi que cette nation est ton peuple\FTNT{\vref{Ps. 25:4}.}.
...
\VS{19}Et Dieu dit~: Je ferai passer toute ma bonté devant ta face, et je crierai le Nom de Yahweh devant toi~; et je ferai grâce à qui je ferai grâce, et j'aurai compassion de celui de qui j'aurai compassion\FTNT{\vref{Ro. 9:15}.}.
\VS{20}Puis il dit~: Tu ne pourras pas voir ma face, car nul homme ne peut me voir et vivre\FTNT{\vref{Jn. 1:18}~; \vref{Jn. 14:8-11}.}.
\VS{21}Yahweh dit aussi~: Voici, il y a un lieu près de moi, et tu t'arrêteras sur le rocher\FTNT{Le rocher préfigurait Jésus-Christ, le Roc sur lequel nous devons bâtir nos vies et le fondement de l'Eglise (\vref{Ps. 18:32}~; \vref{Mt. 7:24-25}~; \vref{Mt. 16:18}~; \vref{1 Co. 3:11}). Voir commentaire \vref{Es. 8:13-17}.}.
...
\Chap{34}
\TextTitle{De nouvelles tables~; la gloire de Yahweh\FTNTT{\vref{Ex. 33:18-23}.}}
\VerseOne{}Et Yahweh dit à Moïse~: Aplanis-toi deux tables de pierre comme les premières, et j'écrirai sur elles les paroles qui étaient sur les premières tables que tu as rompues\FTNT{\vref{De. 10:1}.}.
...
\VS{3}Mais que personne ne monte avec toi, et même que personne ne paraisse sur toute la montagne~; et que ni menu ni gros bétail ne paisse sur cette montagne\FTNT{\vref{Ex. 19:12-13}.}.
...
\VS{6}Comme donc Yahweh passait par devant lui, il cria~: Yahweh, Yahweh~! Le Dieu compatissant, miséricordieux, lent à la colère, abondant en bonté et en fidélité\FTNT{\vref{No. 14:18}~; \vref{2 Ch. 30:9}~; \vref{Né. 9:17}~; \vref{Ps. 103:8}.}.
\VS{7}Qui conserve sa bonté jusqu'à mille générations, ôtant l'iniquité, le crime, et le péché, qui ne tient point le coupable pour innocent, et qui punit l'iniquité des pères sur les fils, et sur les fils des fils, jusqu'à la troisième et à la quatrième génération\FTNT{\vref{Ex. 20:6}~; \vref{De. 5:10}~; \vref{Jé. 32:18}.}.
...
\TextTitle{Yahweh renouvelle ses promesses\FTNTT{\vref{Ex. 33:18-23}.}}
\VS{10}Et il répondit~: Voici, moi qui traite alliance devant tout ton peuple, je ferai des merveilles qui n'ont point été faites en toute la terre ni en aucune nation. Et tout le peuple au milieu duquel tu es, verra l'œuvre de Yahweh, car ce que je m'en vais faire avec toi sera une chose redoutable.
...
\VS{12}Garde-toi de traiter alliance avec les habitants du pays où tu dois entrer, de peur que peut-être ils ne soient un piège pour toi\FTNT{\vref{De. 7:2}~; \vref{Jos. 23:12-13}~; \vref{2 Co. 6:14}.}.
\VS{13}Mais vous démolirez leurs autels, vous briserez leurs statues, et vous couperez leurs emblèmes d'Asherah\FTNT{Cité au moins quarante fois dans le Tanakh, le terme hébreu «~Asherah~» fait référence à un «~arbre sacré, un pieu près d'un autel~» ou encore «~une idole~», terme par lequel il est majoritairement traduit. Il s'agit également de l'objet en bois utilisé dans le culte de la parèdre de Baal. Manassé, roi de Juda, introduisit l'emblème d'Asherah dans le temple (\vref{2 R. 21:1-7}) en dépit de l'interdiction formelle de Yahweh (\vref{De. 16:21}). Il n'en fut enlevé que lors des réformes de Josias et d'Ezéchias (\vref{2 R. 18:3-4}~; \vref{2 R. 23:6-14}). Pourtant, Yahweh a toujours exigé la destruction de celle qu'il a nommé «~l'abomination des Sidoniens~», de peur que son peuple y trouve une occasion de chute (\vref{Jg. 2:13}~; \vref{Jg. 10:6}~; \vref{1 S. 31:10}~; \vref{1 R. 11:5-33}~; \vref{2 R. 23:13}). Bien qu'étant majoritairement citée dans les Ecritures en tant qu'objet de culte, Asherah est également associée à la divinité Astarté, connue pour être la Diane des Ephésiens (\vref{Ac. 19:23-40}), la reine du ciel (\vref{Jé. 7:18}~; \vref{Jé. 44:15-30}), l'Isis des Egyptiens et l'épouse de Baal (voir commentaire en \vref{Jg. 2:13}).}.
...
\TextTitle{Les fêtes et le sabbat\FTNTT{\vref{Lé. 23:4-44}.}}
...
\VS{30}Mais Aaron et tous les enfants d'Israël ayant vu Moïse, et s'étant aperçus que la peau de son visage était rayonnante, ils craignirent d'approcher de lui.
...
\TextTitle{Les offrandes pour le tabernacle\FTNTT{\vref{Ex. 25:1-8}.}}
...
\VS{5}Prenez des choses qui sont chez vous une offrande pour Yahweh. Quiconque sera de bonne volonté, apportera cette offrande pour Yahweh, à savoir de l'or, de l'argent, de l'airain\FTNT{\vref{Ex. 25:2}~; \vref{2 Co. 8:12}.},
...
\VS{19}les vêtements du service pour faire le service dans le sanctuaire, les saints vêtements d'Aaron, le prêtre, et les vêtements de ses fils pour exercer la sacrificature.
...
\VS{25}Toute femme adroite fila de sa main et apporta ce qu'elle avait filé~: De la pourpre, de l'écarlate, du cramoisi, et du fin lin\FTNT{\vref{Pr. 31:19}.}.
...
\VS{31}Et il l'a rempli de l'Esprit de Dieu, en sagesse, en intelligence, en science, pour toutes sortes d'ouvrages.
...
\VS{35}Et il les a remplis de sagesse pour faire toutes sortes d'ouvrages d'ouvrier, même d'ouvrier en ouvrage exquis, et en broderie, en pourpre, en écarlate, en cramoisi, et en fin lin, et d'ouvrage de tisserand, faisant toutes sortes d'ouvrages et inventant toutes sortes de dessins\FTNT{\vref{Es. 28:26}.}.
\Chap{36}
\TextTitle{Construction du tabernacle d'après le modèle donné par Yahweh\FTNTT{\vref{Ex. 36-39}.}}
...
\VS{4}C'est pourquoi, tous les hommes d'esprit qui faisaient tout l'ouvrage du sanctuaire, vinrent chacun de l'ouvrage qu'ils faisaient,
...
\TextTitle{Les tapis de fin lin}
\VS{8}Tous les hommes donc de plus grand esprit d'entre ceux qui faisaient l'ouvrage, firent le tabernacle, à savoir dix tapis de fin lin retors, de pourpre, d'écarlate, et de cramoisi~; et ils les firent semés de chérubins d'un ouvrage exquis.
\VS{9}La longueur d'un tapis était de vingt-huit coudées, et la largeur du même tapis de quatre coudées~; tous les tapis avaient une même mesure\FTNT{\vref{Ex. 26:1-6}.}.
...
\Chap{37}
\TextTitle{L'arche de l'alliance}
\VerseOne{}Puis Betsaleel fit l'arche de bois d'acacia. Sa longueur était de deux coudées et demie, et sa largeur d'une coudée et demie, et sa hauteur d'une coudée et demie\FTNT{\vref{Ex. 23:10-31}.}.
...
\TextTitle{L'autel des parfums}
\VS{25}Il fit aussi de bois d'acacia l'autel des parfums. Sa longueur était d'une coudée, et sa largeur d'une coudée. Il était carré, et sa hauteur était de deux coudées, et ses cornes procédaient de lui\FTNT{\vref{Ex. 30:1-10}.}.
...
\VerseOne{}Il fit aussi de bois d'acacia l'autel des holocaustes. Et sa longueur était de cinq coudées, et sa largeur de cinq coudées. Il était carré, et sa hauteur était de trois coudées\FTNT{\vref{Ex. 27:1-8}.}.
...
\VS{8}Il fit aussi la cuve d'airain et sa base d'airain avec les miroirs des femmes qui s'assemblaient à l'entrée de la tente d'assignation\FTNT{\vref{Ex. 30:14-18}.}.
\TextTitle{Le parvis}
...
\VerseOne{}Ils firent aussi de pourpre, d'écarlate, et de cramoisi les vêtements du service, pour faire le service du sanctuaire. Et ils firent les saints vêtements sacrés pour Aaron, comme Yahweh l'avait ordonné à Moïse\FTNT{\vref{Ex. 28}.}.
...
\VS{13}A la quatrième rangée, un chrysolithe, un onyx, et un béryl\FTNT{\vref{Ap. 21:18-19}.}, enchâssés dans leur monture d'or.
...
\VS{36}la table avec tous ses ustensiles, et les pains de proposition\FTNT{\vref{Ex. 31:8-10}.}~;
...
\VS{41}les vêtements du service pour faire le service du sanctuaire, les saints vêtements pour le prêtre Aaron, et les vêtements de ses fils pour exercer la sacrificature.
...
\VS{13}Et tu feras vêtir à Aaron les saints vêtements, et tu l'oindras et le sanctifieras~; et il m'exercera la sacrificature.
\VS{14}Tu feras aussi approcher ses fils que tu revêtiras de tuniques.
\VS{15} Et tu les oindras comme tu auras oint leur père~; et ils m'exerceront la sacrificature, et leur onction leur sera pour exercer la sacrificature à toujours parmi leur génération.
...
\VS{34}Et la nuée couvrit la tente d'assignation, et la gloire de Yahweh remplit le tabernacle\FTNT{\vref{No. 9:15}~; \vref{1 R. 8:10}.},
