...
\VS{17}Il fit aussi d'airain les bases des colonnes, mais il fit d'argent les crochets des colonnes et les filets, et leurs chapiteaux furent couverts d'argent ;  et toutes les colonnes du parvis furent ceints à l'entour d'un filet d'argent.
\TextTitle{La porte du parvis}
\VS{18} Et il fit le rideau de la porte du parvis de pourpre, d'écarlate, et de cramoisi et de fin lin retors, d'ouvrage de broderie, de la longueur de vingt coudées, et de la hauteur qui était la largueur de cinq coudées, à la correspondance des  ccourtines du parvis.
