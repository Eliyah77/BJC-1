...
\TextTitle{Le parvis}
\VS{9}Il fit aussi un parvis, pour le côté sud, et des courtines de fin lin retors, de cent coudées, pour le parvis.
...
\VS{12}Pour le côté de l'occident, des courtines de cinquante coudées, leurs dix colonnes, et leurs dix bases. Les crochets des colonnes et leurs tringles étaient d'argent.
...
\VS{15}Pour l'autre côté, quinze coudées de courtines, afin qu'il y en eût autant de part et d’autre de la porte du parvis, et leurs trois colonnes avec leurs trois bases.
\VS{16}Il fit toutes les courtines du parvis qui étaient tout autour de fin lin retors.
...
\TextTitle{La porte du parvis}
\VS{18}Il fit le rideau de la porte du parvis d'ouvrage de broderie de fil bleu, de pourpre, de cramoisi et de fin lin retors, de la longueur de vingt coudées, et sa hauteur était de cinq coudées, comme la largeur des courtines du parvis.
