...
\VS{3}à cause de l'odeur de tes excellents parfums, ton nom est comme un parfum  répandu ; c'est pourquoi les filles t'ont aimé.
\VS{4}[La Sulamithe :] tire-moi [Les filles de Jérusalem :] et nous courrons après toi ! [La Sulamithe :] lorsqe le roi m'aura introduite dans ses chambres, [Les filles de Jérusalem :] nous nous égaierons et nous nous réjouirons en toi ; nous célébrerons tes amours plus que le vin; les hommes droits t'ont aimé.
...
\VS{6}Ne prenez pas garde à moi, de ce que je suis noire : Car le soleil m'a regardée. Les fils de ma mère se sont mis en colère contre moi, ils m'ont faite gardienne des vignes et je n'ai pas gardée la vigne qui était à moi.
...
\VS{12}[La Sulamithe :] Tandis que le roi était assis à table, mon nard a exhalé son parfum.
...
\VS{3}[La Sulamithe :] Tel qu'est le pommier entre des arbres de la forêt, tel est mon bien-aimé entre les jeunes hommes. J'ai désiré son ombre et m'y suis assise et son fruit à été doux à mon palais.
\VS{4}Il m'amenait dans la salle du festin\FTNT{La maison du vin ou des festins (Ap. 19:7-8).} ; et sa bannière que je porte c'est l'amour\FTNT{Jésus-Christ est notre bannière (Ex. 17:15).}.
...
\VS{7}[Salomon :] Filles de Jérusalem, je vous en conjure, par les chevreuil et par les biches des champs, ne réveillez pas celle que j'aime, ne la réveillez pas jusqu'à ce qu'elle le veuille.
...
\VS{9}Mon bien-aimé est semblable à la chevreuil ou au faon des biches. Le voici qui se tient derrière notre muraille, il regarde par les fenêtres, il se fait voir par les treillis.
...
\VS{17}Avant que le jour se rafraîchisse et que les ombres s'enfuient, reviens mon bien-aimé ! Sois comme le chevreuil ou le faon des biches, sur les montagnes de séparation.
\Chap{3}
...
\VS{4}A peine les avais-je passés, que j'ai trouvé celui que mon âme aime ; je l'ai saisi et je ne le lâcherai point jusqu'à ce que je l'aie amené dans la maison de ma mère et dans la chambre de celle qui m'a conçue.
...
\VS{8}Tous maniant l'épée et très bien exercés à la guerre ; chacun porte son épée sur sa cuise, à cause des frayeurs de la nuit.
...
\VS{3}Tes lèvres sont comme un fil teint d'écarlate, et ta bouche est gracieuse ; ta tempe est comme pièce de pomme de grenade, derrière ton voile.
...
\VS{9}Tu m'as ravis le cœur, ma sœur, mon épouse, tu m'as ravis le cœur, par l'un de tes regards et par l'un des colliers de ton cou.
...
\VS{16}Lève-toi, aquilon\FTNTT{Vent du nord} et viens autan\FTNTT{Vent du sud} du midi ! Soufflez sur mon jardin afin que ses droques aromatiques distillent ! [La Sulamithe :] Que mon bien-aimé entre dans son jardin et qu'il mange de ses fruits délicieux.
\Chap{5}
\VerseOne{}[Salomon :] Je sui entré dans mon jardin, ma sœur, mon épouse ; je cueilli ma myrrhe avec mes droques aromatiques, j'ai mangé mes rayons de miel et mon miel, j'ai bu mon vin et mon lait. Mes amis, mangez, buvez ; faites bonne chère, mes bien-aimés. 
...
\VS{10}[La Sulamithe :] Mon bien-aimé est éblouissant et roux, un porte-enseigne choisi entre dix mille.
...
\VS{15}Ses jambes sont comme des piliers de marbre, posés sur des bases de fin d'or. Son apparence est comme le Liban, elle est précieuse comme les cèdres.
...
\VS{4}[Salomon :] Tu es belle, grande amie, comme Thirtsa ; agréable comme Jérusalem, redoutable comme des armées qui marchent avec bannières déployées. 
\VS{5}Détourne tes yeux, qu'ils ne me regardent, car ils me troublent. Tes cheveux sont comme un troupeau de chèvres suspendus aux flancs de Galaad.
...
\VS{9}ma colombe, ma parfaite est unique ; elle est l'unique de sa mère, de celle qui l'a enfantée. Les filles l'ont vue et ont dit d'elle bienheureuse ; les reines et les concubines l'ont louée en disant :
...
\VS{2}[Les filles de Jérusalem :] Fille de prince combien sont belles tes démarches avec ta chaussure ! Les contours de ta hanche sont comme des colliers traivaillés de la main d'un excellent ouvrier.
...
\VS{5}Ton cou est comme une tour d'ivoire ; tes yeux sont comme les étangs qui sont à Hesbon, près de la porte de Bath-Rabbim ; ton visage est comme la tour du Liban qui regarde vers Damas.
...
\VS{10}et ta bouche comme le bon vin [La Sulamithe :] …qui coule en faveurs de mon bien-aimé et qui fait parler les lèvres de ceux qui s'endorment.
...
\VS{14}Les mandragores répandent leur parfum, et à nos portes il y a toutes sortes de fruits exquis, des fruits nouveaux, et des fruits gardés que je t'ai conservés ô bien !
\Chap{8}
...
\VS{6}Mets-moi comme un sceau sur ton cœur\FTNT{l'Eglise du Seigneur est scellée du Saint-Esprit (Ep. 1: 13 ; Ep. 4:30).}, comme un sceau sur ton bras ; car l'amour est fort comme la mort, et la jalousie est cruelle comme le scheol ; leurs embrasements sont des embrasements de feu et une flamme de Yah.
\VS{7}[La Sulamithe (à Salomon) :] Beaucoup ne pourraient éteindre cet amour-là et même les fleuves ne pourraient le submerger ; si un homme donnait toutes les richesses de sa maison pour cet amour, certainement on n'en tiendrait aucun compte.
