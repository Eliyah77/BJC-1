...
\VS{2}\TextDial{Salomon~:} Tel qu'est le lis entre les épines\FTNT{L'Eglise du Seigneur est au milieu des loups (\vref{Mt. 10:16}).}, telle est ma grande amie entre les filles.
...
\VS{4}Il m'amenait dans la salle du festin\FTNT{La maison du vin ou des festins (\vref{Ap. 19:7-9}).}~; et sa bannière que je porte c'est l'amour\FTNT{Jésus-Christ est notre bannière (\vref{Ex. 17:15}).}.
...
\VS{14}Ma colombe qui te tiens dans les fentes du rocher\FTNT{Jésus-Christ notre rocher (\vref{Es. 8:13-17}). L'Eglise véritable est fondée sur le roc, c'est-à-dire Jésus-Christ lui-même (\vref{Mt. 16:18}).}, dans les lieux secrets\FTNT{Les lieux secrets (\vref{Mt. 6:6}).} et escarpés, fais-moi voir ta figure, fais-moi entendre ta voix~; car ta voix est douce, et ta figure est belle.
...
\VS{7}Tu es toute belle, ma grande amie, et il n'y a point de tache\FTNT{\vref{Ep. 5:27}.} en toi.
...
\VS{12}Ma sœur, mon épouse, tu es un jardin clos, une source close, une fontaine scellée\FTNT{La virginité de l'Eglise~: «~un jardin fermé~», «~une source fermée~» et «~une fontaine scellée~». Nous avons ici une belle image de l'Eglise (\vref{Ep. 5:25-27}) comparée par Paul à une vierge pure destinée à être présentée à son Christ, son Epoux (\vref{2 Co. 11:2}). Selon la loi de Moïse, un homme qui séduisait une vierge devait l'épouser (\vref{Ex. 22:16}) et ne pouvait plus jamais la répudier (\vref{De. 22:28-29}). Tout comme la femme adultère, la vierge fiancée qui se rendait coupable d'infidélité était lapidée (\vref{De. 22:22-24}), sauf si elle n'avait pas pu appeler à l'aide lors de son viol (\vref{De. 22:25-27}). Un homme qui accusait faussement sa femme de ne pas avoir été vierge lors du mariage était sévèrement puni, mais si l'accusation se révélait exacte, la femme était lapidée (\vref{De. 22:13-21}). Si une femme était faussement accusée, ses parents pouvaient produire, pour la disculper, les «~signes de sa virginité~» (\vref{De. 22:15}), c'est-à-dire le drap nuptial portant les traces sanglantes de la perforation de l'hymen. Notons que le grand-prêtre n'avait le droit d'épouser qu'une vierge (\vref{Lé. 21:13-14}). De même, Jésus-Christ, le Grand-Prêtre par excellence, désire aussi une Eglise vierge.}.
...
\VS{16}Lève-toi, aquilon\FTNTT{Vent du nord.} et viens autan\FTNTT{Vent du sud.} du midi~! Soufflez sur mon jardin afin que ses drogues aromatiques distillent~! \TextDial{La Sulamithe~:} Que mon bien-aimé entre dans son jardin et qu'il mange de ses fruits délicieux~!
\Chap{5}
...
\VS{2}\TextDial{La Sulamithe~:} J'étais endormie, mais mon cœur veillait\FTNT{\vref{Mt. 25:1-13}.}, et voici c'est la voix de mon bien-aimé qui frappe, en disant~: \TextDial{La Sulamithe rapporte les propos de Salomon~:} Ouvre-moi, ma sœur, ma grande amie, ma colombe, ma parfaite~! Car ma tête est pleine de rosée et mes cheveux de l'humidité de la nuit.
...
\VS{16}Son palais n'est que douceur, et tout ce qui est en lui est désirable\FTNT{\vref{Mt. 11:29}.}. Tel est mon bien-aimé, tel est mon ami, filles de Jérusalem~!
\Chap{6}
