...
\VS{21}qui transformera notre corps vil, afin qu'il soit rendu conforme à son corps glorieux, selon cette efficacité\FTNT{\vref{Ep. 3:7}} par laquelle il peut même s'assujettir toutes choses. 
\Chap{4}
...
\VS{3}Et toi aussi, mon vrai compagnon\FTNT{Le mot compagnon est la traduction du grec « suzugos » qui signifie littéralement: Ensemble sous le joug, compagnon de peine, de joug. Cette expression renvoie à \vref{2 Co. 6:14}.}, oui je te prie de les aider, elles qui ont combattu avec moi pour l'Evangile, avec Clément, et mes autres compagnons d'œuvre, dont les noms sont écrits dans le livre de vie.
