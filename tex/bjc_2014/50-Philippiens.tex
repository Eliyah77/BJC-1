...
\VS{17}Mais les autres le font par charité, sachant que je suis établi pour la défense de l'Evangile\FTNT{Les versets 16 et 17 sont inversés dans certaines versions de la bible qui sont traduites à partir des textes minoritaires, moins précis. D'autres versions telles que Martin, Ostervald, et King James, basées sur le texte majoritaire (byzantin), utilisent bien cet ordre des versets que l'on retrouve ainsi dans les écrits grecs.}.
