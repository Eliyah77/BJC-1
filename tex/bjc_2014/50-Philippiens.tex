...
\VS{17}Mais les autres le font par charité, sachant que je suis établi pour la défense de l'Evangile\FTNT{Les versets 16 et 17 sont inversés dans les versions Segond, Darby et TOB notamment. Ces bibles sont basées sur les textes minoritaires, moins précis et . Les versions Martin, Ostervald et King James, basées sur le texte majoritaire (byzantin), utilisent bien cet ordre des versets que l'on retrouvent ainsi dans les écrits grecs.}.
...
\VS{22}Mais s'il est utile pour mon oeuvre de vivre dans la chair, et ce que je dois choisir, je n'en sais rien. 
...
\VS{21}arce que tous cherchent leur intérêt particulier, et non les intérêts de Jésus-Christ. 
\VS{22}Mais vous connaissez son épreuve que j'ai faite puisqu'il a servi avec moi dans l'Evangile, comme l'enfant sert son père. 
...
\VS{25}Mais j'ai cru nécessaire de vous envoyer Epaphrodite mon frère, mon compagnon d'œuvre et mon compagnon d'arme, par qui vous m'aviez envoyé de quoi pourvoir à mes besoins.
...
\VS{30}Car il a été proche de la mort pour l'oeuvre de Christ, n'ayant eu aucun égard à sa propre vie, afin de suppléer au défaut de votre service envers moi.
\Chap{3}
\TextTitle{Les légalistes et la justice de la loi mosaïque}
...
\VS{19}Eux donc la fin est la perdition, qui ont pour dieu leur ventre, et don la gloire est dans leur confusion, n'ayant d'affection que pour les choses de la terre.
...
\VS{21}Qui transformera notre corps vil, afin qu'il soit rendu conforme à son corps glorieux, selon cette efficacité par laquelle il peut même s'assujettir toutes choses. 
\Chap{4}
...
\VS{10}Or je me suis fort réjoui en notre Seigneur, de ce qu'à la fin vous avez fait revivre le soin que vous avez pour moi ; à quoi aussi vous pensiez, mais vous n’en aviez pas l'occasion. 
