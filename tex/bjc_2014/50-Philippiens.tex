...
\VS{3}Ne faites rien par esprit de dispute\FTNT{Parti : Du grec «~eritheia~». Ce mot ne se trouve, avant la nouvelle alliance, que dans Aristote où il dénote une recherche personnelle, la poursuite d'une fonction politique par des moyens injustes. Ce mot signifie aussi faire une campagne électorale ou intriguer pour une fonction dans un esprit partisan, querelleur.}, ou par vaine gloire ; mais que l’humilité de cœur vous fasse regarder les autres comme étant au-dessus de vous-mêmes.
