...
%\bigskip
\\Dieu y agit comme un juge en détruisant la terre par le déluge en réponse à la méchanceté du cœur de l’homme mais Il s’y révéle aussi comme un sauveur en accordant grâce à Noé et à sa famille. Après cet évènement, les hommes se tournent une fois de plus vers le mal en tentant Dieu par la construction de la tour de Babel, œuvre à l’origine de la dispersion des nations. 
%\bigskip
\\On nous raconte ensuite l’élection d’un homme originaire d’Ur en Chaldée (actuelle Mésopotamie), Abraham, qui reçu la promesse de devenir une grande nation et en qui toutes les familles de la terre seraient bénies. Le récit se poursuit par l’histoire de ses descendants Isaac, Jacob et les douze fils de ce dernier qui ont formé par la suite la nation d’Israël.\bigskip
}
}
\par\nobreak\noindent\hrulefill
\begin{multicols}{2}
...
\VS{3}Dieu dit : Que la lumière apparaisse\FTNT{«~Que la lumière apparaisse !~» (Es. 9:1 ; Mt. 4:16-16 ; Jn. 1:1-5). Cette lumière n’est autre que Yahweh lui-même qui va s’incarner en la personne de Jésus-Christ pour chasser les ténèbres (2 S. 22:9-12 ; Es. 60:1 ; Es. 60:19-20 ; Jn. 1:1-2 ; Jn. 8:13-14 ; 2 Co. 4:6).} ; et la lumière apparut.
...
\TextTitle{[Cinquième jour : les animaux vivants dans les eaux et les airs\FTNT{ Ge. 2:19}]}
...
\TextTitle{[Yahweh forma l'homme et le plaça en Eden\FTNT{Job 10:8-9 ; Ps. 119:73}]}
...
\TextTitle{[L'innocence\FTNT{Ge. 1:28-3:6}]}
...
\TextTitle{[L'alliance d'Eden entre Yahweh et l'homme\FTNT{Ge. 1:28}]}
...
\TextTitle{[Yahweh forme une femme pour l'homme\FTNT{Ge. 1:27}]}
...
\TextTitle{[La création soumise à la vanité\FTNT{Ro. 8:20-22}]}
...
\TextTitle{[Yahweh fait une tunique de peau]}
...
\TextTitle{[intrusion de la violence : Caïn tue son frère Abel\FTNT{Ge. 4:23}]}
...
\Chap{5}
\TextTitle{[La postérité d'Adam soumise à la mort\FTNT{Ro. 5:12}]}
...
\TextTitle{[De Seth aux fils de Noé\FTNT{Ro. 5:12}]}
...
\Chap{6}
\TextTitle{[Le mal dans le cœur de l'homme\FTNT{Ro. 5:12}]}
...
\TextTitle{[Le monde avant le déluge\FTNT{Luc 17:27}]}
...
\TextTitle{[Noé sort de l'arche: Le règne des hommes\FTNT{Ge. 8:11-15:32}]}
...
\Chap{9}
\TextTitle{[Yahweh établit une alliance avec Noé\FTNT{Ge. 9:16}]}
...
\Chap{10}
\TextTitle{[La postérité de Noé\FTNT{Ge. 9:28-10:32}]}
...
\Chap{12}
\TextTitle{[Appel d'Abram : La promesse de Yahweh\FTNT{Ge. 12:2 ; 13:14-18 ; 15:1-21 ; 17:4-8 ; 22:15-24 ; 26:1-5 ; 28 : 10-15}]}
...
\TextTitle{[Abram se sépare de Lot\FTNT{Ge. 13:12; 19:1,33}]}
...
\TextTitle{[Lot s'établit à Sodome\FTNT{Ge. 13:10; 19:1,33}]}
...
\Chap{18}
\TextTitle{[Abraham, ami de Yahweh\FTNT{Jn 3:29 ; 15:13-15}]}
...
\Chap{19}
\TextTitle{[Des anges chez Lot\FTNT{Ge. 13:10, 12 ; 19:33}]}
...
\TextTitle{[Une abomination commise dans la famille de Lot\FTNT{Ge. 13:10,12 ; 19:1 ; Lu. 22:31-62}]}
...
\Chap{20}
\TextTitle{[Faute d'Abraham à Guérar\FTNT{Ge. 26:6-32}]}
...
\TextTitle{[Abraham chasse Agar avec Ismaël\FTNT{Ga. 4:21-31}]}
...
\Chap{22}
\TextTitle{[Abraham présente Isaac en sacrifice\FTNT{Hé. 11:17-19}]}
...
\TextTitle{[Isaac hérite d'Abraham\FTNT{Hé. 1:2}]}
...
\TextTitle{[Faute d'Isaac à Guérar\FTNT{Ge. 20}]}
...
\TextTitle{[Déception d'Esaü\FTNT{Hé. 12:16-17}]}
...
\Chap{43}
\TextTitle{[Juda se porte garant de Benjamin\FTNT{Ge. 37:26-28}]}
...
\TextTitle{[Juda prend la place de Benjamin\FTNT{Ge. 43:9}]}
\Chap{44}
...
\TextTitle{[Joseph pardonne à ses frères et fait venir Jacob\FTNT{Ge. 43:9}]}
