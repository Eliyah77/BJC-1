...
\VS{13}Et Yahweh dit à Abram : Sache comme une chose certaine que tes descendants habiteront quatre cents ans comme étrangers dans un pays qui ne leur appartiendra point, et qu'ils seront asservis aux habitants du pays qui les opprimera\FTNT{\vref{Ac. 7:6} ; \vref{Ga. 3:17}.}.
...
\VS{10}Et l'un d'entre eux dit : Je ne manquerai pas de revenir vers toi en ce même temps où nous sommes ; et voici, Sara, ta femme, aura un fils. Et Sara écoutait à la porte de la tente qui était derrière lui\FTNT{\vref{Ro. 9:9}.}.
