...
%\setdescription{partopsep=\topsep}
%\setdescription{topsep=0pt}
%\setlist{nosep}
...
\addcontentsline{toc}{section}{Concordance BJC}\clearpage
% annexe concordance
\newcommand{\ConcordanceEntry}[1]{\smallskip\parindent=0mm{\textbf{#1}\newline}\markboth{#1}{#1}}
\makeatletter
	\def\@oddhead{{\small{Concordance BJC\hfil\thepage\hfil\rightmark---\leftmark}}}
	\def\@evenhead{{\small{\rightmark---\leftmark\hfil\thepage\hfil Concordance BJC}}}
\makeatother
		\small{\parindent=0mm{\begin{center}\Large\bfseries{Concordance BJC}\end{center}}\par\input{concordance/bjc_concordance}\clearpage}\markboth{}{}
	\makeatletter
