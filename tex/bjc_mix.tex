...
% chapitres
\newcommand{\Chap}[1]{\def\webchap{#1:}\def\vchap{#1}\ssubsection{\centerline{\textbf{{CHAPITRE\ #1}}}}}
% versets
\newcommand{\VerseOne}{\def\webvs{1}\markboth{\webbook\ \webchap 1}{\webbook\ \webchap 1}$^{\vschap 1}$}
\newcommand{\VS}[1]{\def\webvs{#1}$^{\vschap#1}$\markboth{\webbook\ \webchap #1}{\webbook\ \webchap #1}}
% commentaires
