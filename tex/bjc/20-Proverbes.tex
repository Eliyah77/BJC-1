...
\VS{35}Les sages hériteront la gloire~; mais la honte élève les insensés.
\Chap{4}
...
\VS{3}Mon fils, fais maintenant ceci, et dégage-toi, puisque tu es tombé entre les mains de ton ami intime, va, prosterne-toi, et importune tes amis.
...
\VS{17}A savoir, les yeux hautains\FTNT{Ps. 101:5.}, la langue mensongère\FTNT{Ps. 120:2-3.}, les mains qui répandent le sang innocent\FTNT{Es. 1:15.},
...
\VS{27}Celui qui recherche le bien cherche la faveur, mais le mal arrive à celui qui le recherche.
...
\VS{16}Quant à l'insensé, sa colère est révélée le jour même, mais l'homme bien avisé couvre son ignominie.
...
\VS{16}Le sage craint et se retire du mal, mais l'insensé se met en colère et il est tout confiant.
...
\VS{20}Un fils sage réjouit son père, et un homme insensé méprise sa mère.
...
\VS{22} Les projets deviennent inutiles là où il n'y a pas de conseil~; mais il y a de la fermeté dans la multitude des conseillers.
...
\VS{14}La colère du roi est comme des messagers de mort, mais l'homme sage l'apaisera.
...
\VS{17}Le chemin aplani des hommes droits, c'est de se détourner du mal~; celui qui prend garde à sa voie garde son âme.
...
\VS{20}Celui qui prend garde à la parole trouvera le bonheur, et celui qui se confie en Yahweh est heureux\FTNT{Ps. 2:12.}.
...
\VS{33}On jette le sort dans le pan de la robe, mais tout ce qui doit arriver est décidé par Yahweh.
\Chap{17}
\TextTitle{La justice s'oppose à la méchanceté (suite)}
...
\VS{26}Il n'est pas bon de condamner l'innocent à l'amende ni aux nobles de frapper quelqu'un pour avoir agi avec droiture.
...
\VS{19}Celui qui se met dans une grande colère en porte la peine~; et si tu l'en retires, tu y ajouteras davantage.
...
\VS{26}L'enfant qui fait honte et sème la confusion, détruit son père et met en fuite sa mère.
...
\VS{4}Le paresseux ne laboure pas à cause du mauvais temps, mais il mendiera durant la moisson, et il n'aura rien.
...
\VS{9}Qui est-ce qui peut dire~: J'ai purifié mon cœur, je suis pur de mon péché~?
...
\VS{21}L'héritage trop vite acquis dès le début ne sera pas béni à la fin.
...
\VS{25}C'est un piège pour l'homme de dévorer les choses saintes, et de chercher à s'emparer de ce qui est voué.
...
\VS{5}Il y a des épines et des pièges dans la voie de l'homme pervers~; celui qui aime son âme s'en éloignera.
...
\VS{29}As-tu vu un homme habile dans son travail~? Il se tiendra devant des rois, et non devant des gens de basse condition.
\Chap{23}
\TextTitle{La justice s'oppose à la méchanceté (suite)}
...
\VS{8}Ne te hâte pas de sortir pour quereller, de peur que tu ne saches que faire à la fin, lorsque ton prochain t'aura confondu.
...
\VS{13}Le messager fidèle est pour ceux qui l'envoient comme la fraîcheur de la neige au temps de la moisson, il restaure l'âme de son maître.
...
\VS{27}Comme il n'est pas bon de manger trop de miel, ainsi il n'y a pas de gloire pour ceux qui la recherchent avec trop d'ardeur.
...
\VS{20}As-tu vu un homme prompt à parler~? Il y a plus d'espérance d'un insensé que de lui.
...
\VS{19}à savoir la trace de l'aigle dans le ciel, la trace du serpent sur un rocher, le chemin d'un navire au milieu de la mer, et la trace de l'homme chez la vierge.
