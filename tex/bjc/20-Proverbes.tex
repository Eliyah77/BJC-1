...
\VS{11}S'ils disent~: Viens avec nous, dressons des embûches pour tuer~; épions secrètement l'innocent, quoiqu'il ne nous ait fait aucun mal.
...
\VS{19}Telle est la voie de tout homme qui convoite le gain déshonnête, qui ôte la vie de ceux qui la possèdent.
...
\VS{33}Mais celui qui m'écoute habitera en sécurité. Il sera tranquille et n'aura à redouter aucun mal.
\Chap{2}
...
\VS{14}qui se réjouissent de faire le mal, et qui prennent plaisir dans la perversité du méchant.
