...
\VS{2}Chaque voie de l'homme lui semble droite~; mais Yahweh pèse les cœurs.
...
\VS{6}Travailler pour avoir des trésors par une langue trompeuse, c'est une vanité poussée au loin par ceux qui cherchent la mort.
...
\VS{12}parce que tu dis~: Voici, nous n'en savons rien~; celui qui pèse les cœurs ne le considère-il pas~? Et celui qui garde ton âme, ne le sait-il pas~? Et ne rendra-t-il pas à chacun selon son œuvre~?
...
\VS{15}Le méchant qui domine sur un peuple pauvre est un lion rugissant et comme un ours guêtant sa proie.
...
\VS{30}Le lion, qui est le plus fort d'entre les bêtes, et qui ne recule pas à la rencontre de qui que ce soit~;
