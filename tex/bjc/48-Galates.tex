...
\VS{2}et tous les frères qui sont avec moi, aux églises de Galatie\FTNT{La Galatie, ou Gallo-Grèce, était une province de l'Asie Mineure (région de la Turquie actuelle). Au nord, elle était délimitée par la Bithynie et la Paphlagonie, à l'est par le Pont et la Cappadoce, au sud par la Cappadoce, la Lycaonie et la Phrygie, et à l'ouest par la Phrygie et la Bithynie. Son nom vient des Gaulois qui s'étaient installés dans la région en 279 av. J.-C. Conquise par les Romains en 189 av. J.-C., elle devint une province de l'Empire en 25 av. J.-C.}~:
...
\VS{8}Mais si nous-mêmes, ou un ange du ciel vous prêche un autre évangile\FTNT{Voir 1 R. 13:11-34.} que celui que nous vous avons prêché, qu'il soit anathème~!
\VS{9}Comme nous l'avons déjà dit, je le dis encore maintenant~: Si quelqu'un vous prêche un autre évangile que celui que vous avez reçu, qu'il soit anathème~!
\TextTitle{Le serviteur de Christ}
\VS{10}Car est-ce les hommes que je prêche ou Dieu~? Ou est-ce que je cherche à plaire aux hommes~? Certes, si je plaisais encore aux hommes, je ne serais pas un serviteur de Christ.
\TextTitle{L'origine de l'appel de Paul}
...
\VS{17}et je ne montai pas à Jérusalem vers ceux qui furent apôtres avant moi, mais je partis pour l'Arabie, puis je revins encore à Damas.
...
\VS{20}Or dans les choses que je vous écris, voici, devant Dieu je vous dis que je ne mens pas.
...
\Chap{2}
\TextTitle{Paul, Barnabas et Tite à Jérusalem\FTNTT{Ac. 15.}}
...
\VS{6}Et je ne suis différent en rien de ceux qui sont les plus estimés, quels qu'ils aient été autrefois, Dieu n'ayant pas d'égard à l'apparence extérieure de l'homme, car ceux qui sont en estime ne m'ont rien communiqué de plus.
...
\VS{13}Les autres Juifs aussi usèrent de dissimulation comme lui, de sorte que Barnabas même se laissa entraîner par leur hypocrisie.
...
\TextTitle{La justification par la foi en Jésus-Christ}
\VS{15}Nous qui sommes Juifs de naissance, et non pas pécheurs d'entre les Gentils,
\VS{16}sachant que l'homme n'est pas justifié par les œuvres de la loi, mais seulement par la foi en Jésus-Christ\FTNT{La justification. Voir Ro. 5:1.}, nous, dis-je, nous avons cru en Jésus-Christ, afin que nous soyons justifiés par la foi en Christ, et non pas par les œuvres de la loi~; parce que personne ne sera justifié par les œuvres de la loi.
...
\VS{21}Je n'anéantis pas la grâce de Dieu, car si la justice vient de la loi, Christ est donc mort inutilement.
\Chap{3}
\TextTitle{L'Esprit est donné à ceux qui ont la foi}
...
\VS{3}Etes-vous si insensés, après avoir commencé par l'Esprit, voulez-vous maintenant finir par la chair~?
...
\TextTitle{Les fils d'Abraham\FTNTT{Ro. 4.}}
\VS{6}Comme Abraham crut à Dieu, et cela lui fut imputé à justice,
\VS{7}sachez donc que ce sont ceux qui ont la foi qui sont enfants d'Abraham.
\VS{8}Aussi, l'Ecriture prévoyant que Dieu justifierait les Gentils par la foi, a prêché d'avance l'Evangile à Abraham, en lui disant~: Toutes les nations seront bénies en toi\FTNT{Ge. 12:3.}.
...
\TextTitle{Jésus-Christ a racheté les chrétiens de la malédiction de la loi}
...
\TextTitle{La loi, un pédagogue qui conduit à Christ}
...
\VS{20}Or le médiateur n'est pas médiateur d'un seul, mais Dieu est un\FTNT{1 Ti. 2:5 ; Ja. 2:19 ; Mc. 12:29.}.
...
\TextTitle{L'unité en Jésus-Christ}
...
\Chap{4}
\TextTitle{L'esclave des rudiments du monde}
...
\VS{14}Et vous ne m'avez pas méprisé ni rejeté à cause de ces épreuves que j'ai dans ma chair~; mais vous m'avez reçu comme un ange de Dieu, et comme Jésus-Christ.
\VS{15}Où donc est votre bonheur~? Car je vous rends témoignage que, si cela avait été possible, vous vous seriez arrachés les yeux pour me les donner.
\VS{16}Suis-je donc devenu votre ennemi en vous disant la vérité~?
\VS{17}Ils ont du zèle pour vous, mais pas comme il faut. Au contraire, ils veulent vous détacher de nous afin que vous soyez zélés pour eux.
\VS{18}Il est bon d'être zélé pour le bien en tout temps, et non pas seulement quand je suis présent parmi vous.
\TextTitle{Les fils de l'esclave et les fils de la femme libre}
...
\VS{21}Dites-moi, vous qui voulez être sous la loi, ne comprenez-vous pas la loi~?
...
\VS{24}Ces faits ont une valeur allégorique, car ces deux femmes sont les deux alliances~: L'une du Mont Sinaï, qui n'enfante que des esclaves, et c'est Agar.
...
\VS{27}Car il est écrit~: Réjouis-toi, stérile, toi qui n'enfantes pas~! Eclate et pousse des cris, toi qui n'as pas éprouvé les douleurs de l'enfantement~! Car les enfants de la délaissée seront plus nombreux que les enfants de celle qui était mariée\FTNT{Es. 54:1.}.
...
\Chap{5}
\TextTitle{Jésus-Christ nous a libérés de la servitude}
...
\VS{16}Je vous dis donc~: Marchez selon l'Esprit, et vous n'accomplirez pas les désirs de la chair.
\TextTitle{La chair et ses œuvres s'opposent à l'Esprit de Dieu\FTNTT{Ro. 8:2.}}
\VS{17}Car la chair a des désirs contraires à ceux de l'Esprit, et l'Esprit en a des contraires à ceux de la chair~; et ils sont opposés entre eux, afin que vous ne fassiez pas ce que vous voudriez.
\VS{18}Or si vous êtes conduits par l'Esprit, vous n'êtes pas sous la loi.
...
\VS{21}les envies, les meurtres, l'ivrognerie, les excès de table, et les choses semblables à celles-là, au sujet desquelles je vous prédis, comme je vous l'ai déjà dit, que ceux qui commettent de telles choses n'hériteront pas le Royaume de Dieu.
...
\VS{15}Car en Jésus-Christ ni la circoncision, ni l'incirconcision n'ont aucune efficacité, mais la nouvelle créature.
