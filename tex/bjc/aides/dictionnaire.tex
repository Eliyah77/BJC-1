...
\DicoEntry{ELÉAZAR}\textit{, de l'hébreu «~'El'azar~»~: «~Dieu a secouru~».}\newline
...
\DicoEntry{ELISÉE}\textit{, de l'hébreu «~'Eliysha'~»~: «~Dieu est sauveur~».}\newline
...
\DicoEntry{EPHÈSE}\textit{, du grec «~Ephesos~»~: «~permis~».}\newline
