...
\VS{17}Vous prendrez donc garde aux pains sans levain, parce qu'en ce même jour, j'ai fait sortir vos armées du pays d'Egypte~; vous observerez donc ce jour-là de génération en génération par une ordonance perpétuelle.
...
\VS{14}Et quand ton fils t'interrogera à l'avenir, en disant~: Que veut dire ceci~? Alors tu lui diras~: Par sa main puissanteYahweh nous a fait sortir d'Egypte, de la maison de servitude.
