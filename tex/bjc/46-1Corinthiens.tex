...
\VS{26}Que faire donc mes frères~? C'est que toutes les fois que vous vous assemblez, selon que chacun de vous aura ou un psaume, ou une instruction, ou une langue, ou une révélation, ou une interprétation, que tout se fasse pour l'édification.
