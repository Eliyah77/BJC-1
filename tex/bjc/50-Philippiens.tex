...
\VS{14}Et que plusieurs de nos frères dans le Seigneur, étant rassurés par mes liens, osent annoncer la parole plus hardiment et sans crainte.
...
\VS{16}Les uns, dis-je, annoncent Christ par un esprit de dispute, et non pas purement, croyant ajouter de tribulation à mes liens.
...
\VS{7}Cependant il s'est vidé de lui-même, ayant pris la forme de serviteur, fait à la ressemblance des hommes~;
...
\VS{21}qui transformera le corps de notre humiliation pour le rendre conforme à son corps glorieux selon le pouvoir\FTNT{Ep. 3:7.} par lequel il peut même s'assujettir toutes choses.
\Chap{4}
...
\VS{14}Néanmoins, vous avez bien fait de prendre part à ma tribulation.
