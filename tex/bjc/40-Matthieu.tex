...
\VS{3}Le roi Hérode, ayant entendu cela, fut troublé, et tout Jérusalem avec lui.
...
\VS{17}Et voici, une voix du ciel déclara~: Celui-ci est mon Fils bien-aimé, en qui j'ai pris mon bon plaisir.
\Chap{4}
...
\VS{4}Mais Jésus répondit, et dit~: Il est écrit~: L'homme ne vivra pas de pain seulement, mais de toute parole qui sort de la bouche de Dieu\FTNT{Jésus se réfère ici à De. 8:3 : «~[…] l’homme vivra de tout ce qui sort de la bouche de Yahweh~». On note cependant que le nom YHWH a été remplacé par le terme générique «~Dieu~». Voir commentaire en Luc 4:18.}.
...
\VS{32}Mais moi, je vous dis que celui qui répudie sa femme, si ce n'est pour cause d'adultère, lui fait commettre adultère~; et que celui qui épouse une femme répudiée commet un adultère.
...
\VS{41}Si quelqu'un te force à faire un mille, fais-en deux avec lui\FTNT{Une loi autorisait les soldats romains à forcer les résidents des pays occupés à les accompagner sur la distance d’un mille (soit 1480 m), pour les aider par exemple à porter leurs bagages. Cet éclairage historique nous permet non seulement d’avoir une bonne compréhension des propos du Seigneur, mais aussi  de réaliser que la première venue du Messie n’avait pas pour but de délivrer les Hébreux de l’occupation romaine, mais de leurs péchés.}.
...
\VS{27}Et qui est celui d'entre vous qui puisse, par ses inquiétudes, ajouter une coudée à sa stature~?
...
\VS{2}Et voici, un lépreux vint et se prosterna devant lui, en lui disant~: Seigneur\FTNT{Le mot grec pour «~Seigneur~» est «~kurios~». C'est la première fois que ce terme est appliqué à Jésus. Notez que c'est un lépreux qui a eu la révélation que Jésus-Christ est YHWH. Voir Lé. 14:4-32~; De. 24:8.}, si tu le veux, tu peux me rendre pur.
\VS{3}Et Jésus étendit la main, le toucha, en disant~: Je le veux, sois pur. Et à l'instant même, il fut purifié de sa lèpre.
\VS{4}Puis Jésus lui dit~: Prends garde de ne le dire à personne~; mais va te montrer au prêtre et offre l'offrande\FTNT{Lé. 14:4-32 ; De. 24:8.} que Moïse a prescrite afin que cela leur serve de témoignage.
...
\VS{36}et l'homme aura pour ennemis les gens de sa propre maison\FTNT{Mi. 7:6.}.
...
\VS{2}Or Jean, ayant entendu parler dans sa prison des œuvres du Christ, envoya deux de ses disciples pour lui dire~:
...
\TextTitle{Jésus guérit les malades à Génésareth\FTNTT{Mc. 6:53-56.}}
\VS{34}Après avoir traversé la mer, ils vinrent dans le pays de Génésareth.
...
\VS{7}Mais Jésus s'approcha, les toucha et leur dit~: Levez-vous, et n'ayez pas peur.
...
\VS{11}Et Jésus répondit et leur dit~: Il est vrai qu'Elie viendra premièrement et rétablira toutes choses.
...
\VS{27}Mais, afin que nous ne les scandalisions pas, va à la mer et jette l'hameçon, et prends le premier poisson qui viendra~; ouvre-lui la bouche, tu trouveras un statère. Prends-le, et donne-le-leur pour moi et pour toi.
\Chap{18}
...
\VS{14}Ainsi ce n'est pas la volonté de votre Père qui est aux cieux qu'un seul de ces petits périsse.
\TextTitle{La discipline dans les assemblées}
\VS{15}Et si ton frère a péché contre toi, va, et reprends-le entre toi et lui seul. S'il t'écoute, tu as gagné ton frère.
...
\TextTitle{Le pardon}
\VS{21}Alors Pierre s'approchant, lui dit~: Seigneur, combien de fois pardonnerai-je à mon frère lorsqu'il aura péché contre moi~? Sera-ce jusqu'à sept fois~?
...
\VS{3}Puis s'étant assis sur la Montagne des Oliviers, ses disciples vinrent à lui en particulier, et lui dirent~: Dis-nous quand ces choses arriveront, et quel sera le signe de ton avènement, et de l’achèvement du siècle~?
...
\VS{9}Alors ils vous livreront aux tribulations, et vous tueront~; et vous serez haïs de toutes les nations, à cause de mon Nom.
...
\VS{21}Car alors il y aura une grande tribulation, telle qu’il n’y en a point eu depuis le commencement du monde jusqu’à présent, et qu’il n’y en aura jamais.
...
\VS{29}Aussitôt après ces jours de tribulation, le soleil s'obscurcira, la lune ne donnera plus sa lumière, et les étoiles tomberont du ciel, et les puissances des cieux seront ébranlées.
...
\VS{39}et ils ne comprirent pas que le déluge viendrait, jusqu'à ce qu'il vienne et les emporte tous~; il en sera de même de l'avènement du Fils de l'homme.
...
\VS{19}Allez donc, et faites de toutes les nations des disciples, les baptisant dans le Nom du Père, du Fils et du Saint-Esprit.
\VS{20}Et enseignez-leur à garder tout ce que je vous ai ordonné. Et voici, je suis avec vous tous les jours jusqu'à l’achèvement du siècle. Amen~!
\PPE{}
\end{multicols}
