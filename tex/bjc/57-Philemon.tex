\ShortTitle{Phm.}\BookTitle{Philémon}\BFont
\noindent\hrulefill
{\footnotesize
\textit{
\bigskip
...
\VS{5}car j'entends parler de la foi que tu as au Seigneur Jésus, et de ta charité envers tous les saints,
...
\VS{7}Car, mon frère, nous avons une grande joie et une grande consolation au sujet de ta charité, parce que tu as réjoui les entrailles des saints.
...
\VS{14}mais je n'ai rien voulu faire sans ton avis, afin que ce ne soit pas comme par contrainte, mais volontairement, que tu me laisses un bien qui est à toi.
...
\VS{16}non plus comme un esclave, mais comme étant au-dessus d'un esclave, à savoir comme un frère bien-aimé, principalement de moi~; et combien plus de toi, soit dans la chair, soit dans le Seigneur~?
...
\VS{21}Etant persuadé de ton obéissance, je t'écris sachant que tu feras même plus que ce que je te dis.
\TextTitle{Conclusion}
\VS{22}Mais en même temps, prépare-moi un logement~; car j'espère que je vous serai rendu par vos prières.
