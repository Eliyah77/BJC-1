...
\VS{16}Les fils de Jojakim furent Jéconia, son fils, qui eut pour fils Sédécias.
\TextTitle{Les fils de Jéconia}
\VS{17}Quant aux fils de Jéconia, Assir qui fut emmené en captivité, Schealthiel fut son fils~;
...
\VS{42}Cinq cent hommes d'entre eux, c'est-à-dire des fils de Siméon, s'en allèrent à la montagne de Séir, et ils avaient à leur tête Pelathia, Nearia, Rephaja, et Uziel, fils de Jischeï~;
...
\VS{23}Les fils de la demi-tribu de Manassé habitèrent aussi dans ce pays-là, et s'étendirent depuis Basan jusqu'à Baal-Hermon et à Sénir, à la montagne de l'Hermon~; ils étaient nombreux.
...
\VS{35}fils de Tsuph, fils d'Elkana, fils de Machath, fils d'Amasaï,
...
\VS{9}Ils le dépouillèrent et emportèrent sa tête et ses armes. Puis ils envoyèrent dans le pays des Philistins, de tous côtés, pour annoncer la nouvelle à leurs dieux et au peuple.
...
\VS{11}Or tous ceux de Jabès de Galaad, ayant appris tout ce que les Philistins avaient fait à Saül,
...
\VS{10}Des fils d'Uziel~: Amminadab, le chef, et ses frères, cent douze.
...
\VS{22}Et il a dit~: Ne touchez point à mes oints, et ne faites point de mal à mes prophètes\FTNT{L'expression «~ne touchez pas à mes oints~» signifie qu'il ne fallait pas porter atteinte physiquement aux rois, aux prophètes, et aux prêtres, sur qui reposait l'onction de Dieu. Il est donc clair que ce verset, que l'on retrouve également dans le Ps. 105:15, ne concerne absolument pas la remise en question des enseignements d'un quelconque pasteur, prophète ou apôtre. Aujourd'hui, tous les chrétiens sont oints de Dieu (Ep. 1:13~; Ep. 4:30).}~!
...
\VS{3}Mais il arriva cette nuit-là que la parole de Dieu vint à Nathan, en disant~:
...
\VS{5}Ils s'en allèrent, et le firent savoir par le moyen de quelques personnes à David, qui envoya des gens à leur rencontre~; car ces hommes-là étaient dans une grande confusion. Et le roi leur fit dire~: Restez à Jéricho jusqu'à ce que votre barbe ait repoussé, et revenez ensuite.
...
\VS{12}Choisis ou la famine durant l'espace de trois ans~; ou trois mois de défaites devant tes adversaires en sorte que l'épée de tes ennemis t'atteigne~; ou trois jours pendant lesquels l'épée de Yahweh et la peste seront dans le pays et l'Ange de Yahweh portera la destruction dans toutes les contrées d'Israël. Vois maintenant ce que j'aurai à répondre à celui qui m'a envoyé.
...
\VS{12}Seulement, que Yahweh te donne de la sagesse et de l'intelligence, et qu'il t'instruise concernant le gouvernement d'Israël, et comment tu dois garder la loi de Yahweh, ton Dieu.
...
\VS{11}David donna à Salomon, son fils, le modèle du portique, de ses maisons, des chambres du trésor, des chambres hautes, des chambres intérieures et du lieu du propitiatoire.
...
\VS{5}afin qu'il y ait de l'or partout où il faut de l'or, et de l'argent partout où il faut de l'argent~; et pour tout l'ouvrage qui se fera par la main des ouvriers. Et qui est celui d'entre vous qui se disposera volontairement à offrir aujourd'hui libéralement à Yahweh~?
...
\VS{24}Et tous les chefs et les héros, et même tous les fils du roi David consentirent à être les sujets du roi Salomon.
