...
% chapitres
%\newcommand{\Chap}[1]{\def\webchap{#1:}\def\vchap{#1}\begin{center}\ssubsection{\textbf{{CHAPITRE\ #1}}}\end{center}}
\newcommand{\Chap}[1]{\def\webchap{#1:}\def\vchap{#1}{\centering\ssubsection{\textbf{{CHAPITRE\ #1}}}}}
% versets
